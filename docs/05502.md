...
# [](#your-localhost-on-the-internet-and-that-too-ssl-enabled-with-no-restrictions)你在互联网上的本地主机，也就是不受限制地启用 SSL。
...
### [](#what-are-the-benefits-of-this-setup-you-may-ask)这种设置有什么好处？你可能会问。
...
## [](#step-1-configuring-server-with-nginx-to-serve-traffic-for-the-subdomain)步骤 1 -使用 nginx 配置服务器，为子域提供流量服务
...
## [](#step-2-configuring-subdomain-on-dns)步骤 2 -在 DNS 上配置子域
