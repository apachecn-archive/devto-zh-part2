...
## [](#an-example-managing-meetups-with-react)一个例子:用 React 管理聚会
...
## [](#its-smart-but-its-complex)很聪明，但是很复杂
...
## [](#fetching-data-without-redux)取数据无冗余
...
## [](#replacing-the-redux-store-by-react-state)用 React 状态替换 Redux 存储
...
### [](#passing-the-state-down-using-react-context)使用 React 上下文传递状态
...
## [](#so-redux-or-not-redux-)那么，Redux 还是不 Redux？
