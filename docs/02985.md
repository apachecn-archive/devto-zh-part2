...
> 原文:[https://dev . to/swim burger/crawling-through-um braco-with-sitemaps-4c K6](https://dev.to/swimburger/crawling-through-umbraco-with-sitemaps-4ck6)
...
## [](#sitemap-implementation-in-umbraco)在 Umbraco 中实现网站地图
...
### [](#adding-a-basepage-composition)添加一个 BasePage 组成
...
### [](#generating-the-sitemap-file)生成站点地图文件
...
### [](#setting-up-a-rewrite-rule-to-sitemapxml)为/sitemap.xml 设置重写规则
...
#### [](#redirect-inconsistent-urls)重定向不一致的 URL
