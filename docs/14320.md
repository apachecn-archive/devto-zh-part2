...
# [](#setting-up-a-new-vuejs-app-for-success)为成功建立新的 Vue.js 应用程序

在这里，我们将看到如何用 **vue-cli** 设置一个新创建的应用程序，这样我们就可以马上开始使用它了。

## [](#prerequisites)先决条件

### [](#install-nodejs-yarn-and-vuecli)安装 Node.js、Yarn 和 vue-cli
...
## [](#adjust-eslint-rules)调整 ESLint 规则
...
## [](#install-project-dependencies)安装项目依赖关系
...
## [](#initial-app-configuration-and-setup)初始应用配置和设置
