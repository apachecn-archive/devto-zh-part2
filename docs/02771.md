...
## [](#why-write-microservices-in-the-first-place)为什么一开始要写微服务？
...
## [](#dont-take-on-the-orm-overhead)不承担 ORM 开销
...
## [](#design-patterns-might-be-a-baggage)设计图案可能是一个包袱
