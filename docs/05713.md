...
## [](#nombre-de-dominio-dns-zona-de-qu%C3%A9-hablamos)域名、DNS、地区，∞我们在说什么？
...
## [](#consideraciones-sobre-el-hecho-de-pagar-para-un-nombre-de-dominio)域名付费的考虑事项
...
## [](#reinicio-y-verificaci%C3%B3n)重新启动和验证
...
## [](#inscripci%C3%B3n-en-euorg)在 EU.org 的注册
...
## [](#creaci%C3%B3n-de-un-nombre-de-dominio)创造一个统治的名字
