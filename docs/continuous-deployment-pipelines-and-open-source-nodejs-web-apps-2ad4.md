# 持续部署管道和开源 Node.js Web 应用

> 原文：<https://dev.to/auth0/continuous-deployment-pipelines-and-open-source-nodejs-web-apps-2ad4>

在本文中，您将了解如何为您的开源 web 应用程序配置持续部署管道。出于演示目的，您将使用 Now.sh、GitHub 和 Travis CI 来自动化管道。然而，该策略实际上可以用于其他编程语言(例如 Python、Java 和。NET Core)和工具(比如 BitBucket、AWS 和 CircleCI)。
