...
> 原文:[https://dev . to/mcapoz/passing-data-in-react-with-prop drilling-454 p](https://dev.to/mcapoz/passing-data-in-react-with-propdrilling-454p)
...
#### [](#more-complex-prop-drilling)更复杂的支柱钻孔
...
#### [](#prop-drilling-with-a-state-change)支柱钻孔有状态变化
