...
## [](#now-a-typescript-class-decorator)现在，一个类型脚本类装饰器
...
## [](#next-a-react-component-class-decorator)接下来，React 组件类装饰器
...
## [](#initializing-a-context)初始化一个上下文
...
## [](#writing-our-context-decorator)编写我们的上下文装饰器
...
## [](#writing-our-provider-component-class)编写我们的提供者组件类
...
## [](#writing-our-consumer-component-classes)编写我们的消费者组件类
...
## [](#lets-render-into-the-dom)让我们渲染成 DOM
