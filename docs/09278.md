...
## [](#get-the-base-aspnet-core-and-react-application)获取 ASP.NET 基地核心和 React 应用
...
## [](#install-your-react-dependencies)安装您的 React 依赖项
...
## [](#add-registration-to-the-react-application)向 React 应用程序添加注册
...
## [](#handle-user-state-in-the-react-application)处理 React 应用程序中的用户状态
...
## [](#add-registration-to-the-aspnet-core-api)添加注册到 ASP.NET 核心 API
...
## [](#add-authentication-to-the-react-application)向 React 应用程序添加认证
...
## [](#add-a-profile-page-to-the-react-application)向 React 应用程序添加一个个人资料页面
...
## [](#add-routes-for-the-login-and-registration-pages)为登录和注册页面添加路线
...
## [](#add-navigation-to-your-react-application)为 React 应用程序添加导航
...
## [](#add-a-talk-submission-react-component)添加一个 Talk 提交 React 组件
...
## [](#add-the-session-creation-route-to-aspnet-core)添加会话创建路由到 ASP.NET 核心
...
## [](#read-the-sessions-in-you-react-application)阅读 React 应用程序中的会话
...
## [](#get-sessions-from-your-aspnet-core-application)从您的 ASP.NET 核心应用程序获取会话
...
## [](#make-the-sessions-editable-in-react)使会话在 React 中可编辑
...
## [](#update-a-session-in-aspnet-core-api)更新 ASP.NET 核心 API 中的会话
...
## [](#delete-submissions-from-react)从 React 中删除提交内容
...
## [](#delete-sessions-in-aspnet-core)删除 ASP.NET 核心中的会话
