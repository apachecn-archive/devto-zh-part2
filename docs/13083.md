...
> 原文:[https://dev . to/whoisryosuke/how-to-make-shopify-template-snippets-27kc](https://dev.to/whoisryosuke/how-to-make-shopify-template-snippets-27kc)
...
## [](#what-does-the-schema-mean)图式是什么意思？
...
## [](#adding-the-variables-to-your-snippet)将变量添加到代码片段中
...
## [](#if-block-contains-variable-do-something)如果块包含变量，做点什么
