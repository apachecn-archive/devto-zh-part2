...
> 原文:[https://dev . to/stuartblang/adding-assemblymetadata attribute-using-new-SDK-project-with-msbuild-2 akl](https://dev.to/stuartblang/adding-assemblymetadataattribute-using-new-sdk-project-with-msbuild-2akl)
