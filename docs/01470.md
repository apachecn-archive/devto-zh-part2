...
> 原文:[https://dev . to/pongsatt/set-up-nginx-ingress-with-lets encrypt-certificate-on-VMs-or-bare-metal-kubernetes-cluster-j25](https://dev.to/pongsatt/set-up-nginx-ingress-with-letsencrypt-certificate-on-vms-or-bare-metal-kubernetes-cluster-j25)
