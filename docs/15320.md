...
> 原文:[https://dev.to/skyrpex/create-a-spa-with-laravel-and-nuxt-54k](https://dev.to/skyrpex/create-a-spa-with-laravel-and-nuxt--54k)
...
## [](#install-laravelnuxt-for-php)安装 laravel-nuxt(针对 PHP)
...
## [](#install-laravelnuxt-for-js)安装 laravel-nuxt(用于 JS)
...
# [](#calling-the-api-from-the-spa)从 SPA 调用 API
