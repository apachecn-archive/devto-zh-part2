# Golang & Angular 系列-第 1 部分:开发和保护 Golang APIs

> 原文：<https://dev.to/auth0/golang--angular-series---part-1-developing-and-securing-golang-apis-41f>

在本系列中，您将学习如何使用 Golang 和 Angular 构建现代应用程序。在第一篇文章中，您将使用 Golang 构建一个安全的后端 API，它将支持待办事项列表应用程序。
