...
> 原文:[https://dev.to/jalogut/proper-magento-2-composer-setup-40dm](https://dev.to/jalogut/proper-magento-2-composer-setup-40dm)
...
## [](#wrong-magento-docs)错误的 Magento 文档
...
## [](#summary-and-files-overview)摘要和文件概述
...
### [](#magentosymlinks)magento.symlinks
