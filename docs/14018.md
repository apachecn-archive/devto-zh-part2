...
# [](#how-to-feed-the-beast-the-web-application)如何喂野兽(web 应用)

## [](#optimal-solution)最优解

最终的解决方案将是一个 web 服务，它交换来自收集客户机数据的 web 应用程序和存储并管理数据的新应用程序的数据。

## [](#call-to-a-web-service-for-every-insertupdate-in-the-excel-file)每次插入/更新 Excel 文件时调用 web 服务
...
## [](#call-to-a-web-service-at-excel-close-passing-all-the-data)调用 Excel 中的 web 服务关闭传递所有数据
