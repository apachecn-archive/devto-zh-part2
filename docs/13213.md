...
> 原文:[https://dev.to/swyx/quick-guide-to-setup-your-react-打字稿-故事书-设计-系统-1c51](https://dev.to/swyx/quick-guide-to-setup-your-react--typescript-storybook-design-system-1c51)
...
# [](#your-first-typescript-component)你的第一个打字稿组件
...
# [](#time-to-build-and-ship-your-onebutton-design-system)构建和交付您的(一键式)设计系统的时间
