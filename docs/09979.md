...
> 原文:[https://dev . to/hajimehoshi/gopherjs-vs-web assembly-for-go-148m](https://dev.to/hajimehoshi/gopherjs-vs-webassembly-for-go-148m)
...
# [](#port-gopherjs-library-to-webassembly)将 GopherJS 库移植到 WebAssembly
...
# [](#binary-size-comparison)二进制大小比较
...
# [](#appendix-how-to-do-experiments)附录-如何做实验

## [](#install-ebiten-and-other-libraries)安装 Ebiten 等库
...
## [](#get-the-latest-go-and-compile-it)获取最新的 Go 并编译
...
## [](#compile-an-ebiten-example-for-webassembly)为 WebAssembly 编译一个 Ebiten 示例
...
## [](#run-gopherjs-server)运行 GopherJS 服务器
