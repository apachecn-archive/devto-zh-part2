...
### [](#line-breaks-with-single-quotes)用单引号换行
...
### [](#special-characters-and-escape-characters-with-single-quotes)特殊字符和转义字符用单引号括起来
...
### [](#special-characters-and-escape-characters-with-double-quotes)特殊字符和转义字符用双引号括起来
