...
> 原文:[https://dev.to/takeshape/graphql-CMS-花生酱-果冻-25b](https://dev.to/takeshape/graphql--cms--peanut-butter--jelly-25b)
...
## [](#headless-graphql-cms-ssg)无头 GraphQL CMS + SSG
...
### [](#static-content-generator-static-site-generator)静态内容生成器(静态站点生成器)
...
### [](#model-create-develop-use)建模、创建、开发、使用
...
## [](#deciding-to-use-graphql)决定使用 GraphQL
...
### [](#in-the-end-it-came-down-to-a-few-things)最后，归结为几件事
...
## [](#how-we-use-graphql-to-build-takeshape)我们如何使用 GraphQL 来构建 TakeShape
...
## [](#how-developers-use-takeshapes-graphql-api)开发者如何使用 TakeShape 的 GraphQL API
