...
> 原文:[https://dev . to/psy ked/put-our-component-library-on-diet-gfb](https://dev.to/psyked/putting-our-component-library-on-a-diet-gfb)

#### [](#performance-matters-and-houston-we-have-a-problem)性能很重要，还有“休斯顿，我们有个问题。”
...
### [](#experiment-driven-development)实验驱动开发
...
#### [](#tree-shaking-dead-code-elimination)树摇动/死码消除
...
### [](#a-better-bundler-with-rollupjs)一个更好的捆绑器…用 rollup.js
...
### [](#bonus-createreactapp-2-amp-webpack-4)奖励:创建-反应-应用 2 &网络包 4
