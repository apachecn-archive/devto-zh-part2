...
> 原文:[https://dev.to/atorin/tables-重组文本-1m6n](https://dev.to/atorin/tables--restructuredtext-1m6n)
...
# [](#sphinx-tables-pdf-output)Sphinx +表格+ PDF 输出
...
# [](#html-table-gt-rst-table)HTML 表格- > RST 表格
