...
> 原文:[https://dev . to/amejiarosario/data-structures-for-初学者-arrays-hashmap-and-lists-5645](https://dev.to/amejiarosario/data-structures-for-beginners-arrays-hashmaps-and-lists-5645)
...
# [](#data-structures-bigo-cheatsheet)数据结构大样图
...
### [](#arrays-builtin-operations)数组内置运算
...
### [](#insert-element-on-an-array)在数组上插入元素
...
### [](#access-an-element-in-an-array)访问数组中的一个元素
...
### [](#search-an-element-in-an-array)搜索数组中的一个元素
...
### [](#deleting-elements-from-an-array)从数组中删除元素
...
### [](#array-operations-time-complexity)阵列运算时间复杂度
...
### [](#na%C3%AFve-hashmap-implementation)天真的 HashMap 实现
...
### [](#improving-hash-function)改进哈希函数
...
## [](#decent-hashmap-implementation)体面散列表实现
...
## [](#optimal-hashmap-implementation)最优 HashMap 实现
...
### [](#insert-element-on-a-hashmap-runtime)在 HashMap 运行时插入元素
...
### [](#searchaccess-an-element-on-a-hashmap-runtime)在 HashMap 运行时搜索/访问元素
...
### [](#editdelete-element-on-a-hashmap-runtime)在 HashMap 运行时编辑/删除元素
...
## [](#hashmap-operations-time-complexity)HashMap 操作时间复杂度
...
### [](#set-operations-runtime)设定操作运行时
...
### [](#singly-linked-lists-time-complexity)单链表时间复杂度
...
## [](#doubly-linked-lists-time-complexity)双链表时间复杂度
...
## [](#queue-implemented-with-arrays)用数组实现的队列
...
## [](#queue-implemented-with-a-doubly-linked-list)用双向链表实现队列
