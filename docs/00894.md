...
> 原文:[https://dev . to/s _ anastasov/functional-hangman-in-kotlin-with-arrow-2 cmd](https://dev.to/s_anastasov/functional-hangman-in-kotlin-with-arrow-2cmd)
...
## [](#reading-and-writing-from-the-console)从控制台读写
