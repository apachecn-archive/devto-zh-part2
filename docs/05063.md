...
> 原文:[https://dev . to/aurelkurtula/creating-a-text-editor-in-electronic-part-3-setting-preferences-584h](https://dev.to/aurelkurtula/creating-a-text-editor-in-electron-part-3---setting-preferences-584h)
...
## [](#initializing-the-preferences-window)初始化首选项窗口
...
### [](#saving-the-colour-preferences)保存颜色首选项
...
## [](#applying-the-saved-colour-to-the-main-window)将保存的颜色应用到主窗口
