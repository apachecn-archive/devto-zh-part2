...
> 原文:[https://dev . to/bnevilleoneill/is-typescript-on-node-js-good-found-for-Java-developers-4m8e](https://dev.to/bnevilleoneill/is-typescript-on-node-js-good-enough-for-java-developers-4m8e)
...
### [](#typescript-interfaces-and-a-bigger-example)Typescript 接口和一个更大的例子
...
### [](#retrieving-from-external-storage%E2%80%8A%E2%80%8Aexecutiontime-type-checking)从外部存储器检索—执行时类型检查
