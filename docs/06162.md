...
> 原文:[https://dev.to/twilio/-emoji-translations-with-the-twilio-API-for-whatsapp-and-nodejs-486d](https://dev.to/twilio/-emoji-translations-with-the--twilio-api-for--whatsapp-and-nodejs-486d)
...
## [](#%F0%9F%8F%97-building-the-app)🏗构建应用程序
