...
> 原文:[https://dev . to/Jeb/angular-CLI-6-under-the-hood-builders-demystified-2975](https://dev.to/jeb/angular-cli-6-under-the-hood-builders-demystified-2975)
...
## [](#angular-cli-builders)角度 CLI 生成器
...
## [](#angular-cli-commands-and-architect-targets)角度 CLI 命令和架构目标
...
## [](#architect-targets-configuration)架构目标配置
...
## [](#creating-you-own-builder)创建自己的构建器
