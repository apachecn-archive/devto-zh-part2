...
> 原文:[https://dev . to/freekmurze/a-package-that-make-event-sourcing-in-laravel-a-breeze-KOA](https://dev.to/freekmurze/a-package-that-makes-event-sourcing-in-laravel-a-breeze-koa)
...
## [](#getting-started-with-event-sourcing)事件采购入门
...
## [](#lets-install-the-package)让我们安装软件包
...
## [](#writing-your-first-projection)书写你的第一个投影
...
## [](#handling-side-effects-using-reactors)利用反应器处理副作用
