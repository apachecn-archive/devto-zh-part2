...
> 原文:[https://dev.to/neshaz/css-101-the-box-model-jjp](https://dev.to/neshaz/css-101-the-box-model-jjp)
...
## [](#the-structure-of-the-box-model)盒子的结构模型
...
### [](#using-inline-and-block-level-elements)使用行内和块级元素
