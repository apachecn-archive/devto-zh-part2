...
> 原文:[https://dev . to/oktadev/add-cicd-to-your-spring-boot-app-with-Jenkins-x-and-kubernetes-1jld](https://dev.to/oktadev/add-cicd-to-your-spring-boot-app-with-jenkins-x-and-kubernetes-1jld)
...
## [](#highperformance-development-with-cicd-kubernetes-and-jenkins-x)使用 CI/CD、Kubernetes 和 Jenkins X 进行高性能开发
...
## [](#what-does-jenkins-x-do)詹金斯 X 是干什么的？
...
## [](#get-started-with-jenkins-x)詹金斯 X 入门

要安装 Jenkins X，您首先需要在您的机器或云提供商上安装`jx`二进制文件。谷歌云可以获得 300 美元的积分，所以我决定从这里开始。

### [](#install-jenkins-x-on-google-cloud-and-create-a-cluster)在谷歌云上安装 Jenkins X，创建集群
...
### [](#create-a-spring-boot-app)创建 Spring Boot App
...
### [](#deploy-your-spring-boot-app-to-production-with-jenkins-x)使用 Jenkins X 将您的 Spring Boot 应用部署到生产环境中
...
## [](#secure-your-spring-boot-app-and-add-an-angular-pwa)保护你的 Spring Boot 应用并添加一个有角度的 PWA
...
### [](#add-actuator-and-turn-off-https)添加执行器并关闭 HTTPS
...
### [](#adjust-paths-in-dockerfile-and-jenkinsfile)调整 Dockerfile 和 Jenkinsfile 中的路径
...
## [](#create-a-web-application-in-okta-for-your-spring-boot-app)在 Okta 为您的 Spring Boot 应用程序创建一个 Web 应用程序
...
### [](#storing-secrets-in-jenkins-x)在詹金斯 X 中储存秘密
...
### [](#transferring-environment-variables-to-docker-containers)将环境变量转移到 Docker 容器
...
### [](#automate-adding-redirect-uris-in-okta)在 Okta 中自动添加重定向 URIs
...
### [](#running-protractor-tests-in-jenkins-x)在詹金斯 X 中运行量角器测试
...
## [](#learn-more-about-jenkins-x-kubernetes-and-spring-boot)了解更多关于詹金斯 X、库伯内特和 Spring Boot 的信息
