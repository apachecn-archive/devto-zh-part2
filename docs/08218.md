...
> 原文:[https://dev . to/evil mars/the-silence-of-the-the-ruby-exceptions-a-railspostgresql-database-transaction-thriller-5e 30](https://dev.to/evilmartians/the-silence-of-the-ruby-exceptions-a-railspostgresql-database-transaction-thriller-5e30)
...
## [](#transaction-locks-to-the-rescue)事务锁来拯救！
...
## [](#postgresqls-builtin-alternative-to-transactionlevel-locks)PostgreSQL 的内置替代事务级锁
...
## [](#what-to-do-with-concurrent-inserts-of-the-same-record)如何处理相同记录的并发插入？
...
## [](#preventing-future-havoc)防止未来的浩劫
