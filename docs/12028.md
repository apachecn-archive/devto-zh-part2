...
> 原文:[https://dev . to/autonomous apps/dagger-dot-Android-part-2-viewmodels-and-viewmodel-factories-10ii](https://dev.to/autonomousapps/dagger-dot-android-part-2-viewmodels-and-viewmodel-factories-10ii)
...
# [](#-raw-mainactivity-endraw-)`MainActivity`
...
# [](#-raw-mainactivityviewmodelfactory-endraw-)`MainActivityViewModelFactory`
...
# [](#viewmodelproviderfactory)视图模型提供者。工厂
...
## [](#viewmodelproviderfactory-defined)视图模型提供者。工厂，已定义
...
# [](#why-do-we-care-about-raw-viewmodel-endraw-s-at-all)我们到底为什么要关心 s 呢？
...
## [](#heavy-objects-and-raw-mutableobjectfactory-endraw-)重物和`MutableObjectFactory`
