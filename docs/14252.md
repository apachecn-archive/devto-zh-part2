...
> 原文:[https://dev . to/remote synth/conforming-to-JavaScript-code-styles-50 h6](https://dev.to/remotesynth/conforming-to-javascript-code-styles--50h6)
