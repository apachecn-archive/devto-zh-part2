...
> 原文:[https://dev . to/Hugo _ _ df/a-simple-JavaScript node-coding-setup-on-MAC-OS-x-h4k](https://dev.to/hugo__df/a-simple-javascriptnode-coding-setup-on-mac-os-x-h4k)
...
### [](#change-edit-mode-to-natural-text)将编辑模式改为自然文本
...
### [](#new-session-should-start-where-previous-left-off)新的会话应该从先前停止的地方开始
...
## [](#install-vscode-command-line-tools)安装 VSCode 命令行工具
...
## [](#nice-to-have-extensions)有扩展功能真好
...
# [](#misc-and-extras)杂项和附加项目

❤️ Spotify

## [](#optional-docker-virtualbox)(可选)坞站、虚拟箱
