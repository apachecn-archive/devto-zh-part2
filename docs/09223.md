...
> 原文:[https://dev . to/django tricks/equivalents-in-python-and-JavaScript-part-2-3 fej](https://dev.to/djangotricks/equivalents-in-python-and-javascript-part-2-3fej)
...
## [](#splitting-strings-by-regular-expressions)通过正则表达式拆分字符串
...
## [](#matching-regular-expression-patterns-in-strings)匹配字符串中的正则表达式模式
...
## [](#replacing-patterns-in-strings-using-regular-expressions)使用正则表达式替换字符串中的模式
