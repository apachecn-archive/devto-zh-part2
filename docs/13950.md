...
> 原文:[https://dev . to/twilio/how-to-detect-if-a-chrome-extension-is-installed-3fmk](https://dev.to/twilio/how-to-detect-if-a-chrome-extension-is-installed-3fmk)
...
## [](#detecting-the-extension-from-the-page)从页面中检测扩展名
...
## [](#extension-detection-completion)扩展检测完成
