...
> 原文:[https://dev.to/onmyway133/using-circleci-20-43n8](https://dev.to/onmyway133/using-circleci-20-43n8)
...
### [](#creating-raw-configyml-endraw-)创造`config.yml`
...
### [](#checking-raw-xcodebuild-endraw-)检查`xcodebuild`
