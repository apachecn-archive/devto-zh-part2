...
> 原文:[https://dev.to/stereobooster/json-json-json-4ed7](https://dev.to/stereobooster/json-json-json-4ed7)
...
### [](#asymetric-encodingdecoding)非对称编码/解码
...
### [](#security-script-injection)安全性:脚本注入
...
### [](#lack-of-schema-and-serializerparser)缺少模式和串行化器/解析器
...
### [](#lack-of-schema-and-performance)缺乏图式和表现
...
### [](#stream-parserserializer)流解析器/串行化器
...
### [](#as-a-configuration-file)作为配置文件
...
### [](#binary-data-and-schema)二进制数据和模式
