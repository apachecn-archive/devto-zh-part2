...
## [](#the-main-problem-isolation)主要问题——隔离
...
## [](#building-the-bridge-between-apis)搭建 API 之间的桥梁
...
## [](#implementing-a-custom-event-propagation-algorithm)实现自定义事件传播算法
...
## [](#attaching-the-scope-information)附加范围信息
...
## [](#using-the-information-to-distribute-events)利用信息分发事件
...
## [](#finishing-our-listener-registration)完成我们的听众注册
...
## [](#writing-our-own-event-bubbling)书写我们自己冒泡的事件
