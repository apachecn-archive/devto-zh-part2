...
> 原文:[https://dev . to/djangostars/asynchronous-programming-in-python-asyncio-guide-2c 61](https://dev.to/djangostars/asynchronous-programming-in-python--asyncio-guide-2c61)

如果出于某种原因，您决定理解 Python 的异步部分，欢迎来到我们的“Asyncio How-to”。

注意:即使不知道异步范式的存在，您也可以成功地使用 Python。然而，如果你对事情如何在引擎盖下工作感兴趣，asyncio 绝对值得一查。

## [](#what-asynchronous-is-all-about)异步是怎么回事？
...
## [](#asynchronous-vs-synchronous-code)异步 vs 同步代码
...
### [](#several-reasons-to-stick-to-asynchronous-programming)坚持异步编程的几个理由
