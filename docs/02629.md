...
> 原文:[https://dev . to/adnanrahic/a-crash-course-on-optimizing-your-docker-images-for-production-2f9l](https://dev.to/adnanrahic/a-crash-course-on-optimizing-your-docker-images-for-production-2f9l)
...
### [](#using-the-default-nodejs-image)使用默认的 Node.js 图像
...
### [](#using-the-nodejs-alpine-image)使用 Node.js 高山影像
...
### [](#excluding-development-dependencies)排除开发依赖
...
### [](#using-the-base-alpine-image)使用基地高山影像
...
### [](#using-multistage-builds)使用多级构建
