...
> 原文:[https://dev . to/mustafaturan/decoupled-modules-with-elixireventbus-4 fcd](https://dev.to/mustafaturan/decoupled-modules-with-elixireventbus-4fcd)
...
### [](#get-started-with-decoupled-modules-in-4%C2%A0steps)通过 4 个步骤开始解耦模块

解耦模块帮助我们编写清晰的代码，一次只关注一件事。使用 EventBus 库，您可以从真实事件总线系统中获益，并轻松编写解耦模块。

#### [](#registering-event%C2%A0topics)注册事件主题
...
#### [](#subscribing-consumers-to%C2%A0topics)为消费者订阅话题
...
### [](#about-the-eventbus%C2%A0library)关于 EventBus 库
