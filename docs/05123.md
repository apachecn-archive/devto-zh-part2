...
> 原文:[https://dev . to/iam _ Tim Smith/let-build-a-search-bar-in-react-120j](https://dev.to/iam_timsmith/lets-build-a-search-bar-in-react-120j)
...
### [](#add-packages-to-our-project)向我们的项目添加包
...
### [](#set-up-packagejson-and-babelrc)设置 package.json 和。巴伯尔克
...
### [](#set-up-appjs-file)设置 app.js 文件
...
#### [](#what-is-the-code-above-doing)上面的代码在做什么？
...
### [](#adding-items-to-the-list)向列表中添加项目
...
#### [](#add-functionality-to-add-item)添加功能添加物品
...
#### [](#add-button-to-delete-item)添加按钮删除项目
...
### [](#turning-the-list-into-a-component)将列表变成组件
...
#### [](#whats-the-code-above-doing)上面的代码在做什么？
...
### [](#create-a-filtered-item-in-list)在列表中创建过滤项
...
### [](#create-the-search-bar-itself)创建搜索栏本身
...
### [](#make-the-search-bar-search)使搜索栏搜索
...
### [](#adding-the-method-to-the-input)向输入中添加方法
