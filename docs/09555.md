...
> 原文:[https://dev . to/adnanrahic/solving-invisible-scaling-issues-with-server less-and-MongoDB-4m 55](https://dev.to/adnanrahic/solving-invisible-scaling-issues-with-serverless-and-mongodb-4m55)
...
### [](#how-do-databases-work-with-serverless)数据库如何与无服务器协同工作？
...
### [](#using-lambda-with-mongodb-atlas)使用 Lambda 与 MongoDB 图册
...
### [](#what-about-connection-limits)连接限制呢？
...
### [](#using-lambda-with-mongodb-stitch)使用 Lambda 与 MongoDB 缝合
