...
## [](#introducing-laraveleventprojector)介绍 laravel-event-projector

我制作了一个简短的视频来解释这个包的高级概念。

## [](#what-are-projectors)什么是投影仪？
...
### [](#creating-your-first-projector)打造您的第一台投影仪
...
### [](#registering-your-projector)注册您的投影仪
...
## [](#your-second-projector)您的第二台投影仪
...
### [](#benefits-of-projectors-and-projections)投影仪和投影的好处
...
## [](#handling-side-effects-with-reactors)用反应器处理副作用
...
### [](#creating-your-first-reactor)创造你的第一个反应堆
...
### [](#registering-your-reactor)注册您的反应堆
...
## [](#handling-events-in-a-queue)处理队列中的事件
