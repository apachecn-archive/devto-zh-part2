...
> 原文:[https://dev . to/tech community/SQL-access-to-mainframe-data-3 mna](https://dev.to/techcommunity/sql-access-to-mainframe-data-3mna)
...
## [](#using-sql-to-bridge-the-gap)使用 SQL 弥合差距
...
## [](#using-connx-to-virtualize-mainframe-data-via-sql)使用 CONNX 通过 SQL 虚拟化大型机数据
...
## [](#securing-access-to-the-mainframe-data)保护对大型机数据的访问
...
## [](#unified-access-from-sqlbased-applications)来自基于 SQL 的应用程序的统一访问
