# 重定向及其对性能的影响，或者(看似微小的)第三方更改如何影响…
...
### [](#redirects-and-their-effect-on-performance-or-how-a-seemingly-minor-third-party-change-affected-the-website-performance-of-a-popular-javascript-bundler)重定向，以及它们对性能的影响，或者一个(看似微小的)第三方变化如何影响一个流行的 JavaScript Bundler 的网站性能
...
### [](#filing-a-defect%E2%80%8A%E2%80%8Aand-resolution)归档缺陷—和解决方案
