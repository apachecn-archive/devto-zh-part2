...
> 原文:[https://dev.to/techiediaries/webpack-4-tutorial-5a59](https://dev.to/techiediaries/webpack-4-tutorial-5a59)
...
## [](#webpack-4-doesnt-need-a-configuration-file-by-default)Webpack 4 默认不需要配置文件
