...
> 原文:[https://dev . to/mason ite/sending-automated-emails-with-mason ite-framework-13cc](https://dev.to/masonite/sending-automated-emails-with-masonite-framework-13cc)
...
# [](#setting-up-your-application)设置您的应用
...
# [](#creating-and-sending-an-email)创建和发送电子邮件
