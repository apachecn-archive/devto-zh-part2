...
## [](#the-pattern-that-emerged-the-quick-version)浮现的图案(快速版)
...
## [](#isolate-first-dependency)先隔离依赖
...
## [](#separating-dependencies)分隔依赖关系
...
## [](#discover-second-dependency-the-raw-fetch-endraw-function)发现第二个依赖项，`fetch()`功能
...
## [](#inject-the-second-dependency)注入第二个依赖项
...
## [](#provide-production-dependencies)提供生产依赖关系
