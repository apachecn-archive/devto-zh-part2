...
> 原文:[https://dev . to/wia io/how-to-build-your-own-your-own-weather-station-using-a-raspberry-pi-415 o](https://dev.to/wiaio/how-to-build-your-own-weather-station-using-a-raspberry-pi-415o)
...
# [](#setting-up-the-wia-nodejs-sdk)设置 Wia Node.js SDK
...
# [](#using-the-sense-hat-with-nodejs)使用带有 Node.js 的 Sense HAT
...
# [](#create-your-weather-device)创建您的天气设备
