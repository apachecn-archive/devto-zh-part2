...
> 原文:[https://dev . to/intrice cloud/web driver io-tips-using-selector-vs-browserelementselector-3c 36](https://dev.to/intricatecloud/webdriverio-tips-using-selector-vs-browserelementsselector-3c36)
...
## [](#using-selector-vs-browserelementsselector)用$$。选择器与浏览器.元素(选择器)
