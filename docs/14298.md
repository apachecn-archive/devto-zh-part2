...
> 原文:[https://dev . to/jordanirabor/build-an-audio-translator-with-vue js-yandex-translate-API-and-response-voice-5b 52](https://dev.to/jordanirabor/build-an-audio-translator-with-vuejs-yandex-translate-api-and-responsive-voice--5b52)
...
### [](#creating-the-translate-component)创建翻译组件
...
## [](#writing-the-code-for-the-translate-component)为翻译组件编写代码
...
### [](#writing-the-event-handlers)编写事件处理程序
...
## [](#building-the-root-component)建筑根构件
...
### [](#writing-the-javascript)编写 Javascript
...
### [](#hooking-into-the-created-lifecycle-method)挂钩到已创建的()生命周期方法
...
### [](#writing-the-translate-and-validateresponse-methods)编写翻译和验证响应方法
