...
> 原文:[https://dev . to/gorvgoyl/run-debug-get-intellisense-for-c-c-in-vs code-4e0o](https://dev.to/gorvgoyl/run-debug-get-intellisense-for-c-c-in-vscode-4e0o)
...
### [](#create-a-sample-cc-project)创建一个样本 C/C++项目
...
### [](#install-cc-compiler)安装 C/C++编译器
...
### [](#run-and-debug-cc-code)运行并调试 C/C++代码
...
#### [](#prefer-to-work-in-java)更喜欢在 JAVA 工作？
