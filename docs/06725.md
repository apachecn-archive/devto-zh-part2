...
最近， [Kevin Rutherford](https://silkandspinach.net/) 写了一系列非常有趣的帖子，在这些帖子中，他谈到了使用 **connascence** 作为选择最有效重构的指南，以及 **connascence** 如何成为比代码气味更客观和有用的工具来识别设计问题[](#nota1)。

### [](#2-what-is-connascence)2。什么是共生？
 ...
 **### [](#3-forms-of-connascence)3。共生的形式。
...
### [](#4-properties-of-connascence)4。共生的性质。
...
### [](#5-connascence-design-principles-and-refactoring)5。相关性、设计原则和重构。
...
### [](#6-how-should-we-apply-connascence)6。我们应该如何应用同生？
