# 使用 ASP.NET 核心 2.0 和 React 开发 Web 应用程序-第 2 部分

> 原文：<https://dev.to/auth0/developing-web-apps-with-aspnet-core-20-and-react---part-2--ao5>

这是关于基于 ASP.NET 核心 2.0 和 React 开发 Web 应用程序的系列文章的第二部分。[在上一篇文章](https://auth0.com/blog/developing-web-apps-with-asp-dot-net-core-2-dot-0-and-react-part-1?utm_source=dev&utm_medium=sc&utm_campaign=aspnet2_reactjs)中，您构建了一个安全的 Web API 应用程序，它使用 ASP.NET 核心 2.0 提供了一个图书列表。在本文中，您将基于 React 创建一个单页面应用程序(SPA)客户端来使用这个 API。
