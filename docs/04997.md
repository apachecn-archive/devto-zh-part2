...
> 原文:[https://dev . to/shostarsson/do-you-care-your-privacy-maybe-it-time to-set-your-own-Dropbox-ncf](https://dev.to/shostarsson/do-you-care-about-your-privacy-maybe-it-is-time-to-set-up-your-own-dropbox-ncf)
...
### [](#you-are-in-control-of-your-files)你掌控着你的文件

我将向你展示一些绝对令人惊奇的东西，那就是开源(非常重要，因为你将把你所有的文件，甚至是最隐私的文件都给它；-))

### [](#move-from-dropbox)从收存箱移动
...
### [](#%C2%A0advanced-configuration)高级配置
...
### [](#move-from-evernote)移自 Evernote
