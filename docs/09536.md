...
### [](#custom-agents-docker-and-more-goodness)定制代理商、码头工人和更多的善良
...
### [](#using-a-docker-vsts-agent)使用码头工人 VSTS 代理
