...
> 原文:[https://dev . to/equi man/run-a-command-in-external-terminal-with net-core-d4l](https://dev.to/equiman/run-a-command-in-external-terminal-with-net-core-d4l)
...
# [](#easy-way-recommended)简单易行的方法(推荐)
...
# [](#usage-magic-comes-true)用法(魔法成真)
