...
> 原文:[https://dev.to/sr_balaji/blockchain-hyperledger-fabric-a-高层-概述- 22g4](https://dev.to/sr_balaji/blockchain---hyperledger-fabric---a-high-level-overview--22g4)
...
### [](#what-is-distributed-ledger)什么是分布式台账？
...
#### [](#components-of-hyperledger-fabric)总账结构的组成部分

##### [](#peers)同行

这些是维护分类帐的网络服务。它接收用于将新交易提交到分类帐并运行智能联系人的有序更新消息。

##### [](#committing-peers)提交同行

它提交事务并维护分类帐& state。

##### [](#endorsing-peers)背书同行

它接收用于背书的交易，并验证该交易是否满足所有必要和充分的条件。因此，认可对等体通过同意或拒绝认可来响应。

##### [](#ordering-service-or-orderers)订购服务或订购者
...
#### [](#architecture-of-hyperledger-fabric-v1)超帐架构 v1
