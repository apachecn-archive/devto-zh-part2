...
> 原文:[https://dev . to/xngwng/rest-vs-graph QL-APIs-the-good-the-bad-the-ugly-34i 8](https://dev.to/xngwng/rest-vs-graphql-apis-the-good-the-bad-the-ugly-34i8)
...
## [](#fetching-multiple-resources)抓取多个资源
...
## [](#more-in-depth-analytics)更深入的分析
...
## [](#diminishes-shared-nothing-architecture)贬低共享的虚无架构
...
## [](#exposed-for-arbitrary-requests)为任意请求而暴露
...
## [](#non-existent-monitoring)不存在的监控
