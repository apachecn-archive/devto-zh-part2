...
> 原文:[https://dev . to/Apium _ hub/functional-PHP-a-first-approach-43 a3](https://dev.to/apium_hub/functional-php-a-first-approach-43a3)
...
## [](#functional-programming-amp-functional-php)函数编程&函数 PHP
...
### [](#pure-vs-impure-functions)纯函数 vs 不纯函数
...
## [](#be-functional-my-friend)要有功能我的朋友
...
## [](#conclusion-functional-php)结论:函数式 PHP
