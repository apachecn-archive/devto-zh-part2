...
> 原文:[https://dev . to/johnpaulada/graph cool-continuous-deployment-with-bit bucket-pipeline-akd](https://dev.to/johnpaulada/graphcool-continuous-deployment-with-bitbucket-pipeline-akd)
