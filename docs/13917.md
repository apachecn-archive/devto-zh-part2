...
## [](#install-gnometerminal)安装 gnome-终端
...
## [](#install-java-development-kit)安装 Java 开发包

`apt-get install openjdk-8-jdk`

## [](#get-the-android-sdk-and-install)获取 Android SDK 并安装
...
## [](#install-nodejs-and-npm)安装 nodejs 和 npm
...
## [](#install-electrodenative)安装电极-原生
