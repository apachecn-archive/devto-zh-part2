...
> 原文:[https://dev.to/onmyway133/uitableviewcell-and-model-1 尼克](https://dev.to/onmyway133/uitableviewcell-and-model--1nck)
...
### [](#category-for-simple-case)类别为简单情况
...
### [](#do-we-access-the-cell-s-subviews)我们是否访问单元格的子视图
