...
> 原文:[https://dev . to/rakan nimer/declarative ly-render-your-firebase-auth-database-firestore-data-with-react-firebase-52b 6](https://dev.to/rakannimer/declaratively-render-your-firebase-auth-database--firestore-data-with-react-firebase-52b6)
...
##### [](#web-or-react-native-with-expo)Web 或 React Native 与 Expo
...
#### [](#firebase-auth-consumers)Firebase 授权消费者

##### [](#-raw-firebaseauthconsumer-endraw-)`FirebaseAuthConsumer`
...
##### [](#auth-api-reference)[认证 API 引用](https://react-firebase-js.com/docs/react-firebase-auth/api)

#### [](#firebase-database-consumers)Firebase 数据库消费者

##### [](#read-data)读取数据

###### [](#-raw-firebasedatabasenode-endraw-)`FirebaseDatabaseNode`
...
#### [](#firestore-database-consumers)Firestore 数据库消费者

##### [](#read-data-with-raw-firestoredocument-endraw-amp-raw-firestorecollection-endraw-)读取数据同`FirestoreDocument` & `FirestoreCollection`

在应用程序组件树的任何地方，添加一个`FirestoreDocument`或`FirestoreCollection`来监听数据，并在数据改变时更新 ui。

###### [](#-raw-firestoredocument-endraw-example)`FirestoreDocument`举例。
...
###### [](#-raw-firestoredocument-endraw-api)[`FirestoreDocument` API](https://react-firebase-js.com/docs/react-firestore-database/api#firestoredocument)
...
###### [](#-raw-firestorecollection-endraw-api)[`FirestoreCollection` API](https://react-firebase-js.com/docs/react-firestore-database/api#firestorecollection)

##### [](#write-data-with-raw-firestoremutation-endraw-amp-raw-firestoretransaction-endraw-amp-raw-firestorebatchedwrite-endraw-)用`FirestoreMutation` & `FirestoreTransaction` & `FirestoreBatchedWrite`写数据
...
##### [](#-raw-firestoremutation-endraw-example)`FirestoreMutation`举例
...
##### [](#-raw-firestoretranasaction-endraw-example)`FirestoreTranasaction`举例
...
##### [](#-raw-firestorebatchedwrite-endraw-example)`FirestoreBatchedWrite`举例
