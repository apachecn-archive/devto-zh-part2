...
> 原文:[https://dev . to/superissarah/adding-timeline-animations-using-anime js-1m 47](https://dev.to/superissarah/adding-timeline-animations-using-animejs-1m47)
...
## [](#picking-an-animation-library)挑选一个动画库
...
## [](#making-shapes-spin-and-react-on-hover)使形状旋转并在悬停时做出反应
