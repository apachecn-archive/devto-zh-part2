...
> 原文:[https://dev . to/craftzdog/how-to-support-split-view-on-ipad-with-react-native-1b0n](https://dev.to/craftzdog/how-to-support-split-view-on-ipad-with-react-native-1b0n)
...
## [](#adaptable-layout-provider-consumer)适应性强的布局提供商/消费者
