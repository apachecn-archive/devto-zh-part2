...
> 原文:[https://dev.to/tomoyukikashiro/amp 使用盖茨比 4kmo](https://dev.to/tomoyukikashiro/amp--using-gatsby-4kmo)
...
### [](#modify-blog-post-template)修改博文模板
