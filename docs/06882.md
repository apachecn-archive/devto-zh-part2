...
> 原文:[https://dev.to/joenas/easy-influxdb-格拉法纳-设置-与-traefik-172j](https://dev.to/joenas/easy-influxdb--grafana-setup-with-traefik-172j)
...
### [](#getting-some-data-in-there)在那里获取一些数据
