...
> 原文:[https://dev . to/flavio copes/JavaScript-asynchronous-programming-and-callbacks-32jh](https://dev.to/flaviocopes/javascript-asynchronous-programming-and-callbacks-32jh)
...
## [](#asynchronicity-in-programming-languages)编程语言中的异步性
...
## [](#handling-errors-in-callbacks)处理回调中的错误
...
## [](#the-problem-with-callbacks)回调的问题
...
## [](#alternatives-to-callbacks)回调的替代品
