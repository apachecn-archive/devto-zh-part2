...
> 原文:[https://dev . to/moxio/moving-individual-MySQL-tables-on-disk-2j0a](https://dev.to/moxio/moving-individual-mysql-tables-on-disk-2j0a)
...
### [](#why-move-tables-on-disk)为什么要在磁盘上移动表格？
...
#### [](#changing-the-data-directory-after%C2%A0creation)创建后更改数据目录
...
#### [](#symlinking-the-data%C2%A0files)对数据文件进行符号链接
...
#### [](#creating-a-copy-in-the-desired%C2%A0location)在所需位置创建副本
