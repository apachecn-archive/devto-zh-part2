...
> 原文:[https://dev . to/ghost/implementing-model-class-inheritance-sqlalchemy-3f 05](https://dev.to/ghost/implementing-model-class-inheritance-in-sqlalchemy-3f05)

### [](#implementing-model-class-inheritance-in-sqlalchemy-with-flask)在 SQLAlchemy 中实现模型类继承(带 Flask)
