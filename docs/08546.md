...
> 原文:[https://dev . to/adrienjoly/make-your-static-site-searchable-with-Jekyll-algolia-edh](https://dev.to/adrienjoly/make-your-static-site-searchable-with-jekyll-algolia-edh)
...
# [](#step-1-integrate-the-plugin)第一步。集成插件
...
# [](#step-2-set-up-the-search-index)第二步。设置搜索索引
...
## [](#32-instantiate-the-search-bar-and-hits)(3.2)实例化搜索栏并点击
...
## [](#33-customise-for-our-search-index)(3.3)定制我们的搜索索引
