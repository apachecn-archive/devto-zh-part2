...
> 原文:[https://dev . to/Kyle Galbraith/how-to-easy-boost-the-delivery-of-static-websites-inaws-m46](https://dev.to/kylegalbraith/how-to-easily-boost-the-delivery-of-static-websites-inaws-m46)
...
### [](#using-our-cicd-pipeline-in-aws-codepipeline-to-invalidate-our%C2%A0cache)使用 AWS 代码管道中的 CI/CD 管道使我们的缓存无效
...
### [](#a-few-things-to%C2%A0note)几件事要注意…
