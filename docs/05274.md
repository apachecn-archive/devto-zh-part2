...
## [](#apecs-components)Apecs 组件

### [](#remembering-types)记忆类型
...
### [](#side-effects-in-monads)副作用在单子上
...
### [](#easy-system-type-synonym)易系统类型同义词
...
### [](#writing-the-initialisation-system)编写初始化系统
...
### [](#writing-the-step-system)编写步骤系统
...
### [](#apecs-magic-with-systems)Apecs 魔法配合系统
...
### [](#writing-the-event-handler-system)编写系统事件处理程序
...
### [](#writing-the-draw-system)书写抽签制度
