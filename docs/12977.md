...
> 原文:[https://dev . to/munamohamed 94/responsive-windows-log in-page-ui-tutorial part-2-9dc](https://dev.to/munamohamed94/responsive-windows-login-page-ui-tutorialpart-2-9dc)
...
### [](#media-queries-using-mixins)**媒体查询(使用 mixins)**
...
### [](#applying-mixin-using-include)**应用 mixin 使用[@包含](https://dev.to/include)**
...
#### [](#for-easy-access-i-have-gathered-the-pens-in-this-twopart-tutorial-and-put-them-in-a-collection-on-codepen-you-can-check-it-out-here)**为了方便访问，我把这两部分教程中的笔收集起来，放在 Codepen 上的一个集合中。你可以在这里查看[。](https://codepen.io/collection/AEWVLV/)**

#### [](#i-hope-you-enjoyed-part-two-of-this-tutorial-till-next-time)**我希望你喜欢本教程的第二部分！下次见！** ✌️