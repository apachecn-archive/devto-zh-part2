...
> 原文:[https://dev . to/hardkoded/how-to-organize-your-git-branches-4d ci](https://dev.to/hardkoded/how-to-organize-your-git-branches-4dci)
...
# [](#gitflow-with-steroids)类固醇 Gitflow
...
# [](#bpmp-branchpushmergeprune)BPMP(分支-推送-合并-修剪)
