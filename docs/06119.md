...
> 原文:[https://dev . to/kylessg/a-sensible-approach-to-cross-platform-development-with-react-and-react-native-57pk](https://dev.to/kylessg/a-sensible-approach-to-cross-platform-development-with-react-and-react-native-57pk)
...
## [](#syncing-common-code-between-web-and-mobile)在网络和手机之间同步常用代码
...
## [](#web-and-mobile-polyfilling)Web 和移动聚合填充
...
## [](#dumb-and-smart-components)哑元件和智能元件
