...
> 原文:[https://dev . to/gauravmak/what-why-and-how-of-PHP-composer-21nc](https://dev.to/gauravmak/what-why-and-how-of-php-composer-21nc)

### [](#lets-demystify-the-package-manager-laravel-and-other-frameworks-use)让我们揭开 Laravel 和其他框架使用的包管理器的神秘面纱
...
## [](#pains-that-composer-fixes)作曲家修复的痛苦
...
### [](#lengthy-installation-procedures)冗长的安装程序
...
### [](#maintaining-a-librarypackage)维护一个库/包
...
## [](#nuts-and-bolts-of-composer)作曲者的具体细节
...
### [](#understanding-composerlock-file)了解 composer.lock 文件
