...
> 原文:[https://dev . to/Joel net/function-decorators-part-2-JavaScript-4k M9](https://dev.to/joelnet/function-decorators-part-2-javascript-4km9)
...
# [](#the-hello-world-of-a-function-decorators)一个函数装饰者的 Hello World
...
# [](#logging-function-decorator)日志功能装饰器
...
# [](#timer-function-decorator)定时器功能装饰器
...
# [](#function-parameter-guard-decorator)函数参数保护装饰器
...
# [](#fetch-json-function-decorator)取 JSON 函数装饰器
...
# [](#nextjs-browser-check)Next.js 浏览器检查
...
# [](#multiple-ways-to-decorate)多种方式装修
...
# [](#combining-function-decorators)组合功能装饰器
