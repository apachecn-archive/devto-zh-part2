...
# [](#injecting-a-raw-fragment-endraw-)注射一次`Fragment`
...
## [](#step-1-implement-raw-hassupportfragmentinjector-endraw-)第一步:实施`HasSupportFragmentInjector`
...
## [](#step-3-have-something-worth-injecting)第三步:有值得注射的东西
...
## [](#why-inject-a-view-model-factory-into-a-fragment)为什么要在片段中注入视图模型工厂？
...
# [](#injecting-a-retained-fragment-or-never-inject-something-twice)注射一个保留的片段，或者，永远不要注射一样东西两次
