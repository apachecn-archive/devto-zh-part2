...
# [](#3-checking-a-users-privileges)3。检查用户权限
...
# [](#6-expire-a-password-temporary-credentials)6。使密码/临时凭证过期
...
# [](#7-how-to-check-expiration-time-of-password)7。如何检查密码的到期时间
...
# [](#8-granting-readonly-access)8。授予只读访问权限
...
# [](#9-check-if-a-user-exists)9。检查用户是否存在
...
# [](#10-get-some-debug-info-about-your-current-user)10。获取一些关于当前用户的调试信息
