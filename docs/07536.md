...
> 原文:[https://dev . to/riccardo _ cardin/the-secret-life-of-objects-inheritance-453m](https://dev.to/riccardo_cardin/the-secret-life-of-objects-inheritance-453m)
...
## [](#the-big-misunderstanding)天大的误会
...
### [](#the-banana-monkey-jungle-problem)香蕉、猴子、丛林问题
...
### [](#inheritance-and-encapsulation)继承和封装
...
## [](#subtyping-or-reusing-behavior)子类型化或重用行为
...
### [](#favor-object-composition-over-class-inheritance)偏爱对象组合胜过类继承
...
## [](#the-liskov-substitution-principle)里斯科夫替代原理
