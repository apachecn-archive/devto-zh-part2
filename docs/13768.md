...
> 原文:[https://dev . to/buffer ings/spring boot 2-blocking-web-vs-reactive-we b-46jn](https://dev.to/bufferings/springboot2-blocking-web-vs-reactive-web-46jn)

你好，我是米茨。这是 dev.to 上的第一个帖子。很高兴见到你:)

# [](#buzzwords-into-my-toolbox)流行语进我的工具箱
...
# [](#springboot2-reactive-web)SpringBoot2 反应网
...
# [](#lets-check-the-performance)来看看性能吧！
...
## [](#gatling-to-blockingapp)加特林去堵-app
...
## [](#gatling-to-reactiveapp)加特林对反应式-app
