...
## [](#what-in-the-world-is-going-on)这到底是怎么回事？
...
## [](#what-happens-when-we-check-for-equality)当我们检查相等时会发生什么？
...
## [](#compiler-type-decisions-can-also-be-demonstrated-with-numbers)编译器的类型决定也可以用数字来演示
