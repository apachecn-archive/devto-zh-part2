...
> 原文:[https://dev . to/rainerahnekamp/ignoring-exceptions-in-Java-2ehn](https://dev.to/rainerhahnekamp/ignoring-exceptions-in-java-2ehn)

在本文中，我展示了如何在 Java 中忽略检查异常。我将首先描述它背后的基本原理以及解决这个问题的常见模式。然后，我将介绍一些用于此目的的库。

## [](#checked-and-unchecked-exceptions)已检查和未检查的异常
...
## [](#why-checked-exceptions-at-all)为什么要检查异常？
...
## [](#exceptions-in-streams-amp-co)溪流中的异常&公司
...
## [](#alternative-libraries)备选库

### [](#throwingfunction)投掷功能
