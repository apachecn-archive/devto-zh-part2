...
> 原文:[https://dev . to/on myway 133/how-to-add-app-icons-and-splash-screens-to-a-react-native-app-in-staging-and-production-4di 9](https://dev.to/onmyway133/how-to-add-app-icons-and-splash-screens-to-a-react-native-app-in-staging-and-production-4di9)
...
## [](#build-configuration-target-build-types-production-flavor-and-build-variant)构建配置、目标、构建类型、产品风格和构建变体
...
> # [](#a-build-configuration-specifies-a-set-of-build-settings-used-to-build-a-targets-product-in-a-particular-way-for-example-it-is-common-to-have-separate-build-configurations-for-debug-and-release-builds-of-a-product)A build configuration specifies a set of build settings for building a target product in a specific way. For example, the debug version and release version of a product usually have different version configurations.
> 
...
### [](#how-to-run-staging-and-production)如何运行暂存和生产
...
### [](#add-app-icon-for-ios)为 iOS 添加应用图标
...
### [](#add-app-icon-for-android)为 Android 添加应用图标
...
### [](#add-launch-screen-for-ios)为 iOS 添加启动屏幕

闪屏在 iOS 中被称为[启动屏](http://Launch%20Screen)，很重要。

> # [](#a-launch-screen-appears-instantly-when-your-app-starts-up-the-launch-screen-is-quickly-replaced-with-the-first-screen-of-your-app-giving-the-impression-that-your-app-is-fast-and-responsive)When the application is started, a startup screen will appear immediately. The startup screen is quickly replaced by the first screen of your application, giving the impression that your application is fast and responsive
...
### [](#launch-screen-storyboard)启动屏幕故事板
...
### [](#constrains-without-margin)约束无余量
...
### [](#add-a-launcher-theme-for-android)为 Android 添加一个启动器主题
...
### [](#learn-about-device-metric)了解设备度量
...
### [](#use-splashtheme)使用 SplashTheme
