...
> 原文:[https://dev . to/Napoleon 039/a-guide-to-writing-awesome-unit-tests-for-the-first-time-2lb 9](https://dev.to/napoleon039/a-guide-to-writing-awesome-unit-tests-for-the-first-time-2lb9)
...
### [](#creating-a-vue-project)创建 Vue 项目:
...
### [](#installing-test-dependencies)安装测试依赖项:
...
### [](#what-to-do-when-a-test-fails)测试失败怎么办？
