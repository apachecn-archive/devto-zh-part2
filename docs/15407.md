...
> 原文:[https://dev . to/abiodunjames/build-a-todo-app-with-nodejs-express js-MongoDB-and-vue js-part-2-3k 11](https://dev.to/abiodunjames/build-a-todo-app-with-nodejs-expressjs-mongodb-and-vuejs--part-2--3k11)
...
### [](#creating-the-vue-components)创建 Vue 组件
...
#### [](#vue-component-for-adding-new-todo-items)用于添加新待办事项的 Vue 组件
...
#### [](#component-for-listing-todo-items)用于列出待办事项的组件
