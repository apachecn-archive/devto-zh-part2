...
## [](#docker-vs-virtual-machines)Docker 与虚拟机
...
## [](#howtoguide-for-your-first-docker-image)如何指导你的第一张 Docker 图片
...
#### [](#before-you-build-your-own-container-with-an-app-have-a-look-at-the-container-provided-by-docker)在你用 app 搭建自己的容器之前，先看看 docker 提供的容器
...
#### [](#create-a-local-docker-container-for-your-app)为你的应用创建一个本地 docker 容器
