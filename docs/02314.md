...
> 原文:[https://dev . to/oo loth/how-to-setup-a-MAC-for-web-development-djc](https://dev.to/ooloth/how-to-set-up-a-mac-for-web-development-djc)
...
## [](#update-your-mac)更新你的 Mac

在安装任何新软件之前，请按照苹果公司的这些说明将 macOS 和您当前的软件升级到最新版本。

## [](#choose-a-terminal-app)选择一个终端 App
...
## [](#command-line-developer-tools)命令行开发工具
