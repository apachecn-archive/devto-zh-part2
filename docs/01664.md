...
> 原文:[https://dev . to/sadarshannayinar/区块链-使用节点-套接字-5gbe](https://dev.to/sadarshannaiynar/blockchain-using-nodejs-and-socketio-5gbe)
...
### [](#components-of-blockchain)区块链的组成部分
...
### [](#event-flow-of-blockchain)区块链的事件流程
...
## [](#creating-your-own-blockchain)打造自己的区块链
...
### [](#proof-of-work-generation-and-verification)工作证明的生成和验证
