...
> 原文:[https://dev . to/nick Parsons/winds-21-building-touch-bar-support-for-MAC OS-in-electron-with-react-3lm 5](https://dev.to/nickparsons/winds-21-building-touch-bar-support-for-macos-in-electron-with-react-3lm5)
...
## [](#send-amp-receive-from-electron)发送&接收来自电子
...
## [](#send-amp-receive-from-react)发送&接收来自反应
...
### [](#react-lifecycle-events)对生命周期事件做出反应
...
# [](#electron-touch-bar-api)电子触摸条 API
