...
> 原文:[https://dev . to/domy see/hosting-aspnet-core-applications-on-windows-server-core-289g](https://dev.to/domysee/hosting-aspnet-core-applications-on-windows-server-core-289g)
...
## [](#enabling-remote-management)启用远程管理
...
## [](#enabling-management-on-your-windows-10-device)在 Windows 10 设备上启用管理
...
## [](#configuring-iis-to-host-aspnet-core-applications)配置 IIS 以托管 Asp.Net 核心应用
...
## [](#preparing-iis-for-web-deploy)为 Web Deploy 准备 IIS
...
## [](#deploying-an-aspnet-core-application)部署 Asp.Net 核心应用
