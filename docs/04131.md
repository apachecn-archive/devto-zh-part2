...
## [](#the-project-changing-headlines-and-hiding-forms)项目:改变标题和隐藏表格
...
## [](#now-learn-how-it-works)现在了解它的工作原理:

### [](#first-parse-the-query-string)首先解析查询字符串:
...
### [](#then-show-and-hide-elements)然后，显示和隐藏元素
...
### [](#finally-update-text-on-the-page)最后，更新页面上的文字
