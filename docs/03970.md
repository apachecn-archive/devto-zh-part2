...
> 原文:[https://dev.to/taowen/what-makes-code-unreadable-6j9](https://dev.to/taowen/what-makes-code-unreadable-6j9)
...
# [](#nonlocal-logic-coding-style)非局部逻辑:编码风格
...
# [](#nonlocal-logic-generalization)非局部逻辑:泛化
...
# [](#nonlocal-logic-nonfunctional-requirements)非本地逻辑:非功能需求
...
# [](#what-you-see-is-not-what-you-get)所见并非所得
