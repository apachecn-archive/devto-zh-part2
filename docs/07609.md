...
## [](#1-deep-nesting-of-if-statements-or-loops)1。If 语句或循环的深层嵌套
...
## [](#2-returning-booleans-from-if-statements)2。从 If 语句返回布尔值
...
## [](#3-lists-are-like-hammers-not-everything-is-a-nail)3。清单就像锤子——不是所有的东西都是钉子
