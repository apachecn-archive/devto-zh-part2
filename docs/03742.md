...
### [](#q3-what-is-virtual-dom)Q3:什么是虚拟 DOM？
...
### [](#q7-what-is-the-difference-between-a-presentational-component-and-a-container-component)Q7:表象组件和容器组件有什么区别？
...
### [](#q8-describe-how-events-are-handled-in-react)Q8:描述如何在 React 中处理事件。
...
### [](#q10-what-is-the-difference-between-state-and-props)Q10:状态和道具有什么区别？
...
### [](#q17-how-to-access-redux-store-outside-a-react-component)Q17:如何访问 react 组件外部的 redux store？
...
### [](#q21-describe-flux-vs-mvc)Q21:描述一下通量 vs MVC？
...
### [](#q22-why-would-you-use-forceupdate-in-a-react-component)Q22:为什么要在 React 组件中使用 forceUpdate？
...
### [](#q23-what-is-wrong-with-this-code)Q23:这段代码怎么了？
...
### [](#q24-what-is-the-difference-between-a-controlled-component-and-an-uncontrolled-component)Q24:受控组件和非受控组件有什么区别？
...
### [](#q25-explain-some-difference-between-flux-and-angularjs-1x-approach)Q25:解释 Flux 和 AngularJS (1.x)方法之间的一些区别
