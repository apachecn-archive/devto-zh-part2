# 用 Node.js、Joi 和 Mongo 开发组织良好的 API

> 原文：<https://dev.to/auth0/developing-well-organized-apis-with-nodejs-joi-and-mongo-23h9>

在本文中，您将学习如何使用 Node.js、Restify、Joi 和 MongoDB 构建组织良好的 API。您还将有机会学习如何在这个堆栈上使用依赖注入。
