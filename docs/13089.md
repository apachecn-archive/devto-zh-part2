...
###### [](#this-post-was-originally-published-on-my-personal-blog)本帖最初发表于我的个人[博客](http://willamesoares.com)。
...
### [](#connecting-to-spotify)连接到 Spotify
...
### [](#connecting-to-genius-api)连接到 Genius API
...
### [](#extracting-the-song-lyrics)提取歌曲歌词
...
### [](#how-to-use-the-github-repository)如何使用 Github 资源库
