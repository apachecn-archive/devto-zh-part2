...
#### [](#modify-code-with-confidence)放心修改代码
...
## [](#black-box-vs-white-box)黑盒 vs 白盒
...
### [](#arrangeactassert-aaa)安排-行动-断言(AAA)
...
#### [](#arrangeactassert-example)排列-动作-断言示例
...
#### [](#givenwhenthen-example)给定-当-然后例子
