...
> 原文:[https://dev . to/Kyle Galbraith/how-to-use-the-excellent-adapter-pattern-and-why-you-should-2c 31](https://dev.to/kylegalbraith/how-to-use-the-excellent-adapter-pattern-and-why-you-should-2c31)
...
### [](#spotting-the-potential-need-for-the-adapter-pattern)发现适配器模式的(潜在)需求
...
### [](#adding-in-the-adapter-spice)在适配器中添加 spice
