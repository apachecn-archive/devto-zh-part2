...
> 原文:[https://dev.to/joaofbantunes/episode-003-与 MVC-aspnet-core-from-to-over kill-3jl 8](https://dev.to/joaofbantunes/episode-003---first-steps-with-mvc---aspnet-core-from-0-to-overkill-3jl8)
...
## [](#adding-mvc-to-the-mix)将 MVC 添加到组合中
...
## [](#creating-the-first-controller)创建第一个控制器
