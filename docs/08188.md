...
> 原文:[https://dev.to/mostlyjason/error-monitoring-in-golang-51a8](https://dev.to/mostlyjason/error-monitoring-in-golang-51a8)
...
## [](#using-defer-panic-and-recover)使用延期、死机和恢复
...
## [](#error-monitoring-in-production)生产中的错误监控
...
## [](#test-rollbar-with-an-example-go-app)用一个例子 Go app 测试滚动条
