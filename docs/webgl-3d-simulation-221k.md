...
> 原文：<https://dev.to/chiff/webgl-3d-simulation-221k>

你好！

首先，我想说“嗨！”感谢我的第一篇帖子中的每一个人，感谢你们是这么好的一个社区。

### 我想请你解释一下我的情况

我最近开始为我的学士论文创建 3D WebGL 模拟。听起来很有趣，对吧？我将不得不模拟自动驾驶汽车在公路上卡在卡车车队之间。
...
我在做前端角度开发。我在 JavaScript 方面有相当丰富的经验(大约 2 年)。

还稍微戳了一下 [PIXI.js](http://www.pixijs.com/) 渲染引擎
...
<figcaption>【web GL】通过 CubicVR 渲染模型——可用[此处](http://webgl.martinfilo.me/)</figcaption>

</figure>

我将继续创造更多的模型和场景。稍后我会用一些好的微分方程加入这些模型。那我就施点魔法，避免碰撞！

### 帮助

我想问一下我从你们这些有这方面经验的人那里得到什么可能性。

*   有没有其他值得尝试的创建 3D 模型的程序？
*   我应该继续使用 CubicVR 还是有更好的引擎？
*   我应该读/研究/尝试什么？
