...
> 原文:[https://dev . to/rakshitsoral/what-makes-react-slow-what-makes-react-fast-33n 7](https://dev.to/rakshitsoral/what-makes-react-slow-what-makes-react-fast-33n7)
...
## [](#enters-the-virtual-dom-react)进入虚拟 DOM - React
...
## [](#the-dirty-parts-about-reacts-virtual-dom)关于 React 的虚拟 DOM 的脏部分
