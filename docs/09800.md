...
> 原文:[https://dev . to/okta dev/what-happens-if-your-jwt-is-think-298d](https://dev.to/oktadev/what-happens-if-your-jwt-is-stolen-298d)
...
## [](#what-is-a-json-web-token-jwt)什么是 JSON Web 令牌(JWT)？
...
## [](#what-happens-if-your-json-web-token-is-stolen)如果你的 JSON Web Token 被盗了会怎么样？
...
## [](#what-to-do-if-your-jwt-is-stolen)如果你的 JWT 被盗了该怎么办
...
## [](#how-to-detect-token-compromise)如何检测令牌泄露
