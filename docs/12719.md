...
> 原文:[https://dev . to/sait/how-to-publish-your-theme-in-visual studio-code-37ld](https://dev.to/sait/how-to-publish-your-theme-in-visual-studio-code-37ld)

### 你是否厌倦了使用你不喜欢的懒散主题？

别担心，我会一步一步地向您展示如何在 Microsoft market Place 中发布您自己的主题。

#### [](#first-we-need-to-install-yocode-generator)首先，我们需要安装 Yocode 生成器
...
### [](#-once-your-done-with-your-development-)== **一旦你完成了你的发展** ==
