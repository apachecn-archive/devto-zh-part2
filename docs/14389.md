...
> 原文:[https://dev.to/joncalhoun/securing-cookies-in-go-1fbe](https://dev.to/joncalhoun/securing-cookies-in-go--1fbe)
...
## [](#cookie-tampering-aka-users-faking-data)Cookie 篡改(又名用户伪造数据)
...
#### [](#1-digitally-sign-the-data)1。对数据进行数字签名
...
## [](#csrf-cross-site-request-forgery)CSRF(跨站点请求伪造)
...
## [](#limit-cookie-access-where-it-isnt-needed)在不需要的地方限制 cookie 的访问
...
## [](#why-not-just-use-jwts)为什么不直接用 jwt？
