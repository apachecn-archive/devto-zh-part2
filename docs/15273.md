...
> 原文:[https://dev . to/enzoftware/let-play-with-the-Android-accelerometer-kot Lin-1k7b](https://dev.to/enzoftware/lets-play-with-the-android-accelerometer--kotlin--1k7b)

这篇文章最初发表在[媒体](https://medium.com/@enzoftware/lets-play-with-the-android-accelerometer-kotlin-%EF%B8%8F-ed92981b0a6c)上

* * *

# [](#general-aspects-about-sensors)关于传感器的一般方面
...
# [](#building-an-accelerometer-app)打造加速度计 app
