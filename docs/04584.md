...
> 原文:[https://dev . to/micahshute/setting-up-windows-subsystem-for-Linux-3b7n](https://dev.to/micahshute/setting-up-windows-subsytem-for-linux-3b7n)
...
# [](#setting-up-windows-subsystem-for-linux-for-development)为开发用 Linux 设置 Windows 子系统

*不再需要为 Windows 子系统 Linux 启用开发人员模式来工作*

## [](#getting-windows-ready)准备好窗户
...
## [](#choose-your-programming-editor-vscode)选择你的编程编辑器:VSCode
...
## [](#important-knowledge-basic-use)重要知识:基础使用
...
## [](#postgresql-database-setup)PostgreSQL 数据库设置
