...
> 原文:[https://dev.to/kyleparisi/making-web-animations-9ng](https://dev.to/kyleparisi/making-web-animations-9ng)

# [](#theres-most-likely-an-app-for-that)最有可能的应用就是这样。

没有。有大量的原型工具，其中大多数都与设计工具密切相关。我是一名开发人员，设计是 99%已经为我目前的项目实施。

## [](#what-about-animation-libraries)动画库呢？

绝对的。我遇到过几个库，但是它们都是动画，我从来没有认真地使用过。将两个动画融合成一个流畅的动作似乎也很难。因为我们试图给用户一个有意义的体验，我们需要制作自己的自定义动画。

## [](#lets-assume-you-know-the-basics)我们假设你知道基础知识。
