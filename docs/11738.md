...
> 原文:[https://dev . to/bnevilleoneill/beyond-rest-using-web sockets-for-two-way-communication-in-your-react-app-535m](https://dev.to/bnevilleoneill/beyond-rest-using-websockets-for-two-way-communication-in-your-react-app-535m)
...
### [](#who-needs-websockets)谁需要 WebSockets？
...
### [](#building-the-connect4-server)构建 Connect4 服务器
...
### [](#building-the-connect4-client)构建 Connect4 客户端

客户端是一个 React 应用程序，所有操作都发生在 App.js 主组件中。它还有两个子组件:board 和 infobar。

#### [](#the-infobar-component)信息栏组件
