...
> 原文:[https://dev . to/code prototype/xa marin-form-application-failed-to-load-Android-project-root-element-missing-27o 0](https://dev.to/codeprototype/xamarin-form-application-failed-to-load-android-project-root-element-missing--27o0)
