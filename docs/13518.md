...
> 原文:[https://dev . to/t4rzsan/next-step-git-for-than ' s have-than-know-add-and-commit-55ac](https://dev.to/t4rzsan/next-step-git-for-those-that-already-know-add-and-commit-55ac)
...
### [](#set-editor-for-commit-messages)为提交消息设置编辑器
...
### [](#set-merge-tool-to-visual-studio)将合并工具设置为 Visual Studio
...
### [](#change-submodule-to-own-fork)将子模块改为自己的分支
...
## [](#create-an-alias-for-a-command)为命令创建别名
