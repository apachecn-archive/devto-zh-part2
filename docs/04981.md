...
> 原文:[https://dev . to/marvindanig/take-your-web-development-skills-a-notch-higher-2 ge](https://dev.to/marvindanig/take-your-web-development-skills-a-notch-higher-2cge)
...
# [](#enter-viewportfit-meta-tag-and-css-environment-variables)输入 viewport-fit meta 标签和 CSS 环境变量。
