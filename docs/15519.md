...
> 原文:[https://dev . to/aurelkurtula/building-a-restful-API-with-express-and-MongoDB-3 MMH](https://dev.to/aurelkurtula/building-a-restful-api-with-express-and-mongodb--3mmh)
...
### [](#get-getting-books-from-database)获取:从数据库中获取图书
...
### [](#post-adding-content-to-the-database)POST:向数据库添加内容
...
### [](#put-editing-books-in-the-database)放:编辑数据库中的书籍
...
### [](#patch-editing-book-properties)补丁:编辑图书属性
...
## [](#refactoring-using-custom-middleware)重构:使用定制中间件
