...
> 原文:[https://dev . to/content ful _ blog/how-asts-power-the-graph QL-schema-handling-3hi 9](https://dev.to/contentful_blog/how-asts-power-the-graphql-schema-handling-3hi9)
...
### [](#but-what-is-an-abstract-syntax-tree)但是什么是抽象语法树呢？
...
### [](#whats-included-in-the-abstract-syntax-tree)抽象语法树包括哪些内容？
...
#### [](#sdl-the-type-system-definition-language)SDL -类型系统定义语言
...
#### [](#the-client-side-of-things-the-query-document)客户端事物-查询文档
...
### [](#the-combination-of-the-query-document-and-the-sdl)查询文档和 SDL 的组合
...
## [](#easy-language-processing-thanks-to-abstract-syntax-trees)得益于抽象语法树，语言处理变得简单
