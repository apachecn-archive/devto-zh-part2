...
> 原文:[https://dev . to/akshendra/generating-documentation-on-the-fly-in-express-2652](https://dev.to/akshendra/generating-documentation-on-the-fly-in-express-2652)
...
### [](#lets-see-some-raw-code-endraw-now)现在让我们来看看一些`code`
