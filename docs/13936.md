...
> 原文:[Android-321 c 上的 https://dev.to/brightdevs/tabs 导航模式](https://dev.to/brightdevs/tabs---navigation-pattern-on-android-321c)
...
#### [](#adding-tabs-programmatically)以编程方式添加选项卡
...
## [](#little-fancy-customization)小花式定制
