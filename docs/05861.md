...
> 原文:[https://dev . to/hasura HQ/using-timescaledb-with-hasura-graph QL-38ea](https://dev.to/hasurahq/using-timescaledb-with-hasura-graphql-38ea)
...
## [](#create-a-digital-ocean-droplet)创建数字海洋水滴
...
## [](#run-timescaledb-with-hasura)用 Hasura 运行 TimescaleDB
