...
## [](#working-with-schemaless-data-on-postgres)在 Postgres 上处理无模式数据
...
## [](#creating-a-table-to-store-json-data)创建表存储 JSON 数据
...
## [](#inserting-json-data-into-the-table)将 JSON 数据插入表中
...
## [](#fetching-data-based-on-json-properties-using-graphql)使用 GraphQL 获取基于 JSON 属性的数据
...
## [](#filtering-from-the-user-table)从用户表中过滤
