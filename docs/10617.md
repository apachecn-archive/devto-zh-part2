...
> 原文:[https://dev . to/paigen 11/levelling-a-spring-cloud-config-server-in-a-nodejs-apps-feature-toggles-pt-2-1 lnj](https://dev.to/paigen11/leveraging-a-spring-cloud-config-server-in-a-nodejs-apps-feature-toggles-pt-2-1lnj)
...
## [](#what-is-a-feature-toggle-and-why-do-i-need-it)什么是特性切换，我为什么需要它？
...
### [](#connecting-your-client-side-ui-framework-to-your-node-server)将客户端 UI 框架连接到节点服务器
...
### [](#automating-the-feature-toggles)自动化特征切换
