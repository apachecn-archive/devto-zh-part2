...
## [](#reordering-social-id-providers-on-the-signin-page)在登录页面重新排序社交 ID 提供者
...
## [](#the-issue-that-the-signin-page-is-automatically-scrolled-up-to-the-mail-form-when-on-loading-on-ios-safari)在 iOS Safari 上加载时，登录页面自动向上滚动到邮件表单的问题
