...
> 原文:[https://dev . to/bnevilleoneill/implicit-state-sharing-react-s-context-API-provide-inject-in-vue-30m 6](https://dev.to/bnevilleoneill/implicit-state-sharing-react-s-context-api-provide-inject-in-vue-30m6)
...
### [](#using-reacts-context-api)使用 React 的上下文 API
...
### [](#provideinject-in-vue)提供/注入 Vue
