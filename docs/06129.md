...
## [](#default-editor-configuration)默认编辑配置
...
## [](#running-pry-from-within-emacs)从 Emacs 内部运行窥探
...
## [](#editing-and-reloading-code)编辑和重装代码
...
## [](#paging-through-source-code)翻阅源代码
...
## [](#viewing-a-file-through-pry)通过窥探查看文件
...
## [](#open-a-gem-in-dired-through-pry)撬开宝石
