...
> 原文:[https://dev . to/iam _ Tim Smith/class-components-vs-stateless-functional-components-51he](https://dev.to/iam_timsmith/class-components-vs-stateless-functional-components-51he)

当我第一次开始学习 React 时，我甚至没有意识到类组件和无状态功能组件之间的区别。我以为它们只是写同一件事的不同方式。

在某些方面，他们是。在许多方面，他们是不一样的。在本文中，我将解释两者之间的区别，以及何时以及为什么使用不同的类型。

### [](#what-is-a-class-component)什么是“类组件”？
...
### [](#what-is-a-stateless-functional-component)什么是“无状态功能组件”？
...
#### [](#the-first-way-put-it-in-a-variable)第一种方式:放入变量中
...
#### [](#the-second-way-export-the-function)第二种方式:导出函数
