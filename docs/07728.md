...
> 原文:[https://dev . to/byte gasm/fusion js-universal-we B- framework-by-Uber-16em](https://dev.to/bytegasm/fusionjs-universal-web-framework-by-uber-16em)

如果你正在读这篇文章，你已经知道这个城市有一个新的“框架”。这听起来像是 Javascript 世界里的日常新闻，但是在你翻白眼并在 twitter 上咆哮之前，让我们看看所有的*fusion*是关于什么的。

## [](#react-angular-vue-and-now%C2%A0fusion)**反应过来，棱角分明，Vue 和现在融合了吗？**
...
### [](#server-side-rendering-out-of-the%C2%A0box)**服务器端开箱渲染**
...
### [](#code-splitting-amp-hmr-right%C2%A0away)**代码拆分& HMR 马上**
...
### [](#plugin-based-architecture)**基于插件的架构**
...
### [](#typed-dependency-injection)**键入依赖注入**
...
### [](#no-more-express-welcome%C2%A0koa)**不再快递，欢迎 Koa**
