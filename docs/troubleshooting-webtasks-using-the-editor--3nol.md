...
> 原文：<https://dev.to/auth0/troubleshooting-webtasks-using-the-editor--3nol>

在本系列中，我们将学习如何对 webtasks 进行故障排除，从在编辑器中监视日志，一直到使用 devtool 和 visual studio 代码进行本地调试。

这篇文章涵盖了 Webtasks 编辑器内置的工具，这里有一些快捷方式可以帮助你快速定位你感兴趣的主题。
