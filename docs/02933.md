...
## [](#migration-script-db-schema-alter-statement)迁移脚本(DB schema alter 语句)
...
## [](#final-schema-after-dropping-commissionpercent-column)删除 commission_percent 列后的最终模式
