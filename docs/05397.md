...
> 原文:[https://dev . to/learo sema/bootstrapping-a-react-type script-project-with-parcel-4oia](https://dev.to/learosema/bootstrapping-a-react-typescript-project-with-parcel-4oia)
...
### [](#additional-project-configuration)附加项目配置
