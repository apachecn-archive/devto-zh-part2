...
# [](#thinking-a-little-more-about-raw-conf-endraw-files)多思考一点`conf`文件
...
## [](#didnt-we-do-this-already)我们不是已经这样做了吗？

我们确实已经看过了`.conf`的文件，但从那以后我得到了一些建议，走得更远了，我想，我已经决定了我要走的大致路线。

### [](#current-raw-conf-endraw-file)当前`conf`文件
