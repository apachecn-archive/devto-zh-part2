...
## [](#setting-up-algolia-and-getting-some-api-keys)设置 Algolia 并获取一些 API 密钥
...
## [](#setting-up-a-serverless-function-on-webtaksio)在 webtaks.io 上设置无服务器功能
...
### [](#what-is-a-serverless-function)什么是无服务器功能？
...
### [](#setting-up-the-algolia-connection)设置 Algolia 连接
...
### [](#setting-up-the-sanity-connection)设置健全连接
...
### [](#preparing-an-observable-for-streaming-contents)为流式内容准备一个可观察对象
...
### [](#adding-the-observable-pipeline)添加可观察管道
...
## [](#scheduling-the-serverless-function)调度无服务器功能
