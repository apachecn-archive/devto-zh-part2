...
> 原文:[https://dev.to/nabbisen/installing-aur-packages-bdf](https://dev.to/nabbisen/installing-aur-packages-bdf)
...
### [](#reference-aur-user-guidelines-statement)参考: [AUR 用户指南](https://wiki.archlinux.org/index.php/AUR_User_Guidelines)声明
...
### [](#step-1-get-git-clone-url)第一步:获取“Git 克隆 URL”
...
### [](#step-2-build-the-package-and-install-it)第二步:构建软件包并安装
