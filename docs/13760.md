...
# [](#machine-language-is-not-a-language-but-languages)“机器语言”不是语言而是语言
...
# [](#the-fun-part-welcome-to-the-matrix-)有趣的部分(欢迎来到黑客帝国)
