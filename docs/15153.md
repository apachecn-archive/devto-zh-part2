...
> 原文:[https://dev . to/djug/POC-基于密码的用户角色和触发器动作-3eo1](https://dev.to/djug/poc-password-based-user-roles-and-triggersactions-3eo1)
...
## [](#headingadd-multiple-roles-for-the-user)标题为用户添加多个角色
...
## [](#headingadd-passwordbased-triggersactions)标题添加基于密码的触发器/操作
