...
> 原文:[https://dev . to/Kyle Galbraith/how-to-run-browser-tests-via-cypress-in-your-cicd-pipeline-with-AWS-code build-7ej](https://dev.to/kylegalbraith/how-to-run-browser-tests-via-cypress-in-your-cicd-pipeline-with-aws-codebuild-7ej)
...
### [](#enter-stage-right-cypressio)进入舞台右侧: [Cypress.io](https://www.cypress.io/?ref=kylegalbraith)
...
### [](#writing-the-cypress-tests)撰写《柏考》
...
### [](#incorporating-cypress-into-aws-codepipeline-and-codebuild)将 Cypress 并入 AWS 代码管道和代码构建
...
### [](#are-you-hungry-to-learn-more-about-amazon-web-services)您是否渴望了解更多关于亚马逊网络服务的信息？
