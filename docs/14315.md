...
## [](#un-problema-sencillo-pero-con-intr%C3%ADngulis)一个简单的问题，但与*内在的*
...
## [](#el-enfoque-de-tests-antes-que-el-c%C3%B3digo-pero-que-no-es-tdd)测试方法先于代码，但不是 TDD
...
### [](#tdd-del-curso-escolar)学校课程 TDD
...
### [](#tdd-de-la-etapa-educativa)教育阶段 TDD
...
### [](#tdd-del-nivel-educativo)教育水平 TDD
...
### [](#tdd-el-resto-de-la-ruta)TDD el resto de la ruta
