...
> 原文:[https://dev.to/fenbf/factory-with-self-registering-types-35h 1](https://dev.to/fenbf/factory-with-self-registering-types--35h1)
...
### [](#static-var-initialization)静态 var 初始化

我们可能会遇到两个问题:

#### [](#order-of-static-variables-initialization)静态变量初始化的顺序:
