...
> 原文:[https://dev . to/kena kamu/use-line-front-end-framework-liff-to-enrich-your-bot-3lkn](https://dev.to/kenakamu/use-line-front-end-framework-liff-to-enrich-your-bot-3lkn)
...
# [](#prepare-the-environment-first)先准备环境

### [](#create-channel-in-line-developer-portal)在 LINE 开发者门户创建“渠道”
...
### [](#create-webapps-in-azure-portal)在 Azure 门户中创建 WebApps
...
### [](#use-liff-cli-with-existing-page)对现有页面使用 LIFF CLI
...
# [](#develop-liff-application)开发 LIFF 应用
...
### [](#deploy-liff-application)部署 LIFF 应用。
...
### [](#send-message-from-liff)发自 LIFF 的消息
...
### [](#open-new-window-from-liff)从 LIFF 打开新窗口
...
### [](#close-liff-application)关闭 LIFF 应用程序
...
### [](#update-or-delete-liff-application)更新或删除 LIFF 申请
