...
> 原文:[https://dev . to/muak _ x/the-sample-of-rendering-faster-avoid-out-of-memory-exception-in-xamarinformes-Android-with-ffimage loading-native cell-mi2](https://dev.to/muak_x/the-sample-of-rendering-faster-avoiding-out-of-memory-exception-in-xamarinforms-android-with-ffimageloading--nativecell-mi2)
...
## [](#a-finished-sample-project)一个已完成的样品项目
...
## [](#in-a-case-without-taking-measures)在没有采取措施的情况下
...
## [](#using-ffimageloading)使用 FFImageLoading
...
### [](#define-photoviewcell-class-derived-from-viewcell-in-a-net-standard-project)定义一个. NET 标准项目中从 ViewCell 派生的 PhotoViewCell 类。
...
### [](#create-an-xml-file-for-layout-in-resourceslayout-and-define-the-layout)在资源/布局中创建布局的 XML 文件，并定义布局。
...
### [](#define-native-cell-class)定义原生细胞类
...
### [](#define-customcellrenderer)定义 CustomCellRenderer
...
### [](#xaml-for-the-native-cell-android)Xaml 为原生细胞(Android)
...
### [](#enable-a-largeheap-option-in-the-androidmanifestxml)在 AndroidManifest.xml 中启用大型堆选项
...
### [](#add-ontrimmemory-override-method-to-the-mainactivity-class)向 MainActivity 类添加 OnTrimMemory 覆盖方法
...
### [](#define-myimageviewasync-class-derived-from-imageviewasync)定义从 ImageViewAsync 派生的 MyImageViewAsync 类
...
## [](#about-pictures-used-by-this-sample-app)关于本样本 app 使用的图片。
