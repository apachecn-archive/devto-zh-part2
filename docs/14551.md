...
> 原文:[https://dev . to/brunoluiz/a-tale-of-how-to-not-deploy-two-month-old-features-520d](https://dev.to/brunoluiz/a-tale-of-how-to-not-deploy-two-months-old-features-520d)
...
## [](#product-development-life-is-full-of-surprises)产品开发生活充满惊喜
...
## [](#that-postmortem-and-its-results)表示剖验及其结果
...
### [](#error-metrics-monitoring-and-alerts)错误度量、监控和警报
