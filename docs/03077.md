...
> 原文:[https://dev.to/techcommunity/apama-builder-for-docker-4j15](https://dev.to/techcommunity/apama-builder-for-docker-4j15)

# [](#deploying-designer-products-with-multistage-builds)采用多阶段构建部署设计师产品
...
## [](#adding-docker-support-to-designer-projects)向设计器项目添加 Docker 支持
...
## [](#building-designer-projects)建筑设计师项目
...
## [](#multistage-dockerfile)多级 Dockerfile
...
## [](#using-multistage-builds-in-ci-pipelines)在 CI 管道中使用多阶段构建
