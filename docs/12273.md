...
> 原文:[https://dev . to/app signal/active record-performance-the-n1-queries-anti pattern-4f 56](https://dev.to/appsignal/activerecord-performance-the-n1-queries-antipattern-4f56)
...
## [](#eager-loading-associations)急切载入联想
