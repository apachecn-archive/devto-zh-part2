...
> 原文:[https://dev . to/mjyc/implementing-a-finite-state-machine-in-cycle ejs-1e 63](https://dev.to/mjyc/implementing-a-finite-state-machine-in-cyclejs-1e63)
...
## [](#making-existing-travel-personality-quiz-program-more-complex)使得现有的“旅行个性问答”程序更加复杂
...
## [](#what-is-a-finite-state-machine)什么是有限状态机？
...
## [](#representing-the-travel-personality-quiz-program-as-an-fsm)将“旅行个性测验”程序表示为 FSM
...
## [](#implementing-the-travel-personality-test-fsm-using-cyclejs)使用 Cycle.js 实现“旅行个性测试”FSM
...
### [](#setting-up-fsm-in-cyclejs)在 Cycle.js 中设置有限状态机
...
### [](#input-transition-and-output)输入、转换和输出
...
#### [](#relation-to-the-modelviewintent-pattern)与模型-视图-意图模式的关系
...
## [](#updating-the-travel-personality-quiz-fsm)更新“旅行个性测验”FSM
