...
## [](#microsoft-search-in-bing)微软必应中的搜索
...
## [](#microsoft-search-in-officecom)微软在 Office.com 搜索
...
## [](#microsoft-search-in-office-apps-release-in-2019)微软 Office 应用搜索(2019 年发布)
...
# [](#whats-new-to-build-a-modern-intranet-with-sharepoint-in-office-365)在 Office 365 中使用 SharePoint 构建现代内部网有何新功能
...
## [](#new-megamenu-layout-for-site-and-hub-site-navigation)网站和枢纽网站导航的新大菜单布局
...
## [](#audience-targeting-for-news-and-highlighted-content-web-parts)针对新闻和突出显示内容的受众定位 Web 部件
...
## [](#header-layouts-and-footer-configuration)页眉布局和页脚配置
...
## [](#communication-site-experience-at-the-root-of-a-office-365-tenant)交流网站体验根办公室 365 房客

现代的内联网主页是显示与组织最相关的信息的基本场所。通过此更新，将有可能将通信站点体验扩展到 Office 365 租户的根站点。

## [](#hub-site-improvements-for-end-users-and-administrators)面向最终用户和管理员的枢纽站点改进
