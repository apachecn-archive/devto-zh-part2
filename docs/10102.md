...
> 原文:[https://dev . to/fros nerd/deploying-an-http-API-on-AWS-using-lambda-and-API-gateway-g61](https://dev.to/frosnerd/deploying-an-http-api-on-aws-using-lambda-and-api-gateway-g61)
...
## [](#api-gateway-lambda-function)API 网关λ函数
...
## [](#wiring-everything-together)把一切都连接在一起
