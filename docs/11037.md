...
> 原文:[https://dev.to/nikolaotasevic/dynamic-programming-解决任何面试问题的 7 个步骤-3870](https://dev.to/nikolaotasevic/dynamic-programming--7-steps-to-solve-any-dp-interview-problem-3870)
...
# [](#dynamic-programming-7-steps-to-solve-any-dp-interview-problem)动态规划——解决任何 DP 面试问题的 7 个步骤
...
## [](#dynamic-programming-predictable-and-preparable)动态编程——可预测和可准备
...
> ### [](#the-biggest-factor-in-solving-dynamic-programming-problems-is-preparedness)The biggest factor to solve the dynamic programming problem is to be prepared.

## [](#7-steps-to-solve-a-dynamic-programming-problem)解决动态规划问题的 7 个步骤
...
## [](#step-1-how-to-recognize-a-dynamic-programming-problem)步骤一:如何识别一个动态规划问题
...
> ### [](#recognizing-a-dynamic-programming-problem-is-often-the-most-difficult-step-in-solving-it-can-the-problem-solution-be-expressed-as-a-function-of-solutions-to-similar-smaller-problems)Knowing a dynamic programming problem is often the most difficult step to solve it. Can the solution to a problem be expressed as a function of the solution to a similar minor problem?

## [](#step-2-identify-problem-variables)第二步:确定问题变量
...
> ### [](#identify-the-changing-parameters-and-determine-the-number-of-subproblems)Identify the changed parameters and determine the number of sub-problems.

## [](#step-3-clearly-express-the-recurrence-relation)第三步:明确表达递归关系
...
> ### [](#recurrence-relation-assuming-you-have-computed-the-subproblems-how-would-you-compute-the-main-problem)Recursive relation: Assuming you have calculated the subproblem, how would you calculate the main problem?

## [](#step-4-identify-the-base-cases)第四步:确定基本案例
...
## [](#step-6-add-memoization)第六步:添加记忆
...
## [](#step-7-determine-time-complexity)第七步:确定时间复杂度
...
## [](#awesome-you-made-it-through)厉害了，你晋级了！🙂
