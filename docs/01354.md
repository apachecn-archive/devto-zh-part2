...
## [](#understanding-the-same-origin-policy)了解同源政策
...
## [](#enabling-subdomains-through-sop)通过 SOP 启用子域
...
## [](#so-what-does-sop-allow)那么 SOP 允许什么呢？
...
### [](#-raw-aboutblank-endraw-and-raw-javascript-endraw-)`about:blank`和`javascript:`
...
## [](#csp-in-reporting-mode)CSP 处于上报模式
...
## [](#crafting-a-csp-policy)精心制定 CSP 政策
