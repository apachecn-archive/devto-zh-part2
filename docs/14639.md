...
> 原文:[https://dev . to/adammcquiff/three-things-I-learn-at-concat-2018-and-other-reasons-to-visit-Salzburg-3amj](https://dev.to/adammcquiff/three-things-i-learnt-at-concat-2018-and-other-reasons-to-visit-salzburg--3amj)
...
## [](#no-1-practical-tips-for-designing-progressive-web-apps)第 1 期:设计渐进式网络应用的实用技巧。
...
## [](#no-2-you-can-use-css-custom-properties-today)No. 2:今天可以使用 CSS 自定义属性。
...
## [](#bonus-heres-some-other-reasons-to-visit-salzburg)奖励:这里有一些*和其他*游览萨尔斯堡的理由
