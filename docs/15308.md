...
# [](#installing-parity-on-macosx)在 macOSX 上安装奇偶校验
...
# [](#installing-parity-on-linux)在 Linux 上安装奇偶校验
...
# [](#creating-and-testing-smart-contract-truffle)创建和测试智能合约- Truffle
