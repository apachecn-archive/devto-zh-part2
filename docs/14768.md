...
> 原文:[https://dev . to/elemarjr/let-me-help-you-to-start-using-ravendb 4-query-with-rql-3i9j](https://dev.to/elemarjr/let-me-help-you-to-start-using-ravendb4-querying-with-rql-3i9j)
...
## [](#getting-ready-to-write-queries)准备编写查询
...
## [](#shaping-the-query-result)塑造查询结果
...
## [](#using-javascript-in-the-query-projections)在查询投影中使用 Javascript
...
## [](#map-and-reduce-oh-yeah)贴图并缩小(哦耶！)
