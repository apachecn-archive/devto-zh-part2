...
## [](#angular-and-laravel-crud-application)角度和角度积垢应用
...
## [](#install-and-configure-the-laravel-application)安装并配置 Laravel 应用程序
...
## [](#create-a-backend-api-with-laravel)用 Laravel 创建后端 API
...
## [](#install-angular-and-create-the-frontend-application)安装 Angular 并创建前端应用程序
...
## [](#customize-the-main-layout-in-angular)自定义主布局中的棱角
...
## [](#create-a-service-in-angular)在 Angular 中创建服务
...
## [](#display-list-of-players-in-angular)以角度显示玩家列表
...
## [](#secure-the-backend-api-with-okta)用 Okta 保护后端 API
...
## [](#create-a-new-player-form-in-angular)在角形中创建新的玩家形态
...
## [](#add-angular-functionality-to-delete-player)添加删除球员角度功能
...
## [](#build-trivia-service-in-angular)在棱角分明中打造琐事服务
...
## [](#add-buttons-to-mark-answers-right-and-wrong)添加按钮标记答案对错
