...
> 原文:[https://dev . to/achiengcindy/in introduction-to-python-lists-26af](https://dev.to/achiengcindy/inntroduction-to-python-lists-26af)
...
### [](#creating-lists-in-python)用 Python 创建列表
...
### [](#accessing-items-in-a-list)访问列表中的项目
...
### [](#how-to-changeadd-elements-in-a-list)如何改变/添加列表中的元素
...
### [](#summary-of-list-methods)列表方法汇总
...
### [](#common-list-operations)常见的列表操作
