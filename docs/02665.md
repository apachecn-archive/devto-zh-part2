...
> 原文:[https://dev . to/Alex _ barashkov/how-to-send-AWS-cloud watch-alarms-to-slack-596 e](https://dev.to/alex_barashkov/how-to-send-aws-cloudwatch-alarms-to-slack-596e)
...
### [](#1-create-aws-access-key-and-secret)1。创建 AWS 访问密钥和密码
...
### [](#3-deploy-the-lambda-function)3。部署 Lambda 函数
...
### [](#4-create-an-sns-topic-and-subscription)4。创建 SNS 主题和订阅
...
### [](#5-create-cloudwatch-alarm)5。创建云监控警报
