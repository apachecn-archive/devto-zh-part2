...
> 原文:[https://dev . to/fros nerd/monitoring-AWS-lambda-functions-with-cloud watch-1 nap](https://dev.to/frosnerd/monitoring-aws-lambda-functions-with-cloudwatch-1nap)
