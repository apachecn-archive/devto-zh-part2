...
> 原文:[https://dev . to/bnevilleoneill/building-a-custom-drop-menu-component-for-react-9mg](https://dev.to/bnevilleoneill/building-a-custom-dropdown-menu-component-for-react-9mg)
...
### [](#functional-component-or-class-component)**功能构件还是类构件？**
...
### [](#controlling-a-parent-state-from-a-child)从子控制父状态
...
### [](#control-function-in-the-parent)控制父功能
