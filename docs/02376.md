...
> 原文:[https://dev . to/jurn _ w/how-I-build-my-side-project-and-get-31000-users-first week-5ea 0](https://dev.to/jurn_w/how-i-built-my-side-project-and-got-31000-users-the-firstweek-5ea0)
...
## [](#define-your-minimum-viable-productmvp)定义你的最小可行产品(MVP)
...
## [](#improve-with-user-feedback)根据用户反馈进行改进
...
## [](#advice-for-shipping-your-sideprojects-faster)装运辅助项目的建议(更快)
