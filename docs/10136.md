...
> 原文:[https://dev . to/3 reps/how-a-non-techniel-to-code-scratch-28fd](https://dev.to/3reps/how-a-non-techie-learned-to-code-from-scratch-28fd)
...
### [](#step-1-html-and-css)第一步:HTML 和 CSS
...
### [](#step-2-command-line-interface)第二步:命令行界面
...
### [](#step-3-learn-a-programming-language)第三步:学习一门编程语言
...
### [](#step-4-set-up-your-coding-environment)第四步:设置你的编码环境
...
### [](#step-5-learn-rails)第五步:学习 Rails
...
### [](#celebrate-small-victories)庆祝小胜利
...
### [](#lean-startup-principles)精益启动原则

与有经验的开发人员相比，你有明显的优势。由于你没有编码知识或经验，你将需要把你的应用程序想法剥离到它的必需品。专注于产品的核心，尽可能简化。

### [](#coding-is-like-a-jigsaw-puzzle)编码就像拼图游戏
...
### [](#code-daily-and-deploy-frequently)每日编码，频繁部署
...
### [](#i-dont-have-any-friends-that-can-help-a-large-network-to-promote-my-app-its-too-hard)“我没有任何可以帮忙的朋友，一大网络推广我的 app，太辛苦了……”
...
### [](#launch-quickly-keep-it-simple-and-add-features-incrementally)快速启动，保持简单，逐步增加功能
...
## [](#should-you-learn-to-code-even-if-you-dont-want-to-be-a-developer)即使不想做开发者也要学编码吗？
