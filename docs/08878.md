...
> 原文:[https://dev.to/douglasmakey/oauth2-example-with-go-3n8a](https://dev.to/douglasmakey/oauth2-example-with-go-3n8a)
...
### [](#handler-oauthgooglelogin)处理程序 oauthGoogleLogin
...
### [](#full-code-oauthgooglego)全代码 oauth_google.go
