...
> 原文:[https://dev.to/risdenk/apache-livy-阿帕奇-spark-HDFS-and-Kerberos-gpj](https://dev.to/risdenk/apache-livy---apache-spark-hdfs-and-kerberos-gpj)
...
### [](#-raw-sparkhdfskerberos-endraw-)`SparkHDFSKerberos`
