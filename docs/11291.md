...
> 原文:[https://dev . to/bnevilleoneill/getting-started-with-recursion-for-tree-traversal-50bn](https://dev.to/bnevilleoneill/getting-started-with-recursion-for-tree-traversal-50bn)
...
### [](#finding-items-in-a-tree)在树中查找项目
...
### [](#removing-items-from-a-tree)从树中删除项目
