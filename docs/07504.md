...
## [](#note-on-actually-using-after-and-before)注意实际使用::after 和::before
...
## [](#adding-an-icon-next-to-certain-types-of-links)在某些类型的链接旁边添加图标
...
## [](#adding-interesting-borders-to-containers)给容器添加有趣的“边框”
...
## [](#adding-stylistic-elements-that-you-dont-want-add-markup-for)添加不想添加标记的样式元素
...
## [](#sign-up-for-my-pseudo-elements-course-pseudo-power)报名参加我的伪元素课程:伪动力
