...
> 原文:[https://dev.to/alexribeirodev/git-um-grande-aliado-41if](https://dev.to/alexribeirodev/git-um-grande-aliado-41if)
...
### [](#afinal-o-que-%C3%A9-git)毕竟 Git 是什么？
...
#### [](#modifica%C3%A7%C3%B5es-locais)局部修改
