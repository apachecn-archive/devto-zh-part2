...
> 原文:[https://dev . to/Hugo _ _ df/bring-redux-to-your-queue-logic-an-express-setup-with-es6-and-bull-queue-56 D1](https://dev.to/hugo__df/bring-redux-to-your-queue-logic-an-express-setup-with-es6-and-bull-queue-56d1)
...
## [](#an-express-application-with-redis-and-a-worker)一个带有 Redis 和一个 worker 的 Express 应用🏃‍♀️
...
## [](#persisting-webhook-data-with-redis)用 Redis 持久化 webhook 数据

### [](#accepting-payloads-and-forwarding-them-on)接受有效载荷并转发它们
...
### [](#persisting-webhook-data-to-redis)坚持 web 手册数据要重写💾
...
### [](#saving-post-data-using-the-new-db-module)使用新的数据库模块保存发布数据
