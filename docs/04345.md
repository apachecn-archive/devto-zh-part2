...
> 原文:[https://dev . to/swyx/networking-essentials-naming-addressing-and-forwarding-13kk](https://dev.to/swyx/networking-essentials-naming-addressing-and-forwarding-13kk)

*这是我参加[免费的 Udacity 计算机网络基础课程](https://www.udacity.com/course/computer-networking--ud436)的一系列课堂笔记中的第四篇。*

## [](#what-is-ip-addressing)什么是 IP 寻址？
...
## [](#classless-interdomain-routing-cidr)无类域间路由(CIDR)
...
## [](#multihoming-vs-ip-prefix-aggregation)多宿主 vs IP 前缀聚合
...
## [](#address-lookups-with-longest-prefix-match-algorithm)用最长前缀匹配算法进行地址查找
...
## [](#solutions-to-ipv4-exhaustion-ipv6-128bit-addresses)解决 IPv4 枯竭的方案:IPv6 (128 位地址)
...
## [](#aside-how-ip-address-allocation-works)先不说:IP 地址分配是如何工作的
