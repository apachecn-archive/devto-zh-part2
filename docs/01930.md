...
> 原文:[https://dev . to/benny powers/lets-build-we B- components-part-6-gluon-27ll](https://dev.to/bennypowers/lets-build-web-components-part-6-gluon-27ll)
...
## [](#-raw-ltgluonlazyimagegt-endraw-)`<gluon-lazy-image>`
...
## [](#properties-and-attributes)属性和属性
...
## [](#rendering-and-lifecycle)渲染和生命周期
