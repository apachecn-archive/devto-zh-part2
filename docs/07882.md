...
## [](#babel-plugin-transformclassproperties-optional)巴别塔插件:转换-类别-属性(可选)
...
## [](#writing-react-components)编写 React 组件
...
## [](#registering-react-components)注册反应组件
...
## [](#rendering-components-on-pages)渲染页面上的组件
