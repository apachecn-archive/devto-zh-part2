...
> 原文:[https://dev.to/banesag/javascript-strings-beginners-1bpj](https://dev.to/banesag/javascript-strings-beginners-1bpj)
...
## [](#string-properties-and-methods)字符串属性和方法
