...
## [](#the-original-approach-to-inotifypropertychanged)原方法为 INotifyPropertyChanged。
...
## [](#a-simpler-approach-to-inotifypropertychanged)一种更简单的 INotifyPropertyChanged 方法
