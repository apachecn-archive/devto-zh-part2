...
> 原文:[https://dev . to/ahas all/angular-pipes-integrated-unit-testing-mg4](https://dev.to/ahasall/angular-pipes-integrated-unit-testing-mg4)
...
## [](#we-need-a-host-component)我们需要一个主机组件
...
## [](#setting-up-the-integrated-tests)设置集成测试！
