...
> 原文:[https://dev . to/microverse/the-portfolio-hack-that-will-make-every one-want-hire-you-1 og 8](https://dev.to/microverse/the-portfolio-hack-that-will-make-everyone-want-to-hire-you-1og8)
...
### [](#step-1-download-a-free-sketch-template)第一步:下载免费草图模板
...
### [](#step-2-export-the-design-to-zeplin)第二步:将设计导出到 Zeplin
...
### [](#step-3-build-the-design-based-on-its-detailed-specs)第三步:根据详细的规格建立设计
...
## [](#adding-the-finishing-touches)添加点睛之笔
