...
> 原文:[https://dev.to/fleepgeek/the-notsodailyui-001-注册-ne6](https://dev.to/fleepgeek/the-notsodailyui-001---signup-ne6)

# [](#introduction)简介

我决定参加来自 dailyui 的#dailyui 挑战。这个旅程将集中在接口的编码上，而不是如何设计它们。为了帮助我做到这一点，我会参考我收集设计灵感的作品。这将是初学者和前端开发人员学习如何创建通用接口的一个途径。

## [](#whats-with-the-title-man)标题男是怎么回事？
