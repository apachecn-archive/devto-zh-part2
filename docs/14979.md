...
> 原文:[https://dev.to/eh3rrera/building-a-realtime-react-vr-app-37 D5](https://dev.to/eh3rrera/building-a-realtime-react-vr-app--37d5)
...
## [](#setting-up-the-react-vr-project)设置 React VR 项目
...
## [](#creating-the-3d-shapes)创建 3D 形状
...
## [](#creating-the-nodejs-backend)创建 Node.js 后端
