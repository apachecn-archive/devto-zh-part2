...
> 原文:[https://dev . to/gloria maris/how-to-programmable-trigger-click-event-in-angular-4-3i6a](https://dev.to/gloriamaris/how-to-programmatically-trigger-click-event-in-angular-4--3i6a)
...
## [](#walkthrough-of-the-process)流程的预排
