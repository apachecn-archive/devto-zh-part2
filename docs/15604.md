...
> 原文:[https://dev . to/jbar don/a-quick-guide-to-learn-react-and-how-its-virtual-DOM-works-4 BCI](https://dev.to/jbardon/a-quick-guide-to-learn-react-and-how-its-virtual-dom-works-4bci)
...
### [](#inject-data-into-the-component)将数据注入组件
...
### [](#what-about-unquoted-html-)不加引号的 HTML 怎么办？
...
### [](#going-further-with-the-virtual-dom)与虚拟 DOM 更进一步
