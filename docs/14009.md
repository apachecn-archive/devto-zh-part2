...
> 原文:[https://dev . to/terrier script/append-reload-notice-on-create-react-app-registerserviceworkerjs-1fp 7](https://dev.to/terrierscript/append-reload-notice-on-create-react-app--registerserviceworkerjs-1fp7)
...
## [](#2-append-event-dispatching-when-raw-onupdatefound-endraw-)2。`onupdatefound`时追加事件调度
...
## [](#2-create-raw-ltreloadmodalgt-endraw-)2。创建`<ReloadModal>`
