...
## [](#tools-of-the-testing-trade)测试贸易的工具
...
## [](#quick-review-our-http-action)快速回顾:我们的 HTTP 行动
...
## [](#1-create-a-mock-store)1。创建一个模拟商店
...
## [](#2-create-some-moxios-helpers)2。创建一些 Moxios 助手
...
## [](#3-configure-setup-and-teardown-for-your-tests)3。为您的测试配置安装和拆卸
...
## [](#4-write-your-on-success-test)4。写下你的成功测试
...
## [](#5-now-do-the-same-for-the-error-response)5。现在对错误响应做同样的事情
...
## [](#apply-this-to-your-applications)将此应用到您的应用程序中
