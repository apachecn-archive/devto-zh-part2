...
> 原文:[https://dev . to/app signal/speeding-up-your-apps-navigation-with-turbo links-4 lmn](https://dev.to/appsignal/speeding-up-your-apps-navigation-with-turbolinks-4lmn)
...
## [](#caching-and-page-previews)缓存和页面预览
...
### [](#-raw-turbolinksload-endraw-and-raw-ltscriptgt-endraw-tags)`turbolinks:load`和`<script>`标签
...
### [](#browser-loading-states)浏览器加载状态
...
# [](#-raw-rails-new-skipturbolinks-endraw-)`$ rails new --skip-turbolinks`？
