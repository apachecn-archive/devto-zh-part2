...
> 原文:[https://dev . to/ybal rid/install-and-run-steam VR-on-arch Linux-for-use-an-HTC-vive-and-do-openglopenvr-development-h1c](https://dev.to/ybalrid/install-and-run-steamvr-on-archlinux-for-using-an-htc-vive-and-do-openglopenvr-developement-h1c)
