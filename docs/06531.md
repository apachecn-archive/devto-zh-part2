...
## [](#2-you-dont-need-a-join-to-get-a-relational-data-out-of-your-database)2。从数据库中获取关系数据不需要连接。
...
## [](#3-you-want-transactional-actions-on-your-data)3。您希望对数据进行事务性操作

我不太了解 NoSQL，但当我处理我写作时，我希望它是原子性的。这意味着，无论何时发生任何错误，都不会对我的数据库进行新的写入。
要么全有，要么全无
RDBMS 将帮助您实现这一目标，简单而高效！

## [](#4-you-want-a-strong-query-language-to-get-efficiently-whatever-data-you-have)4。您需要一种强大的查询语言来高效地获取您拥有的任何数据。
...
## [](#5-you-want-to-take-benefit-of-a-rdbms-to-manage-all-security-issues)5。您希望利用 RDBMS 来管理所有安全问题。
