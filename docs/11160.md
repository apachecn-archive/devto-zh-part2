...
##### [](#a-better-solution-exists-vuex)更好的解决方案存在:VueX
...
### [](#why-vuex-actions-are-the-perfect-interface-to-the-api)为什么 VueX 动作是 API 的完美接口
...
##### [](#handling-data-mismatches)处理数据不匹配
