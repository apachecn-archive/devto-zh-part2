...
## [](#loops-are-the-core-of-sonic-pi)循环是音速π的核心
...
## [](#adding-a-sample-to-our-song)给我们的歌添加一个样本
...
## [](#adding-a-second-loop-with-bass)添加第二个带低音的循环
...
## [](#adding-in-audio-samples)添加音频样本
...
## [](#my-favorite-feature-of-sonic-pi)我最喜欢的索尼克 Pi 的功能
