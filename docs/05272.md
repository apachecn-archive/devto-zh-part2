...
> 原文:[https://dev . to/Hugo _ _ df/a-gentle-introduction-to-graph QL-API-integrations-6fk](https://dev.to/hugo__df/a-gentle-introduction-to-graphql-api-integrations-6fk)
...
### [](#graphql-query-concepts)GraphQL 查询概念
...
## [](#running-a-graphql-query)运行 GraphQL 查询

GraphQL 查询可以在 POST 或 GET 上运行，它包括:

### [](#post-recommended)帖子(推荐)
...
### [](#single-pokemon-by-name)单个口袋妖怪的名字
...
### [](#single-pokemon-by-id)单人口袋妖怪凭 id
...
### [](#get-some-pokemon-to-create-strengthsweaknessresistance-classification)弄点口袋妖怪来制造强项/弱项/抗性分类
...
### [](#get-selected-pokemon-as-named-fields-with-their-evolution-names)获取选中的口袋妖怪及其进化名称作为命名域
