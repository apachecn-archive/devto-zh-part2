...
> 原文:[https://dev . to/koscheyscrag/git-how-to-delete-all-branches-except-master-2pi 0](https://dev.to/koscheyscrag/git-how-to-delete-all-branches-except-master-2pi0)
