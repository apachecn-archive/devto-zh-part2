...
> 原文:[https://dev . to/therma tix/building-my-first-rust-project-wer cker-build-status-3fkl](https://dev.to/thermatix/building-my-first-rust-project-wercker-build-status-3fkl)
...
# [](#the-tool-werker-build-status)工具- [Werker 构建状态](https://github.com/thermatix/wercker_build_status)
...
# [](#loading-the-user-config)加载用户配置
...
# [](#getting-the-list-of-runs)获取运行列表
...
# [](#deserializing-the-json)反序列化 json
