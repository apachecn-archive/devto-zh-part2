...
> 原文:[https://dev . to/fleepgeek/django-quick-tip-1-human-friendly-timestamps-with-djangos-humanize-50lm](https://dev.to/fleepgeek/django-quick-tip-1-human-friendly-timestamps-with-djangos-humanize-50lm)
...
# [](#lets-get-to-work)我们开始工作吧

## [](#1-add-the-module-to-your-raw-installedapps-endraw-)1。将模块添加到您的`INSTALLED_APPS`:
...
## [](#2-load-it-up-in-your-template)2。将其加载到您的模板中:
...
## [](#3-apply-the-filter-to-your-timestamp)3。将过滤器应用于您的时间戳
