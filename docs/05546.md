...
> 原文:[https://dev . to/neo/build-a-cryptocurrency-alert-app-using-kot Lin-and-go-part-2-the-back end-1 hhn](https://dev.to/neo/build-a-cryptocurrency-alert-app-using-kotlin-and-go-part-2--the-backend-1hhn)
...
### [](#building-our-go-api)构建我们的 Go API
...
#### [](#creating-internal-go-packages)创建内部 Go 包
