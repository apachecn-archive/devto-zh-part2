...
> 原文:[https://dev . to/Kyle Galbraith/getting-family-with-the-awesome-repository-pattern-1ao 3](https://dev.to/kylegalbraith/getting-familiar-with-the-awesome-repository-pattern--1ao3)
...
### [](#implementing-repository-pattern)实现存储库模式
