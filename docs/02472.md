...
> 原文:[https://dev . to/marpme/changes-in-JavaScript s-life cycle-es 6es 7 es 8-4c5o](https://dev.to/marpme/changes-in-javascripts-lifecycle-es6es7es8-4c5o)
...
## [](#es6-vs-es7-aka-2016)ES6 vs ES7(又名。2016)

### [](#arrayindexof-vs-arrayincludes)Array.indexOf vs 数组。包含
...
### [](#spreading-arguments-within-functions)在函数内传播自变量
...
### [](#object-assigningmerging)对象分配/合并
...
## [](#ecmascript-8-es82017)ECMAScript 8 (ES8/2017)
