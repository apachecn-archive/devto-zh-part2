...
## [](#binary-search-tree-is-a-very-common-type-of-a-tree-used-in-computer-science)二叉查找树是计算机科学中非常常见的一种树。
...
## [](#lets-look-at-some-other-terminology-for-trees)我们来看看其他一些树木的术语。
...
## [](#binary-trees-are-very-commonly-used)二叉树非常常用。

所以一棵二叉树最多有两个子树。对于一棵二叉树，我们通常有一个明确的左右子树，它们中的任何一个都可以为零，而不是在这个一般的子树列表中。

## [](#lets-look-at-a-couple-of-procedures-operating-on-trees)让我们来看几个在树上运行的程序。
