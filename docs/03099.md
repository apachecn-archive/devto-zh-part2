...
> 原文:[https://dev . to/adamspannbauer/choice-between-r-and-python-by-questing-the-languages-self-2klh](https://dev.to/adamspannbauer/choosing-between-r-and-python-by-asking-the-languages-themselves-2klh)
...
## [](#a-little-bit-about-why-the-comparisons-differ)稍微解释一下为什么比较会不同
...
### [](#sorting-characters-in-r)在 R 中排序字符
