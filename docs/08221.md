...
> 原文:[https://dev . to/kball/understanding-higher-order-components-in-react-and-Gutenberg-1 MII](https://dev.to/kball/understanding-higher-order-components-in-react-and-gutenberg-1mii)
...
### [](#the-bare-minimum-higherorder-component)裸露的最小高阶分量
...
### [](#higherorder-components-with-arguments)带自变量的高阶分量
