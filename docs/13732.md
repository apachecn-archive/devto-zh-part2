...
## [](#support-for-saving-into-dxf-file)支持保存成 DXF 文件:
...
## [](#support-for-adding-raster-image-during-export-of-dwg-image)支持导出 DWG 图像时添加光栅图像:
...
## [](#support-for-adding-text-during-export-of-dwg-image)支持在导出 DWG 图像时添加文本:
