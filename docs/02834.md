...
> 原文:[https://dev . to/runtime-revolution/getting-started-with-angular-6-git lab-cicd-and-Google-app-engine-2 okk](https://dev.to/runtime-revolution/getting-started-with-angular-6-gitlab-cicd-and-google-app-engine--2okk)
...
### [](#gcloud-deploy-with-user-credentials)使用用户凭证部署 gcloud
...
### [](#gcloud-deploy-with-service-account)使用服务帐户部署 gcloud
...
## [](#angular-6-gitlab-ci)有角 6 + GitLab CI
...
### [](#test-with-headless-browser-via-puppeteer)通过木偶师用无头浏览器测试
...
### [](#set-environment-variables-in-gitlab)在 GitLab 中设置环境变量
...
### [](#gitlabciyml-update)。gitlab ci . yml 更新
