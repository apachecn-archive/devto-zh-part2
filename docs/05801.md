...
> 原文:[https://dev . to/paigen 11/implementing-JSON-we B- tokens-passport js-in-a-react-app-45cp](https://dev.to/paigen11/implementing-json-web-tokens-passportjs-in-a-react-app-45cp)
...
## [](#what-is-a-json-web-token)什么是 JSON Web Token？
...
## [](#what-is-passportjs-amp-why-should-i-use-it)什么是 Passport.js &为什么要用？
...
## [](#how-do-i-implement-them-in-expressjs-and-a-little-react)我如何在 Express.js 中实现它们(还有点 React)？
...
### [](#passportjs-gotcha-1-info-in-error-handling)Passport.js 陷阱#1:错误处理中的信息
...
### [](#passportjs-gotcha-2-passportlocal-wants-return-passportjwt-does-not)Passport.js Gotcha #2:护照-当地想要返回，护照-JWT 不想
...
### [](#passportjs-gotcha-3-dont-forget-raw-reqlogin-endraw-in-your-custom-callback)Passport.js 问题 3:在你的自定义回调中不要忘记`req.logIn()`
...
### [](#passportjs-gotcha-4-passing-authorization-headers-correctly)Passport.js 问题 4:正确传递授权头
