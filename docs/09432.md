...
> 原文:[https://dev . to/oktadev/tutorial-build-a-basic-crud-app-with-nodejs-1 ohn](https://dev.to/oktadev/tutorial-build-a-basic-crud-app-with-nodejs-1ohn)
...
## [](#create-your-expressjs-app)创建您的 Express.js 应用程序
...
## [](#initialize-authentication)初始化认证
...
## [](#define-database-models-with-sequelize)用序列定义数据库模型
...
## [](#initialize-your-expressjs-app)初始化你的 Express.js App
...
### [](#initialize-nodejs-middlewares)初始化 Node.js 中间件
...
### [](#initialize-nodejs-routes)初始化 Node.js 路线
...
### [](#initialize-error-handlers)初始化错误处理程序
...
#### [](#create-an-authentication-helper)创建一个认证助手
...
#### [](#create-the-dashboard-routes)创建仪表板路线
...
#### [](#create-the-delete-route)创建删除路线
...
#### [](#create-the-display-route)创建显示路线
...
## [](#test-your-new-crud-app)测试你的新 CRUD App！
