...
> 原文:[https://dev.to/drminnaar/react-redux-starter-4176](https://dev.to/drminnaar/react-redux-starter--4176)
...
#### [](#build-application-and-watch-for-changes)构建应用程序并观察变化

| 偏差 | 刺针 |
| --- | --- |
| npm 运行构建:开发:观察 | npm 运行构建:生产:观察 |

#### [](#build-application-with-bundleanalayzer-plugin-included)构建包含 BundleAnalayzer 插件的应用程序
...
#### [](#build-application-with-bundlebuddy-plugin-included)构建包含 BundleBuddy 插件的应用
...
#### [](#lint-project-using-eslint)Lint 项目使用 ESLint
...
#### [](#lint-project-using-eslint-and-autofix)Lint 项目使用 ESLint，并自动修复
...
#### [](#run-dev-server-with-dashboard)使用仪表板运行开发服务器
