...
> 原文:[https://dev . to/Joel net/why-async-code-is so-damn-following-a-how-to-make-it-easy-3441](https://dev.to/joelnet/why-async-code-is-so-damn-confusing-and-a-how-to-make-it-easy-3441)
...
# [](#dirty-hacks-to-force-sync)脏黑客强行同步
...
# [](#the-problem-is-not-asynchronous-code)问题不是异步代码
...
# [](#write-asynchronously-from-the-start)从一开始就异步写入
...
# [](#what-if-there-was-no-difference)如果没有区别呢？
...
# [](#asynchronous-function-composition)异步功能组成
...
# [](#esnext-proposal-the-pipeline-operator)ESNext 建议:管道运营商
...
# [](#mojiscript-async-examples)MojiScript 异步示例
