# 提供有用的函数式编程助手的 JavaScript 库

> 原文：<https://dev.to/shystruk/javascript-library-that-provides-useful-functional-programming-helpers-3ml4>

只是好奇，你有没有一瞬间意识到你已经把那个 helper 写好了？
...
*   [substr](https://raw.githubusercontent.com/shystruk/famulus/master/docs/substr.md)

### 目标

*   [对象接口](https://raw.githubusercontent.com/shystruk/famulus/master/docs/objectInterface.md)

### 排列

*   [sortAndAddFirstElement](https://raw.githubusercontent.com/shystruk/famulus/master/docs/sortAndAddFirstElement.md)
*   [isvaluesun](https://raw.githubusercontent.com/shystruk/famulus/master/docs/isValuesUnique.md)

### 日期

*   [dateDifferenceFromNow](https://raw.githubusercontent.com/shystruk/famulus/master/docs/dateDifferenceFromNow.md)
*   [时差](https://raw.githubusercontent.com/shystruk/famulus/master/docs/dateDifference.md)

## 贡献的

在添加您自己的助手或对代码片段、解释等的改进之前，请阅读[投稿指南](https://raw.githubusercontent.com/shystruk/famulus/master/CONTRIBUTING.md)。

## 许可证

麻省理工学院[瓦西里·斯托科洛萨](https://about.me/shystruk)

</article>

[View on GitHub](https://github.com/shystruk/famulus)