...
# [](#a-brief-introduction-to-error)错误简介
...
## [](#they-do-not-convey-context)它们不传达上下文
...
## [](#the-burden-is-on-the-function-caller)负担在函数调用者身上
...
## [](#an-exceptional-example)一个例外的例子
...
### [](#why-cant-we-always-write-the-code-like-in-scenario-1)*为什么我们总不能像场景 1 那样写代码？*
...
### [](#exceptions-exist-to-help-you-fix-problems-in-the-future)异常的存在是为了帮助你将来解决问题
