...
## [](#moving-in-and-settling-down)迁入并定居下来
...
### [](#protip-yum-errors)ProTip: Yum 错误
...
## [](#bonus-bringing-in-dot-files)奖励:带入点文件
...
### [](#installing-onto-our-server)安装到我们的服务器上
...
## [](#bonus-bonus-message-of-the-day)奖励奖励:今日消息
