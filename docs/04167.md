...
> 原文:[https://dev.to/aspittel/intro-to-generative-art-2hi7](https://dev.to/aspittel/intro-to-generative-art-2hi7)

生殖艺术可能是一个令人生畏的话题——看起来好像涉及到很多数学，艺术本身就很棘手！但是，这并不一定很难——即使没有数学或艺术学位，你也可以做出一些非常酷的东西。这篇文章将分析什么是生成艺术，以及你如何开始建立自己的生成艺术。

## [](#first-what-is-code-art)一、什么是代码艺术？
...
## [](#examples-of-generative-art)生成艺术的例子
...
#### [](#impressionists-blobs-by-murasaki-uma)印象派大师村崎优马
...
#### [](#generated-tree-by-miriam-nadler)由米丽娅姆·纳德勒生成的树
...
## [](#what-goes-into-a-piece-of-generative-art)一件生成性艺术作品包含哪些内容？
...
## [](#where-should-you-start)应该从哪里开始？
...
## [](#another-strategy-tweaking-tutorials)另一个策略:微调教程
