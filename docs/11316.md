...
> 原文:[https://dev . to/leandrocp/elixir-quick-reference-for-debugging-techniques-118g](https://dev.to/leandrocp/elixir-quick-reference-for-debugging-techniques-118g)
...
## [](#ioinspect-with-binding)IO.inspect 与绑定
...
## [](#sysgetstate-and-sysgetstatus):系统获取状态和系统获取状态
