...
> 原文:[https://dev . to/anoff/markdown-native-diagrams-with-plant UML-ik4](https://dev.to/anoff/markdown-native-diagrams-with-plantuml-ik4)
...
## [](#reasons-to-love-plantuml)爱上 PlantUML 的理由🤗
