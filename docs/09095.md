...
> 原文:[https://dev . to/azure/use-server less-functions-and-cdn-to-speed-up-API-data-calls-595 c](https://dev.to/azure/use-serverless-functions-and-cdn-to-speed-up-api-data-calls-595c)
...
### [](#using-serverless-azure-functions-to-get-and-upload-the-data)使用无服务器 Azure 函数获取和上传数据
