...
> 原文:[https://dev.to/jainroe/the-ultimate-guide-to-big-o-notation-通过实例学习-5ecp](https://dev.to/jainroe/the-ultimate-guide-to-big-o-notation--learning-through-examples-5ecp)
...
### [](#on%E2%80%8A%E2%80%8Alinear%C2%A0time)O(n) —线性时间:
