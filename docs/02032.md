...
> 原文:[https://dev . to/asposecells/use-auto filter-to-filter-excel-data-in-c-20lf](https://dev.to/asposecells/use-autofilter-to-filter-excel-data-in-c-20lf)
...
# [](#filter-data-using-autofilter-in-microsoft-excel)在 Microsoft Excel 中使用自动筛选功能筛选数据
...
# [](#filter-data-using-autofilter-in-asposecells)在 Aspose 中使用自动筛选功能筛选数据。细胞
