...
## [](#solution-without-async-iteration)无异步迭代的解决方案
 ...
 *## [](#async-generators-raw-async-function-endraw-and-raw-for-await-endraw-loops)异步发电机(`async function*`)和`for await`回路
