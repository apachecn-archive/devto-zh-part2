...
> 原文:[https://dev.to/risdenk/apache-solr-前导-通配符-查询-and-reversedwildcardfilterfactory-48kc](https://dev.to/risdenk/apache-solr---leading-wildcard-queries-and-reversedwildcardfilterfactory-48kc)
...
### [](#what-are-leading-wildcard-queries)什么是前导通配符查询？
...
### [](#why-are-leading-wildcard-queries-inefficient)前导通配符查询为什么效率低？
...
### [](#how-to-improve-leading-wildcard-queries)如何改进前导通配符查询
...
### [](#-raw-reversedwildcardfilterfactory-endraw-implementation)`ReversedWildcardFilterFactory`实现
...
#### [](#solr-setup-reference)Solr 设置参考
