...
### [](#there-are-3-possible-use-cases-for-this-repository-due-to-its-server-amp-client-perspectives)由于其服务器&客户端的观点，该存储库有 3 种可能的用例

#### [](#client-my-main-use-case)客户端(我的主要用例)
...
#### [](#server-not-thoroughly-tested)服务器(未彻底测试)
...
### [](#a-few-words-on-the-impact-of-switching-to-messagepack-from-gearman)简单说说从 Gearman 切换到 MessagePack 的影响
