...
> 原文:[https://dev . to/p _ chhetri/running-a-modern-infra structure-on-kubernetes-1 end](https://dev.to/p_chhetri/running-a-modern-infrastructure-on-kubernetes-1end)
