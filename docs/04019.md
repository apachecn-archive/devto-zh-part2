...
## [](#entries-should-be-organised-as-a-heading-with-a-list-of-subitems)条目应组织成一个标题，并附有一个子条目列表
...
## [](#sort-entries-in-reverse-chronology)按逆年表排序条目
...
## [](#structure-a-release-entry)构造一个发布条目
...
## [](#structure-change-item-entries)结构变更项条目
...
## [](#autogenerating-change-log)自动生成变更日志
...
## [](#bonus-tip-write-in-markdown)奖励提示:写入减价
