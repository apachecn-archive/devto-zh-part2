...
## [](#el-m%C3%A9todo-execcommand-del-documento)文件的执行命令方法
...
## [](#selecci%C3%B3n-de-contenido)内容选择
...
## [](#cosas-importantes-a-tener-en-cuenta)要考虑的重要事项
...
## [](#y-qu%C3%A9-pasa-con-el-pegado)胶水怎么了？
...
## [](#eventos-del-portapapeles)剪贴板事件
...
## [](#un-ejemplo-completo-para-descargar)下载的完整例子
