...
> 原文:[https://dev . to/bj haid _ 93/practical-explain-of-JavaScript-iterators with-a-demo-app-o95](https://dev.to/bjhaid_93/practical-explanation-of-javascript-iteratorswith-a-demo-app-o95)

### [](#what-are-iterators)迭代器是什么？
