...
### [](#the-largest-item-on-an-unsorted-array)未排序数组中最大的项目
...
## [](#on2-quadratic-time)O(n <sup>2</sup> ) -二次时间
...
## [](#onc-polynomial-time)O(n <sup>c</sup> ) -多项式时间
...
## [](#olog-n-logarithmic-time)O(log n) -对数时间
...
## [](#on-log-n-linearithmic)O(n log n) -线性算法
...
## [](#o2n-exponential-time)O(2 <sup>n</sup> ) -指数时间
...
# [](#all-running-complexities-graphs)所有运行复杂性图表
