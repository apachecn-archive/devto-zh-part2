...
> 原文:[https://dev . to/IBM developer/machine-learning-in-nodejs-with-tensorflowjs-1g1p](https://dev.to/ibmdeveloper/machine-learning-in-nodejs-with-tensorflowjs-1g1p)
...
#### [](#importing-existing-models-into-tensorflowjs)将现有模型导入 TensorFlow.js
...
## [](#using-tensorflowjs-in-nodejs)使用 Node.js 中的 TensorFlow.js

### [](#installing-tensorflow-libraries)安装 TensorFlow 库
...
### [](#loading-tensorflow-libraries)加载 TensorFlow 库
...
### [](#loading-tensorflow-models)加载张量流模型
...
#### [](#loading-models-from-a-filesystem)从文件系统加载模型
...
#### [](#downloading-models-manually)手动下载模型
...
#### [](#generating-tensor3d-from-an-image)从图像生成张量 3D
...
#### [](#creating-input-values-for-jpegs)为 JPEGs 创建输入值
...
#### [](#mobilenet-models-input-requirements)MobileNet 型号输入要求
