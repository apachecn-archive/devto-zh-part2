...
> 原文:[https://dev.to/k_penguin_sato/es6-basic-features-40hl](https://dev.to/k_penguin_sato/es6-basic-features-40hl)
...
# [](#variable-declaration-with-const-and-let)用 const 和 let 进行变量声明
...
### [](#get-multiple-arguments-as-an-array)获取多个参数作为数组
