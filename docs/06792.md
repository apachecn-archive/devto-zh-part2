...
> 原文:[https://dev . to/oktadev/build-and-understand-a-simple-nodejs-website-with user-authentic ation-4ml 9](https://dev.to/oktadev/build-and-understand-a-simple-nodejs-website-with-user-authentication-4ml9)
...
## [](#setup-your-authorization-server)设置您的授权服务器
...
## [](#configure-session-management)配置会话管理
...
## [](#create-expressjs-views)创建 Express.js 视图
...
### [](#create-the-homepage-view)创建主页视图
...
### [](#create-the-dashboard-view)创建仪表板视图
...
## [](#configure-user-authentication)配置用户认证
...
## [](#how-authentication-works)认证如何工作
...
## [](#test-out-your-new-login-portal)测试您的新登录门户
...
## [](#learn-more-about-nodejs-and-authentication)了解关于 Node.js 和认证的更多信息
