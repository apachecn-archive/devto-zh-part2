...
> 原文:[https://dev . to/itachiuchiha/passing-data-to-a-router-link-in-vue js-2cb 0](https://dev.to/itachiuchiha/passing-data-to-a-router-link-in-vuejs-2cb0)
...
## [](#creating-profilevue-component)创建 Profile.vue 组件
...
## [](#modification-in-helloworldvue)在 HelloWorld.vue 中修改
...
## [](#configuration-of-the-router-file)路由器文件的配置
