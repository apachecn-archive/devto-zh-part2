...
> 原文:[https://dev . to/jamesmh/strategy-pattern-implementations-in-c-basic-to-advanced-6o 4](https://dev.to/jamesmh/strategy-pattern-implementations-in-c-basic-to-advanced-6o4)
...
# [](#why-should-i-know-the-strategy-pattern)为什么要知道策略模式？
...
# [](#the-flow-of-the-strategy-pattern)策略模式的流程
...
# [](#practical-uses-of-the-strategy-pattern)战略模式的实际用途
...
# [](#basic-with-switch-statement-removal)基本同开关语句删除
...
# [](#expensive-object-instantiation)昂贵的对象实例化？
...
# [](#last-one-advanced-factory)最后一名:先进工厂
