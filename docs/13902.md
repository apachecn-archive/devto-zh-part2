...
> 原文:[https://dev.to/franiglesias/test-doubles-1-fei](https://dev.to/franiglesias/test-doubles-1-fei)
...
## [](#el-concepto-de-test-double)双重测试的概念
...
## [](#por-qu%C3%A9-y-para-qu%C3%A9-de-los-tests-doubles)双重测试的原因和目的
...
## [](#test-doubles-y-d%C3%B3nde-encontrarlos)双重测试，在哪里可以找到
...
### [](#test-doubles-que-no-acoplan-el-test-a-la-implementaci%C3%B3n)不配合试验实施的双重试验
...
### [](#test-doubles-que-son-implementaciones-alternativas)*双重测试*是替代实现
...
## [](#alternativas-para-generar-test-doubles)产生双重测试的备选方案

### [](#usar-las-clases-reales)使用真实班级
...
### [](#implementaci%C3%B3n-directa)直接实施
