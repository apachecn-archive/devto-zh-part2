...
### [](#the-basic-git-bisect-workflow)基本 git 平分工作流程
...
## [](#automated-git-bisect)自动 git 二等分
...
### [](#about-git-bisect-and-tdd)关于 git 二等分和 TDD
...
### [](#setup-you-test-scenario-wisely)明智地设置您的测试场景
