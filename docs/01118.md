...
## [](#react-vs-web-components-is-a-false-dichotomy)React vs. Web Components 是一个伪二分法。
...
## [](#react-is-tomorrows-mootools)React 是明天的 MooTools
...
## [](#the-fud-around-wcs-is-unjustified)围绕 WC 的 FUD 是没道理的
