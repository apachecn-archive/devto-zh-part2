...
## [](#what-is-a-slab)什么是石板

**slab** s 是预先分配的 1M 内存块，可以细分为多个对象。它们被分组为**平板类** es，为各种尺寸的分配请求提供服务。

## [](#what-is-memory-fragmentation-how-it-occurs)什么是内存碎片，它是如何发生的
