...
> 原文:[https://dev . to/wia io/setup-an-ada fruit-feather-huzzah-esp8266-and-publish-an-event-to-wia-5c 85](https://dev.to/wiaio/setup-an-adafruit-feather-huzzah-esp8266-and-publish-an-event-to-wia-5c85)
...
#### [](#usb-to-uart-drivers-required)**USB 转 UART 所需驱动**
...
#### [](#chargeonly-usb-cables)充电专用 USB 线
