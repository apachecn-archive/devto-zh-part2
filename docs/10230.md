...
## [](#add-aws-appsync-layer-to-connect-to-backend)添加 AWS AppSync 层连接到后端
...
## [](#add-cache-and-state-management)添加缓存和状态管理
...
## [](#using-state-in-component)在组件中使用状态
