...
# [](#sections-of-packer-template)各段封隔器模板
...
## [](#so-what-exactly-does-packer-do-)那么 Packer 到底是做什么的？
...
# [](#getting-hands-dirty-with-packer)用打包机弄脏手
