...
> 原文:[https://dev . to/marvelouswololo/how-to-server-side-render-react-hydrate-it-on-the-client-and-combine-client-and-server-routes-1a3p](https://dev.to/marvelouswololo/how-to-server-side-render-react-hydrate-it-on-the-client-and-combine-client-and-server-routes-1a3p)

# [](#how-to-serverside-render-react-hydrate-it-on-the-client-and-combine-client-and-server-routes)如何在服务器端渲染 React，在客户端水合，结合客户端和服务器路由
...
### [](#here-is-the-final-code-and-demo)[下面是最终代码](https://github.com/MarvelousWololo/ssr-react)和[演示](https://react-ssr-mw.herokuapp.com)
...
## [](#initial-webpack-configuration)初始 Webpack 配置
...
## [](#first-serverside-rendering)先服务器端渲染
...
## [](#combine-the-express-router-with-react-router)将 Express 路由器与 React 路由器结合
...
## [](#using-express-query-string)使用快速查询字符串
...
## [](#create-a-test-environment)创建测试环境
