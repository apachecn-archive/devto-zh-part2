...
> 原文:[https://dev . to/scale grid/using-redis-object-cache-to-speed-your-WordPress-installation-3 HDL](https://dev.to/scalegrid/using-redis-object-cache-to-speed-up-your-wordpress-installation-3hdl)
