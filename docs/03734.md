...
> 原文:[https://dev . to/Alex _ barashkov/999-uptime-static-site-deployment-with-cloud flare-and-AWS-S3-1b 5i](https://dev.to/alex_barashkov/999-uptime-static-site-deployment-with-cloudflare-and-aws-s3-1b5i)
...
### [](#1-create-s3-bucket)1。创建 S3 存储桶
...
### [](#3-set-the-right-permissions-for-your-user)3。为您的用户设置正确的权限
...
### [](#4-deploy-with-aws-cli)4。使用 AWS CLI 部署
