...
#### [](#2-reading-a-csv-and-printing-a-specific-column)2。读取 CSV 并打印特定列
...
#### [](#3-computing-some-statistics)3。计算一些统计数据
...
#### [](#special-variables-and-builtin-functions)特殊变量和内置函数
