...
> 原文:[https://dev . to/bright devs/how-to-use-different-Google-configuration-for-each-build-config-2fnh](https://dev.to/brightdevs/how-to-use-different-google-configurations-for-each-build-config-2fnh)
...
## [](#run-scripts-to-the-rescue)运行脚本进行救援
