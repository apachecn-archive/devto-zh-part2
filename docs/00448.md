...
> 原文:[https://dev . to/obahareth/a-quick-dive-into-graph QL-part-1-building-a-graph QL-API-2 CNP](https://dev.to/obahareth/a-quick-dive-into-graphql-part-1-building-a-graphql-api-2cnp)

## [](#what-is-graphql)什么是 [GraphQL](https://graphql.org/) ？
...
## [](#consuming-a-graphql-api)使用 GraphQL API
