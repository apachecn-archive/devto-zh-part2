...
> 原文:[https://dev . to/yysun/I-also-created-the-exact-same-app-using-apprun-37kc](https://dev.to/yysun/i-also-created-the-exact-same-app-using-apprun-37kc)
...
# [](#1-what-is-the-project-structure)1。项目结构是什么？
...
# [](#2-how-do-we-mutate-data)2。我们如何改变数据？
...
# [](#3-how-do-we-create-new-to-do-items)3。我们如何创建新的待办事项？
...
# [](#4-how-do-we-delete-from-the-list)4。我们如何从列表中删除？
...
# [](#5-how-do-we-pass-event-listeners)5。我们如何传递事件侦听器？
...
# [](#6-how-do-we-pass-data-through-to-a-child-component)6。我们如何将数据传递给子组件？
...
# [](#7-how-do-we-emit-data-back-to-a-parent-component)7。我们如何将数据发送回父组件？
...
# [](#8-what-makes-apprun-different)8。是什么让 AppRun 与众不同？

## [](#1-we-drive-the-appcomponent-update-lifecycle-using-events)1)我们使用事件驱动应用/组件更新生命周期。
...
## [](#2-apprun-functions-do-not-need-this)2) AppRun 函数不需要“这个”
...
## [](#3-twoway-data-binding-is-possible-but-think-yagni)3)双向数据绑定是可能的，但 YAGNI 认为
