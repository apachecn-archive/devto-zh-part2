...
> 原文:[https://dev . to/gwllmnn/automatic-security-tests-in-Jenkins-with-owasp-zap-2f6b](https://dev.to/gwllmnn/automatic-security-tests-in-jenkins-with-owasp-zap-2f6b)
