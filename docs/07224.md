...
> 原文:[https://dev . to/timber/decorators-in-python-what-you-need-to-know-2 IAF](https://dev.to/timber/decorators-in-python-what-you-need-to-know-2iaf)
...
# [](#writing-your-own-decorator)编写自己的装饰器
...
# [](#wrapping-functions-correctly)包装功能正常
...
# [](#adding-variables-to-the-decorator)给装饰器添加变量
