...
> 原文:[https://dev . to/cindyachieng/-how-to-set-up-django-environment-in-Linux-for-初学者-35am](https://dev.to/cindyachieng/-how-to-set-up-django-environment-in-linux-for-beginners-35am)
...
##### [](#setting-up-virtual-environment)设置虚拟环境
...
##### [](#create-and-name-virtualenv)创建并命名 virtualenv
...
##### [](#activate-virtualenv)激活 Virtualenv
...
##### [](#how-to-check-packages-installed-in-the-virtualenv-you-just-created)如何检查刚创建的 virtualenv 中安装的包
...
##### [](#creating-django-project)创建 Django 项目
...
##### [](#test-development-server)测试开发服务器
...
##### [](#configuring-settingspy)配置设置. py
