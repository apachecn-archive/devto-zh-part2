...
> 原文:[https://dev . to/plain programmer/the-problem with-free-open-source-software-fo4](https://dev.to/plainprogrammer/the-problem-with-free-open-source-software-fo4)
...
#### [](#freedom-is-the-problem-and-the-solution)自由是问题(也是解决方案)
