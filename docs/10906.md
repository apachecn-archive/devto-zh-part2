...
> 原文:[https://dev . to/paigen 11/why-a-spring-cloud-config-server-is-critical-to-a-good-cicd-pipeline-pt-1-2ib 3](https://dev.to/paigen11/why-a-spring-cloud-config-server-is-crucial-to-a-good-cicd-pipeline-pt-1-2ib3)
...
## [](#setting-up-your-config-server)设置您的配置服务器
...
## [](#setting-up-your-config-server-properties)设置您的配置服务器属性
...
## [](#connecting-your-java-spring-boot-application-to-your-config-server)将 Java Spring Boot 应用程序连接到配置服务器
...
## [](#conclusion-and-part-two-the-config-server-and-nodejs)结论和第二部分:配置服务器和 Node.js
