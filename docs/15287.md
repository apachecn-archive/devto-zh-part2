...
> 原文:[https://dev . to/neo/create-a-real time-prototype-feedback-app-using-vuejs-and-pusher-5g 92](https://dev.to/neo/create-a-realtime-prototype-feedback-app-using-vuejs-and-pusher--5g92)
...
## [](#requirements-we-will-need-to-build-our-application)需求我们将需要构建我们的应用程序
...
## [](#setting-up-our-prototype-feedback-application)设置我们的原型反馈应用
...
## [](#using-vue-to-create-the-functionalities-of-our-prototype-feedback-app)使用 Vue 创建我们的原型反馈应用程序的功能
...
## [](#creating-the-endpoints-for-our-prototype-feedback-application)为原型反馈应用程序创建端点
...
## [](#adding-realtime-functionality-to-the-prototype-feedback-app-using-pusher)使用 Pusher 为原型反馈应用添加实时功能
