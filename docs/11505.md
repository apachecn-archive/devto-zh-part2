...
> 原文:[https://dev.to/mattferderer/what-is-csp-why-如何把它添加到你的网站-28df](https://dev.to/mattferderer/what-is-csp-why--how-to-add-it-to-your-website-28df)
...
## [](#how-to-add-a-csp-policy)如何添加 CSP 策略
...
## [](#inline-script-is-my-middle-name)内联脚本是我的中间名
...
## [](#cheer-up-unsafe-inline-isnt-the-end-of-the-world-just-your-company-just-kidding-sort-of)振作起来！不安全的内联不是世界末日！只有你的公司。(开玩笑，算是吧...)
...
## [](#generating-the-rest-of-your-csp)生成剩余的 CSP
