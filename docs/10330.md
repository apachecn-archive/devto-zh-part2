...
## [](#why-svgs-whats-the-benefit-why-not-just-make-it-into-a-png)为什么是 SVGs？有什么好处？为什么不直接做成 PNG 呢？
...
### [](#right-so-svgs-it-is-now-how-to-use-them-in-react)正确。那么 SVG 就是了，现在如何在 React 中使用它们
...
### [](#then-svg-inline-loader)然后… SVG 内联加载器
