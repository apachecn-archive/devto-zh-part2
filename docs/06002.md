...
> 原文:[https://dev . to/kball/js-by-example-8-distinct-uses-of-JavaScript-array-slice-38 m3](https://dev.to/kball/js-by-example-8-distinct-uses-of-javascript-array-slice-38m3)
...
### [](#use-2-subarray-starting-at-n)使用 2:从 N 开始的子阵列
...
### [](#use-3-last-n-of-an-array)使用 3:数组的最后 N 个
...
### [](#use-4-first-n-of-an-array)使用 4:数组的前 n 个
...
### [](#use-5-inner-segment-of-n-starting-at-m)使用 5:n 的内段，从 m 开始
...
## [](#working-with-arraylike-objects)处理类似数组的对象
...
### [](#use-6-convert-arraylike-objects-into-arrays)使用 6:将类似数组的对象转换成数组
...
### [](#use-7-coerce-arbitrary-length-extra-arguments-into-an-array)使用 7:将任意长度的多余参数强制放入一个数组中
...
## [](#functional-array-manipulation)功能数组操作

`slice`的另一个巨大用途是以函数/纯粹的方式操作数组，而不修改原始数组。

### [](#use-8-modifying-a-particular-index-in-an-array)使用 8:修改数组中的某个索引
