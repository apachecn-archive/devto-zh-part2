...
#### [](#considering-the-benefits-of-redux-we-have-the-article-for-you)考虑 Redux 的好处？我们有文章给你。
...
> Redux 是 JavaScript 应用程序的可预测状态容器。它帮助您编写行为一致、在不同环境(客户机、服务器和本机)中运行、易于测试的应用程序。——[](https://redux.js.org/)
...
### [](#why-you-need-a-state-management-tool)为什么需要状态管理工具
...
### [](#understanding-how-redux-works)了解 Redux 如何工作
...
#### [](#other-benefits-of-using-redux)使用 Redux 的其他好处
