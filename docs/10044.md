...
> 原文:[https://dev.to/stuartblang/iasyncenumerablet-安-简介-g99](https://dev.to/stuartblang/iasyncenumerablet---an-introduction-g99)
...
### [](#about-ixasync)关于 Ix。异步ˌ非同步(asynchronous)
...
### [](#producing-sequences)生产序列

如果我们不能生成可供消费的序列，所有这些都将是非常学术的。今天有几个选择。

#### [](#1-implement-the-raw-iasyncenumerablelttgt-endraw-and-raw-iasyncenumeratorlttgt-endraw-interfaces-directly)1。直接实现`IAsyncEnumerable<T>`和`IAsyncEnumerator<T>`接口
...
#### [](#2-use-the-static-helper-methods-in-ixnet)2。在 Ix.NET 中使用静态帮助器方法
...
#### [](#3-use-cxuesongasyncenumerableextensions)3。用 c 雪松。AsyncEnumerableExtensions
...
#### [](#4-coming-soon-to-a-c-80-near-you)4。即将在您身边推出 C# 8.0
...
### [](#consuming-sequencing)消耗排序

我们可以产生序列，但是如果我们不能消费它们，那对我们来说就没什么用了。

#### [](#1-foreachasync)1。ForEachAsync
...
#### [](#2-c-80-foreach)2。C# 8.0 foreach
