...
#### [](#pain-point-1-we-dont-know-where-to-start)痛点#1:“我们不知道从哪里开始”
...
#### [](#pain-point-2-we-cant-or-dont-want-to-write-machine-learn-code)痛点#2:“我们不能(或不想)编写机器学习代码”
...
#### [](#pain-point-3-building-and-preparing-the-data-set-is-hard)难点 3:“构建和准备数据集很难”
...
#### [](#pain-point-4-everything-takes-forever)痛点#4:“一切都需要永远”
...
#### [](#pain-point-5-infrastructure-cant-keep-up)痛点#5:“基础设施跟不上”
...
#### [](#pain-point-6-we-have-to-keep-costs-under-control)痛点#6:“我们必须控制成本”
