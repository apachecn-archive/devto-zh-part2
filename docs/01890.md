...
> 原文:[https://dev . to/swyx/networking-essentials-content-distribution-jag](https://dev.to/swyx/networking-essentials-content-distribution-jag)
...
## [](#namingbased-redirection)基于命名的重定向
...
## [](#cdn-and-isp-peering)CDN 和 ISP 对等
