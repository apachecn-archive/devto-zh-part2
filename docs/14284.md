...
> 原文:[https://dev . to/MongoDB/optimizing-for-fast-responsive-reads-with-cross-region-replication-in-MongoDB-atlas-28d 7](https://dev.to/mongodb/optimizing-for-fast-responsive-reads-with-cross-region-replication-in-mongodb-atlas-28d7)
...
### [](#primer-on-read-preference)引子上的阅读偏好
...
### [](#enabling-read-replicas-in-mongodb-atlas)在 MongoDB Atlas 中启用读取副本
...
### [](#security-and-connectivity-on-aws)安全性和连接性(AWS 上)
