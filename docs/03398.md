...
> 原文:[https://dev . to/adamspannbauer/OOP-fractal-trees-in-r-with-R6-gg plot 2-gg animate-part-1-19bm](https://dev.to/adamspannbauer/oop-fractal-trees-in-r-with-r6-ggplot2--gganimate-part-1-19bm)
...
### [](#-raw-branchbase-endraw-)`branch_base`
...
### [](#-raw-fractaltree-endraw-)`fractal_tree`
