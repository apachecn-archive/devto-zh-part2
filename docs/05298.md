...
> 原文:[https://dev . to/dev kiran/building-a-salon-booking-chatbot-with-laravel-and-botman-1250](https://dev.to/devkiran/building-a-salon-booking-chatbot-with-laravel-and-botman-1250)
...
# [](#install-and-set-up-the-botman-studio)安装并设置 BotMan Studio
...
# [](#create-a-new-chatbot-project)创建新的聊天机器人项目
...
# [](#test-the-installation-works)测试安装工程
...
# [](#install-the-web-driver)安装 web 驱动程序
...
# [](#chatbot-conversation-flows)聊天机器人对话流程
...
# [](#build-the-chatbot-dialogs)建立聊天机器人对话框
...
## [](#ask-for-the-name-email-and-mobile)询问姓名、邮箱和手机
...
## [](#prompt-the-visitor-to-choose-one-of-the-services)提示访客选择其中一项服务
...
## [](#prompt-the-visitor-to-choose-a-date-and-time-slot)提示访客选择日期和时间段
