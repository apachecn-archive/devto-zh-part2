...
> 原文:[https://dev.to/mijustin/how-to-autoscale-on-heroku-2ddl](https://dev.to/mijustin/how-to-autoscale-on-heroku-2ddl)
...
### [](#when-should-i-add-dynos-for-my-heroku-app)我的 Heroku app 应该什么时候添加 dynos？
...
### [](#will-adding-dynos-scaling-up-make-my-app-faster)添加 dynos(向上扩展)会让我的应用更快吗？
