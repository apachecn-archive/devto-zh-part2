...
> 原文:[https://dev.to/staceypyee/new-attempt-on-github-pages-6go](https://dev.to/staceypyee/new-attempt-on-github-pages--6go)
...
#### [](#step-1-create-a-repository-with-the-naming-format-as-indicated)***第一步:按照指定的命名格式创建一个存储库。***
...
#### [](#step-2%E2%80%8A%E2%80%8A4-follow-step-2-4-as-mentioned-in-httpspagesgithubcom)***步骤 2 — 4:按照***中的步骤 2—4 进行。

***克隆你的存储库，用你熟悉的 Git 客户端创建并推送你的初始页面内容。我用了 GitX。*T3】**

### [](#alright-step-5-hold-your-breath)**好吧！第五步！屏住呼吸！**
...
### [](#oh-no-what-went-wrong)哦不！！哪里出了问题？！！
