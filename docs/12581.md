...
### [](#structure-of-the-replicator-database-documents)复制器数据库文档的结构
...
### [](#duplicate-replication-documents)复制重复的单据？
...
### [](#cancelling-replications)取消复制

要取消正在进行的复制，只需删除触发复制的文档。

### [](#typical-replication-procedure)典型的复制程序
