...
> 原文:[https://dev . to/nlowe/easy-automated-code-coverage-for-net-core-1khh](https://dev.to/nlowe/easy-automated-code-coverage-for-net-core-1khh)
...
#### [](#instrument-the-assemblies-under-test)对被测组件进行测试。
...
## [](#simplify-things-with-cake)用蛋糕简化事物
...
#### [](#locating-the-tools-project)定位工具项目
...
#### [](#writing-the-test-target)编写测试目标
...
### [](#generating-coverage-results)生成覆盖结果
...
## [](#automating-tests-amp-publishing-coverage)自动化测试&发布覆盖范围
