...
> 原文:[https://dev . to/vonagedev/creating-a-web socket-server-with-the-spark-framework-1837](https://dev.to/vonagedev/creating-a-websocket-server-with-the-spark-framework-1837)
...
## [](#websockets-with-the-spark-framework)采用 Spark 框架的 WebSockets
...
### [](#add-the-spark-dependency)添加火花依赖
...
### [](#create-the-websocket-handler)创建 WebSocket 句柄
...
### [](#register-the-websocket-handler)注册 WebSocket 处理程序
...
### [](#create-a-client-to-test-your-application)创建一个客户端来测试你的应用程序
