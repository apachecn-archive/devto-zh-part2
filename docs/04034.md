...
> 原文:[https://dev . to/on myway 133/machine-learning-in-IOs-azure-custom-vision-and-coreml-3p1n](https://dev.to/onmyway133/machine-learning-in-ios-azure-custom-vision-and-coreml-3p1n)
...
## [](#microsoft-azure-custom-vision)微软 Azure 自定义远景
...
## [](#using-coreml-model-in-ios-app)在 iOS app 中使用 CoreML 模型
...
## [](#what-about-other-cloud-services)其他云服务呢？
