...
# [](#search-github-stars-with-octokit-and-fzf)用 Octokit 和 fzf 搜索 GitHub 明星
...
### [](#fetching-starred-repositories-with-octokit)使用 Octokit 获取带星号的存储库
...
### [](#finding-repositories-with-fzf)使用 fzf 查找存储库
