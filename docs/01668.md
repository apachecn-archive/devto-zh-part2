...
> 原文:[https://dev . to/bnevilleoneill/setting-up-a-restful-API-with-node-js-and-PostgreSQL-1jbf](https://dev.to/bnevilleoneill/setting-up-a-restful-api-with-node-js-and-postgresql-1jbf)
...
### [](#postgresql-command-prompt)PostgreSQL 命令行提示
...
### [](#setting-up-an-express-server)设置快递服务器
...
### [](#connecting-to-the-database-from-nodejs)从 Node.js 连接数据库
...
### [](#get-a-single-user-by-id)**获取单个用户的 id**
...
### [](#put-updated-data-in-an-existing-user)**将更新的数据放入现有用户**
