...
> 原文:[https://dev . to/aspose pdf/export-data-to-pdf-using-aspose pdf-for-net-core-20-1c c8](https://dev.to/asposepdf/export-data-to-pdf-using-asposepdf-for-net-core-20--1cc8)
...
## [](#basics-of-generation-pdf-with-asposepdf)用 Aspose.PDF 生成 PDF 的基础知识
