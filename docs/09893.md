...
# [](#umbraco-grid-layout-guide)**Umbraco 网格布局指南**
...
# [](#setting-up-the-grid-editor)设置网格编辑器
...
## [](#configuring-the-grid-editor)配置网格编辑器
...
## [](#setting-custom-settings-and-styles)设置自定义设置和样式
...
### [](#rich-text-editor-settings)富文本编辑器设置
...
### [](#adding-the-grid-to-a-document-type)给文档类型添加网格
...
### [](#added-content-to-the-grid)向网格中添加内容
...
### [](#adding-settings-and-styles)添加设置和样式
...
# [](#grid-editor-document-type-plugin)网格编辑器文档类型插件
...
## [](#installing-the-custom-plugin)安装自定义插件
...
### [](#configuring-the-document-types)配置单据类型
...
## [](#using-the-document-type)使用文档类型
...
# [](#umbraco-content-templates)Umbraco 内容模板
...
## [](#setting-up-content-templates)设置内容模板
