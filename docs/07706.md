...
> 原文:[https://dev . to/agrin man/spoof-a-commit-on-github-from-any one-4gf 4](https://dev.to/agrinman/spoof-a-commit-on-github-from-anyone-4gf4)
...
## [](#try-it-for-yourself-spoofkryptco)自己试试:【spoof.krypt.co】T2
...
## [](#how-can-do-prove-that-my-commits-are-really-mine)怎么能证明我的提交是*真的*我的呢？

任何人都可以将 Git 提交的“作者”设置为任何值。为了证明你是提交人，你必须附上数字签名。
有人知道这真的是你提交的唯一方法是验证提交的签名。

## [](#github-supports-verifying-amp-signing-git-commits)GitHub 支持验证&签名 Git 提交
...
# [](#lets-see-some-well-known-forgeries)让我们来看看一些众所周知的赝品...
...
# [](#anonymously-forged-commits)匿名伪造作案
