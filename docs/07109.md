...
#### [](#because-config-management-sucks)因为配置管理烂。
...
#### [](#executing-scripts-with-command-line-options)使用命令行选项执行脚本
...
#### [](#executing-scripts-with-config-files)用配置文件执行脚本
...
#### [](#humanised-command-line-experiences)人性化命令行体验
