...
### [](#what-are-relative-units-amp-why-do-we-need%C2%A0em)**什么是相对单位&我们为什么需要它们？**
...
### [](#1-the-unpredicatble-em)**1。不可预测的 em**
...
### [](#2-the-savior-rem-root%C2%A0em)**2。救世主雷姆(root em)**
...
### [](#34-vh-and%C2%A0vw%C2%A0)**3、4。vh 和 vw**
...
### [](#56-vmax-amp%C2%A0vmin)**5、6。vmax & vmin**
...
### [](#89-experimental-vi-amp%C2%A0vb)**8、9。实验六& vb**
...
### [](#1011-lh-amp%C2%A0rlh)**10，11。lh & rlh**
...
### [](#15-ic-ideograph-count)**15。ic '象形文字计数**
