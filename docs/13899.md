...
> 原文:[https://dev.to/jansonsa/a-star-a-path-finding-c-4a4h](https://dev.to/jansonsa/a-star-a-path-finding-c-4a4h)
...
##### [](#then-we-make-our-class-and-inside-we-use-these-functions)然后我们让*成为我们的类*，在里面我们使用这些函数:
...
#### [](#now-the-algorithm-itself)现在算法本身
...
#### [](#to-actually-use-the-algorithm)实际使用的算法:
