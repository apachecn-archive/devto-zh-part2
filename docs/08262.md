...
> 原文:[https://dev . to/bnevilleoneill/conquer-navigation-state-with-react-router-and-redux-2 IAA](https://dev.to/bnevilleoneill/conquer-navigation-state-with-react-router-and-redux-2iaa)
...
### [](#the-application-well-be-working-with)我们将要使用的应用程序
...
### [](#a-quick-overview-of-how-emojiland-is-built)快速概述 *EmojiLand* 是如何建造的
...
### [](#avoiding-redirects-from-replacing-the-current-route-in-history)避免重定向替换历史中的当前路线
...
### [](#maintaining-navigation-state)保持导航状态
...
### [](#but-theres-another-solution)但是，还有另外一种解决方法！
...
### [](#weve-got-all-this-out-of-the-box)我们已经开箱即用了
...
### [](#considering-a-deeper-integration-between-reactrouter-and-redux)考虑 React-Router 和 Redux 之间更深层次的整合
...
### [](#integrating-connectedreactrouter-into-emojiland)将 Connected-React-Router 集成到 EmojiLand 中
