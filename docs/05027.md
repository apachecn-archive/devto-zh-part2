...
> 原文:[https://dev . to/oktadev/build-and-understand-express-middleware-through-examples-1 ago](https://dev.to/oktadev/build-and-understand-express-middleware-through-examples-1ago)
...
## [](#what-is-express-middleware)什么是快递中间件？
...
## [](#requirements-to-write-express-middleware)要求编写快递中间件
...
## [](#express-middleware-the-basics)快递中间件:基础知识
...
## [](#express-request-logging-middleware-example)快速请求日志中间件示例
...
## [](#restrict-express-request-content-type-example)限制快递请求内容类型示例
...
## [](#thirdparty-express-middleware)第三方快递中间件
...
### [](#why-okta-for-express-applications)为什么 Okta 适用于快递申请
...
## [](#oktas-oidc-express-middleware)Okta 的 OIDC 快递中间件
...
## [](#middleware-order-is-important)中间件顺序很重要
...
## [](#learn-more-about-express-middleware)了解更多关于 Express 中间件的信息
