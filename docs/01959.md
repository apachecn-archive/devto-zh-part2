...
## [](#rounding-to-the-nearest-5-degrees)四舍五入到最近的 5 度
...
### [](#converting-celsius-to-fahrenheit-and-rounding-results)将摄氏温度转换为华氏温度并舍入结果
...
### [](#converting-fahrenheit-to-celsius-and-rounding-results)将华氏温度转换为摄氏温度并舍入结果
