...
## [](#crossdomain-tracking-and-skewed-data)跨域跟踪和偏斜数据
...
## [](#google-analytics-and-amp)谷歌分析和 AMP
...
### [](#adding-google-analytics-to-amp)将谷歌分析添加到 AMP
...
## [](#adding-amp-linker-for-crossdomain-tracking)添加 AMP 链接器进行跨域跟踪
