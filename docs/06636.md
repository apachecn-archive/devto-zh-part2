...
> 原文:[https://dev . to/terrehbyte/resolving-file-path-to-tools-on-different-workstations-4g 55](https://dev.to/terrehbyte/resolving-file-paths-to-tools-on-different-workstations-4g55)
...
## [](#using-the-symbolic-link)使用符号链接
