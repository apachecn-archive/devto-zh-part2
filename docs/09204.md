...
## [](#step-2-creating-the-page-element)第二步-创建页面元素
...
## [](#step-3-sliding-the-page)第三步-滑动页面
...
## [](#step-4-creating-the-nav-element)步骤 4 -创建导航元素
...
## [](#step-5-implement-routing)第五步-实施路由
...
## [](#step-6-only-render-what-is-visible)第 6 步——只渲染可见的东西
...
## [](#step-7-optional-customizing-and-extending-the-code)步骤 7(可选)-定制和扩展代码
