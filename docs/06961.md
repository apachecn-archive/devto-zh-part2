...
> 原文:[https://dev.to/zellwk/your-first-git-commit-4686](https://dev.to/zellwk/your-first-git-commit-4686)
...
## [](#committing-more-than-one-file)提交多个文件
...
## [](#checking-the-git-history)查看 Git 历史记录
