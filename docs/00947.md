...
## [](#we-may-want-to-limit-our-results-to-a-specific-path-or-a-pattern-that-matches-multiple-paths)我们可能希望将我们的结果限制到特定的路径，或者匹配多个路径的模式
...
## [](#we-may-only-want-to-search-to-a-particular-depth-or-search-beyond-a-particular-depth)我们可能只想搜索*到*特定深度或者搜索特定深度以外的
...
## [](#we-may-want-to-find-files-that-are-newerolder-relative-to-another-file)我们可能希望找到相对于另一个文件较新/较旧的文件
...
## [](#we-may-want-to-search-for-a-particular-kind-of-file-file-directory-symlink-etc)我们可能想搜索一种特定的“文件”(文件、目录、符号链接等。)
...
## [](#we-may-want-to-search-for-files-that-a-particular-user-or-group-owns-or-inversely-that-are-not-owned-by-a-known-user-or-group)我们可能想要搜索特定用户或组拥有的文件(或者相反，不属于已知用户或组的文件)
...
## [](#we-may-want-to-find-empty-files-or-directories)我们可能想要找到空的文件或目录
...
## [](#we-may-want-to-run-a-utility-on-the-files-identified-by-raw-find-endraw-)我们可能想要对由`find`标识的文件运行一个实用程序
...
## [](#we-may-want-to-format-raw-find-endraw-s-output)我们可能想要格式化`find`的输出
...
## [](#we-may-want-to-delete-found-files)我们可能想删除找到的文件
