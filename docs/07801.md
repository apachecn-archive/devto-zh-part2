...
> 原文:[https://dev . to/kbk 0125/JavaScript s-reduce-method-explained-by-going-on-adiet-3078](https://dev.to/kbk0125/javascripts-reduce-method-explained-by-going-on-adiet-3078)
...
### [](#simulating-reduce-with-a-for%C2%A0loop)用 For 循环模拟 Reduce
...
### [](#a-simple-example-of%C2%A0reduce)减少的简单例子
...
### [](#example-2-using%C2%A0objects)例 2-使用对象
...
### [](#example-3-using-mulitple-categories)示例 3-使用多个类别
...
### [](#get-the-latest-tutorials)获取最新教程
