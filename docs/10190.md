...
## [](#-raw-lh-endraw-and-raw-rlh-endraw-)`lh`和`rlh`
...
## [](#-raw-vi-endraw-and-raw-vb-endraw-)`vi`和`vb`
...
# [](#now-something-more-anecdotal)现在多了一些轶事...

让我们来看看更老的规范(3 级)，因为即使它*应该*被广泛支持和使用，它仍然有一些不太为人所知的部分...

## [](#-raw-turn-endraw-and-brothers)`turn`和兄弟
...
## [](#-raw-hz-endraw-and-raw-khz-endraw-)`Hz`和`kHz`
