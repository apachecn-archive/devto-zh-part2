...
> 原文:[https://dev . to/wangonya/JavaScript-lookaheads-and-lookbehinds-4p 60](https://dev.to/wangonya/javascript-lookaheads-and-lookbehinds-4p60)
...
#### [](#lookaheads-match-a-string-depending-on-what-follows-it)Lookaheads:根据后面的内容匹配一个字符串

##### [](#format-raw-xy-endraw-)格式:`x(?=y)`
...
#### [](#lookbehinds-match-a-string-depending-on-what-precedes-it)Lookbehinds:根据前面的内容匹配字符串

**这是一个 [ES2018](https://github.com/tc39/proposal-regexp-lookbehind) 的特色**🎉🎊🚀🎸🤘🏾

##### [](#format-raw-ltyx-endraw-)格式:`(?<=y)x`
