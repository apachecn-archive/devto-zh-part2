...
> 原文:[https://dev . to/mostly Jason/react-16-error-boundaries-let-you-recovery-gracefully-152d](https://dev.to/mostlyjason/react-16-error-boundaries-let-you-recover-gracefully-152d)
...
## [](#what-are-error-boundaries)什么是误差边界？
...
## [](#how-to-implement-react-error-boundaries)如何实现 React 错误边界
...
## [](#adding-rollbar-to-react-error-boundaries)添加滚动条来反应错误边界
