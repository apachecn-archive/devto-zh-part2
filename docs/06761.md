...
# [](#characteristic-of-the-value-object)价值对象的特征:

* * *

### [](#1-measures-quantifies-or-describes-the-subject-of-a-domain)1)度量、量化或描述一个领域的主题
...
### [](#3-composes-linked-attribute-values-into-the-integral-unit)3)将链接的属性值组成整数单元
...
### [](#4-is-replaceable-in-the-situation-when-the-measurement-changes)4)在测量值变化的情况下是可替换的
...
### [](#5-could-be-compared-with-other-value-objects)5)可以与其他价值对象相比较
...
### [](#6-has-sideeffectfree-behavior)6)具有无副作用的行为
