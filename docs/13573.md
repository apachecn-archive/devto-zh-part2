...
> 原文:[https://dev . to/lauragift 21/build-a-static-site-with-Hugo-and-deploy-with-netlify-35 a6](https://dev.to/lauragift21/build-a-static-site-with-hugo-and-deploy-with-netlify-35a6)
...
#### [](#step-2-create-a-new-hugo-site)第二步:创建新的 Hugo 站点
...
#### [](#step-4-running-the-theme)第四步:运行主题
...
#### [](#step-5-deploy-to-netlify)第五步:部署到网络生活
