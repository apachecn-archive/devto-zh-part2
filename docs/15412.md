...
> 原文:[https://dev . to/jgaskins/fast-type-checked-serializer-for-ruby-we b-API-2o 19](https://dev.to/jgaskins/fast-type-checked-serializers-for-ruby-web-apis-2o19)
...
## [](#the-downside-of-those-options)那些选项的不利方面
...
## [](#what-happens-if-the-type-check-fails)如果类型检查失败会怎样？
