...
#### [](#creating-a-class-component)创建一个类组件
...
#### [](#adding-state-to-a-class-component)给类组件添加状态
...
#### [](#render-our-jsx-with-the-render-method)用渲染方法渲染我们的 JSX
...
#### [](#custom-functions-in-our-component)自定义我们组件中的函数
...
#### [](#receiving-props-inside-component)接收道具内部组件
