...
> 原文:[https://dev . to/georgina grey/my-first-portfolio-with-react-and-AWS-2g 73](https://dev.to/georginagrey/my-first-portfolio-with-react-and-aws-2g73)
...
### [](#how-did-i-end-up-with-that)我怎么会落得如此下场？！
...
#### [](#caching-and-invalidating-cloudfront)缓存并使 CloudFront 失效
...
###### [](#edit-0730-added-warning-about-intersectionobserver)编辑 07/30:追加 IntersectionObserver 警告。

###### [](#edit-0803-added-aws-billing-statement)编辑 08/03:新增 AWS 账单。