...
> 原文:[https://dev.to/jeikabu/more-windows-service-in-c-3keg](https://dev.to/jeikabu/more-windows-service-in-c-3keg)
...
## [](#start-process-as-desktop-user)以桌面用户身份启动流程
