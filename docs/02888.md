...
## [](#custom-form-builder-helpers)自定义表单生成器助手
...
### [](#activerecord-syntax)ActiveRecord 语法
...
### [](#criticism-is-the-sincerest-form-of-make-a-new-framework)批评是制定新框架的最真诚的形式
