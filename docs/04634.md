...
> 原文:[https://dev . to/Jorge _ rockr/configuring-ssh-key-for-bit bucket-repositories-2925](https://dev.to/jorge_rockr/configuring-ssh-key-for-bitbucket-repositories-2925)
...
## [](#step-0-install-git)步骤 0:安装 Git

我想你以前做过这个😒，不管你用的是 Windows 还是 Linux，但如果你用的是 Windows...请安装 GIT BASH 。

## [](#step-1-create-the-file-raw-idrsapub-endraw-)第一步:创建文件`id_rsa.pub`
...
## [](#step-2-check-if-you-did-it-well)第二步:检查自己做得好不好
...
## [](#step-3-configure-your-ssh-key-into-bitbucket-similar-applies-to-github)第三步:将您的 SSH 密钥配置到 Bitbucket 中(类似的情况也适用于 Github)
...
## [](#step-4-clone-your-repository-using-ssh-protocol)步骤 4:使用 SSH 协议克隆您的存储库
