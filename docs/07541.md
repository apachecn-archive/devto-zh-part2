...
> 原文:[https://dev . to/jovanhernandex/using-twilio-to-send-SMS-texts-via-python-flask-and-ngrok-4 i39](https://dev.to/jovanhernandex/using-twilio-to-send-sms-texts-via-python-flask-and-ngrok-4i39)
...
### [](#outbound-sms%E2%80%8A%E2%80%8Ahow-does-it-work)出站短信—如何工作？
...
### [](#creating-a-twilio-account-amp-purchasing-a-number)创建 Twilio 账户&购买号码
...
### [](#setting-up-your-environment-and-installing-packages)设置您的环境并安装软件包
...
### [](#receiving-and-replying-to-incoming-sms-messages)接收和回复收到的短信

为了接收和回复收到的短信，我们需要安装 Flask，设置 virtualenv 沙箱，并配置 ngork，以便 Twilio 可以与我们的应用程序对话。我们开始吧。

#### [](#installing-pip-and-virtualenv)安装 Pip 和 Virtualenv
...
#### [](#installing-dependencies-in-your-virtualenv)在您的虚拟机中安装依赖项
...
### [](#allow-twilio-to-talk-to-your-flask-app-using-ngrok)允许 Twilio 使用 ngrok 与您的 Flask 应用程序对话
...
### [](#replying-to-incoming-sms-messages-sent-from-twilio)回复 Twilio 发来的短信
