...
> 原文:[https://dev . to/stereo booster/developers-experience-a-feedback-loop-2c a2](https://dev.to/stereobooster/developers-experience-a-feedback-loop-2ca2)
...
### [](#tdd-specific-recieps)TDD 特定接收方
