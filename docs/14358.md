...
> 原文:[https://dev . to/dkundel/protect-your-nodejs-app-from-cross-site-request-forgery-46b 9](https://dev.to/dkundel/protect-your-nodejs-app-from-cross-site-request-forgery--46b9)
...
### [](#going-raw-csurf-endraw-ing)打算`csurf` ing
