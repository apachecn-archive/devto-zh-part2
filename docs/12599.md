...
## [](#step-1-setting-up-on-clarifai)步骤 1 -在 Clarifai 上设置
...
## [](#step-2-setting-up-nsfai)步骤 2 -设置国家自然科学基金
...
## [](#step-3-predicting-images)第三步-预测图像
...
## [](#interlude-image-result)幕间-图像结果
...
## [](#step-4-predicting-videos)第四步-预测视频
...
## [](#interlude-video-result)插曲-视频结果
