...
> 原文:[https://dev . to/verdaccio/verdaccio-and-deterministic-lock-files-19go](https://dev.to/verdaccio/verdaccio-and-deterministic-lock-files-19go)
...
### [](#how-does-a-lock-file-look-like)一个锁文件是什么样子的？
...
#### [](#simple-example-with-verdaccio-as-localhost)以 Verdaccio 为本地主机的简单例子
...
### [](#how-does-the-resolved-field-is-being-used-by-)解析字段是如何被…使用的？
...
### [](#scoped-registry-workaround)作用域注册表解决方法
