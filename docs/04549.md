...
> 原文:[https://dev . to/mokkapps/sticky-footer-in-gatsbyjs-using-flexbox-5162](https://dev.to/mokkapps/sticky-footer-in-gatsbyjs-using-flexbox-5162)

我最近开发了一些基于 [GatsbyJS](https://gatsbyjs.org) 的静态网站，它们有一个粘性页脚。粘性页脚总是位于页面的底部，即使对于稀疏的内容也是如此。

不幸的是，我很难解决这个问题，因此，我想与你分享我的经验。

## [](#nongatsbyjs-solution)非盖茨比方案
