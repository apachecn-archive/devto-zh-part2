...
### [](#translating-marked-strings-or-translation-strings)翻译标记字符串或翻译字符串。
...
## [](#activating-translation-manually)手动激活翻译
...
### [](#using-strings-translations-in-templates)在模板中使用字符串翻译
...
## [](#activating-translation-by-url-prefix)通过 URL 前缀激活翻译
