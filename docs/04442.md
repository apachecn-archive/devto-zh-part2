...
> 原文:[https://dev . to/what rocks/teaching-my-robot-with-tensor flow-3i1a](https://dev.to/whatrocks/teaching-my-robot-with-tensorflow-3i1a)
...
## [](#1-use-cozmo-to-generate-training-data)1。使用 Cozmo 生成训练数据
...
### [](#uploading-dataset-to-floydhub)上传数据集到 FloydHub
...
## [](#2-training-our-model-on-floydhub)2。在 FloydHub 上训练我们的模型
...
## [](#3-connecting-cozmo-to-our-retrained-model)3。将 Cozmo 连接到我们的再培训模型
