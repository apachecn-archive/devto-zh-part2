...
> 原文:[https://dev . to/NNE VOD/geometry-analysis-features-in-aspose GIS-1 HMD](https://dev.to/nnevod/geometry-analysis-features-in-asposegis-1hmd)
...
#### [](#coordinatedimension)[圆坐标](https://apireference.aspose.com/net/gis/aspose.gis.geometries/geometry/properties/coordinatedimension)

获取此几何图形的坐标维数。即只有 X 和 Y 坐标时为 2，有 X、Y 和 Z 或 M 坐标时为 3，等等。

#### [](#dimension)[维度](https://apireference.aspose.com/net/gis/aspose.gis.geometries/geometry/properties/dimension)
...
#### [](#hasm)[哈斯姆](https://apireference.aspose.com/net/gis/aspose.gis.geometries/geometry/properties/hasm)
...
#### [](#isempty)[是空的](https://apireference.aspose.com/net/gis/aspose.gis.geometries/geometry/properties/isempty)
...
#### [](#isvalid)[IsValid](https://apireference.aspose.com/net/gis/aspose.gis.geometries/geometry/properties/isvalid)
...
#### [](#null)[Null](https://apireference.aspose.com/net/gis/aspose.gis.geometries/geometry/properties/null)

返回空几何的静态方法。

#### [](#spatialreferencesystem)[空间参考系统](https://apireference.aspose.com/net/gis/aspose.gis.geometries/geometry/properties/spatialreferencesystem)
...
## [](#methods-for-basic-property-analysis)基本属性分析方法

#### [](#getarea)[GetArea](https://apireference.aspose.com/net/gis/aspose.gis.geometries/geometry/methods/getarea)

获取几何图形的面积，如果是集合，则为所有面积的总和。

#### [](#getdistanceto)[GetDistanceTo](https://apireference.aspose.com/net/gis/aspose.gis.geometries/geometry/methods/getdistanceto)

获取从该几何图形到指定的其他几何图形的最近距离。如果至少有一个几何图形为空，则返回-1。

#### [](#getlength)[GetLength](https://apireference.aspose.com/net/gis/aspose.gis.geometries/geometry/methods/getlength)

获取几何图形的长度。如果是多边形，则返回周长。如果是集合，则返回所有长度的总和。

## [](#methods-for-boolean-relationships)用于布尔关系的方法

#### [](#coveredby)[被](https://apireference.aspose.com/net/gis/aspose.gis.geometries/geometry/methods/coveredby)覆盖

如果此几何图形在空间上被另一个几何图形覆盖，则返回 true，否则返回 false。

#### [](#covers)[封面](https://apireference.aspose.com/net/gis/aspose.gis.geometries/geometry/methods/covers)

如果此几何图形在空间上覆盖了其他几何图形，则返回 true。本质上与被此几何图形和其他几何图形交换覆盖的相同。

#### [](#crosses)[穿越](https://apireference.aspose.com/net/gis/aspose.gis.geometries/geometry/methods/crosses)
...
#### [](#disjoint)[不相交](https://apireference.aspose.com/net/gis/aspose.gis.geometries/geometry/methods/disjoint)

如果两个几何图形没有公共点，则返回 true。

#### [](#intersects)[相交](https://apireference.aspose.com/net/gis/aspose.gis.geometries/geometry/methods/intersects)
...
#### [](#overlaps)[重叠](https://apireference.aspose.com/net/gis/aspose.gis.geometries/geometry/methods/overlaps)
...
#### [](#spatiallycontains)[空间上包含](https://apireference.aspose.com/net/gis/aspose.gis.geometries/geometry/methods/spatiallycontains)
...
#### [](#spatiallyequals)[在空间上等于](https://apireference.aspose.com/net/gis/aspose.gis.geometries/geometry/methods/spatiallyequals)
...
#### [](#touches)[触动](https://apireference.aspose.com/net/gis/aspose.gis.geometries/geometry/methods/touches)
...
## [](#methods-for-generation-of-derivative-geometry)衍生几何图形的生成方法

#### [](#difference)[差异](https://apireference.aspose.com/net/gis/aspose.gis.geometries/geometry/methods/difference)
...
#### [](#getcentroid)[获取质心](https://apireference.aspose.com/net/gis/aspose.gis.geometries/geometry/methods/getcentroid)
...
#### [](#intersection)[路口](https://apireference.aspose.com/net/gis/aspose.gis.geometries/geometry/methods/intersection)

返回包含点的几何图形，这些点包含在此几何图形和自变量几何图形中。

#### [](#symdifference)[同异](https://apireference.aspose.com/net/gis/aspose.gis.geometries/geometry/methods/symdifference)

返回包含点的几何图形，这些点包含在此几何图形或参数几何图形中，但不同时包含在两者中。

#### [](#union)[联盟](https://apireference.aspose.com/net/gis/aspose.gis.geometries/geometry/methods/union)

返回是此几何和参数几何之和的几何，包含来自这两个几何的点。

## [](#general-case-relation-de9im-model)一般情况关系，DE-9IM 模型。
...
## [](#miscellaneous-methods)杂法

#### [](#roundm)[RoundM](https://apireference.aspose.com/net/gis/aspose.gis.geometries/geometry/methods/roundm)

将 M 坐标舍入到指定的小数位数。

#### [](#roundxy)[RoundXY](https://apireference.aspose.com/net/gis/aspose.gis.geometries/geometry/methods/roundxy)

将 X 和 Y 坐标舍入到指定的小数位数。

#### [](#roundz)[回合](https://apireference.aspose.com/net/gis/aspose.gis.geometries/geometry/methods/roundz)

将 Z 坐标舍入到指定的小数位数。

#### [](#setempty)[SetEmpty](https://apireference.aspose.com/net/gis/aspose.gis.geometries/geometry/methods/setempty)
