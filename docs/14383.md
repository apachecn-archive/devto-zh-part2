...
> 原文:[https://dev.to/chancesm/running-nodejs-forever-3eof](https://dev.to/chancesm/running-nodejs-forever-3eof)
...
## [](#nodemon-better-option)Nodemon(更好的选项)
