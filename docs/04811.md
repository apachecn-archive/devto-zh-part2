...
> 原文:[https://dev.to/azure/azure-functions-开发者指南-关键功能-2j0d](https://dev.to/azure/azure-functions--a-developers-guide-to-key-features-2j0d)

### [](#how-to-get-started-with-azure-functions)如何入门 Azure 功能
...
#### [](#simple-amp-native-developer-tooling)简单的&原生开发者工具
...
#### [](#built-in-http-trigger)内置 HTTP 触发器
