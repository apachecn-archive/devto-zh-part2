...
> 原文:[https://dev . to/neo/build-a-ride-sharing-IOs-app-with-push-notifications-2d 93](https://dev.to/neo/build-a-ride-sharing-ios-app-with-push-notifications-2d93)
...
## [](#about-our-applications)关于我们的应用
...
## [](#building-the-backend-application-api)构建后端应用程序(API)
...
## [](#building-the-rider-application)构建骑手应用
...
### [](#defining-secret-keys-and-ride-status)定义密钥和乘坐状态
...
## [](#building-the-driver-application)构建驱动程序应用
...
## [](#adding-push-notifications-to-our-ios-applications)向我们的 iOS 应用添加推送通知
...
### [](#creating-your-pusher-application)创建 Pusher 应用程序
...
### [](#updating-your-rider-application-to-support-push-notifications)更新您的骑手应用程序以支持推送通知
...
### [](#updating-your-driver-application-to-support-push-notifications)更新您的驱动程序应用程序以支持推送通知

你的 rider 应用程序也需要能够接收推送通知。该过程类似于上面的设置。唯一的不同是我们将在`AppDelegate`中订阅的利息，这将是 **ride_requests** 。

## [](#adding-rich-actions-to-our-push-notifications-on-ios)为我们在 iOS 上的推送通知添加丰富的动作
...
### [](#creating-our-notification-service-extension)创建我们的通知服务扩展
...
## [](#sending-push-notifications-from-our-nodejs-api)从我们的 Node.js API 发送推送通知
