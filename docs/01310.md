...
> 原文:[https://dev . to/dbsheta/processing-streaming-Twitter-data-using-Kafka-and-spark-part-1-setting-up-Kafka-cluster-32lh](https://dev.to/dbsheta/processing-streaming-twitter-data-using-kafka-and-spark--part-1-setting-up-kafka-cluster-32lh)
...
### [](#zookeeper-standalone-mode)**动物园管理员独立模式**
...
### [](#single-node-multi-broker-snmb)**单节点多代理(SNMB):**
