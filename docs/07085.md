...
> 原文:[https://dev . to/play tomic/play tomics-shared-architecture-using-swift-and-kot Lin-320 b](https://dev.to/playtomic/playtomics-shared-architecture-using-swift-and-kotlin-320b)
...
#### [](#multiplatform-solutions)多平台解决方案
...
###### [](#string-similarity-7359)字符串相似度:73.59%
...
###### [](#string-similarity-708)字符串相似度:70.8%
