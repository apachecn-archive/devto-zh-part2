...
> 原文:[https://dev . to/acanimal/graceful-shut down-nodejs-http-server-when-using-PM2-44-10o 0](https://dev.to/acanimal/graceful-shutdown-nodejs-http-server-when-using-pm2-44-10o0)
...
## [](#starting-a-http-server)启动 HTTP 服务器
...
## [](#how-to-shutdown-properly-an-http-server-)如何正确关闭 HTTP 服务器？
...
## [](#graceful-shutdownrestart-with-and-without-pm2)带和不带 PM2 的正常关机/重启
