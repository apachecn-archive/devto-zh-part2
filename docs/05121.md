...
## [](#empty-and-blank-in-real-world-situations):空:现实世界情况下的空白
...
### [](#styling-an-empty-element)样式化一个空元素
...
### [](#poor-developer-experience)开发者体验差
...
## [](#support-for-empty-and-blank)支持:空和:空白
