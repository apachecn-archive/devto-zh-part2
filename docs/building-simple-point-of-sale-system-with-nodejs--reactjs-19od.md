...
> 原文：<https://dev.to/kris/building-simple-point-of-sale-system-with-nodejs--reactjs-19od>
...
**:NeDB 与 SQLite 非常相似，它是一个更大的数据库系统的较小的可嵌入版本。NeDB 是一个模仿 MongoDB 的较小的 NoSQL 数据存储。**
...
`app.get("/, function(req, res)`函数是库存数据库的默认路径。
