...
> 原文:[https://dev . to/Apium _ hub/Scala-generics-iii-generalized-type-constraints-58km](https://dev.to/apium_hub/scala-generics-iii-generalized-type-constraints-58km)
