...
> 原文:[https://dev.to/itsasine/pusher-project-为什么-生病-永不被开发](https://dev.to/itsasine/pusher-project---why-ill-never-be-devops-520d)
...
## [](#cost-breakdown-thus-far)至此费用明细
...
## [](#stuff-still-to-do)事情还没做完

*   整个前端。这是一张白纸。
*   几乎整个后端

## [](#stuff-not-left-to-do)没有留下来做的事情

*   部署堆栈！
*   为这个应用程序取个名字——我告诉我的男朋友这是一个卖表情符号的商店，所以他把它命名为 **Shopoji** 。

## [](#nice-to-haves)拥有者的美好
