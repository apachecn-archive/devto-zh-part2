...
> 原文:[https://dev.to/flaviocopes/introduction-to-nodejs-3can](https://dev.to/flaviocopes/introduction-to-nodejs-3can)
...
### [](#a-huge-number-of-libraries)数量庞大的图书馆
...
## [](#an-example-nodejs-application)一个 Node.js 应用的例子
...
## [](#nodejs-frameworks-and-tools)Node.js 框架和工具
