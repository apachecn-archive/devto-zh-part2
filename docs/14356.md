...
> 原文:[https://dev . to/captain safia/trying-to figure-out-how-git-status-works-a-saga-72a](https://dev.to/captainsafia/trying-tofigure-out-how-git-status-works-a-saga-72a)
