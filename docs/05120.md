...
> 原文:[https://dev . to/ore/building-a-offline-pwa-camera-app-with-react-and-cloud inary-5b9k](https://dev.to/ore/building-an-offline-pwa-camera-app-with-react-and-cloudinary-5b9k)
...
## [](#installing-the-prerequisites)安装先决条件
...
## [](#creating-a-raw-webcam-endraw-class)创建一个`Webcam`类
...
## [](#creating-a-raw-notifier-endraw-component)创建一个`Notifier`组件
...
## [](#creating-a-raw-clcamera-endraw-component)创建一个`ClCamera`组件
...
## [](#setting-up-a-cloudinary-account)设置云端账户
...
## [](#testing-and-auditing-cloudycam)测试和审计 CloudyCam
