...
## [](#the-global-execution-context)全局执行上下文
...
## [](#objectlevel-execution-context)对象级执行上下文
...
## [](#changing-execution-context-using-jquery)使用 jQuery 更改执行上下文
...
## [](#pulling-a-function-out-of-context)脱离上下文提取功能
...
## [](#how-anonymous-functions-affect-context)匿名函数如何影响上下文
