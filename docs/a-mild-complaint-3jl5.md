...
1.  据我所知，这与 [Dev 没有明显的联系。编辑指南](https://dev.to/p/editor_guide)(读起来更像是“作者指南”),当我忘记如何在帖子中格式化液体标签或其他东西时，这是一个非常有用的资源。我想我必须自己发现你可以嵌入 Dev。给你自己的帖子和评论中的用户和帖子。
    ...
    #java #regex #shell #maven](/awwsmm/getting-the-gist-of-java-15eg)
    ...
    也有针对 Twitter、Glitch、GitHub、Gist 等等的嵌入。这种能力真的很酷，如果我没有偶然发现编辑指南，我想我不会知道它。
...
我刚刚发现的另一件事是:你可以[使用内嵌锚
在帖子顶部添加一个目录](https://dev.to/biros/help-how-to-manage-the-toc-of-articles-on-devto-6bp)
