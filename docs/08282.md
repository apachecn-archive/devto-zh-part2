...
#### [](#a-comprehensive-guide-that-explores-the-difference-between-iot-development-kits-mpm-kits-and-mass-production-modules)探索物联网开发套件、MPM 套件和量产模块之间差异的全面指南
...
### [](#what-is-the-difference-between-prototyping-and-production-hardware)原型制作和生产硬件有什么区别？
...
### [](#prototype-amp-production-hardware-examples)原型&生产硬件实例
...
### [](#mass-production-modules-mpms)批量生产模块(MPMs)
...
### [](#mpm-evaluation-kits-evks)MPM 评估套件(EVKs)
...
### [](#other-factors-to-consider-when-choosing-iot-hardware)选择物联网硬件时需要考虑的其他因素

当您为原型开发或生产采购硬件时，您还应该考虑随之而来的平台、工具和支持:

### [](#1-consistent-platform-infrastructure-firmware-and-development-tools)1。一致的平台、基础设施、固件和开发工具
