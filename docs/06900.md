...
#### [](#1-init-project-and-install-its-dependencies)1。初始化项目并安装其依赖项
...
#### [](#2-create-your-stylesheet)2。创建您的样式表
...
#### [](#3-load-your-file-contents-in-indexjs-and-remove-unwanted-characters)3。将文件内容加载到 index.js 中，并删除不需要的字符。
...
#### [](#4-now-you-need-to-configure-and-access-cogito-api-remember-to-use-the-correct-region)4。现在您需要配置和访问 Cogito API。记得使用正确的地区！
...
#### [](#5-next-prepare-all-of-your-params-and-call-the-api)5。下一步——准备好所有的参数并调用 API
