...
*   在一个漂亮的日历或网格模式下显示商店所有即将举行的活动
*   销售活动门票就像销售虚拟产品一样简单
*   允许顾客看到以前的、当前的和即将发生的事件
*   允许购物者注册免费活动或购买付费活动的门票
*   在事件详细信息页面(类似于产品页面)上显示所有事件信息

点击 查看演示并下载扩展 **[。](https://www.tigren.com/magento-2-extensions/magento-2-event-calendar/)**