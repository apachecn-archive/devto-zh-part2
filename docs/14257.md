...
> 原文:[https://dev . to/neo/how-to-send-push-notifications-to-a-food-delivery-swift-app-22d 7](https://dev.to/neo/how-to-send-push-notifications-to-a-food-delivery-swift-app--22d7)
...
## [](#building-our-application-planning)构建我们的应用——规划
...
## [](#building-the-client-application)构建客户端应用程序
...
## [](#creating-the-pizza-list-scene)创建披萨列表场景
...
## [](#creating-the-pizza-view-scene)创建披萨视图场景
...
### [](#creating-the-orders-list-scene)创建订单列表场景
...
### [](#creating-the-order-status-scene)创建订单状态场景
...
## [](#building-the-admin-application)构建管理应用程序
...
## [](#adding-push-notifications-to-our-food-delivery-ios-app)向我们的送餐 iOS 应用添加推送通知
...
## [](#updating-your-client-application-to-support-push-notifications)更新您的客户端应用程序以支持推送通知
...
### [](#updating-your-admin-application-to-support-push-notifications)更新您的管理应用程序以支持推送通知

您的管理应用程序还需要能够接收推送通知。该过程类似于上面的设置。唯一的区别将是我们在`AppDelegate`中认购的利息，这将是**订单**。

### [](#updating-your-api-to-send-push-notifications)更新您的 API 以发送推送通知
