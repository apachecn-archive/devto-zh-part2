...
> 原文:[https://dev . to/graphic beacon/building-restful-we B- API-with-dart-aqueduct-and-PostgreSQL part-3-postgres-9c 7](https://dev.to/graphicbeacon/building-restful-web-apis-with-dart-aqueduct-and-postgresqlpart-3-postgres-9c7)
...
## [](#1-setup-a-postgresql-server)1。设置 PostgreSQL 服务器
...
## [](#2-refactor-the-book%C2%A0class)2。重构 Book 类
...
## [](#3-create-a-managedcontext)3。创建 ManagedContext
...
## [](#4-build-our-database%C2%A0schema)4。构建我们的数据库模式
...
## [](#5-refactor-our-bookscontroller-class)5。重构我们的 BooksController 类
