...
> 原文:[https://dev . to/Davids bond/golang-debugging-memory-leaks-using-pprof-5di 8](https://dev.to/davidsbond/golang-debugging-memory-leaks-using-pprof-5di8)
...
### [](#enabling-pprof-output-via-http)通过 HTTP 启用 pprof 输出
...
### [](#understanding-pprof-output)了解 pprof 输出
