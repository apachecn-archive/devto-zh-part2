...
## [](#dealing-with-a-github-fork-repository)处理一个 GitHub 分叉库🍴
...
## [](#following-setup-instructions)遵循设置指令📐
...
## [](#releasing-the-updates)发布更新🚀

### [](#trying-to-contribute-back-upstream)试图逆流而上
...
### [](#publishing-a-fork-as-an-npm-scoped-module)将 fork 发布为 npm 范围的模块
...
## [](#lessons-about-the-open-source-movement)关于开源运动的教训📖

### [](#people-are-paid-to-make-mistakes-people-who-work-for-free-will-also-make-similar-mistakes)有人拿工资就犯错误，免费工作的人也会犯(类似的)错误
