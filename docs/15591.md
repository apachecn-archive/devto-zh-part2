...
> 原文:[https://dev . to/worldclassdev/leveling-the-power-of-the-JavaScript-console-in-development-24ap](https://dev.to/worldclassdev/leveraging-the-power-of-the-javascript-console-in-development-24ap)
...
### [](#launching-the-console-in-your-browser)在浏览器中启动控制台
...
## [](#exploring-the-console-api)探索控制台 API
...
### [](#consoletime-and-consoletimeend)控制台.时间和控制台.时间结束
...
## [](#common-operations-carried-out-with-the-console)用控制台进行的常见操作
