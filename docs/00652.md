...
> 原文:[https://dev . to/adityasridhar/how-you-can-go-misk-with-git-3lkn](https://dev.to/adityasridhar/how-you-can-go-wrong-with-git-3lkn)
...
# [](#force-push-to-remote-repository)强制推送到远程存储库
...
# [](#trying-to-rebase-the-remote-repository)尝试重置远程存储库
...
# [](#amending-commits-in-the-remote-repository)修改远程存储库中的提交
