...
> 原文:[https://dev.to/yos/entity-component-systems-in-elixir-2cph](https://dev.to/yos/entity-component-systems-in-elixir--2cph)
...
# [](#drawbacks-of-classbased-inheritance)基于类的继承的弊端
...
# [](#entity-component-systems)实体组件系统
...
## [](#data-flow-in-entitycomponentsystem)实体-组件-系统中的数据流
...
## [](#the-spreadsheet-analogy)比喻电子表格
...
# [](#ecs-in-the-real-world)现实世界中的 ECS
...
# [](#an-ecs-implementation-in-elixir)仙丹中的一个 ECS 实现
