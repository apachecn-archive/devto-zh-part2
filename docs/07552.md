...
> 原文:[https://dev . to/dimitrinicolas/learn-how-to-automate-your-image-optimization-process with-lepto-890](https://dev.to/dimitrinicolas/learn-how-to-automate-your-image-optimization-process-with-lepto-890)
...
## [](#getting-started-with-lepto)轻者入门
...
## [](#lets-add-some-plugins)让我们添加一些插件
...
### [](#then-well-add-a-new-filter-in-our-lepto-config)然后我们将在我们的 Lepto 配置中添加一个新的过滤器:
...
### [](#lets-add-another-filter-to-create-retinas-versions-of-our-png)让我们添加另一个滤镜来创建我们的 png 的 Retina 版本:
