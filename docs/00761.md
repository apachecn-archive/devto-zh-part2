...
## [](#1-do-use-javascript-to-prefetch-or-prerender-on-probable-click)1。*在*可能的*点击上*使用 JavaScript 预取或预呈现。
...
## [](#2-do-not-use-js-to-prerender-more-than-one-page-per-load)2。*不要*使用 JS 来*预渲染*每次加载超过一页。
...
## [](#3-do-be-very-intentional-in-how-you-decide-when-you-should-prerender-a-page)3。*在你决定什么时候应该预读一页的时候，*会不会是*故意的？*
...
## [](#4-do-not-prefetch-or-prerender-pages-on-someone-elses-site)4。*不要*在别人的网站上预取或预读页面。
