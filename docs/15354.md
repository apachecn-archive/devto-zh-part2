...
> 原文:[https://dev . to/xngwng/the-best-free-rest-API-debugging-tools-for-development-APIs-4 E8](https://dev.to/xngwng/the-best-free-rest-api-debugging-tools-for-developing-apis-4e8)
...
## [](#sending-api-requests)发送 API 请求
...
## [](#capturing-ajax-calls-in-web-apps)捕获 web 应用中的 AJAX 调用
...
## [](#capturing-http-requests-from-mobile-apps)捕获来自移动应用的 HTTP 请求
...
### [](#apirequestio)ApiRequest。超正析象管(Image Orthicon)
