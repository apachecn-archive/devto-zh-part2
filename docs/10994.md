...
> 原文:[https://dev . to/bright devs/how-to-deploy-a-service-to-Amazon-elastic-container-service-with-cloud formation-28dl](https://dev.to/brightdevs/how-to-deploy-a-service-to-amazon-elastic-container-service-with-cloudformation-28dl)
...
# [](#ecs-cluster-definition)ECS 集群定义
...
# [](#ecs-service-and-task-definition)ECS 服务和任务定义
