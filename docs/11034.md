...
> 原文:[https://dev . to/kayis/startup-clix-server less-pusher-contest-entry-written-in-JavaScript-1 jai](https://dev.to/kayis/startup-clix-serverless-pusher-contest-entry-written-in-javascript-1jai)
...
## [](#demo-link)[试玩链接](https://kay-is.github.io/startup-clix/)

## [](#link-to-code)[链接到代码](https://github.com/kay-is/startup-clix)
...
## [](#the-role-of-pusher-channels)推子通道的作用
...
### [](#unidirectional-step-functions)单向步进功能
...
## [](#i-appreciate-all-your-likes-and-unicorns)我欣赏你所有的喜欢和独角兽！