...
> 原文:[https://dev . to/David _ oje da/make-requests-from-docker-container-running-on-Jenkins-3ln 1](https://dev.to/david_ojeda/make-requests-from-docker-container-running-on-jenkins-3ln1)
