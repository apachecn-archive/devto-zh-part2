...
> 原文:[https://dev.to/appsignal/parsing-numbers-in-elixir-4odo](https://dev.to/appsignal/parsing-numbers-in-elixir-4odo)
...
## [](#the-quick-and-boring-builtin)快速(且枯燥)内置
...
### [](#parsing-an-entire-integer)解析一个整数
