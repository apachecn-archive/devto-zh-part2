...
### [](#sending-udp-packets-using-go)使用 Go 发送 UDP 数据包
...
### [](#tcp-dialing-vs-udp-dialing)TCP 拨号 vs UDP 拨号
...
### [](#writing-to-a-udp-connection)写入一个 UDP“连接”
...
### [](#receiving-from-a-udp-connection-in-a-client)在客户端接收来自 UDP 的“连接”
...
### [](#receiving-from-a-udp-connection-in-a-server)接收来自服务器中 UDP 的“连接”
...
### [](#a-udp-server-in-go)一个 UDP 服务器在 Go
