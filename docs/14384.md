...
> 原文:[https://dev . to/rpalo/publish-single-directory-to-another-branch-l8b](https://dev.to/rpalo/publish-single-directories-to-another-branch--l8b)
...
## [](#1-make-sure-the-dist-folder-is-actually-checked-into-your-repo)1。确保 dist 文件夹确实已签入您的 repo。

把它从你的`.gitignore`和`add/commit/push`中取出来。

## [](#2-use-the-subtree-luke-andor-leia)2。使用子树，卢克(和/或莱娅)。
