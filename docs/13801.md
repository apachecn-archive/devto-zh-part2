...
## [](#structure-of-a-ui-component)一个 ui 组件的结构

#### [](#simple-ui-component-with-few-view-property-bindings)具有少量视图属性绑定的简单 ui 组件
...
#### [](#more-complex-ui-component-with-several-view-property-bindings)具有多个视图属性绑定的更复杂的 ui 组件
...
## [](#nested-ui-components)嵌套的 ui 组件

#### [](#nest-a-ui-component-as-a-child-ui-component-11-nesting)嵌套一个 ui 组件作为子 ui 组件(1:1 嵌套)
...
#### [](#nest-a-component-as-a-kind-of-control-1n-nesting)嵌套一个组件作为一种控件(1:n 嵌套)
...
## [](#interaction-with-the-backend)与后端交互
