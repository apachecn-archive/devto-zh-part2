...
> 原文:[https://dev . to/eder chrono/how-I-make-a-smiley-toggle-control wotw-5612](https://dev.to/ederchrono/how-i-made-a-smiley-toggle-controlwotw-5612)
...
### [](#binding-css-classes-to-vue-property)将 CSS 类绑定到 Vue 属性
