...
> 原文:[https://dev . to/CIA _ Rana/quick-tutorial-write-go-run-wasm-2 ilf](https://dev.to/cia_rana/quick-tutorial-write-go-run-wasm-2ilf)
...
### [](#step-1-setup-raw-go111beta3-endraw-)第一步:设置`go1.11beta3`
...
### [](#step-2-compile-go-to-wasm)第二步:编译去 WASM
...
### [](#step-3-use-html-and-javascript-to-load-wasm)第三步:使用 HTML 和 JavaScript 加载 WASM
...
### [](#step-4-spin-up-a-web-server)第四步:启动网络服务器
...
### [](#step-5-open-the-website)第五步:打开网站！
