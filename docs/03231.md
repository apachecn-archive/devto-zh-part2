...
# [](#creating-simple-kanban-application-with-vue-and%C2%A0firebase)使用 Vue 和 Firebase 创建简单的看板应用程序
...
#### [](#what-is-firebase-real-time-database)什么是 Firebase 实时数据库？

> 它为应用程序开发人员提供了一个 API，允许应用程序数据跨客户端同步并存储在 Firebase 的云上。

### [](#the-steps)步骤:

#### [](#1-preparing-vue-application)1。正在准备 Vue 应用程序
...
#### [](#2-preparing-firebase%C2%A0database)2。正在准备 Firebase 数据库
...
#### [](#3-preparing-vue-components)3。准备 Vue 组件
...
#### [](#4-get-data-from%C2%A0firebase)**4。从 Firebase 获取数据**
