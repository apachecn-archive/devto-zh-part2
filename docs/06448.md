...
> 原文:[https://dev . to/yysun/redux-vs-the-react-context-API-vs-apprun-2k nm](https://dev.to/yysun/redux-vs-the-react-context-api-vs-apprun-2knm)
...
## [](#the-useravatar-component)用户头像组件
