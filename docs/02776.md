...
## [](#the-common-misconception-the-order-of-javascript-properties-cannot-be-guaranteed)常见的误解——“无法保证 JavaScript 属性的顺序”

几年前开始编写 JavaScript 时，您可能听说过 JS 对象中属性的顺序是不可预测的。我从未遇到过奇怪和不寻常的属性顺序，但我总是遵循“从不依赖属性顺序”的规则。

### [](#the-internal-raw-ownpropertykeys-endraw-method)内功`ownPropertyKeys`心法
...
#### [](#2-strings-that-are-no-integers)2。字符串(非整数)
