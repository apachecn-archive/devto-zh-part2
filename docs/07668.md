...
> 原文:[https://dev . to/isabolic 99/how-to-set-host-only-adapter-on-VM-virtual-box-2jka](https://dev.to/isabolic99/how-to-set-host-only-adapter-on-vm-virtual-box-2jka)

您可以找到许多关于如何设置仅主机适配器的教程，但大多数都不完整，缺少一些东西。所以我决定从我的个人笔记中提供一个循序渐进的指南。

### [](#1-configuration-of-network-adapter)1)网卡的配置
...
### [](#2-set-up-the-adapter-in-network-settings-of-vm)2)在虚拟机的网络设置中设置适配器
