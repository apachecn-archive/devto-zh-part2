...
## [](#a-simple-nodejs-command-line-tool-with-yargs)一个简单的 Node.js 命令行工具，带 yargs
...
## [](#adding-yargs-middleware)添加 yargs 中间件
...
## [](#can-i-use-yargs-middleware-now)现在可以用 yargs 中间件了吗？
