...
## [](#1-500-random-coordinates)1。500 个随机坐标
...
## [](#2-setting-up-the-weather-api)2。设置天气 API
...
## [](#3-setting-up-to-get-the-data)3。设置以获取数据
...
## [](#3a-logging-our-requests)3a。记录我们的请求
...
## [](#3b-getting-the-closest-city-name)3b。获取最近的城市名称
...
## [](#4-actually-getting-our-data)4。实际获取我们的数据
