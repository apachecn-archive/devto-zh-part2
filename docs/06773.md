...
> 原文:[https://dev . to/j _ Sakamoto/workrance-how-to-two-way-data-binding-of-radio-button-input with-blazor-spa-v 050-31fd](https://dev.to/j_sakamoto/workaround-how-to-two-way-data-binding-of-radio-button-input-with-blazor-spa-v050-31fd)
...
## [](#bind-syntax-doesnt-work-for-radio-button-inputs)“绑定”语法对单选按钮输入无效！
...
## [](#workaround-for-this-problem)解决此问题的方法
