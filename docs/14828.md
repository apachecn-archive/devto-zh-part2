...
> 原文:[https://dev . to/xeroism/why-thes-5-myths-about-the-the-Linux-command-line-is-false-i3a](https://dev.to/xeroxism/why-these-5-myths-about-the-linux-command-line-are-false-i3a)
...
## [](#myth-1-everything-that-can-be-done-with-it-can-be-done-without-it)误区一:能用它做的事，不用它也能做。
...
## [](#myth-4-you-need-to-know-all-the-commands)误区四:你需要知道所有的命令。
...
## [](#myth-5-no-command-assistance-or-documentation)误区 5:没有命令协助或文档。
