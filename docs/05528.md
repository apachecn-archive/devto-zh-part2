...
> 原文:[https://dev.to/emma_odia/api-for-newbies-5e 94](https://dev.to/emma_odia/api-for-newbies--5e94)
...
### [](#1-is-an-api-a-piece-of-software)1。API 是一种软件吗？
...
### [](#1a-can-i-build-my-own-api)1a。我可以构建自己的 API 吗？

### [](#1b-can-other-people-use-my-api-as-well)1b。其他人也可以使用我的 API 吗？
