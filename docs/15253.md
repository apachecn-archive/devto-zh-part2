...
> 原文:[https://dev . to/datawireio/in-search-of-a-effective-developer-experience with-kubernetes-42nn](https://dev.to/datawireio/in-search-of-an-effective-developer-experience-with-kubernetes--42nn)
...
## [](#removing-friction-from-the-codedeployexperiment-cycle)消除代码-部署-实验循环中的摩擦
...
## [](#smart-routing-and-monitoring-with-ambassador-api-gateway)通过 Ambassador API 网关实现智能路由和监控
...
## [](#and-the-cycle-begins-again)周而复始
