...
> 原文:[https://dev . to/mister _ frostee/raspberry-pi-zero-w-headless-setup-2n8b](https://dev.to/mister_frostee/raspberry-pi-zero-w-headless-setup-2n8b)
...
#### [](#step-2-write-os-image-to-an-sd-card)第二步:将操作系统映像写入 SD 卡
...
#### [](#step-3-set-up-wifi)第三步:设置 WiFi
...
#### [](#step-4-finding-the-ip-address)第四步:查找 IP 地址

我打开 RPi，打开移动热点，等待连接。几秒钟之内，树莓派就连上了。好极了。但是我该如何对一个我不知道 IP 地址的设备进行 SSH 呢？有不同的方法可以解决这个问题:

##### [](#1-on-linux-using-raw-arp-endraw-)1:在 Linux 上，使用`arp`
...
#### [](#step-5-making-the-ssh-connection)第五步:建立 SSH 连接
