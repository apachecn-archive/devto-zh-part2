...
## [](#getting-a-list-of-layout-names)获取布局名称列表
...
## [](#selection-of-layout-for-export)选择要导出的布局
...
## [](#getting-a-list-of-layer-names)获取图层名称列表
...
## [](#selection-of-particular-layer-for-export)选择特定图层进行导出
