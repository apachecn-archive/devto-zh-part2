...
### [](#why-is-this-so-different)为什么这个差别这么大？
...
### [](#step-1-tsconfigjson)第一步:tsconfig.json
...
### [](#step-2-packagejson)第二步:package.json
...
### [](#step-3-raw-dist-endraw-step)步骤三:`dist`步骤
...
### [](#step-4-set-up-the-npm-dist-script)步骤 4:设置 npm 分发脚本
...
### [](#step-5-amend-circleci-configuration)第五步:修改 CircleCI 配置
...
### [](#step-6-beanstalk-configuration)第六步:豆茎配置
