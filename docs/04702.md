...
# [](#install-anbox-steps)**安装 Anbox【步骤】:**

Anbox 的安装包括两个步骤。

## [](#1-install-necessary-kernel-modules)**1。安装必要的内核模块**
...
## [](#2-install-the-anbox-snap)**2。安装 Anbox 卡扣:**
...
## [](#when-you-want-to-uninstall-anbox)**当你想卸载 Anbox**
