...
> 原文:[https://dev . to/digital ocean/moderning-applications-for-kubernetes-1 hon](https://dev.to/digitalocean/modernizing-applications-for-kubernetes-1hon)
...
## [](#preparing-the-application-for-migration)准备迁移应用程序
...
### [](#extract-configuration-data)提取配置数据
...
### [](#offload-application-state)卸载应用状态
...
### [](#implement-health-checks)实施健康检查
...
### [](#instrument-code-for-logging-and-monitoring)用于记录和监控的仪器代码
...
### [](#build-administration-logic-into-api)在 API 中构建管理逻辑
...
### [](#keep-image-sizes-small)保持图像尺寸较小
...
### [](#publish-image-to-a-registry)将图像发布到注册表
...
### [](#implement-a-build-pipeline)实现一个构建管道
...
### [](#implement-container-logging-and-monitoring)实现容器日志记录和监控
...
### [](#configure-pod-storage)配置 Pod 存储
...
### [](#injecting-configuration-data-with-kubernetes)用 Kubernetes 注入配置数据
