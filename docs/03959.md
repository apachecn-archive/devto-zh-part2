...
> 原文:[https://dev . to/David _ j _ eddy/the-case-against-terra form-to-prevent-vendor-lock-in-3 LLE](https://dev.to/david_j_eddy/the-case-against-terraform-to-prevent-vendor-lock-in-3lle)
