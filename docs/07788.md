...
## [](#pro-elm-tips-to-write-code-like-a-pro)亲榆提示写代码像亲
...
## [](#0001-type-alias-as-a-function)0001 —键入别名作为函数
...
## [](#0010-calling-infix-functions)0010 —调用中缀函数
...
## [](#0011-function-composition)0011 —功能组成
...
## [](#0101-special-function-for-tuple-creation)0101 —创建元组的特殊功能
...
## [](#0110-special-notation-in-the-function-definition-to-pattern-match)0110 —用于模式匹配的函数定义中的特殊符号
...
## [](#1010-similar-gt-function-in-elm)1010 —相似= >榆树中的函数
