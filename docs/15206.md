...
> 原文:[https://dev.to/yos/getting-started-with-serverless-go-1 lff](https://dev.to/yos/getting-started-with-serverless-go--1lff)
...
## [](#aws-lambda-go-programming-model)AWS Lambda Go 编程模型
...
# [](#building-a-go-crud-api)构建一个 Go CRUD API
...
### [](#step-1-create-the-raw-post-todos-endraw-endpoint)第一步:创建`POST /todos`端点
...
### [](#step-2-create-the-raw-get-todos-endraw-endpoint)第二步:创建`GET /todos`端点
...
### [](#step-3-create-the-raw-patch-todosid-endraw-endpoint)第三步:创建`PATCH /todos/{id}`端点
...
### [](#step-4-create-the-raw-delete-todosid-endraw-endpoint)第四步:创建`DELETE /todos/{id}`端点
