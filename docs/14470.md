...
> 原文:[https://dev.to/iwilsonq/why-use-graphql-6cj](https://dev.to/iwilsonq/why-use-graphql--6cj)
...
## [](#why-create-a-graphql-server)为什么要创建 GraphQL 服务器？
...
### [](#no-more-overfetching-or-roundtrip-api-calls)不再有溢出或往返 API 调用
