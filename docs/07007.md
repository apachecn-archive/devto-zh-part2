...
# [](#web-curiosity-crazy-tabs)网络好奇心=疯狂标签页
...
# [](#solution-1-text-editor)解决方案 1:文本编辑器
...
# [](#solution-2-app-and-browser-extensions)解决方案 2:应用和浏览器扩展
...
# [](#solution-3-selfhosted-web-app)解决方案 3:自托管 Web 应用
