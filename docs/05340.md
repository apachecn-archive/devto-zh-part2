...
> 原文:[https://dev . to/matmooredev/its-ok-for-things-to-go-error-1dg 0](https://dev.to/matmooredev/its-ok-for-things-to-go-wrong-1dg0)
...
## [](#what-should-you-do-during-an-incident)发生事故时，你应该怎么做？
...
## [](#run-a-postmortem-after-the-incident)事发后进行尸检
...
## [](#blameless-postmortems-are-effective-postmortems)无可指责的验尸是有效的验尸
...
### [](#previous-knowledgeexperience)以前的知识/经验
