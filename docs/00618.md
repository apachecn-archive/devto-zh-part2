...
> 原文:[https://dev.to/k_penguin_sato/react-routing-4fmb](https://dev.to/k_penguin_sato/react-routing-4fmb)
...
# [](#setting-up-router-and-route)设置路由器和路由
...
# [](#passing-data-with-props)用道具传递数据
