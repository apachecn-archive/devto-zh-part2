...
> 原文:[https://dev . to/ns23/Facebook-messenger-bot-that-displays-latest-it-jobs-in-goa-India-68g](https://dev.to/ns23/facebook-messenger-bot-that-displays-latest-it-jobs-in-goa-india-68g)
...
## [](#major-node-packages-used)使用的主要节点包。
