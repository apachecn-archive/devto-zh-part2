...
> 原文:[https://dev . to/min ompi/better-performances-high-security-deprecated-functions-heres-all-the-news-about-PHP-72-2 AOL](https://dev.to/minompi/better-performances-high-security-deprecated-functions-heres--all-the-news-about-php-72-2aol)
...
## [](#type-hinting-return-value)键入提示返回值
...
## [](#abstract-methods-and-rewritable-interfaces)抽象方法和可重写接口
...
## [](#comma-into-syntax-at-the-end-of-use-statements-lists)逗号放入语法末尾的 use 语句列表中
...
## [](#argon2-in-passwords-hash)密码散列中的 Argon2
