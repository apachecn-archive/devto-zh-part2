...
> 原文:[https://dev . to/Richard _ klose/learn-from-others-errors-how-not-to-write-an-PHP-install-script-516 I](https://dev.to/richard_klose/learn-from-others-mistakes-how-not-to-write-an-php-install-script--516i)
...
# [](#outdated-jquery-180)过时的 jQuery (1.8.0)
...
# [](#script-itself-must-be-writeable)脚本本身必须可写
...
# [](#weird-download-enables-mitm-attacks)诡异的下载启用了 MITM 攻击
...
# [](#checking-browser-far-too-late)查看浏览器远远来不及
...
# [](#more-insecure-https)更不安全的 HTTP(S)
