...
> 原文:[https://dev.to/shyamala_u/beyond-the-login-screen-第二部分- 450n](https://dev.to/shyamala_u/beyond-the-login-screen---part-ii--450n)
...
## [](#the-familiar-oauth2-dance)熟悉的 OAuth2 舞蹈
...
### [](#the-questions-we-need-to-ask)我们需要问的问题，
...
### [](#the-answer-is-raw-idtoken-endraw-)答案是`id_token`
