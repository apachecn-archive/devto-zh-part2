...
### [](#predictable-command-structure)可预测的命令结构
...
#### [](#aliases-make-your-life-easy)化名让你生活轻松
...
#### [](#best-practice-for-scripting)脚本的最佳实践
...
### [](#when-youre-not-sure-which-command-to-use)当你不确定使用哪个命令时
...
### [](#when-youre-not-sure-what-a-command-does)当你不确定一个命令做什么的时候
...
### [](#when-youre-not-sure-what-properties-your-object-has)当你不确定你的对象有什么属性时
...
### [](#when-you-want-to-get-a-portion-of-the-data)当你想得到一部分数据时
...
### [](#when-you-want-to-filter-your-data)当你想过滤你的数据时
...
### [](#basic-unix-commands-translated)翻译的基本 Unix 命令
...
### [](#access-the-path-and-other-environment-variables)访问路径(和其他环境变量)
...
### [](#customize-your-profile)自定义您的个人资料

如果您喜欢命令行，并且和我一样，您可能想知道如何定制它们。答案就在`$profile`里。

#### [](#finding-the-profile)寻找轮廓
...
### [](#customize-your-prompt)自定义您的提示

有两种方法可以做到这一点:简单的方法和复杂的方法。

#### [](#the-simple-prompt)简单提示
...
### [](#get-it-to-not-look-ugly)把它弄得不难看
