...
> 原文:[https://dev.to/zellwk/how-to-submit-a-pull-request-4j0g](https://dev.to/zellwk/how-to-submit-a-pull-request-4j0g)
...
## [](#submitting-a-pull-request-when-you-have-write-access)拥有写权限时提交拉取请求
...
## [](#submitting-a-pull-request-without-write-access)提交无写权限的拉取请求
