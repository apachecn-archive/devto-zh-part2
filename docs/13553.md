...
> 原文:[https://dev . to/app signal/understanding-system-load-and-load-averages-ca](https://dev.to/appsignal/understanding-system-load-and-load-averages-ca)
