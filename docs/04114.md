...
> 原文:[https://dev . to/johnbwoodruf/component-libraries-with-stenciljs-going-deep-5a pm](https://dev.to/johnbwoodruff/component-libraries-with-stenciljs---going-deeper-5apm)
