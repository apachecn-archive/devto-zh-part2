...
> 原文:[https://dev.to/pbnj/kubernetes-security-best-practices-hlk](https://dev.to/pbnj/kubernetes-security-best-practices-hlk)
...
### [](#full-pod-security-policy-example)全 Pod 安全策略示例
