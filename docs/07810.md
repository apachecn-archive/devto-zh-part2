...
> 原文:[https://dev . to/Hugo _ _ df/deploy-to-multi-environments-with-git-and-circle ci-5g 49](https://dev.to/hugo__df/deploy-to-multiple-environments-with-git-and-circleci-5g49)
...
### [](#logging-in-to-heroku-optional)登录 Heroku(可选)🔑
...
## [](#12ish-factor-app-%F0%9F%8F%97)12(ish)因子 app🏗

我们希望以某种方式管理配置，适用于[https://12factor.net/](https://12factor.net/)所描述的所有环境

### [](#injecting-config-and-secrets)注入配置和秘密💉
