...
### [](#transa%C3%A7%C3%B5es-acid-multidocumentos)多文档酸性交易
...
### [](#convers%C3%A3o-de-tipos-no-aggregation-pipeline)聚合管道中的类型转换
...
### [](#nonblocking-secondary-reads)非阻塞二次读取
...
### [](#data-migrations-40-mais-r%C3%A1pidas)数据迁移 40% mais rápidas
...
### [](#amplia%C3%A7%C3%B5es-nos-change-streams)变化流中的放大
...
### [](#iniciando-com-o-mongodb-40)从蒙戈布 4.0 开始
