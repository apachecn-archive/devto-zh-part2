...
> 原文:[https://dev.to/joaofbantunes/episode-007-logging-aspnet-core-from-0-to-over kill-l74](https://dev.to/joaofbantunes/episode-007---logging---aspnet-core-from-0-to-overkill-l74)
...
## [](#using-the-builtin-logging-facilities)使用内置的日志记录设施

### [](#setting-up-logging)设置记录
...
## [](#using-third-party-loggers)使用第三方记录器
...
### [](#remove-builtin-providers-and-add-nlog)移除内置提供者并添加 NLog
