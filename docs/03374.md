...
> 原文:[https://dev . to/michi/build-full stack-JavaScript-apps-with-Adonis-and-vue-3 EDC](https://dev.to/michi/build-fullstack-javascript-apps-with-adonis-and-vue-3edc)
...
#### [](#install-adonis-cli)安装 Adonis CLI
...
#### [](#create-adonis-project)创建 Adonis 项目
...
## [](#get-webpack-rolling)获取 Webpack 滚动
...
#### [](#adding-the-necessary-scripts)添加必要的脚本
