...
### [](#mocking-in-typescript-with-typemoq)用 TypeMoq 在打字稿中嘲讽
...
#### [](#method-1-using-typemoq)方法一:使用 TypeMoq
...
#### [](#method-2-using-awssdkmock)方法二:使用 aws-sdk-mock
...
### [](#recapping-mocking-aws-in-typescript)重述打字稿中的嘲讽 AWS
