...
## [](#build-the-api-with-the-serverless-framework)用无服务器框架构建 API
...
#### [](#3-explore-the-service-directory-with-a-code-editor)3。使用代码编辑器浏览服务目录
...
#### [](#5-write-business-logic)5。编写业务逻辑
...
## [](#deploy-the-api-to-aws-lambda)将 API 部署到 AWS Lambda
...
## [](#test-the-api-with-dashbird)用 Dashbird 测试 API
