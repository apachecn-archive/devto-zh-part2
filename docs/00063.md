...
> 原文:[https://dev . to/orange jelly fish/get-good-with-git-bi section-20l 1](https://dev.to/orangejellyfish/get-good-with-git-bisect-20l1)
...
## [](#-raw-git-bisect-endraw-basics)`git bisect`基础知识
...
## [](#automating-raw-git-bisect-endraw-)自动化`git bisect`
