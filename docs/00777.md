...
> 原文:[https://dev . to/mokkapps/how-I-write-marble-tests-for-rxjs-observables-in-angular-4l0k](https://dev.to/mokkapps/how-i-write-marble-tests-for-rxjs-observables-in-angular-4l0k)
...
### [](#a-practical-angular-example)一个实用的角度例子
...
#### [](#allmightyservice)AllMightyService
