...
> 原文:[https://dev . to/robertcoopercode/using-aliases-to-speed-your-git-workflow-2f5a](https://dev.to/robertcoopercode/using-aliases-to-speed-up-your-git-workflow-2f5a)
...
## [](#adding-and-amending-commits)增加和修改提交
...
## [](#pushing-amp-pulling-tofrom-remote)推动&拉向/拉离遥控器
...
### [](#-raw-grn-endraw-shell-command)**`grn`** *(外壳命令)*
...
### [](#-raw-grbic-endraw-shell-command)**`grbic`** *(外壳命令)*
