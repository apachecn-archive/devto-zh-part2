...
> 原文:[https://dev.to/s1hofmann/kotlin-龙卷风 fx - opencv - fun - 39e5](https://dev.to/s1hofmann/kotlin--tornadofx--opencv--fun--39e5)
...
# [](#opencv-with-maven)OpenCV 与 Maven
...
## [](#opencv-java-bindings)OpenCV Java 绑定
...
## [](#github-as-maven-repository)GitHub 作为 Maven 资源库
...
## [](#using-the-github-repository-with-maven)通过 Maven 使用 GitHub 资源库
...
## [](#packaging-opencv-native-library)打包 OpenCV 原生库
...
# [](#including-kotlin-standard-library)包括科特林标准库
