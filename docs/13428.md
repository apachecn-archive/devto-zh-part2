...
> 原文:[https://dev.to/kayis/maximum-javascript-performance-4l65](https://dev.to/kayis/maximum-javascript-performance-4l65)
...
## [](#1-global-variables-only)1。仅全局变量
...
## [](#4-raw-settimeout-endraw-all-the-way)4。`setTimeout`一路
...
## [](#5-object-access-through-raw-with-endraw-)5。通过`with`进行对象访问
