...
> 原文:[https://dev . to/Arden nl/what-I-talk-about-when-I-talk-about-trans piling-JavaScript-part-1-1hm 4](https://dev.to/ardennl/what-i-talk-about-when-i-talk-about-transpiling-javascript---part-1-1hm4)
...
## [](#javascript-and-ecmascript)JavaScript 和 Ecmascript
...
## [](#tc39-and-stage0-to-4)TC39 和阶段-0-4
...
## [](#transpiling-javascript-to-javascript)将 Javascript 转换成 JavaScript
...
### [](#transpiling-vs-polyfills)传输与聚合填充
...
## [](#babel-use-next-generation-javascript-today)巴别塔——使用下一代 JavaScript，今天。
