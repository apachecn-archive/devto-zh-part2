...
> 原文：<https://dev.to/sarthology/best-open-source-menubar-apps-you-must-have--1k9k>

所以你喜欢最后的[名单](https://dev.to/sarthology/best-open-source-tools-for-developers--300f)？太棒了，我为 MacOS 用户准备了一个新的菜单栏应用列表。这个列表中的所有应用都是开源和免费的。
...
这个应用程序是我个人最喜欢的。简单，但你需要做的一切与日历应用程序。您可以添加、编辑或查看任何活动，并将其与您的日历相链接。它的设计是可定制的。它还有一个*黑暗主题*。顺便说一句，如果你对生产力感兴趣，强烈推荐你看看我的最新文章《早间[惯例](https://medium.com/naturehub/the-most-effective-morning-routine-of-all-5f947d8e1883)
...
如此强大的工具，但并不流行，我们有武士刀在我们的名单上。如果你拍了很多截图，并且你的桌面总是满是截图，看看武士刀吧。它会自动上传截图并将链接复制到你的剪贴板上。**不再有集群桌面。**
...
没错。一个小巧的工具，可以直接从你的菜单栏下载 Youtube 视频，这是它唯一的功能😃
...
我知道，我知道，你们都喜欢 github 条纹，这个小小的应用程序位于你的菜单栏中，提醒你不要错过。在完成你的 **100 天代码挑战**之后，添加它并感谢我。🤓
...
这个应用程序可以帮助你在菜单栏中看到当前的天气。它有非常酷的图标，代表当前的天气，支持黑暗和光明的主题。您可以通过 gps 或邮政编码选择位置。非常方便。
...
我可以告诉你，这是最好的发现。所有其他的 MenuMeter 应用程序都是付费的，但是这个是免费和开源的。它有很多定制功能，你可以随意使用，比如颜色、阅读类型、数据可视化等等。

## 结论

伙计们，这只是暂时的。如果你喜欢这篇文章，请查看我在[媒体](https://medium.com/@Sarthaksharma0)上的博客。你会喜欢它的😍。
