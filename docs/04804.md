...
> 原文:[https://dev . to/oktadev/build-a-desktop-app-with-electronic and-authentic ation-1 AOI](https://dev.to/oktadev/build-a-desktop-app-with-electron-and-authentication-1aoi)
...
## [](#build-desktop-apps-with-electron)用电子构建桌面应用
...
## [](#use-okta-for-authentication-with-oidc-in-your-desktop-app)在桌面应用程序中使用 Okta 进行 OIDC 认证
...
## [](#add-pkce-support-to-your-desktop-app)为您的桌面应用添加 PKCE 支持
...
### [](#add-an-avatar-in-okta)在 Okta 添加头像
...
## [](#package-your-desktop-app-for-production)将您的桌面应用打包用于生产
...
## [](#electron-example-app-source-code)电子示例 App 源代码
...
## [](#learn-more-about-electron-appauth-and-oidc)了解更多关于电子、AppAuth 和 OIDC 的信息
