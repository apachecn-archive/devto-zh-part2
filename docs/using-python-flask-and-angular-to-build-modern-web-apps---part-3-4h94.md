...
> 原文：<https://dev.to/auth0/using-python-flask-and-angular-to-build-modern-web-apps---part-3-4h94>

在本系列中，您将学习如何使用 Python、Flask 和 Angular 创建现代 web 应用程序。第 3 部分:安装和配置 Angular Material，为你的应用程序添加一个漂亮的界面，使用 Alembic(一个数据库迁移工具)管理你的数据库模式，等等！
