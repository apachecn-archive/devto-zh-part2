...
> 原文：<https://dev.to/jstvssr/are-we-getting-better-at-software-development-4gc0>
...
部署自动化正在迅速普及。**积压** **梳理**正在进一步完善。代码质量控制和自动化测试正在改进，但是仍然没有被大多数团队完全采用。这些仅仅是我们从每年一次的开发最佳实践基准重新校准中学到的 3 条经验。

请继续阅读一些有趣的**统计数据**以及它们告诉我们软件开发的发展方向。最后的奖励:一个快速的**自我评估**来衡量你自己的团队。
...
这种年度更新也是研究数据和寻找趋势的绝佳时机。 ***我们是不是越来越擅长软件开发了？*** 我们刚刚完成了最新的校准，这里是我们所了解到的关于发展趋势的最佳实践。
...
所以我们的问题: ***我们是不是越来越擅长软件开发了？*** 可以回答: ***可以，但是速度适中。***
...
但我们还没到那一步。就我个人而言，我对不到三分之一的软件开发团队遵循质量和测试最佳实践感到有点震惊，因为采用这些最佳实践可以用有限的努力带来立竿见影的好处。

> 不到三分之一的软件开发团队遵循质量和测试最佳实践

你能做什么？

*   **评估你自己的团队:**如果你想了解更多，或者想让我们评估你的团队，请给我写信。要做一个快速的自我评估，您可以参加[这个调查](https://docs.google.com/forms/d/e/1FAIpQLSfLy4HwxoWpC3TKqsmxvI5JIGzPwWgvJb_X_RylioGsWF3pIQ/viewform?usp=sf_link)
*   了解最新的软件质量趋势:如果你有兴趣了解更多软件质量方面的长期趋势，你很幸运。SIG 的软件质量 10 年回顾即将到来。如果你想在它发布时得到通知，请在 Medium 或 twitter 上关注我。
...
感谢 [Lodewijk Bergmans](https://medium.com/u/49e805b994b5) 处理和绘制数据！
