...
> 原文:[https://dev . to/Sr _ Bala Ji/kubernetes-cluster-setup-on-AWS-13m 6](https://dev.to/sr_balaji/kubernetes-cluster-setup-on-aws-13m6)
...
#### [](#kubernetes-cluster-creation)Kubernetes 集群创建
