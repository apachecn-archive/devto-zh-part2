...
> 原文:[https://dev . to/saschadittmann/how-to-create-a-low-cost-Apache-spark-cluster-on-Microsoft-azure-5 bia](https://dev.to/saschadittmann/how-to-create-a-low-cost-apache-spark-cluster-on-microsoft-azure-5bia)
...
## [](#azure-distributed-data-engineering-toolkit-aztk)Azure 分布式数据工程工具包(AZTK)
...
### [](#azure-resources-and-credentials)Azure 资源和凭证
...
## [](#provision-your-first-apache-spark-cluster)配置您的第一个 Apache Spark 集群
...
## [](#getting-cluster-information)获取集群信息
