...
> 原文:[https://dev . to/vcarl/testing-NPM-packages-before-publishing-h7o](https://dev.to/vcarl/testing-npm-packages-before-publishing-h7o)
...
## [](#some-build-tools-dont-understand-symlinks)有些构建工具不理解符号链接。
...
## [](#module-resolution-doesnt-work-with-2-file%C2%A0trees)模块解析不适用于 2 个文件树。
