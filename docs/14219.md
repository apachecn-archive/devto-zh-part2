...
> 原文:[https://dev . to/jeremylikness/use-the-server less-cloud-for-ETL-scenarios-1 nad](https://dev.to/jeremylikness/use-the-serverless-cloud-for-etl-scenarios-1nad)

#### [](#a-real-world-scenario-that-leverages-azure-functions)利用 Azure 功能的真实场景
