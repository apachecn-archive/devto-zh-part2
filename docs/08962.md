...
> 原文:[https://dev . to/citizen 428/10-common-git-problems-and-how-to-fix-them-234 o](https://dev.to/citizen428/10-common-git-problems-and-how-to-fix-them-234o)
...
## [](#1-discard-local-file-modifications)1。放弃本地文件修改
...
## [](#3-remove-a-file-from-git-without-removing-it-from-your-file-system)3。从 git 中删除一个文件，但不从文件系统中删除它
...
## [](#4-edit-a-commit-message)4。编辑提交消息
...
## [](#5-clean-up-local-commits-before-pushing)5。推送前清理本地提交
...
## [](#6-reverting-pushed-commits)6。还原推送的提交
...
## [](#7-avoid-repeated-merge-conflicts)7。避免重复的合并冲突
...
## [](#8-find-the-commit-that-broke-something-after-a-merge)8。在合并后找到中断某些东西的提交
...
## [](#9-avoid-common-mistakes-with-git-hooks)9。避免使用 git 挂钩的常见错误
...
## [](#10-when-all-else-fails)10。当一切都失败的时候
