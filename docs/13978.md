...
## [](#3-magical-steps-to-execute-automation-web-testing)**执行自动化 Web 测试的 3 个神奇步骤**
...
## [](#run-selenese-selenium-ide-scripts-on-chrome-amp-firefox)**在 Chrome 上运行 Selenese (Selenium IDE)脚本& Firefox**
