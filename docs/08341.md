...
> 原文:[https://dev.to/vinceumo/vuejs-101-todo-pwa-tutorial-4bne](https://dev.to/vinceumo/vuejs-101-todo-pwa-tutorial-4bne)
...
## [](#toggle-navigation-on-mobile)在手机上切换导航
...
## [](#bind-our-todo-lists-to-the-side-navigation)将待办事项列表绑定到侧边导航
...
### [](#toggle-the-sidebar-content)切换侧边栏内容
...
#### [](#change-the-title-and-keyword-value)改变标题和关键字值
...
## [](#create-and-edit-a-todo)创建和编辑待办事宜
...
# [](#bonus-offline-progressive-web-app-pwa)奖励-离线渐进式网络应用程序(PWA)
