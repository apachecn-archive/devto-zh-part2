...
> 原文:[https://dev . to/bnevilleoneill/13-ways-to-vertical-center-in-2018-29ni](https://dev.to/bnevilleoneill/13-ways-to-vertical-center-in-2018-29ni)
...
### [](#1-absolute-positioning-and-margin-auto)1。绝对定位和自动边距
...
### [](#2-the-classic-top-50-translate-50)2。经典的前 50%转化为 50%
...
### [](#3-tables-yup-i-just-said-tables)3。桌子。是的，我刚说了桌子。
...
### [](#4-the-ghost-element-method)4。鬼元素法
...
### [](#5-margin-auto-on-a-flexitem)5。弹性物料的自动毛利
...
### [](#6-pseudoelements-on-a-flexcontainer)6。flex 容器上的伪元素
...
### [](#7-amp-8-align-on-the-flexcontainer-or-the-flexitem)7 & 8。在弹性容器或弹性项目上对齐
...
### [](#9-amp-10-align-on-the-gridcontainer-or-the-griditem)9 & 10。在网格容器或网格项目上对齐
...
### [](#11-pseudoelements-on-a-grid)11。网格上的伪元素
...
### [](#12-explicit-grid-row-placement)12。显式网格行放置
...
### [](#13-margin-auto-on-a-griditem)13。网格项目上的自动边距
...
### [](#some-probable-future-implementations)一些(可能的)未来实现:
