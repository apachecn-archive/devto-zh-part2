...
> 原文:[https://dev . to/zim ski/the-complete-guide-to-setup-a-cicd-for-rails-5-on-git lab-2f2d](https://dev.to/zimski/the-complete-guide-to-setup-a-cicd-for-rails-5-on-gitlab-2f2d)

# [](#continuous-integrationdeployment-for-rails-on-gitlab)在 Gitlab 上持续集成/部署 Rails
...
# [](#what-will-we-achieve-)我们将实现什么？

## [](#the-build-stage)建造阶段
...
### [](#the-integration-tests)集成测试

在这个阶段，我们将运行我们所有的集成测试，这些测试基本上会变成
运行:
`bundle exec rails test`

### [](#the-system-tests)系统测试
...
## [](#use-the-cache-to-speedup-the-ci)使用缓存加速 CI
...
### [](#prepare-the-build-container)准备构建容器
...
## [](#2-the-integration-tests-script)2。集成测试脚本
...
## [](#3-the-system-tests-script)3。系统测试脚本
...
## [](#4-the-staging-deployment)4。分段部署
