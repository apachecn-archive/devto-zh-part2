...
> 原文:[https://dev.to/miguelcoba/elixir-api-and-elm-spa-第 5 部分-4j1k](https://dev.to/miguelcoba/elixir-api-and-elm-spa---part-5-4j1k)

# [](#part-5-persisting-session-data-to-localstorage)第 5 部分:将会话数据保存到本地存储
...
## [](#persisting-the-session-to-localstorage)将会话保存到本地存储
