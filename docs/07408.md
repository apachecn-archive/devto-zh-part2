...
> 原文:[https://dev . to/mdemblani/docker-container-un catch-kill-signal-10l 6](https://dev.to/mdemblani/docker-container-uncaught-kill-signal-10l6)
...
##### [](#this-post-is-based-on-the-solution-provided-in-the-following-github-issue-container-does-not-catch-signals-and-exit-ctrlc-thanks-to-user-j%C3%A9r%C3%A9my-vignelles-for-the-solution-provided)*本帖基于以下 Github 问题提供的解决方案:[容器没有捕捉到信号并退出(Ctrl+C)](https://github.com/docker-library/mysql/issues/47) 。感谢用户 [Jérémy VIGNELLES](https://github.com/jeremyVignelles) 提供的解决方案。*