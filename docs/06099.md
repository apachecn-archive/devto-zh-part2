...
> 原文:[https://dev . to/gaijinity/using-vue js-graph QL-to-make-practical-magic-1o2o](https://dev.to/gaijinity/using-vuejs-graphql-to-make-practical-magic-1o2o)

# [](#using-vuejs-graphql-to-make-practical-magic)使用 VueJS + GraphQL 制作超异能快感
...
## [](#autocom%C2%ADplete-search)自动完成搜索
...
## [](#vue-instance-for-autocom%C2%ADplete-search)用于自动完成搜索的 Vue 实例
...
## [](#html-for-autocom%C2%ADplete-search)用于自动完成搜索的 HTML
...
## [](#graphql-for-autocom%C2%ADplete-search)GraphQL 用于自动完成搜索
...
## [](#con%C2%ADtact-form-sub%C2%ADmis%C2%ADsion-saving)联系人表单子任务保存
...
## [](#vue-instance-for-con%C2%ADtact-form-sub%C2%ADmis%C2%ADsion-saving)保存合同表单子任务的实例
...
## [](#html-for-con%C2%ADtact-form-sub%C2%ADmis%C2%ADsion-saving)保存联系人表单子信息的 HTML
...
## [](#graphql-for-con%C2%ADtact-form-sub%C2%ADmis%C2%ADsion-saving)保存合同表单子信息的图表
...
## [](#autocom%C2%ADplete-search-full-source)自动完成搜索全部源代码
...
## [](#con%C2%ADtact-form-sub%C2%ADmis%C2%ADsion-sav%C2%ADing-full-source)合同表单子任务保存完整源代码
