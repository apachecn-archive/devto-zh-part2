...
> 原文:[https://dev . to/theodesp/a-step-by-step-guide-to-go-国际化-i18n-localization-l10n-4ig 2](https://dev.to/theodesp/a-step-by-step-guide-to-go-internationalization-i18n--localization-l10n-4ig2)
...
### [](#string-interpolation-in-messages)消息中的字符串插值
...
#### [](#manually-setting-the-translation-strings)手动设置翻译字符串
...
#### [](#automatic-loading-of-messages)自动加载消息
