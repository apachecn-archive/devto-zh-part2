...
> 原文:[https://dev . to/singuerinc/how-to-make-your-JavaScript-code-faster-4pn 8](https://dev.to/singuerinc/how-to-make-your-javascript-code-faster-4pn8)
...
### [](#strsubstr-vs-strslice)str.substr() vs str.slice()
...
### [](#indexof-vs-object-prop)indexOf() vs 对象属性
...
### [](#string-concatenation-vs-template-literals)字符串串联 vs 模板文字
...
### [](#mathfloor-vs-bitwise-shift)Math.floor() vs 按位移位
