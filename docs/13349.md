...
> 原文:[https://dev . to/NNE VOD/introduction-to-asposecad-library-361h](https://dev.to/nnevod/introduction-to-asposecad-library-361h)
...
## [](#loading-cad-file-and-exporting-image)加载 CAD 文件并导出图像
...
### [](#set-up-exporting-options)设置导出选项
...
## [](#rotating-and-flipping-image)旋转和翻转图像
