...
> 原文:[https://dev . to/ruidfigueiredo/aspnet-core-development-in-Linux-fge](https://dev.to/ruidfigueiredo/aspnet-core-development-in-linux-fge)
...
### [](#creating-the-projects-and-solution-file)创建项目和解决方案文件
...
## [](#adding-project-references)添加项目引用
...
## [](#picking-the-startup-project)挑选启动项目
...
## [](#adding-classes-and-interfaces)添加类和接口
