...
> 原文:[https://dev . to/Apium _ hub/back-to-the-root-to-true-continuous-integration-part-one-14m 7](https://dev.to/apium_hub/back-to-the-roots-towards-true-continuous-integration-part-one-14m7)
...
## [](#what-is-true-continuous-integration)什么是真正的持续集成？
