...
**鹿**建立在[电子](https://electronjs.org)的基础上，目标是
...
目前，Deer 可用于 Linux、Mac 和 Windows。
[立即下载！](https://github.com/abahmed/Deer/releases)

### 入门指南

查看[我方文件](./docs/README.md)中的**建造**和**安装**说明。

如果你想为 Deer 做贡献，也可以看看[我们的文档](./docs/README.md)。

### 取得联系！

欢迎加入我们的 [Gitter](https://gitter.im/abahmed/Deer) 网站，或者如果您有任何问题，请发邮件至 deer-project@googlegroups.com[联系我们。](deer-project@googlegroups.com)

### 许可证

Deer 是在麻省理工学院的许可下获得许可的。