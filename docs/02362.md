...
# [](#angular-unit-testing-cheat-sheet)角度单元测试备忘单
...
#### [](#notes-on-async-testing-tools)异步测试工具说明
...
#### [](#test-example-raw-async-endraw-)测试示例`async()`
...
#### [](#testexample-raw-fakeasync-endraw-raw-tick-endraw-raw-flush-endraw-raw-flushmicrotasks-endraw-)测试示例`fakeAsync()`、`tick()`、`flush()`、`flushMicrotasks()`
...
#### [](#case-2-assert-that-a-method-was-called-and-execute-method)案例二:断言一个方法被调用，执行方法。
...
#### [](#case-3-assert-that-a-method-was-called-and-execute-a-function)案例 3:断言一个方法被调用，执行一个函数。
...
#### [](#case-4-mock-a-response-for-an-existing-method)案例 4:模拟一个现有方法的响应。
...
#### [](#case-5-mock-several-responses-for-an-existing-method)案例 5:对一个已有方法模拟几个响应。
...
#### [](#case-6-assert-that-a-method-was-called-more-than-once)案例 6:断言一个方法被调用了不止一次。
...
#### [](#case-7-assert-that-a-method-was-called-with-arguments)案例 7:断言一个方法被带参数调用
...
#### [](#case-8-assert-that-a-method-was-called-with-arguments-several-times)案例 8:断言一个方法被带参数调用了几次
