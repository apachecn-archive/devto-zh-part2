...
> 原文:[https://dev . to/CJ brooks 12/orchid-home pages-and-static-pages-3965](https://dev.to/cjbrooks12/orchid-homepages-and-static-pages-3965)
...
# [](#adding-static-pages)添加静态页面

## [](#example-small-business)示例:小型企业
...
## [](#adding-location-index-page)添加位置索引页面
