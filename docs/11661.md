...
> 原文:[https://dev . to/xngwng/choosing-the-libraries-and-frameworks-for-rest-API-in-the-nodejs-stack-5a9k](https://dev.to/xngwng/choosing-the-libraries-and-frameworks-for-rest-apis-in-the-nodejs-stack-5a9k)
...
## [](#main-layers-of-tech-stack-for-setting-up-a-restful-api)用于建立 Restful API 的技术栈的主要层。
...
## [](#http-server-and-router)HTTP 服务器和路由器
...
### [](#resources-for-jwt-tokens)资源为 JWT 代币
...
### [](#generating-apis-automatically)自动生成 API
