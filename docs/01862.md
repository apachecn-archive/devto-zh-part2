...
> 原文:[https://dev . to/decudio ly/up-and-running-with-clo jure-for-the-web-pk1](https://dev.to/deciduously/up-and-running-with-clojure-for-the-web-pk1)

# [](#quickly-set-up-a-clojure-webserver-with-boot)用 Boot 快速设置 Clojure webserver
