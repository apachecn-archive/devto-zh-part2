...
> 原文:[https://dev . to/arturolinares/setup-Solr-and-Drupal-using-docker-3n h6](https://dev.to/arturolinares/setup-solr-and-drupal-using-docker-3nh6)

# [](#setup-solr-and-drupal-using-docker)使用 Docker 设置 Solr 和 Drupal
