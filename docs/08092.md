...
## [](#a-framework-means-i-dont-need-to-reinvent-the-wheel)一个框架意味着我不需要多此一举
...
## [](#its-easier-for-beginners-to-use-a-framework)初学者更容易使用框架
...
## [](#but-its-really-hard-without-a-framework)但是没有框架真的很难
...
## [](#learn-the-basics-not-someones-abstraction)学习基础知识，而不是某人的抽象
