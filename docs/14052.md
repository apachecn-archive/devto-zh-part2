...
> 原文:[https://dev.to/risdenk/apache-knox-代理-阿帕奇-尼菲-pfe](https://dev.to/risdenk/apache-knox---proxying-apache-nifi-pfe)
...
## [](#apache-knox-support-for-apache-nifi)Apache Knox 支持 Apache NiFi
...
## [](#setting-up-apache-knox-and-apache-nifi)设置 Apache Knox 和 Apache NiFi
...
### [](#generating-ssltls-certificates-with-apache-nifi-tls-toolkit)使用 Apache NiFi TLS 工具包生成 SSL/TLS 证书

#### [](#download-and-extract-apache-nifi-tls-toolkit)下载并解压 Apache NiFi TLS 工具包
...
#### [](#generate-certificates-for-apache-nifi-hosts-apache-knox-hosts-and-initial-admin-user)为 Apache NiFi 主机、Apache Knox 主机和初始管理员用户生成证书
...
#### [](#copy-the-generated-certificates-to-the-correct-hosts)将生成的证书复制到正确的主机上

对于为其生成 TLS/SSL 证书的每台主机，将 FQDN 主机名文件夹复制到节点上的`/opt/certs/`。

**注意:**如果您想使用不同的位置，稍后跟踪即可。

#### [](#configure-browser-for-apache-nifi-tlsssl-authentication)为 Apache NiFi TLS/SSL 认证配置浏览器
...
### [](#setting-up-apache-nifi)设置 Apache NiFi

#### [](#download-and-extract-apache-nifi)下载并解压 Apache NiFi
...
#### [](#configure-apache-nifi-for-tlsssl)为 TLS/SSL 配置 Apache NiFi
...
#### [](#start-apache-nifi-and-check-ui)启动 Apache NiFi 并检查 UI
...
#### [](#configure-apache-nifi-for-apache-knox)为 Apache Knox 配置 Apache NiFi
...
### [](#setting-up-apache-knox)设置 Apache Knox

#### [](#download-and-extract-apache-knox)下载并解压 Apache Knox
...
#### [](#start-apache-knox-demo-ldap-server)启动 Apache Knox 演示 LDAP 服务器
...
#### [](#start-apache-knox)启动 Apache Knox
...
#### [](#setup-apache-knox-for-apache-nifi)为 Apache NiFi 设置 Apache Knox
...
### [](#check-apache-knox-proxying-of-apache-nifi)检查 Apache NiFi 的 Apache Knox 代理
...
### [](#apache-nifi-logs)Apache NiFi 日志
...
### [](#apache-knox-logs)Apache Knox 日志
...
### [](#browser-your-connection-is-not-private)浏览器——“您的连接不是私人的”
...
### [](#browser-this-site-cant-provide-a-secure-connection)浏览器-“此站点无法提供安全连接”
...
### [](#browser-this-site-cant-provide-a-secure-connection-login-certificate)浏览器-“本站无法提供安全连接”-“登录证书”
...
### [](#apache-nifi-fails-to-start-raw-no-truststore-properties-are-configured-endraw-)阿帕奇 NiFi -启动失败- `... no truststore properties are configured.`
...
### [](#apache-nifi-fails-to-start-raw-keystore-was-tampered-with-or-password-was-incorrect-endraw-)阿帕奇 NiFi -启动失败- `Keystore was tampered with, or password was incorrect`
...
### [](#apache-nifi-unknown-user-with-identity-raw-cnnifiadmin-ounifi-endraw-)Apache NiFi -身份未知的用户- `CN=nifi-admin, OU=NIFI`
...
### [](#apache-nifi-insufficient-permissions-untrusted-proxy)Apache NiFi -权限不足-代理不可信
...
### [](#apache-nifi-unknown-user-with-identity-raw-cnadmin-ounifi-endraw-)Apache NiFi -身份未知的用户- `CN=admin, OU=NIFI`
...
### [](#apache-nifi-insufficient-permissions-unable-to-view-the-user-interface)Apache NiFi -权限不足-无法查看用户界面
...
### [](#apache-knox-browser-repeated-login-boxes)Apache Knox -浏览器-重复登录框

这意味着您输入了错误的用户名/密码，或者 Apache Knox LDAP 服务器没有启动。请参阅上面的“启动 Apache Knox 演示 LDAP 服务器”中的详细信息。

### [](#apache-knox-fails-to-start-raw-unrecoverablekeyexception-cannot-recover-key-endraw-)阿帕奇诺克斯——启动失败——`UnrecoverableKeyException: Cannot recover key`
...
### [](#apache-knox-browser-500-error)阿帕奇 Knox -浏览器- 500 错误
...
#### [](#apache-knox-host-not-reachable)Apache Knox -主机不可达？
...
#### [](#apache-knox-raw-pkix-path-building-failed-endraw-)阿帕奇诺克斯- `PKIX path building failed`
...
#### [](#apache-knox-raw-received-fatal-alert-badcertificate-endraw-)阿帕奇诺克斯- `Received fatal alert: bad_certificate`
...
#### [](#apache-knox-raw-sslpeerunverifiedexception-endraw-)阿帕奇诺克斯- `SSLPeerUnverifiedException`
...
### [](#something-not-mentioned)没有提到的事情？
