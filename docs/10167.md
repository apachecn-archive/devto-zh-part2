...
> 原文:[https://dev . to/on inross/identifying-objects-using-your browser-1i3d](https://dev.to/oninross/identifying-objects-using-yourbrowser-1i3d)
...
### [](#warning-if-you-dont-have-any-machine-learning-background-tensorflow-is-not-for-you)警告:如果你没有任何机器学习背景，TensorFlow 不适合你
...
### [](#teach-it-as-if-it-was-like-a-2yearold)像教 2 岁小孩一样教它
