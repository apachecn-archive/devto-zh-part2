...
> 原文:[https://dev . to/xngwng/tutorial-for-building-an-ether eum-dapp-with-integrated-web 3-monitoring-1fj 0](https://dev.to/xngwng/tutorial-for-building-an-ethereum-dapp-with-integrated-web3-monitoring-1fj0)
...
### [](#what-are-smart-contracts)什么是智能合约？
...
### [](#how-the-pieces-fit-together)碎片如何组合在一起
...
## [](#tutorial-for-building-an-dapp)建造 DApp 教程
...
### [](#step-by-step-guide)逐步引导

#### [](#1-install-truffle-framework)1。安装 Truffle 框架
...
#### [](#2-generate-the-boilerplate-code)2。生成样板代码
...
#### [](#3-start-the-development-environment)3。启动开发环境
...
#### [](#4-compile-the-contracts)4。汇编合同
...
#### [](#7-modify-dapp-code)7。修改 DApp 代码
...
#### [](#8-run-our-simple-dapp)8。运行我们简单的 DApp
...
## [](#set-up-ethereum-web3-api-monitoring)设置以太坊 Web3 API 监控。
...
#### [](#1-create-a-moesif-account-to-get-an-application-id)1。创建一个 [Moesif 账户](https://www.moesif.com)以获得一个*应用 id。*

#### [](#2-add-the-following-code-snippet-into-raw-publicindexhtml-endraw-)2。将以下代码片段添加到`public/index.html`
...
#### [](#3-reload-your-application)3。重新加载您的应用程序
