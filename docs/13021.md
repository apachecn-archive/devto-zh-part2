...
> 原文:[https://dev . to/zch Rb/where-is-a-loops-initial ization-variable-stored-in-memory-2m0o](https://dev.to/zchrb/where-is-a-loops-initialization-variable-stored-in-memory-2m0o)
