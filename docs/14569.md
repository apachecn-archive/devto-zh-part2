...
> 原文:[https://dev . to/elemarjr/getting-started-with-cuda-using-vs 2017-56ba](https://dev.to/elemarjr/getting-started-with-cuda-using-vs2017-56ba)
...
## [](#starting-a-new-project-using-cuda)使用 CUDA 启动新项目
...
## [](#basic-cpu-processing)基本 CPU 处理
...
## [](#bringing-cuda-to-the-game)将 CUDA 带入游戏
