...
> 原文:[https://dev . to/raddevon/jquery-vs-JavaScript-in-2018-explained-through-analogies-21fk](https://dev.to/raddevon/jquery-vs-javascript-in-2018-explained-through-analogies-21fk)

## Javascript 和 jQuery 是什么？

### [](#javascript-is-like-a-hammer)javascript 就像一把锤子。
...
## [](#which-one-should-i-learn)该学哪个？

### [](#javascript-is-like-the-iphone-mail-app)Javascript 就像 iPhone 的邮件 app。

### [](#jquery-is-like-siris-interface-to-mailapp)jQuery 就像 Siri 对 Mail.app 的接口。
...
### [](#javascript-is-like-a-smartphone-camera)Javascript 就像智能手机摄像头。

### [](#jquery-is-like-a-pointandshoot-camera)jQuery 就像一个傻瓜相机。
