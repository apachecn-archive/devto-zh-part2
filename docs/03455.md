...
> 原文:[https://dev . to/yelouafi/代数效果-JavaScript-part-2-capture-continuations-with-generators-13da](https://dev.to/yelouafi/algebraic-effects-in-javascript-part-2---capturing-continuations-with-generators-13da)
...
### [](#driving-generators-in-direct-style)直接驱动发电机
...
### [](#driving-generators-in-cps)驱动 CPS 中的发电机
...
### [](#the-road-to-undelemited-continuations)通往未被删除的延续之路
...
### [](#example-1-emulating-trycacth)例 1:仿效 try/cacth
...
### [](#example-2-cooperative-scheduling)例 2:协同调度
