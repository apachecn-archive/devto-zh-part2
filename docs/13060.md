...
> 原文:[https://dev.to/usamaashraf/service-workers-rails-中间件-3im3](https://dev.to/usamaashraf/service-workers--rails-middleware-3im3)
...
## [](#adding-our-service-worker-to-the-browser)将我们的服务人员添加到浏览器
...
## [](#ok-but-where-does-rails-middleware-come-in-and-by-the-way-wtf-is-middleware)好的，但是 Rails 中间件在哪里呢？还有对了，WTF 是中间件？
