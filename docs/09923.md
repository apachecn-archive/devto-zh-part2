...
## [](#localstorage-is-not-defined)未定义 localStorage
...
## [](#testing-something-is-in-the-dom-or-not)测试某事是否在 DOM 中
...
## [](#test-that-some-element-has-a-certain-class)测试某个元素有某个类
...
## [](#you-dont-have-testids)你没有 testids
...
## [](#unmount-components-in-tests)卸载测试中的组件
