...
> 原文:[https://dev.to/kengotoda/build-stage-on-travis-ci-3pdk](https://dev.to/kengotoda/build-stage-on-travis-ci-3pdk)
...
## [](#no-more-raw-if-endraw-in-analysis-and-deploy-part)分析和部署部分不再有`if`
