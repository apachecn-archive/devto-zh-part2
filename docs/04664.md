...
> 原文:[https://dev . to/bnevilleoneill/how-browser-rendering-works-behind-the-scene-1ce 5](https://dev.to/bnevilleoneill/how-browser-rendering-works-behind-the-scenes-1ce5)

### [](#how-browser-rendering-works%E2%80%8A%E2%80%8Abehind-the-scenes)浏览器渲染如何工作——幕后
...
### [](#sending-amp-receiving-information)发送&接收信息
...
### [](#from-raw-bytes-of-html-to-dom)从 HTML 的原始字节到 DOM
...
### [](#but-wait-what-about-css-)但等。CSS 呢？
...
### [](#from-raw-bytes-of-css-to-cssom)从 CSS 的原始字节到 CSSOM
...
### [](#renderblocking-resources)渲染-阻塞资源
...
### [](#but-wait-what-about-javascript)但等。JavaScript 呢？
