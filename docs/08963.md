...
> 原文:[https://dev . to/bright devs/typescript-tips-from-kot Lin-developer-const-jde](https://dev.to/brightdevs/typescript-tips-from-kotlin-developer---const-jde)
...
## [](#use-raw-const-endraw-whenever-possible)尽可能使用`const`
...
## [](#compilers-love-raw-const-endraw-)编译者的最爱`const`
...
## [](#compilers-catch-bugs-with-raw-const-endraw-)编译器用`const`捕捉 bug
