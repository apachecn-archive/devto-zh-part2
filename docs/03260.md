...
> 原文:[https://dev . to/acanimal/using-PM2-to-manage-nodejs-cluster-34-30ee](https://dev.to/acanimal/using-pm2-to-manage-nodejs-cluster-34-30ee)
...
### [](#the-hard-part-of-cluster-module)集群模块的硬部件
