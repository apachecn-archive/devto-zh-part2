...
> 原文：<https://dev.to/jaybeekeeper/byte-size-changing-habits-with-the-command-line-3lil>

我认为，作为一名编程初学者，跟踪我的进步的一个更切实的因素是跟踪我在使用计算机时，习惯是如何以最基本的方式发生变化的。我与电脑用户界面交互的体验已经相对快速地完全改变了。
...
在发现终端并学习了一些非常基本的 bash 命令之后，一切都变了。
...
bash shell 似乎是一个非常强大的工具，有很多功能我还只是刚刚接触到一点——毕竟，它不仅仅用于导航。

Lifehacker 有一个真正的初学者友好指南，教你如何习惯命令行。