...
> 原文:[https://dev.to/huijing/css-exclusions-with-queen-bey-2k4l](https://dev.to/huijing/css-exclusions-with-queen-bey-2k4l)
...
## [](#its-not-all-unicorns-and-rainbows)不全是独角兽和彩虹……
...
## [](#okay-now-lets-talk-about-exclusions)好了，现在我们来谈谈除外责任
...
#### [](#-raw-auto-endraw-)`auto`

未创建排除。照常生活。

#### [](#-raw-both-endraw-)`both`
...
## [](#web-standards-need-time)网络标准需要时间
