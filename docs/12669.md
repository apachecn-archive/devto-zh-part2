...
## [](#2-enter-billing-information)2。输入帐单信息
...
## [](#2-enable-cloud-vision-api)2。启用云视觉 API
...
## [](#3-raspberry-pi-side-setup)3。Raspberry Pi 侧面设置
