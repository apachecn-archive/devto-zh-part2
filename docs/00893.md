...
> 原文:[https://dev . to/paigen 11/the-absolute-easy-way-to-debug-nodejs-with-vs-code-n4h](https://dev.to/paigen11/the-absolute-easiest-way-to-debug-nodejs-with-vs-code-n4h)
...
## [](#enter-the-pain-of-debugging-in-nodejs)进入 Node.js 中调试的痛苦
...
### [](#setting-up-vs-code-to-debug-in-nodejs)在 Node.js 中设置 VS 代码进行调试
...
### [](#vs-code-debugging-in-action)VS 代码调试在行动
