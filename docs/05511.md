...
> 原文:[https://dev . to/sanity-io/transform-JSON-to-CSV-using-jq-in-the-command line-53gb](https://dev.to/sanity-io/transform-json-to-csv-using-jq-in-the-commandline-53gb)
