...
> 原文:[https://dev . to/惠晶/so-I-mucked-up-my-server-last-night-2a0g](https://dev.to/huijing/so-i-mucked-up-my-server-last-night-2a0g)
...
## [](#the-ubuntu-upgrade-that-went-south)南下的 Ubuntu 升级
...
## [](#what-i-learnt-about-recovery-mode)我对恢复模式的了解
