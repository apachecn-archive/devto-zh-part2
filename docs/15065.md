...
> 原文:[https://dev . to/freekmurze/using-content-security-policy-headers-in-a-laravel-app-5e 67](https://dev.to/freekmurze/using-content-security-policy-headers-in-a-laravel-app-5e67)
...
## [](#implementing-csp-in-a-laravel-app)在 Laravel 应用中实施 CSP
