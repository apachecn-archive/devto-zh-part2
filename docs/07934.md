...
### [](#removing-chromedriverhelper)移除 chromedriver-helper
...
### [](#chrome-crashes-on-launch)Chrome 启动时崩溃
...
## [](#extra-credit-filter-system-tests-with-metadata)额外学分:用元数据过滤系统测试
