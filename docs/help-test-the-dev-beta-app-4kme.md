...
> 原文：<https://dev.to/devteam/help-test-the-dev-beta-app-4kme>

致所有的 iOS 用户:我们非常希望你们能帮助测试 DEV beta 应用。我们核心团队中没有一个人是移动专家，但是在一些社区成员的帮助下，我们已经建立了一些东西，在解决了一些问题后可以很快发布。

如果您有兴趣帮助我们报告和/或修复这些错误，请下载该应用程序。这个链接应该提供所有的细节(你必须先下载试飞):[https://testflight.apple.com/join/7Wq8VRLQ](https://testflight.apple.com/join/7Wq8VRLQ)

GitHub repo 提供给有兴趣的人:
