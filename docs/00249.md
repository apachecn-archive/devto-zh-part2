...
> 原文:[https://dev . to/bnevilleoneill/adding-pipelines-to-JavaScript-19m 9](https://dev.to/bnevilleoneill/adding-pipelines-to-javascript-19m9)
...
#### [](#1-no-strings-attached-simple-pipelines)1)无附加条件:简单管道
...
#### [](#2-adding-async-magic-f-pipelines)2)添加异步魔法:F#管道
...
### [](#pipelines-and-the-javascript-ecosystem)管道和 JavaScript 生态系统
