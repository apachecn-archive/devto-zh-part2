...
> 原文:[https://dev . to/adnanrahic/a-crash-course-on-server less-side-rendering-with-vue js-nuxtjs-and-AWS-lambda-1nk 4](https://dev.to/adnanrahic/a-crash-course-on-serverless-side-rendering-with-vuejs-nuxtjs-and-aws-lambda-1nk4)
...
## [](#build-the-app-with-the-serverless-framework-and-nuxtjs)用无服务器框架和 Nuxt.js 构建 app
...
#### [](#1-setting-up-the-nuxtjs-serverlessside-rendering)1。设置 Nuxt.js 服务器端渲染
...
#### [](#2-writing-clientside-vuejs)2。编写客户端 Vue.js
...
## [](#test-the-app-with-dashbird)用 [Dashbird](https://dashbird.io/) 测试 app
