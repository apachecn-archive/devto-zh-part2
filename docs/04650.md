...
> 原文:[https://dev . to/vonheikemen/setting-up-tape-testing-framework-for-basic-frontend-development-4b 08](https://dev.to/vonheikemen/setting-up-tape-testing-framework-for-basic-frontend-development-4b08)
...
## [](#using-es6-modules)使用 ES6 模块

有几种方法可以实现这一点。

### [](#with-babelregister)同通天塔-寄存器
