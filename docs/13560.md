...
> 原文:[https://dev.to/risdenk/apache-hbase-rest-API-atomic-operations-5g 58](https://dev.to/risdenk/apache-hbase---rest-api---atomic-operations-5g58)
...
## [](#apache-hbase-and-atomic-operations)Apache HBase 和原子操作
...
## [](#using-the-apache-hbase-rest-api)使用 Apache HBase REST API
...
## [](#example-base64-encoded-values)示例 Base64 编码值
...
### [](#checkandput-single-qualifier)检查并输出单个限定符
...
### [](#checkanddelete-qualifier-single-version)检查并删除限定符单个版本
...
### [](#checkanddelete-qualifier-all-versions)检查并删除所有版本的限定符
...
### [](#checkanddelete-column-family)检查并删除列族
