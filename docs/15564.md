...
> 原文:[https://dev . to/mu/programmably-create-AWS-dynamo db-table-from-AWS-lambda-function-37jj](https://dev.to/mu/programmatically-create-aws-dynamodb-table-from-aws-lambda-function--37jj)
