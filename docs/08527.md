...
> 原文:[https://dev . to/meday mentn/creating-a-real time-chat-app-with-Android-nodejs-and-socketio-4o 55](https://dev.to/medaymentn/creating-a-realtime-chat-app-with-android--nodejs-and-socketio-4o55)
...
# [](#our-nodejs-server)本方 NodeJs 服务器
...
# [](#our-android-app-socket-client)我们的安卓应用(Socket 客户端)
