...
> 原文:[https://dev . to/kbk 0125/we b-APIs-explained-by-selling-goods-from-your-farm-pd9](https://dev.to/kbk0125/web-apis-explained-by-selling-goods-from-your-farm--pd9)
...
### [](#then-what-is-an-api)那么什么是 API 呢？
...
### [](#what-can-be-accessed-through-an-api)通过 API 可以访问什么？
...
### [](#tracking-an-individual-api-call)跟踪单个 API 调用
...
### [](#the-difference-between-a-farm-and-a-web-app)农场和网络应用的区别
...
### [](#what-does-it-mean-to-open-your-api)“开放你的 API”是什么意思？
