...
## [](#es6-variables)ES6 变量

### [](#-raw-var-endraw-vs-raw-let-endraw-)`var` vs `let`
...
## [](#es6-template-literals)ES6 模板文字
...
## [](#es6-destructuring-assignment)ES6 解构赋值
...
## [](#es6-default-parameters)ES6 默认参数
...
### [](#-raw-super-endraw-and-raw-this-endraw-)`super`和`this`
