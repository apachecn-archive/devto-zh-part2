...
> 原文:[https://dev . to/edr pls/migrating-a-large-flux-app-tore dux-without-everything-fragmented-133g](https://dev.to/edrpls/migrating-a-large-flux-app-toredux-without-everything-falling-apart-133g)
...
### [](#a-bridge-between-stores)商店之间的桥梁
...
## [](#sample-app-structure)示例 App 结构
...
## [](#creating-the-first-reducer)创建第一个减速器
...
## [](#redux-reducer-with-a-coat-of-flux-store)Redux 减速器用一层焊剂储存
...
## [](#migrating-the-first-action)迁移的第一个动作
...
## [](#migrating-an-async-action)迁移异步操作
