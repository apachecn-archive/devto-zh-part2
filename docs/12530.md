...
### [](#unit-testing-best-practices)单元测试最佳实践
...
### [](#so-how-did-we-catch-this-error-today)那么我们今天是如何捕捉到这个错误的呢？
...
#### [](#catch-this-kind-of-potential-error-with-a-static-analysis-inspection)用静态分析检查捕捉这种潜在的错误
