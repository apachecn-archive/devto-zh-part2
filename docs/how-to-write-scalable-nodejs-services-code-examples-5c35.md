...
> 原文：<https://dev.to/k1r0s/how-to-write-scalable-nodejs-services-code-examples-5c35>
...
所以我们有两个模型类 developer 和 app 以及一个资源类。但是，在运行时，我们有两个资源实例，每个都有自己的模型实例，负责特定的域规则。
