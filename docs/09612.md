...
# [](#part-4-adding-login-and-register-pages)第 4 部分:添加登录和注册页面
...
## [](#add-cors-to-the-backend-api)将 CORS 添加到后端 api
...
## [](#create-the-session-model)创建会话模型
...
## [](#create-the-register-page)创建注册页面
