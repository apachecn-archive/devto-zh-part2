...
> 原文:[https://dev . to/John phamous/customizing-Firefox-quantums-about config-1542](https://dev.to/johnphamous/customizing-firefox-quantums-aboutconfig-1542)
...
### [](#4-view-page-source-in-your-text-editor)4。在文本编辑器中查看页面源代码
