...
当我开始时，我爱上了编程。我的第一条建议是学习它，因为你喜欢它，你觉得它有趣，或者可能觉得它有用(确实是这样！).
...
作为一名软件工程师，我的挑战之一是始终跟踪我们世界正在出现的新事物:像 2013 年的 [ReactJS 这样的新库，像](https://en.wikipedia.org/wiki/React_(JavaScript_libary)) [SPA](https://en.wikipedia.org/wiki/Single-page_application) 、 [PWA](https://en.wikipedia.org/wiki/Progressive_web_app) 这样的网络应用，像机器学习、人工智能、加密货币(区块链区块链区块链！)，等等。

我并不是说我们需要学习一切，压倒自己。我的观点是，在科技世界里，新事物产生得如此之快，所以我们需要拥抱**终身学习**的心态。

说到压倒一切，这里有第三条建议:尽量不要压倒自己。不需要先从硬概念开始，也不需要从最重的算法书开始。
...
实践是关键。想办法学习概念并实践它。这是提示五。用概念和理论建立基础很重要，但要实际。试试看。实验。我们稍后将深入探讨这一点，但实践是关键！
...
> [成为语言
> 不可知论者](http://www.gayle.com/blog/2014/07/09/15-pieces-of-career-advice-software-developers-should-follow)。语言只是一种工具。深入了解一门语言是有价值的，但学习新事物也是有价值的。最好的开发人员往往不认为自己是 _ _ _ _ _ 开发人员。— [盖尔·拉克曼·麦克道尔](https://medium.com/u/e21bc4f4525e)
...
> 代码。很多……成为一名伟大的程序员的最好方法就是练习——很多。
> ——[格利·拉克曼
> 麦克道尔](http://www.gayle.com/blog/2014/07/09/15-pieces-of-career-advice-software-developers-should-follow)
...
2.  您习惯于注册模式，并将模式与您的模式
    库进行匹配。

3.  你知道如何在压力下集中注意力和表现。

4.  作为一名编码员，你对自己的能力和缺点有意识和信心。

5.  你已经学会了管理时间，尤其是在你的思维和编码习惯方面。
...
*   [Codeforces](http://codeforces.com/) :真的是一个很好的培训学习的网站。它有很多很棒的问题集。社论在这里是加分项(*社论*:问题作者写你应该如何处理和解决问题——使用哪种算法或数据结构)。
...
> “我搭建了[第一个 app 版本](https://play.google.com/store/apps/details?id=co.iacovelli.usp)，发布到 Play Store。然后，我对 Java/Kotlin/Android 了解得越来越多，可以在这个应用程序上实现更多功能。但这是一个耗时的过程。我需要很大的毅力”——道格
...
这个清单还在继续。这里[另一个列表([https://github.com/karan/Projects#networking](https://github.com/karan/Projects#networking))可以帮助你选择项目。但我同意 Feross 的观点，你造什么都不重要，只要你挑个东西开始。所以开始建设吧！你会有问题，你会被卡住。但是你会学到很多！
...
搜索了 100 天的代码故事，我发现了[艾米丽](https://medium.com/@emilyyu_17465)写的“[我如何在 365 天](https://hackernoon.com/how-i-coded-everyday-for-365days-67ebb5fc7ae)中每天编码”。这是一个关于纪律和愿意学习编码的鼓舞人心的故事。
...
*   如果你对机器学习感兴趣，[吴恩达](https://medium.com/@andrewng)就是那个人！
*   对于编程方面的东西，我喜欢阅读来自 [DHH](https://medium.com/@dhh) (Ruby on Rails 创建者)[丹·阿布拉莫夫](https://medium.com/@dan_abramov) (Redux 合著者)[特雷西·周](https://medium.com/@triketora)(前 Quora，Pinterest)[昆西·拉森](https://medium.com/@quincylarson) (freeCodeCamp 创建者)[丹·巴德](https://medium.com/@dbader_org)(运行真正的 Python)，等等。

#### 在媒体上记录自己旅程的人

*   [如何成功自学如何编码](https://medium.freecodecamp.org/successfully-teaching-yourself-how-to-code-f6aac23db44a)作者[莉迪亚·哈利](https://medium.com/@lydiahallie)
*   [我如何在一年内从时装模特变成软件工程师](https://medium.freecodecamp.org/how-i-went-from-fashion-model-to-software-engineer-in-1-year-a7399a40d9e7)作者[麦迪森·卡纳](https://medium.com/@madisonkanna)
*   [BaseCS](https://medium.com/basecs) 作者[瓦伊德希·乔希](https://medium.com/@vaidehijoshi)
*   [这就是为什么学习如何编码如此困难](https://medium.com/the-mission/heres-why-learning-how-to-code-is-so-hard-and-what-to-do-about-it-3d6fda152409)作者[凯文·科诺年科](https://medium.com/@kevink)
*   [我想学编程，但不知道从哪里开始](https://codeburst.io/i-want-to-learn-programming-but-i-dont-know-where-to-start-80dd2d55e1fd)作者[罗宾·西尔伯](https://medium.com/@robynjsilber)
...
*   Mayuko 是一名 iOS 软件工程师，在 [Patreon](https://medium.com/@Patreon) 工作。她还谈到了工程和一般的生活方式。
*   CS Dojo 真正关注的是编程面试建议、算法和数据结构之类的东西。这个频道来自[YK·杉下](https://medium.com/@ykdojo)，前谷歌工程师。
*   霍马理工大学是所有 YouTube 频道中最有趣、最有娱乐性的。 [Jonathan Ma](https://medium.com/@joma) 是脸书的一名数据科学家。他分享了自己的工程师生活，并根据自己在一些科技公司实习的经历，给出了编码面试的建议。
...
查看我的[Twitter](https://twitter.com/LeandroTk_)&[github](https://github.com/LeandroTk)☺