...
> 原文:[https://dev . to/full stack cafe/8-ultimate-full-stack-interview-questions-dj5](https://dev.to/fullstackcafe/8-ultimate-full-stack-interview-questions-dj5)
...
### [](#q1-what-is-inversion-of-control)Q1:什么是控制反转？
...
### [](#q3-what-is-bridge-pattern)Q3:什么是桥型？
...
### [](#q4-explain-a-use-case-for-docker)Q4:解释 Docker 的一个用例
...
### [](#q5-explain-the-main-difference-between-rest-and-graphql)Q5:解释 REST 和 GraphQL 的主要区别
...
### [](#q6-what-is-event-loop)Q6:什么是事件循环？
...
### [](#q7-can-you-explain-what-git-reset-does-in-plain-english)Q7:能否用通俗易懂的英语解释一下“git reset”是做什么的？
...
### [](#q8-explain-prototype-inheritance-in-javascript)Q8:解释 JavaScript 中的原型继承？
