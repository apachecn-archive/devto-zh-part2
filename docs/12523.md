...
# [](#first-of-all-what-is%C2%A0vuenut)首先，vuenut 是什么？
...
### [](#iniciar-proyecto-con-vue%C2%A0cli)使用 vista CLI 启动项目
...
# [](#install-and-implement-vuenut-to-the%C2%A0project)在项目中安装并实现 Vuenut
...
# [](#install-and-deploy%C2%A0vuex)安装并部署 Vuex
