...
> 原文:[https://dev . to/PS nebc/QEMU-KVM-centos-7-install-vim-emacs-git-curl-wgetzsh-ohmyzsh-DMN](https://dev.to/psnebc/qemu-kvm-centos-7-install-vim-emacs-git-curl-wgetzsh-ohmyzsh-dmn)
