# 设置 Adafruit Feather HUZZAH ESP8266 并向 Wia 发布事件
...
如果你对 Arduino IDE 完全不熟悉，在这里看这个视频[会让你更好地理解它是如何工作的。](https://www.youtube.com/watch?v=nbD_V4QtNvY)
...
对于 ESP 8266，端口名称往往具有不常见的名称，例如:

*   在 Mac OS 上:`/dev/tty.usb.modem8232`或`/dev/cu.SLAB_USB_toUART`
...
*   点击`File > New`创建一个新草图
*   复制并粘贴下面的发布事件示例代码。你也可以在 GitHub [这里](https://github.com/wiaio/wia-board-examples/tree/master/Arduino/ESP8266)查看。在那里你将直接看到如何发布`Events`和`Locations`
