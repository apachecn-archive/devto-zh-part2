...
### [](#step-1-breaking-the-ui-into-components)第一步:将 UI 分解成组件
...
### [](#step-2-setting-up-the-codebase)第二步:设置代码库
...
### [](#step-3-creating-the-root-component)第三步:创建根组件
...
### [](#step-4-rendering-dummy-messages)第四步:渲染虚拟消息
...
### [](#step-5-fetching-apikeys-from-chatkit)第五步:从聊天工具中获取 API 密钥
...
### [](#step-6-rendering-real-chat-messages)第六步:渲染真实聊天消息
...
### [](#step-7-handling-user-input)第七步:处理用户输入
...
### [](#step-8-sending-messages)第八步:发送消息
...
### [](#step-9-sending-the-messages-to-chatkit)第九步:发送消息到聊天工具
...
### [](#step-10-creating-the-title-component)第十步:创建标题组件
