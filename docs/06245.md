...
> 原文:[https://dev . to/wreulicke/export-application-metrics-with-micrometer-for-Prometheus-on-your-micronaut-application-3d 27](https://dev.to/wreulicke/export-application-metrics-with-micrometer-for-prometheus-on-your-micronaut-application-3d27)
...
## [](#create-metrics-endpoint-for-prometheus)为普罗米修斯创建指标端点。
