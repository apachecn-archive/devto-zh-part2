...
## [](#deploy-a-containerized-nodejs-app-to-a-kubernetes-cluster-on-aws)将容器化的 Node.js 应用部署到 AWS 上的 Kubernetes 集群
...
### [](#1-creating-a-container-image)1。创建容器图像
...
### [](#2-create-the-kubernetes-cluster)2。创建 Kubernetes 集群
...
### [](#3-deploy-the-container-image)3。部署容器映像
...
## [](#serverless-pros-and-cons)无服务器利弊
...
## [](#deploy-a-serverless-nodejs-app-to-aws)将无服务器 Node.js app 部署到 AWS
...
### [](#1-configure-the-serverless-resources)1。配置无服务器资源
...
### [](#2-deploy-the-serverless-resources)2。部署无服务器资源
