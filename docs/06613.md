...
## [](#2-setup-open-weather-map)2。设置打开天气图
...
## [](#3-setting-up-the-flask-server)3。设置 Flask 服务器
...
### [](#set-up-tunnelling-to-localhost)设置隧道传输到本地主机
...
### [](#set-up-facebook-messenger)设置 facebook messenger
