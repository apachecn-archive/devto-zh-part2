...
> 原文:[https://dev.to/jamesrweb/accessibility-101-测试-和-qa-595o](https://dev.to/jamesrweb/accessibility-101---testing-and-qa-595o)
...
## [](#fixing-the-results)修正结果

### [](#images-must-have-alternate-text)图像必须有替换文字
...
### [](#ensures-the-contrast-between-foreground-and-background-colors-meets-wcag-2-aa-contrast-ratio-thresholds)确保前景色和背景色之间的对比度符合 WCAG 2 AA 对比度阈值
...
### [](#ensures-all-content-is-contained-within-a-landmark-region)确保所有内容都包含在地标区域内
...
## [](#gitlab-ci-pipeline-continuous-integration-pipelines)Gitlab CI 管道(持续集成管道)
