...
> 原文:[https://dev . to/logaretm/vee validate-21-validation-providers-5cij](https://dev.to/logaretm/veevalidate-21-validation-providers-5cij)

#### [](#a-retake-on-vuejs-form-validation)对 Vue.js 表单进行重考验证
