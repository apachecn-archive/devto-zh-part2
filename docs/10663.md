...
> 原文:[https://dev.to/dotnetcoreblog/how-docker-works-sort-of-5hg5](https://dev.to/dotnetcoreblog/how-docker-works-sort-of-5hg5)
...
### [](#containers-images-what)集装箱？图像？什么？
...
### [](#back-to-containers-kind-of)回集装箱...有点儿
...
### [](#back-to-containers-proper)回到容器(适当)
