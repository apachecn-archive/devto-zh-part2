...
> 原文:[https://dev . to/galdin/generating-pdf-from-an-aspnet-core-app-using-a-node-library-3bp 8](https://dev.to/galdin/generating-pdfs-from-an-aspnet-core-app-using-a-node-library-3bp8)
...
## [](#create-an-action-that-invokes-the-node-script)创建一个调用节点脚本的动作
...
## [](#register-nodeservices-with-the-di)向 DI 注册节点服务
