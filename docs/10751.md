...
## [](#versioning-dotfiles-with-git)用 Git 对点文件进行版本控制

首先，除了使用版本控制，保存几个文件(`.bashrc`、`.gitignore_global`、`bin/`)的状态以保持它们同步的最好方法是什么？

在考虑对您的主目录中的文件进行版本控制时，您可能会想到一个问题...

#### [](#the-dotfiles-you-would-like-to-version-is-a-very-small-subset-of-filesdirectories-in-your-home-directory)您想要版本化的点文件是您主目录中文件/目录的一个非常小的子集
...
## [](#cloning-dotfiles-in-new-environments)克隆。新环境中的点文件
...
## [](#using-an-installer-as-a-bash-script)使用安装程序作为 bash 脚本
...
## [](#last-extension-dist-files)最后扩展名:dist 文件
