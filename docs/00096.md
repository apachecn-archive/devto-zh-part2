...
> 原文:[https://dev . to/circle ci/level-up-go-test-with-gotestsum-4p0b](https://dev.to/circleci/level-up-go-test-with-gotestsum-4p0b)
...
## [](#circleci-junit-support)CircleCI / JUnit 支持
...
## [](#installing-gotestsum)安装 gotestsum

### [](#requirements)要求

*   转到 1.10 版或更高版本

### [](#installing-locally)本地安装
...
### [](#installing-on-circleci)安装在 CircleCI 上
