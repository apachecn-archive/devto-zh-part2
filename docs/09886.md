...
> 原文:[https://dev . to/wia io/how-to-upload-a-file-to-wias-rest-API-3oe 5](https://dev.to/wiaio/how-to-upload-a-file-to-wias-rest-api-3oe5)

在本教程中，我将向您展示如何将任何类型的文件(如 png、jpg、pdf 或 txt)上传到 Wia。

### [](#installing-python-and-the-wia-library)**安装 Python 和 Wia 库**
