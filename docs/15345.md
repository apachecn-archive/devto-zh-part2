...
> 原文:[https://dev . to/twilio/build-a-in-browser-video-chat-with-screen-sharing-using-twilio-video-2m1i](https://dev.to/twilio/build-an-in-browser-video-chat-with-screen-sharing-using-twilio-video--2m1i)
...
### [](#getting-the-users-screen)获取用户的屏幕
...
## [](#screen-share-all-you-like-within-the-right-browsers)在合适的浏览器中分享您喜欢的一切
