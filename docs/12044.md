...
## [](#learn-to-effectively-use-git-branches)学会有效使用 git 分支
...
## [](#the-6-infinity-ruby-gems-you-need-to-use)您需要使用的 6 颗无限红宝石

#### [](#by-thanos)灭霸

是的，我花了无数年的时间来寻找这些宝石，以便它们永远在我的手中。第一个可以帮助您清理时区测试。在处理日期时，时间宝石取代了时间盖成为了压倒性的胜利者。

## [](#introducing-the-newest-rails-helper-activevision)介绍最新 Rails 助手:ActiveVision

#### [](#by-aaron-patterson-tenderlove)作者亚伦·帕特森(@tenderlove)
...
## [](#hulk-bash-my-favorite-shell-scripts)绿巨人迎头痛击！我最喜欢的 shell 脚本

#### [](#by-bruce-banner)布鲁斯·班纳
...
## [](#show-hn-thanos-an-operating-system-that-will-change-your-reality)展示 HN:thanOS——一个将改变你现实的操作系统。

#### [](#submitted-by-thanos-8-hours-ago)由灭霸提交——8 小时前

## [](#advanced-web-development)高级网页开发

#### [](#by-spiderman)被蜘蛛侠

## [](#dark-mode-all-the-things)黑暗模式所有的东西！

#### [](#by-black-widow)黑寡妇

## [](#full-stark-developers)满斯塔克开发者

### [](#the-next-generation-of-robotic-developers)下一代机器人开发者

#### 斯塔克工业的实习生彼得·帕克

## [](#rails-magic-under-the-hood)铁轨魔法:引擎盖下

#### [](#by-scarlet-witch-and-dr-strange)由猩红女巫和奇异博士
