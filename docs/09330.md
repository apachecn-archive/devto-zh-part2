...
> 原文:[https://dev . to/django tricks/equivalents-in-python-and-JavaScript-part-1-3317](https://dev.to/djangotricks/equivalents-in-python-and-javascript-part-1-3317)
...
## [](#object-attribute-value-by-attribute-name)对象属性值由属性名决定
...
## [](#slicing-lists-and-strings)切片列表和字符串
...
## [](#operations-with-list-items)与列表项的操作
...
## [](#joining-lists-of-strings)连接字符串列表
