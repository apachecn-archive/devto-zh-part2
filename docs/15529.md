...
## [](#why-we-need-to-bind-the-basics-of-raw-this-endraw-)为什么我们需要绑定:基础知识`this`
...
## [](#how-to-bind-raw-this-endraw-)如何绑定`this`
...
## [](#binding-raw-this-endraw-in-a-react-component)绑定`this`在一个 React 组件中
...
### [](#using-the-public-class-fields-syntax)使用*公共类字段语法*
...
### [](#binding-raw-this-endraw-inside-the-constructor)绑定`this`构造函数内部
...
## [](#alternatives-and-their-caveats)替代品及其说明

在前面的章节中，我解释了绑定`this`的推荐方式。然而，如果你不喜欢上面提到的方法，这里还有一些——如果你同意它们的警告的话。

### [](#binding-directly-inside-a-prop)直接装订在道具内
...
### [](#passing-an-arrow-function-to-props)传递箭头功能给道具
