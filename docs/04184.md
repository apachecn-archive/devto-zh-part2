...
## [](#install-the-required-gems)安装需要的宝石

### [](#for-jruby-or-ruby-v18x)为 JRuby 或 Ruby v1.8.x
...
## [](#create-a-raw-launchjson-endraw-file)创建一个`launch.json`文件
...
## [](#launch-a-debugging-session)启动调试会话
