...
> 原文:[https://dev . to/circle ci/kubernetes-deployments-with-cloud flare-4gjm](https://dev.to/circleci/kubernetes-deployments-with-cloudflare-4gjm)
...
### [](#authenticating-with-docker-hub)向 Docker Hub 认证
...
### [](#authenticating-with-google-cloud-platform)向谷歌云平台认证
...
### [](#authenticating-with-cloudflare)使用 Cloudflare 进行认证
...
## [](#deploying-docker-containers-to-kubernetes-with-circleci)使用 CircleCI 将 Docker 容器部署到 Kubernetes
...
### [](#configuring-the-command-line-tools)配置命令行工具
...
### [](#running-your-first-deployment)运行您的首次部署
...
### [](#routing-your-domain-with-cloudflare)使用 Cloudflare 路由您的域
...
## [](#updating-existing-kubernetes-deployments-on-gcp-with-circleci)使用 CircleCI 更新 GCP 上现有的 Kubernetes 部署
...
## [](#adding-aws-deployments)添加 AWS 部署
...
## [](#tie-it-together-with-cloudflare)用 Cloudflare 绑在一起

与 Cloudflare 的 DNS 服务一样，他们的流量服务公开了用于管理负载平衡器配置的完整 API。这使得我们可以在 CircleCI 中直接自动化这项任务。

### [](#create-a-load-balancer-in-cloudflare)在 Cloudflare 中创建负载平衡器
...
### [](#updating-our-cloudflare-origin-pools-on-deployment)在部署时更新我们的 Cloudflare 源池
