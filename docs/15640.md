...
### [](#show-me-the-code-almost-there)给我看看代码！(快到了)
...
### [](#show-me-the-code-for-real-the-naive-solution)给我看看代码！(真的)-天真的解决方案
...
##### [](#-raw-hasviolation-endraw-)`has_violation`
...
##### [](#-raw-getpositionstocheck-endraw-)`get_positions_to_check`
...
##### [](#-raw-fillmatrix-endraw-)`fill_matrix`
...
#### [](#so-what-whats-the-real-point-in-all-of-this)那又怎样？这一切的真正意义是什么？
