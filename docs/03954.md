...
> 原文:[https://dev . to/booyaa/we B- app-development-core-skill-fox-3ij 5](https://dev.to/booyaa/web-app-development-core-skill-fox-3ij5)
...
# [](#web-app-dev-core-skills-level-2-aka-fox)Web 应用开发核心技能二级又名 Fox
...
## [](#getting-crafty-with-react)变得诡计多端
...
### [](#a-word-about-the-example-code)关于示例代码的一句话
...
### [](#contains-a-component-without-any-props-or-state)包含一个没有任何道具或状态的组件
...
### [](#contains-a-use-of-the-key-prop)包含一个使用的关键道具
...
### [](#contains-a-component-which-makes-use-of-a-function-passed-in-as-a-prop)包含一个组件，它使用一个作为道具传入的函数

请参见下一节中的示例。

### [](#contains-a-component-which-renders-differently-based-on-the-following-prop-types-being-passed-in)包含一个组件，该组件根据传入的以下属性类型进行不同的渲染
...
### [](#contains-a-component-which-renders-differently-based-on-state-changes)包含一个根据状态变化进行不同渲染的组件
...
### [](#contains-a-component-which-changes-state-in-response-to-an-onclick-event)包含一个响应 onClick 事件而改变状态的组件
...
### [](#contains-a-component-which-has-been-styled-without-global-styles)包含一个已经样式化但没有全局样式的组件
