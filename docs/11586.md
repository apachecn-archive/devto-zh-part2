...
> 原文:[https://dev . to/heroku/rails-52-active-storage-previews-poppler-and-solution-licensing-陷阱-2b80](https://dev.to/heroku/rails-52-active-storage-previews-poppler-and-solving-licensing-pitfalls-2b80)
...
## [](#adding-active-storage-to-an-existing-app)向现有应用添加活动存储
