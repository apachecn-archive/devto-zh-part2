...
> 原文:[https://dev . to/jlen grand/installing-gdal-for-python-3-6-3 IFF](https://dev.to/jlengrand/installing-gdal-for-python-3-6-3iff)
...
## [](#installing-gdal-on-python-36)在 Python 3.6 上安装 GDAL
...
### [](#installing-conda)安装康达

只需跟随官方指南[。](https://conda.io/docs/user-guide/getting-started.html)

### [](#creating-an-environment-with-gdal-as-a-dependency)创建以 GDAL 为依赖的环境
