...
> 原文:[https://dev . to/gene jams/add-a-view pager-to-the-mobile-we B- app-n67](https://dev.to/genejams/adding-a-viewpager-to-the-mobile-web-app-n67)

 <small>虽然这篇文章中的主题可能仍然是真实的，但是这些内容引用了一个旧版本的 *zuix.js* 库。最新文档见 [zuix.js](https://zuixjs.org) 网站。</small> 

* * *

## [](#what-is-a-viewpager)什么是 ViewPager？
