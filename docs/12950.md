...
###### [](#note-all-credit-goes-to-original-authors-linked-within-the-text-the-converted-c-code-is-public-domain-feel-free-to-have-fun-with-it)(注:所有荣誉归于文中链接的原作者。转换后的 C#代码是公共领域，请随意使用它)
