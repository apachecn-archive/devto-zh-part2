...
> 原文:[新用户 https://dev.to/uilicious/5-fatal-docker-gotchas-2o 87](https://dev.to/uilicious/5-fatal-docker-gotchas----for-new-users-2o87)
...
## [](#2-not-understanding-docker-data-persistence)2)不了解 docker 数据持久性
...
## [](#3-using-latest-tag-for-containers)3)使用:容器的最新标签
...
## [](#4-containers-do-not-have-persistent-ip-address)4)容器没有永久 IP 地址
...
## [](#5-lack-of-cpu-ram-disk-in-planning-and-monitoring)5)缺乏对 CPU、RAM、磁盘的规划和监控
...
## [](#one-more-thing-monitoring-is-not-only-about-http-code-200)还有一点:监控不仅仅是关于 http 代码 200
