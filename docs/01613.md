...
> 原文:[https://dev . to/drbearhands/should-programming-languages-be-made-for-ides-而不是-humans-3dnf](https://dev.to/drbearhands/should-programming-languages-be-made-for-ides-rather-than-humans-3dnf)
