...
> 原文:[https://dev . to/django tricks/equivalents-in-python-and-JavaScript-part-3-4 ICC](https://dev.to/djangotricks/equivalents-in-python-and-javascript-part-3-4icc)
...
## [](#iteration-without-indexes)无索引迭代
