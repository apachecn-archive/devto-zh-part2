...
### [](#helper-methods-for-loading-and-saving-profiles)加载和保存配置文件的帮助方法
...
### [](#applying-color-profile-when-saving-to-tiff)保存为 TIFF 时应用颜色配置文件
...
### [](#disabling-default-application-of-embedded-color-profile)禁用嵌入颜色配置文件的默认应用。
