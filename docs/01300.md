...
> 原文:[https://dev . to/awwsmm/installing-and-running-Hadoop-and-spark-on-windows-33kc](https://dev.to/awwsmm/installing-and-running-hadoop-and-spark-on-windows-33kc)

# [](#installing-and-running-hadoop-and-spark-on-windows)在 Windows 上安装运行 Hadoop 和 Spark
...
# [](#set-up-your-environment-variables)设置你的环境变量
...
# [](#testing-hadoop-and-spark)测试 Hadoop 和 Spark
