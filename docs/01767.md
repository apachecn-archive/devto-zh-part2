...
> 原文:[https://dev . to/Joel net/null-the-billion-dollar-mission-maybe-just-nothing-1cak](https://dev.to/joelnet/null-the-billion-dollar-mistake-maybe-just-nothing-1cak)
...
# [](#do-not-underestimate-the-problems-of-null)不要低估 NULL 的问题
...
# [](#getting-in-and-out-of-maybes)进出不定
...
# [](#javascript-type-coercion)JavaScript 类型强制
...
# [](#maybe-function-decorator)也许是函数装饰器
...
# [](#tc39-optional-chaining-for-javascript)TC39 可选 JavaScript 链接
