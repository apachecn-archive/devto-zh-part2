...
### [](#navigating-and-working-with-files-amp-directories)导航和处理文件&目录
...
### [](#manipulating-output-for-input)操纵输出进行输入
...
## [](#other-helpful-commands-ive-found)我发现的其他有用的命令
...
### [](#shortcutstips-amp-tricks)快捷键/提示&招数
