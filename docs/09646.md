...
#### [](#separation-of-dependencies)**分离依赖**
...
#### [](#separation-of-translations)**分离译名**
...
# [](#enabling-authentication-in-the-main-application)在主应用程序中启用认证
...
# [](#testing-enginegem-integration-into-a-main-application)测试引擎/Gem 集成到主应用程序中
