...
> 原文:[https://dev . to/Noah 11012/using-SDL 2-optimizing-surface-blitting-38 F8](https://dev.to/noah11012/using-sdl2-optimizing-surface-blitting-38f8)
...
## [](#loading-different-image-types)加载不同的图像类型
