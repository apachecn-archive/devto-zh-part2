...
> 原文:[https://dev . to/ore/building-a-screen-recorder-for-the-web-with-a-jiffy-i6n](https://dev.to/ore/building-a-screen-recorder-for-the-web-with-cloudinary-in-a-jiffy-i6n)
...
## [](#putting-in-place-the-prerequisites)把先决条件落实到位
...
## [](#adding-the-pertinent-features)添加相关特征
...
## [](#connecting-with-cloudinary)与云相连

### [](#understand-the-connection-process)了解连接过程
...
### [](#find-out-your-cloud-name)找出你的云名
...
### [](#create-a-cloudinary-upload-preset)创建一个云上传预置
...
### [](#test-uploads-to-cloudinary)测试上传到 Cloudinary
...
## [](#accessing-uploaded-videos)访问上传的视频
