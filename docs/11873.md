...
> 原文:[https://dev . to/adnanrahic/a-crash-course-on-securing-server less-APIs-with-JSON-we B- tokens-22fa](https://dev.to/adnanrahic/a-crash-course-on-securing-serverless-apis-with-json-web-tokens-22fa)
