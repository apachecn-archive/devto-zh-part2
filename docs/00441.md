...
> 原文:[https://dev . to/some dood/emulating-private-variables-in-JavaScript-with-closures-and-factory-functions-2314](https://dev.to/somedood/emulating-private-variables-in-javascript-with-closures-and-factory-functions-2314)
...
# [](#what-is-a-private-variable)什么是私有变量？
...
# [](#using-closures-for-private-variables)对私有变量使用闭包
