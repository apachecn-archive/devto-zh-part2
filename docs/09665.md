...
> 原文:[https://dev . to/fros nerd/deploying-and-benchmark-an-AWS-rds-MySQL-instance-2faf](https://dev.to/frosnerd/deploying-and-benchmarking-an-aws-rds-mysql-instance-2faf)
...
## [](#finding-our-way-through-the-network)在网络中找路
...
### [](#internet-gateway-and-route-tables)互联网网关和路由表
...
### [](#adding-security-group-rules)添加安全组规则
...
## [](#connecting-through-an-ssh-tunnel)通过 SSH 隧道连接
