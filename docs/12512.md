...
> 原文:[https://dev.to/sait/how-to-make-a-4 列页脚-无媒体查询- 352j](https://dev.to/sait/how-to-make-a--4-column-footer-with-no-media-queries--352j)

## [](#footer-with-no-media-queries-and-margins)页脚无媒体查询和页边距。
...
## [](#autofit-and-minmax-functions-are-used)使用自动适应和最小-最大功能。

我将解释最小最大值是什么，最小最大值有两个参数，第一个是最小值，第二个是最大值。

自动适应帮助我们用给定的列覆盖可用空间。

### [](#check-out-demo-amp-code-in-code-pen)在代码笔中检查演示&代码
