...
> 原文:[https://dev . to/jfernancordova/deploy-a-restful-API-using-laravel-and-docker-31 a4](https://dev.to/jfernancordova/deploy-a-restful-api-using-laravel-and-docker-31a4)
...
#### [](#api-boilerplate-reference)API 样板参考
