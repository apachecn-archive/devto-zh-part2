...
> 原文:[https://dev . to/neo/build-an-Android-messenger-app-with-online-presence-using-kot Lin-34lk](https://dev.to/neo/build-an-android-messenger-app-with-online-presence-using-kotlin-34lk)
...
## [](#building-the-backend-server)构建后端服务器
