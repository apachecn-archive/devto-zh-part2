...
> 原文:[https://dev . to/whoisryosuke/deploy-a-static-react-blog-using-gatsbyjs-and-github-45gc](https://dev.to/whoisryosuke/deploy-a-static-react-blog-using-gatsbyjs-and-github-45gc)
...
## [](#but-first-what-is-gatsbyjs)但是首先，盖茨比是什么？
...
## [](#and-what-the-heck-is-a-jamstack)还有 JAMstack 到底是个什么鬼东西？
...
## [](#grabbing-our-markdown-files)抓取我们的降价文件
...
## [](#making-pages-dynamically)动态制作页面
...
### [](#sign-up-on-github)在 Github 上注册
...
### [](#sync-up-your-repo-with-github)用 Github 同步你的回购
...
## [](#maybe-not-the-wordpress-5minute-install)也许不是 Wordpress 5 分钟安装
