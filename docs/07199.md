...
> 原文:[https://dev.to/jonhilt/learning-react 使用组件和虚拟数据构建用户界面 106d](https://dev.to/jonhilt/learning-react---building-up-the-user-interface-using-components-and-dummy-data--106d)
...
## [](#components-all-the-way-down)组件一路向下
...
## [](#building-the-user-details-row)建立用户明细行
...
## [](#map-a-bit-like-linq)地图(有点像 Linq)
