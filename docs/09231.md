...
> 原文:[https://dev . to/mason ite/mason ite-framework-tutorial-series-part-1-140 e](https://dev.to/masonite/masonite-framework-tutorial-series-part-1-140e)
...
## [](#activating-virtual-environment-optional)激活虚拟环境(可选)
