...
> 原文:[https://dev.to/florimondmanca/consuming-apis-in-angular-模型-适配器-模式-3fk5](https://dev.to/florimondmanca/consuming-apis-in-angular--the-model-adapter-pattern-3fk5)
