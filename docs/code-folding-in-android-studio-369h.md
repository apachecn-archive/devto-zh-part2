# Android Studio 中的代码折叠

> 原文：<https://dev.to/n8ebel/code-folding-in-android-studio-369h>

**[查看我的 YouTube 频道](https://www.youtube.com/c/NateEbel)T3】**

> *“关注重要的事情”*

在我们的 IDE 中工作时，有时很容易被屏幕上的所有代码淹没。为了更好地关注最重要的内容，在编辑器窗口中隐藏不重要的代码块是很有用的。

Android Studio 中的代码折叠快捷方式可以帮助我们做到这一点。

这允许我们折叠代码块&区域块，这样我们就可以在任何给定的时刻对我们正在查看的代码进行更细粒度的控制。
...
展开和折叠快捷方式允许我们快速显示或隐藏代码块或代码区域。

我们可以通过在上面的快捷方式中添加 shift 键来展开或折叠所有内容。

# 代码块

我们可以用一个扩展的代码块，比如这个匿名内部类
...
并使用折叠快捷方式在 IDE 中折叠它，这样它看起来就像这样。
...
我们失去了代码的直接视图，但是如果此时代码与我们无关，那么它实际上可以帮助减少 IDE 中的视觉噪声。

要折叠特定的代码块，请将光标放在代码块内并执行快捷方式。

如果多次运行该快捷方式，IDE 可能会继续折叠范围不断扩大的代码块，直到折叠当前文件中的所有内容。同样的逻辑也适用于扩展代码。

# 区域块

我们可以使用注释来定义自定义区域块。这些区域有助于对代码的相关部分进行文档化和分组；例如接口的实现。
...
使用 collapse 命令，我们可以折叠整个区域，这样只有区域标签在编辑器中可见。
...
关于代码折叠的更多信息，请查看我在 YouTube 上的视频
[https://www.youtube.com/embed/oyKmEc7399Q](https://www.youtube.com/embed/oyKmEc7399Q)
