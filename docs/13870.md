...
### [](#should-be-easy-to-learn-and-memorize)要易学易记。
...
### [](#adaptable-to-change-overreliance-of-design-on-implementation-details-makes-it-difficult-to-addremove-logic)适应变化。设计对实现细节的过度依赖使得添加/删除逻辑变得困难。
...
### [](#separating-out-code-that-interacts-with-different-layers-of-the-software-as-much-as-possible-for-eg-db-queries-third-party-api-calls-push-notifications-etc)尽可能分离出与软件不同层交互的代码。例如:数据库查询、第三方 API 调用、推送通知等。
...
### [](#writing-testable-code)编写可测试的代码。
