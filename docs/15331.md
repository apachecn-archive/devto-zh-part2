...
> 原文:[https://dev . to/tmclaughbos/static-websites-on-AWS-S3-with-server less-framework-21b 7](https://dev.to/tmclaughbos/static-websites-on-aws-s3-with-serverless-framework-21b7)
...
## [](#using-s3-to-host-a-static-website)利用 S3 托管一个静态网站
...
### [](#serverless-framework-setup)无服务器框架设置
...
#### [](#aws-s3-bucket-and-bucket-policy)AWS S3 斗和斗策
