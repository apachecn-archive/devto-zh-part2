...
> 原文:[https://dev . to/tmclaughbos/server less-ops-infra structure-as-code-with-AWS-server less-45en](https://dev.to/tmclaughbos/serverless-ops-infrastructure-as-code-with-aws-serverless-45en)
...
## [](#infrastructure-as-code-today)基础设施作为今天的代号
...
## [](#infrastructure-as-code-in-aws)基础设施作为 AWS 中的代码
...
### [](#what-you-can-do-today-with-serverless)使用无服务器，您今天能做什么
...
### [](#what-you-will-be-able-to-do-tomorrow)明天你能做什么
