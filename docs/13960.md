...
> 原文:[https://dev . to/net cell/programmatically-run-motive io-script-in-unity-3d-5hie](https://dev.to/netcell/programatically-run-motiveio-script-in-unity-3d-5hie)
...
# [](#anatomy-of-a-motive-script)解剖动机脚本
...
# [](#operations-on-motive-script)对动机脚本的操作
...
# [](#scriptmanager-singleton)ScriptManager Singleton
