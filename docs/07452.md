...
## [](#defining-a-data-hierarchy)定义一个数据层次

#### [](#the-chosen-technology)所选择的技术
...
#### [](#the-content-of-the-pages)页面的内容
...
## [](#rendering-the-data-as-html)将数据渲染为 HTML
