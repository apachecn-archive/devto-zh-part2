...
> 原文:[https://dev . to/darksmille 92/run-GUI-app-in-Linux-docker-container-on-windows-host-4k de](https://dev.to/darksmile92/run-gui-app-in-linux-docker-container-on-windows-host-4kde)
...
# [](#how-to-share-the-display-from-a-windows-host)如何从 windows 主机共享显示器？

## [](#install-vcxsrv-and-configure-it)安装并配置 VcXsrv
...
## [](#build-and-run-the-container)构建并运行容器
