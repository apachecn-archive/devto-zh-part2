...
> 原文:[https://dev . to/oktadev/use-typescript-to-build-a-node-API-with-express-3g8d](https://dev.to/oktadev/use-typescript-to-build-a-node-api-with-express-3g8d)
...
## [](#the-case-for-typescript)为打字稿的情况
...
## [](#build-a-guitar-inventory-application-with-typescript-and-nodejs)用 TypeScript 和 Node.js 构建一个吉他库存应用
...
## [](#create-your-nodejs-project)创建你的 Node.js 项目
...
## [](#set-up-your-nodejs-project-to-use-typescript)设置 Node.js 项目以使用 TypeScript
...
### [](#getting-the-right-types)获取正确的类型
...
## [](#build-a-better-user-interface-with-materialize-and-ejs)用物化和 EJS 构建更好的用户界面
...
### [](#add-an-asset-build-script-for-typescript)为 Typescript 添加一个资产构建脚本
...
## [](#a-better-way-to-manage-configuration-settings-in-nodejs)管理 Node.js 中配置设置的更好方法
...
## [](#easily-add-authentication-to-node-and-express)轻松给节点和快递添加认证
...
### [](#enable-selfservice-registration)启用自助注册
...
### [](#secure-your-nodejs-application)保护您的 Node.js 应用程序
...
## [](#add-a-navigation-menu-to-your-node-typescript-app)给你的 Node + Typescript App 添加导航菜单
...
## [](#create-an-api-with-node-and-postgresql)用 Node 和 PostgreSQL 创建 API

下一步是将 API 添加到吉他库存应用程序中。然而，在继续之前，您需要一种存储数据的方法。

### [](#create-a-postgresql-database)创建一个 PostgreSQL 数据库
...
### [](#database-configuration-settings)数据库配置设置
...
### [](#add-a-database-build-script)添加一个数据库构建脚本
...
### [](#add-api-routes-in-nodejs)在 Node.js 中添加 API 路由
...
## [](#update-the-user-interface-with-vue-axios-and-parcel)用 Vue、Axios 和 Parcel 更新用户界面
...
## [](#learn-more-about-node-and-typescript)了解更多关于节点和类型脚本的信息
