...
> 原文:[https://dev . to/stefannibrasil/object-oriented-programming-with-ruby-pt1-a6f](https://dev.to/stefannibrasil/object-oriented-programming-with-ruby-pt1--a6f)
...
## [](#lets-go-back-to-the-basics)让我们回到最基本的

每个开始学习 OOP 的人都会听到很多关于类、对象和实例的东西。让我们从理论上探讨一下。

#### [](#classes-objects-instances)类、对象、实例
