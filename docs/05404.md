...
> 原文:[https://dev . to/frust Igor/validate-JavaScript-data-type-in-runtime-yes-hello-type-27m](https://dev.to/frustigor/validate-javascript-data-type-in-runtime-yes-hello-type-27m)
...
## [](#survive-from-api-data-structure)从 API 数据结构中幸存
...
## [](#trace-error-without-break-program)跟踪错误而不中断程序
