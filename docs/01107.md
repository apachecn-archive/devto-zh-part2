...
> 原文:[https://dev . to/bnevilleoneill/creating-nodemon-in-node-js-2p0e](https://dev.to/bnevilleoneill/creating-nodemon-in-node-js-2p0e)
...
#### [](#getting-and-parsing-the-arguments)获取并解析参数
...
#### [](#getting-the-information-about-a-file)获取关于文件的信息
...
#### [](#watching-only-needed-files)只看需要的文件
...
#### [](#executing-the-provided-script)执行提供的脚本
