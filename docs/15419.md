...
> 原文:[https://dev . to/techiediaries/bootstrap-4-flexbox-explained-5g B4](https://dev.to/techiediaries/bootstrap-4-flexbox-explained-5gb4)
...
## [](#bootstrap-4-flex-utilities)Bootstrap 4 Flex 工具
...
## [](#bootstrap-4-display-utilities)引导程序 4 显示实用程序
