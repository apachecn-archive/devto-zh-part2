...
> 原文:[https://dev . to/fros nerd/continuous-delivery-on-AWS-with-terraform-and-Travis-ci-3914](https://dev.to/frosnerd/continuous-delivery-on-aws-with-terraform-and-travis-ci-3914)
...
# [](#remote-state-chicken-and-egg-problem)遥邦鸡和蛋的问题
...
## [](#remote-state-bootstrapping-and-configuration)远程状态引导和配置
