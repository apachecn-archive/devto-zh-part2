...
### [](#ssr-isomorphic-universal-wtf)SSR？同构？万能的？WTF？
...
### [](#why-would-i-want-to-use-react-with-server-side-rendering-in-the-first-place)为什么我首先要使用 React 进行服务器端渲染？
...
### [](#should-i-use-react-server-side-rendering)应该用 React 服务器端渲染吗？
