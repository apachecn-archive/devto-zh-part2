...
> 原文:[https://dev . to/techiediaries/bootstrap-4-card-explained-16l 1](https://dev.to/techiediaries/bootstrap-4-card-explained-16l1)
...
## [](#how-to-create-complex-card-based-layouts)如何创建复杂的基于卡片的布局？
