...
## [](#getting-a-working-graphql-application)获得一个工作的 GraphQL 应用程序！
...
## [](#moving-on-to-the-application)继续应用
...
### [](#creating-our-first-graphql-query)创建我们的第一个 GraphQL 查询
...
#### [](#designing-the-shape-of-our-data)设计我们数据的形状
...
#### [](#getting-our-database-tables-running-in-ecto)让我们的数据库表在 Ecto 中运行
...
#### [](#building-support-for-our-first-query-in-graphql)构建对 GraphQL 中第一个查询的支持
...
#### [](#sidebar-graphql-definitions)侧栏:GraphQL 定义
...
#### [](#back-to-our-implementation)回到我们的实现
...
### [](#and-finally-testing-it-out)最后，测试一下
