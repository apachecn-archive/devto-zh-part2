...
> 原文:[https://dev . to/olearycrew/using-git lab-to-project-manage-home-renewal-priorities-29n 0](https://dev.to/olearycrew/using-gitlab-to-project-manage-home-renovation-priorities-29n0)
...
### [](#trying-to-get-organized)努力变得有条理
...
### [](#enter-gitlab-issue-boards)进入 GitLab 发行板
