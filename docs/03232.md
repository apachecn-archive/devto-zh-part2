...
> 原文:[https://dev . to/twilio/set-up-a-react-app-with-a-nodejs-server-proxy-2pgc](https://dev.to/twilio/set-up-a-react-app-with-a-nodejs-server-proxy-2pgc)
...
### [](#running-the-server-and-the-react-app)运行服务器和 React app
...
### [](#using-the-proxied-server-from-react)使用 React 的代理服务器
