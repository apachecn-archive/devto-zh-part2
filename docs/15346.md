...
> 原文:[https://dev . to/muak _ x/how-to-use-a-private-nu get-server-feed-on-app-center-1 alf](https://dev.to/muak_x/how-to-use-a-private-nuget-server-feed-on-app-center--1alf)
...
## [](#3-settings-on-app-center)3。App Center 上的设置
