...
> 原文:[https://dev . to/jessa Chandler/setting-up-fast lane-when-you-not-know-you-do-1 BPH](https://dev.to/jessachandler/setting-up-fastlane-when-you-dont-know-what-you-are-doing--1bph)
...
### [](#okay-im-ready-how)好的，我准备好了，怎么样？
...
#### [](#setup-ui-tests-for-screenshots)设置 UI 测试截图
...
#### [](#try-the-screenshots-first)先试截图
...
#### [](#now-the-beta-test)现在进行 Beta 测试
