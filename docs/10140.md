...
> 原文:[https://dev.to/saiicharan/immutability-in-javascript-j0m](https://dev.to/saiicharan/immutability-in-javascript-j0m)
...
### [](#but-why-is-mutation-a-problem-in-javascript)但是，为什么 JavaScript 中突变是个问题？
...
## [](#solution-going-immutable)解决方法:去不可改变！
