...
> 原文:[https://dev . to/Lucas prag/use-case-oriented-rails-applications-28jb](https://dev.to/lucasprag/use-case-oriented-rails-applications-28jb)
...
### [](#the-user-interacts-with-the-system)用户与系统交互
...
### [](#the-delivery-mechanism-builds-a-request-model-and-passes-it-to-the-boundaryinterface)交付机制构建请求模型，并将其传递给边界/接口
...
### [](#and-the-interactor-executes-the-business-rules)交互器执行业务规则
...
### [](#and-interacts-with-entities)与实体互动
...
### [](#the-interactor-builds-a-result-model-and-give-it-back-to-the-boundaryinterface)交互器建立一个结果模型，并将其返回给边界/接口
...
### [](#which-will-give-it-back-to-the-delivery-mechanism-and-the-user)将其返还给交付机构和用户
...
## [](#as-an-user-i-want-to-pay-an-invoice)作为用户，我想支付一张发票
...
## [](#we-separated-what-the-application-has)我们把**有什么应用**分离出来

发票、账户等变化不大的模型(稳定)

## [](#of-what-the-application-does)的什么应用**做什么**

随着业务的增长，行为和用例往往会发生很大的变化

## [](#when-to-write-use-cases)何时写用例？
