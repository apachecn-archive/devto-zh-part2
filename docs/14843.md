...
> 原文:[https://dev . to/rohitpatil 5/the-matrix-calculus-you-need-for-deep-learning-notes-from-a paper-by-terence-parr-and-Jeremy-59n 7](https://dev.to/rohitpatil5/the-matrix-calculus-you-need-for-deep-learning-notes-from-a-paper-by-terence-parr-and-jeremy-59n7)

### [](#the-matrix-calculus-you-need-for-deep-learning-notes-from-a-paper-by-terence-parr-and-jeremy-howard)深度学习需要的矩阵演算(摘自[特伦斯·帕尔](http://parrt.cs.usfca.edu/)和[杰瑞米·霍华德](http://www.fast.ai/about/#jeremy)的一篇论文)
...
### [](#review-scalar-derivative-rules)复习:标量导数规则
...
### [](#introduction-to-vector-calculus-and-partial-derivatives)向量微积分与偏导数导论
...
### [](#generalization-of-the-jacobian)雅可比的概括
...
### [](#derivatives-of-vector-elementwise-binary-operators)向量元素式二元算子的导数
