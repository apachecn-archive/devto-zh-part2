...
> 原文:[https://dev . to/nburgess/creating-a-react-app-with-react-router-and-a-express-back end-33 L3](https://dev.to/nburgess/creating-a-react-app-with-react-router-and-an-express-backend-33l3)
...
# [](#create-the-express-app-backend)创建快递 App 后端
...
### [](#test-our-express-server)测试我们的快递服务器
...
### [](#adding-reactrouter)添加 React-路由器
...
### [](#calling-our-express-app)调用我们的快递 App
