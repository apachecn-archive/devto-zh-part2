...
> 原文:[https://dev . to/hasurahq/setting-a-production-ready-real time-graph QL-back end-in-just-a-minutes-13bf](https://dev.to/hasurahq/setting-up-a-production-ready-realtime-graphql-backend-in-just-a-few-minutes-13bf)
...
## [](#getting-started-with-graphql-quickly)快速入门 GraphQL
