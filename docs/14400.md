...
# [](#write-a-lambda-function)写一个 Lambda 函数
...
## [](#2-configure-your-function)2。配置您的功能
...
## [](#5-set-up-cloudwatch-events)5。设置 CloudWatch 事件
