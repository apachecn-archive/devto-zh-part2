...
## [](#what-are-the-steps-to-prepare-for-adding-a-custom-link)添加自定义链接的准备步骤有哪些？
...
### [](#step-i-configure-main-menu-module)第一步-配置主菜单模块
...
### [](#step-ii-scroll-down-to-add-a-new-link-area)第二步-向下滚动到“添加新链接”区域

您将看到“添加新链接”区域，您可以在其中添加任何自定义链接。如果您在 Prestashop 电子商务网站上使用多种语言，您可以为每种语言选择不同的 URL 地址。

### [](#step-iii-fill-the-custom-link-to-link-field-and-save)第三步-填写自定义链接到链接字段并保存
...
## [](#what-is-the-better-way)有什么更好的办法？
...
### [](#step-i-click-on-firstlevel-menu-that-you-want-to-create-custom-link)第一步-点击您想要创建自定义链接的一级菜单
...
### [](#step-ii-fill-the-custom-link-into-custom)第二步-将自定义链接填入自定义
