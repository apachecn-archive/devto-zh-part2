...
> 原文:[https://dev . to/samw software/building-an-API-with-lambdas-and-API-gateway-3k la](https://dev.to/samwsoftware/building-an-api-with-lambdas-and-api-gateway-3kla)

#### [](#want-to-access-your-database-control-your-system-or-execute-some-code-from-another-website-an-api-can-do-all-of-this-for-you-and-theyre-surprisingly-easy-to-set-up)想访问你的数据库，控制你的系统或者从另一个网站执行一些代码？一个 API 可以帮你做所有这些事情，而且它们非常容易设置。
...
#### [](#hide-your-access-keys-and-tokens)隐藏您的访问密钥和令牌
...
#### [](#setting-up-api-gateway)设置 API 网关
...
#### [](#connecting-the-lambdas-to-api-gateway)将 Lambdas 连接到 API 网关
