...
## [](#defining-some-variables)定义一些变量
...
## [](#update-all-the-repositories)更新所有储存库
...
## [](#pull-and-update-nuget-packages)拉取并更新 Nuget 包
...
## [](#pull-and-update-npm-packages)拉取和更新 npm 包
...
## [](#move-all-nuget-packages-to-the-offline-nuget-folder)将所有 Nuget 包移动到离线 Nuget 文件夹
...
## [](#enable-npm-offline-package-store)启用 NPM 线下包店
...
## [](#enable-nuget-offline-package-source)启用 Nuget 离线包源
...
## [](#putting-it-all-together-the-script)综合起来:剧本
