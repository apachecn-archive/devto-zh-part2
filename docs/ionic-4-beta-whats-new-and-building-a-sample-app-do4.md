# Ionic 4 Beta:新特性和构建示例应用程序

> 原文：<https://dev.to/auth0/ionic-4-beta-whats-new-and-building-a-sample-app-do4>

在本文中，您将了解 Ionic 4 的新功能、现有功能的变化、如何将 Ionic 3 应用程序迁移到 Ionic 4 应用程序，以及如何将 Ionic 与模板和电容器结合使用。最后，您将使用 Ionic 4 创建一个简单的应用程序来查看这个框架的新版本。
