...
# [](#1-talk-to-wikidata-and-retrieve-information)1。与维基数据对话并检索信息
...
# [](#2-grab-one-of-the-deaths-and-create-a-sentence)2。抓住其中一个死亡，创造一个句子
...
# [](#post-that-sentence-to-twitter-in-the-account-wikidatabot)把那句话发布到账户 wikidatabot 的 twitter 上
...
# [](#4-throw-it-all-into-a-docker-container)4 把它全部扔进一个 docker 容器
...
## [](#things-that-could-be-done-better)可以做得更好的事情:
