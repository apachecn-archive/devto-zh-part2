...
> 原文：<https://dev.to/darthvid/programming-in-anime-11ci>

当编程在大多数节目中被描绘时，特别是在动画中，它通常显示有人在键盘上疯狂地打字。屏幕要么显示最终输出，要么是胡言乱语。如果有任何对实际语言或堆栈的引用，就像在新游戏中一样！动漫，都是典型的背景。
...
上面的剪辑可能会让你回想起你第一次玩代码的时候，你明显看到它在屏幕上做的事情。啊，我们多么容易被冲昏头脑...！

有时候，它还是会发生。:P

你在动画中遇到过现实生活中的编程语言或者技术栈吗？