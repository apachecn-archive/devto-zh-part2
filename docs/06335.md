...
## [](#video-breakdown)视频击穿

在本节中，我们将跟随视频，我将描述每个命令的作用。大多数命令要求您以根用户的身份运行它们。

### [](#make-mount-private)使坐骑私有
...
### [](#testing-using-chroot)使用 chroot 进行测试
...
## [](#links-further-reading)链接/进一步阅读
