...
> 原文:[https://dev . to/mitchjacksontech/auto-generate-a-database-schema-diagram-be3](https://dev.to/mitchjacksontech/auto-generate-a-database-schema-diagram-be3)

# [](#generate-a-live-database-schema-diagram-for-your-catalyst-application)为您的 Catalyst 应用生成实时数据库模式图
