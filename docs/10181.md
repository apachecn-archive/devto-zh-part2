...
> 原文:[https://dev . to/oktadev/add-auth-to-your-pwa-with-okta-and-stencil-1 lam](https://dev.to/oktadev/add-auth-to-your-pwa-with-okta-and-stencil-1lam)
...
## [](#set-up-the-starter-application)设置启动程序
...
## [](#set-up-your-okta-application)设置您的 Okta 应用程序
...
## [](#add-the-authentication-component)添加认证组件
...
## [](#add-the-login-methods-dependencies)添加登录方法的依赖项
...
## [](#update-the-profile-page)更新个人资料页面
