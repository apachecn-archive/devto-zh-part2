...
## [](#what-is-html5-canvas)什么是 HTML5 画布？
...
## [](#lets-see-a-canvas-markup-code)让我们来看一个画布标记代码
...
## [](#how-to-draw-on-a-canvas)如何在画布上画画
...
<html>
<head>
<title>JavaScript HTML5 Canvas Example</title> </head> <body onload="canvasExample()">
