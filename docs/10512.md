...
#### [](#create-and-then-copy-a-keystore-file-to-androidapp)创建并复制一个密钥库文件到 android/app

```
keytool -genkey -v -keystore mykeystore.keystore -alias mykeyalias -keyalg RSA -keysize 2048 -validity 10000 
```

#### [](#setup-your-gradle-variables-in-androidgradleproperties)在 android/gradle.properties 中设置你的 gradle 变量
...
#### [](#add-signing-config-to-androidappbuildgradle)添加签名配置到 android/app/build.gradle
...
#### [](#generate-your-release-apk)生成你的释放 APK:
