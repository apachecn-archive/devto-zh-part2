...
> 原文:[https://dev . to/tech community/how-to-call-cobol-on-IBM-I-as-400-from-integration-server-42i 5](https://dev.to/techcommunity/how-to-call-cobol-on-ibm-i-as-400-from-integration-server-42i5)
...
## [](#extract-the-interface-of-the-cobol-server-subprogram)提取 COBOL 服务器子程序的接口
...
## [](#generate-is-service-and-is-connections)生成 IS 服务和 IS 连接
...
## [](#test-is-service-to-cobol-server-on-as400)测试是服务于 AS/400 上的 COBOL 服务器
