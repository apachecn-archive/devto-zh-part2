...
> 原文:[https://dev.to/stefanjudis/faster-static-site-builds-part-1-只处理你所需要的-2j70](https://dev.to/stefanjudis/faster-static-site-builds-part-1--process-only-what-you-need-2j70)
...
## [](#beautiful-image-placeholder-with-sqip)美丽的 SQIP 形象占位符
...
## [](#generation-of-preview-images-using-sqip)使用 SQIP 生成预览图像
...
## [](#fetch-all-assets-from-contentful)从 Contentful 获取所有资产
...
### [](#download-images-to-create-svgs)下载图片创建 SVG
...
### [](#define-a-caching-folder-locally-and-in-netlify)在本地和网络中定义一个缓存文件夹
...
### [](#check-of-existent-generated-files)检查已存在的生成文件
...
### [](#generation-of-new-preview-svgs)生成新的预览 SVG
...
## [](#think-of-a-kill-switch-clearing-the-cache)想象一个终止开关——清除缓存
