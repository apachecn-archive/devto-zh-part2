...
> 原文:[https://dev . to/Kyle parisi/understanding-AWS-lambda-qualifiers-16nc](https://dev.to/kyleparisi/understanding-aws-lambda-qualifiers-16nc)

# [](#heres-the-scenario)场景如下
...
### [](#the-code)[代码](https://github.com/kyleparisi/cloudwatch-logs-slack)
