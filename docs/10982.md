...
> 原文:[https://dev . to/tomoyukiaota/visualizing-the-patterns of-missing-value-occurrence with-python-46dj](https://dev.to/tomoyukiaota/visualizing-the-patterns-of-missing-value-occurrence-with-python-46dj)

###### [](#a-japanese-translation-is-available-here)(此处有日文翻译[。)](https://qiita.com/TomoyukiAota/items/fd75c28b802bad9e6632)
...
# [](#method-1-seabornheatmap)方法一:seaborn.heatmap
...
# [](#method-2-missingno-module)方法二:[缺少](https://github.com/ResidentMario/missingno)模块
