...
> 原文:[https://dev . to/Dan _ MCM _/the-inspiration-API-a-project-build-with-Scala-play-framework-195d](https://dev.to/dan_mcm_/the-inspiration-api-a-project-built-with-scala--play-framework-195d)
...
## [](#handling-json-in-scala)在 Scala 中处理 JSON
