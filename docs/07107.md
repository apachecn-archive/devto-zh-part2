...
> 原文:[https://dev . to/r0 f1/a-simple-way-to-anonymous-data-with-python-and-pandas-79g](https://dev.to/r0f1/a-simple-way-to-anonymize-data-with-python-and-pandas-79g)
...
### [](#anonymizing-by-sampling-from-the-same-distribution)从同一分布中抽样匿名
...
#### [](#treatment-of-nominalcategorical-variables)名词性/类别性变量的处理
...
#### [](#treatment-of-continuous-variables)连续变量的处理
...
#### [](#putting-the-codes-into-one-function)将代码放入一个函数中
