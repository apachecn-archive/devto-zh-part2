...
> 原文:[https://dev.to/digitaledawn/nightwatch-browserstack-5f5a](https://dev.to/digitaledawn/nightwatch-browserstack-5f5a)

### [](#vue-cli-2-nightwatch-browserstack)Vue cli 2:夜视+浏览器堆栈
...
### [](#configuring-browserstack-to-only-run-on-testprod-environments)将 Browserstack 配置为仅在测试/生产环境中运行
...
#### [](#1-runnerjs-updates)1。Runner.js 更新
...
#### [](#2-nightwatch-config-updates)2。守夜人配置更新
...
#### [](#3-update-test-status-in-browserstack-through-api)3。通过 API 更新 Browserstack 中的测试状态
