...
> 原文:[https://dev . to/progress telerik/master-time-with-the-kendo-ui-for-angular-scheduler-4746](https://dev.to/progresstelerik/master-time-with-the-kendo-ui-for-angular-scheduler-4746)
...
### [](#the-schedulerevent-class)调度事件类
...
## [](#time-zones-amp-globalization)时区&全球化
