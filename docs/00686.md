...
> 原文:[https://dev . to/Kyle parisi/technical-interview-wit-robin-malfait-4ne 6](https://dev.to/kyleparisi/technical-interview-with-robin-malfait-4ne6)

我今天尝试一些不同的东西。我曾经在 twitch 上直播过流媒体 web 开发。在那段时间里，我只吸引了几个观众。其中一个观众变成了永久的友谊。比利时的罗宾·马尔费特。罗宾的编程能力总是给我留下深刻的印象。这是一篇关于他编程经历的采访。

### [](#give-me-a-brief-story-of-who-you-are)简单说说你是谁。
...
### [](#what-are-your-thoughts-on-react-vs-vuejs)你对 react vs vuejs 有什么看法？
...
### [](#but-wasnt-there-rules-like-no-forwhile-loops)但是不是有“不允许 for/while 循环”之类的规则吗？
...
### [](#and-how-do-you-feel-about-it-now)那你现在感觉如何？
...
### [](#are-there-any-lesser-known-tools-that-you-use-daily)您日常使用的工具中有哪些不太为人所知？
...
### [](#do-you-follow-tdd-or-write-tests-in-general)一般是遵循 TDD 还是写测试？
...
### [](#for-the-beginners-in-web-development-what-kind-of-advice-would-you-give-them)对于 web 开发的初学者，你会给他们什么样的建议？
...
### [](#where-can-people-learn-more-about-you-you-live-stream-sometimes-as-well-right)哪里可以让别人更了解你？你有时也住在溪流里，对吗？
