...
### [](#one-option-loop-through-all-the-things)一个选项:循环遍历所有的东西。

我们*可以*做一些事情，比如获取所有的帖子，然后在我们的 PHP 中循环每一个检索到的帖子，过滤掉特定字符数下的帖子。但是，与我们现有的另一种选择相比，这种方法效率较低，而且有点麻烦。

### [](#better-option-use-the-postswhere-filter-to-modify-the-where-clause-in-your-wpquery)更好的选择:使用‘posts _ where’过滤器来修改 WP_Query 中的‘where’子句。
...
### [](#when-am-i-ever-going-to-need-this)“我什么时候会需要这个？”

我不知道。我们谈论的这个 WordPress 开发项目。时刻准备着。

### [](#this-doesnt-make-me-feel-very-good)“这让我感觉不太好。”
