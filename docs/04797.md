...
##### [](#you-need-to-install-docker-and-dockercompose-to-follow)需要安装 Docker 和 Docker-compose 才能跟随

### [](#first-write-a-simple-express-server)首先，写一个简单的快递服务器
...
### [](#next-lets-add-database-connection-and-write-the-schema)接下来让我们添加数据库连接并编写模式
...
### [](#next-lets-make-a-simple-raw-ejs-endraw-view)接下来让我们来简单的看一下 **`ejs`**
...
### [](#next-we-create-the-post-route-and-render-the-view)接下来我们创建发布路线并渲染视图
...
### [](#now-lets-dive-into-docker)现在让我们潜入 docker
...
### [](#next-we-need-to-create-the-docker-compose)接下来我们需要创建 docker compose
...
### [](#next-we-need-to-change-the-path-to-connect-to-mongodb)接下来我们需要更改连接到 MongoDB 的路径
...
#### [](#now-moment-of-truth)现在真相大白的时刻

##### [](#run-this-command-in-your-terminal)在你的终端运行这个命令
...
##### [](#to-stop-it-hit-raw-ctlc-endraw-)住手，打`ctl+c`

##### [](#if-you-have-it-runing-in-background-type-raw-dockercompose-stop-endraw-to-stop-it)如果你在后台运行它，输入`docker-compose stop`停止它。

##### [](#to-remove-both-containers-run-dockercompose-down)删除两个容器运行 docker-compose down
