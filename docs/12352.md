...
> 原文:[https://dev . to/sense deep/immutable-infra structure-can-draulic-more-secure-1nm 0](https://dev.to/sensedeep/immutable-infrastructure-can-be-dramatically-more-secure-1nm0)
...
## [](#mutability-the-vector-for-compromise)易变性，为妥协之矢
