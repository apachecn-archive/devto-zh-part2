...
#### [](#example-1-raw-ssplit-endraw-)例一:`s.split(/-/)`
...
#### [](#example-2-raw-ssplit-endraw-)例二:`s.split(/(-)/)`
...
#### [](#example-3-raw-ssplit-endraw-)例三:`s.split(/(-|\+)/)`
...
#### [](#the-final-boss-tying-everything-together)最终 Boss(把一切绑在一起)
