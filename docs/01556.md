...
> 原文:[https://dev.to/nickpad/modern-html-to-pdf-conversion-31i0](https://dev.to/nickpad/modern-html-to-pdf-conversion-31i0)
...
## [](#the-tried-and-tested-approaches)屡试不爽的方法
...
## [](#controlling-chrome-with-puppeteer)用木偶师控制铬
...
### [](#using-puppeteer-with-chrome-on-your-own-server)在自己的服务器上用 Chrome 操作木偶
...
### [](#using-puppeteer-via-browserlessio)通过 browserless.io 使用木偶师
...
### [](#using-puppeteer-via-google-cloud-functions)通过谷歌云功能使用木偶师
...
## [](#creating-your-own-pdf-microservice)创建自己的 PDF 微服务
...
## [](#generating-pdfs-using-a-cloud-api)使用云 API 生成 pdf
...
## [](#finegrained-control%E2%80%8A%E2%80%8Aadvanced-typesetting-features)细粒度控制——高级排版功能
