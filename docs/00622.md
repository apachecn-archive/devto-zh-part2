...
# [](#using-qt-from-python)使用来自 Python 的 Qt
...
# [](#installing-qt-for-python)为 Python 安装 Qt
...
# [](#positioning-gui-elements)定位 GUI 元素
...
# [](#running-your-app-on-other-computers)在其他电脑上运行你的应用
