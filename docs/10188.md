...
> 原文:[https://dev . to/antogarand/JavaScript-async-maths-is-hard-5b6i](https://dev.to/antogarand/javascript-async-maths-is-hard-5b6i)
...
### [](#solution-1-awaiting-in-a-variable)方案一:在变量中等待
...
### [](#solution-2-adding-to-x-after-awaiting)方案二:等待后添加到 X
