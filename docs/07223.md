...
### [](#about-the-but-it-looks-different-on-the-specs-effect-ui-toolkits-and-other-stuff)关于‘但是在规格上看起来不一样’的效果，UI 工具包和其他东西。
...
### [](#a-kind-of-a-typical-scenario)一种典型的场景
...
### [](#frustrated-designers-frustrated-developers)失意的设计师，失意的开发者。
...
### [](#why-you-really-need-a-good-ui-toolkit)为什么你真的需要一个好的 UI 工具包
...
### [](#why-you-need-your-own-ui-toolkit)为什么您需要自己的 UI 工具包
...
#### [](#theme-define-the-constants)主题，定义常量
...
#### [](#plug-the-theme-into-your-app)将主题插入你的应用程序
...
#### [](#create-basic-ui-components)创建基本 UI 组件
...
#### [](#more-specialised-ui-components)更专业的 UI 组件
...
#### [](#implement-ui-components-in-your-feature-files)在你的特征文件中实现 UI 组件
...
#### [](#time-to-render-something)渲染某物的时间
