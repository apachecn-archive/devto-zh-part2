...
> 原文:[https://dev . to/NBA u21/writing-code-that-make-your-teammate-lifes-easy-2e 8](https://dev.to/nbau21/writing-code-that-makes-your-teammates-lives-easier-2e8)
...
### [](#add-comments-to-hacky-implementations)给 hacky 实现添加注释
...
### [](#write-self-documenting-code-variables-methods-classes-instead-of-adding-comments)编写自我记录的代码/变量/方法/类，而不是添加注释
