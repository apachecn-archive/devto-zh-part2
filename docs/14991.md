...
> 原文:[https://dev.to/heroku/dissecting-kubernetes-deployments-16ej](https://dev.to/heroku/dissecting-kubernetes-deployments--16ej)
...
## [](#a-triggerbased-system)基于触发器的系统
...
### [](#a-deployment-is-created)一个部署被创建
...
### [](#a-replicaset-is-updated)副本集被更新
...
### [](#a-replicaset-is-deleted)一个副本集被删除
...
### [](#the-deployment-is-finished)部署完毕
