...
> 原文:[https://dev . to/dmerejkowsky/porting-to-pytest-a-practical-example-12hm](https://dev.to/dmerejkowsky/porting-to-pytest-a-practical-example-12hm)
...
# [](#starting-point-using-tests-from-the-documentation)起点:使用文档中的测试
...
# [](#step-one-setup-pytest)第一步:设置 pytest
...
# [](#step-two-rewrite-assertions)第二步:重写断言
...
# [](#step-three-move-code-out-of-classes)第三步:将代码移出类
...
# [](#step-four-get-rid-of-doc-strings)第四步:去掉文档串
...
# [](#step-five-fun-with-selenium)第五步:硒的乐趣

## [](#selenium-basics)硒基础知识
...
## [](#the-live-server-test-case)现场服务器测试案例
...
## [](#launching-the-driver-only-once)只启动一次驱动程序
