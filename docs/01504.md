...
> 原文:[https://dev . to/Aral roca/don t-control-everything-react-forms-4d 9](https://dev.to/aralroca/dont-control-everything-react-forms-4d9)
...
### [](#difference-between-controlled-and-uncontrolled)受控与非受控的区别
...
### [](#improving-the-uncontrolled-way)改善不受控制的方式
