...
> 原文:[https://dev . to/dormo she/prepare-your-skill-set-for-web-developer-visities-part-1-ig1](https://dev.to/dormoshe/prepare-your-skill-set-for-web-developer-interviews---part-1-ig1)
...
## [](#javascript-is-single-threaded)JavaScript 是单线程的
...
## [](#event-loop-call-stack-queue-heap)事件循环，调用堆栈，队列，堆
...
## [](#asynchronous%E2%80%8A%E2%80%8Acallbacks-promises-asyncawait-and-generators)异步—回调、承诺、异步\等待和生成器
