...
> 原文:[https://dev.to/kodekage/git-backend-behind-the-scene-12l5](https://dev.to/kodekage/git-backend-behind-the-scene-12l5)
...
### [](#git-frontend-what-you-already-know)GIT 前端(你已经知道的)
