...
## [](#generating-project-structure)生成项目结构
...
## [](#installing-code-bundler)安装代码捆绑器
...
### [](#defining-npm-script-and-running-the-bundler)定义 npm 脚本并运行捆绑器
...
## [](#calling-purescript-from-javascript)从 JavaScript 调用 PureScript
