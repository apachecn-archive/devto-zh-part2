...
> 原文:[https://dev.to/twilio/screen-capture-in-microsoft-edge-14f4](https://dev.to/twilio/screen-capture-in-microsoft-edge-14f4)
...
*   为本地主机设置的 [](https://ngrok.com/) [ngrok](https://ngrok.com/) 或等效的隧道服务或 TLS 证书(我们稍后会看到原因)
