...
> 原文:[https://dev . to/bnevilleoneill/the-complete-guide-to-using-local storage-in-JavaScript-apps-3jc 1](https://dev.to/bnevilleoneill/the-complete-guide-to-using-localstorage-in-javascript-apps-3jc1)
...
#### [](#localstorage-javascript-limitations)LocalStorage JavaScript 限制
