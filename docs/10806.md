...
> 原文:[https://dev . to/fros nerd/手写数字识别使用卷积神经网络-11g0](https://dev.to/frosnerd/handwritten-digit-recognition-using-convolutional-neural-networks-11g0)
...
# [](#handwritten-digit-recongition)手写数字识别
