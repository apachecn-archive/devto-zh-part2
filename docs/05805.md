...
> 原文:[https://dev . to/k1r0s/idiomatic-JavaScript-back end-part-1-4g0b](https://dev.to/k1r0s/idiomatic-javascript-backend-part-1-4g0b)
...
# [](#1-preparing-the-environment)1。准备环境
...
# [](#2-connecting-a-persistence-layer)2。连接持久层
...
# [](#3-improving-the-project-structure)3。改善项目结构
