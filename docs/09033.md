...
> 原文:[https://dev . to/alshakero/the-true-delight-of-reactions-error-and-warning-messages-168j](https://dev.to/alshakero/the-true-delight-of-reacts-error-and-warning-messages-168j)
...
### [](#3-a-little-obvious-one)3。有点明显的一个
...
### [](#6-the-beginners-rescuer)6。初学者的救助者
...
### [](#7-ok-i-fixed-it-but-it-still-doesnt-work)7。好的，我修好了，但是它还是不能用
...
### [](#8-a-very-common-mistake-in-the-first-couple-days)8。在最初的几天里，这是一个很常见的错误
...
### [](#9-why-dont-you-come-back)9。你为什么不回来？🎼
...
## [](#10-and-the-one-that-doesnt-need-an-example)10。不需要例子的是:
