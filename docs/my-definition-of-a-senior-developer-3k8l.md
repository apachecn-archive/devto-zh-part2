...
> 原文：<https://dev.to/mokkapps/my-definition-of-a-senior-developer-3k8l>
...
例如，许多人使用 Angular CLI，但不熟悉幕后发生的所有步骤。或者使用 Angular with TypeScript，但不知道如何读取缩小的捆绑代码中的 JavaScript 代码。
