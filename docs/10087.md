...
> 原文:[https://dev . to/wia io/setup-an-arduino-mkr-fox-1200-and-publish-an-event-to-wia-979](https://dev.to/wiaio/setup-an-arduino-mkr-fox-1200-and-publish-an-event-to-wia-979)
...
### [](#connect-the-board-to-your-computer)**将板卡连接到电脑上**
...
### [](#receiving-the-message-on-sigfox-dashboard)**接收 Sigfox 仪表盘上的消息**
