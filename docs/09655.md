...
> 原文:[https://dev . to/peterj/traffic-routing-between-functions-using-fn-project-and-istio-2619](https://dev.to/peterj/traffic-routing-between-functions-using-fn-project-and-istio-2619)
...
## [](#istio-routing-101)Istio 路由 101
...
## [](#create-and-deploy-functions)创建和部署功能
...
### [](#but-where-does-the-function-run)但是函数在哪里运行呢？
