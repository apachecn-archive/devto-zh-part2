...
> 原文:[https://dev . to/oktadev/build-user-registration-with-node-react-and-okta-3944](https://dev.to/oktadev/build-user-registration-with-node-react-and-okta-3944)
...
## [](#install-the-node-and-react-prerequisites)安装节点和反应先决条件
...
## [](#scaffold-the-base-application)脚手架底座应用
...
## [](#add-an-okta-application)添加一个 Okta 申请
...
## [](#add-authentication-to-the-reactjs-application)向 ReactJS 应用程序添加身份验证
...
## [](#add-pages-to-the-reactjs-app)向 ReactJS 应用程序添加页面
...
## [](#add-routes-to-the-react-app)向 React 应用添加路线
...
## [](#add-api-endpoints-to-the-node-app)向节点 App 添加 API 端点
