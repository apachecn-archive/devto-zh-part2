...
> 原文:[https://dev . to/oktadev/build-a-react-native-application-and-authenticate-with-oauth-20-3c bk](https://dev.to/oktadev/build-a-react-native-application-and-authenticate-with-oauth-20-3cbk)
...
## [](#create-your-react-native-application)创建你的 React 原生应用
...
## [](#react-native-and-oauth-20)React Native 和 OAuth 2.0
...
### [](#create-native-application-in-okta)在 Okta 创建原生应用
...
### [](#add-react-native-appauth-for-authentication)添加 React Native AppAuth 进行认证
...
## [](#build-your-react-native-app)构建您的 React 原生应用
...
### [](#run-on-ios-simulator)运行在 iOS 模拟器上
...
### [](#upgrade-to-the-latest-release-of-react-native)升级至 React Native 最新版本
...
### [](#get-and-view-an-id-token)获取并查看 ID 令牌
...
### [](#call-an-api-with-your-access-token)用你的访问令牌调用 API
...
## [](#learn-more-about-react-native-and-react)了解更多关于 React Native 和 React
