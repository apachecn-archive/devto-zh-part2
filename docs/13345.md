...
## [](#about-the-json-api)关于 JSON API
...
### [](#step-one-linking-graphql-to-express)第一步:连接 GraphQL 到 Express
...
### [](#step-two-create-api-endpoint-for-new-movies)第二步:为新电影创建 API 端点
...
### [](#step-three-get-information-for-a-single-movie)第三步:获取单部电影的信息
...
## [](#step-five-credits-and-reviews)第五步:学分和点评
