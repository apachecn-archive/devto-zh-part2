...
> 原文:[https://dev . to/bright devs/working-with-IOs-push-notifications-1a 73](https://dev.to/brightdevs/working-with-ios-push-notifications--1a73)
...
#### [](#to-enable-push-notifications-service-in-application-identifier)在应用标识符中启用推送通知服务:
...
#### [](#to-generate-raw-apns-ssl-certificate-endraw-on-apple-developer-center)生成`APNs SSL Certificate`[苹果开发者中心](https://developer.apple.com):
