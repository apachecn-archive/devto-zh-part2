...
一种*开放标准的*文件格式，使用人类可读的文本来传输由属性-值对和数组数据类型(或任何其他可序列化的值)组成的数据对象。 **JSON** 是一种独立于语言的数据格式。它源于 **JavaScript** ，但截至 *2017* 许多编程语言都包含生成和解析 **JSON** 格式数据的代码。 **JSON** 的官方互联网媒体类型为*应用/json* 。 **JSON** 文件名使用扩展名*。json* 。
