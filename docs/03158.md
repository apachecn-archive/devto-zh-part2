...
> 原文:[https://dev . to/oktadev/build-a-simple-web-app-with-express-react-and-graph QL-5cc 2](https://dev.to/oktadev/build-a-simple-web-app-with-express-react-and-graphql-5cc2)
...
## [](#create-the-graphql-server)创建 GraphQL 服务器
...
## [](#connect-react-to-graphql)连接 React 到 GraphQL
...
## [](#add-the-ability-to-edit-posts-in-graphql)增加了在 GraphQL 中编辑帖子的能力
...
## [](#add-user-authentication-to-the-react-graphql-web-app)向 React + GraphQL Web 应用添加用户认证
...
## [](#add-user-authentication-to-the-server)向服务器添加用户认证
...
## [](#learn-more-about-graphql-react-express-and-web-security)了解有关 GraphQL、React、Express 和 Web 安全的更多信息
