# ruby on Rails——使用 Docker 的黑仔工作流(第 1 部分)

> 原文：<https://dev.to/auth0/ruby-on-railskiller-workflow-with-docker-part-1-42j0>

在本文中，您将了解如何使用带有外部身份管理的 Ruby on Rails 建立一个 dockerized 工作流来引导一个全栈、数据库驱动的应用程序。
