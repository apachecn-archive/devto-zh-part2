...
> 原文:[https://dev . to/Ben/how-dev to-dynamically-generates-social-images-2c2n](https://dev.to/ben/how-devto-dynamically-generates-social-images--2c2n)
...
### [](#here-is-an-example-twitter-card-for-a-discuss-post)这是一个#讨论帖子的 Twitter 卡片示例
...
## [](#other-approaches-we-could-take)我们可以采取的其他方法

### [](#generate-the-image-with-html-and-then-using-a-service-to-take-a-screengrab)用 HTML 生成图像，然后使用服务进行截屏

这将给我们更多的灵活性和对设计的控制。我认为这将是我们理想的方法。Cloudinary 本身以插件的形式提供这项服务，但我们还没有转而使用它。

### [](#dynamically-generating-an-image-on-our-server)在我们的服务器上动态生成图像。
...
### [](#services-like-sharemeow)服务如[分享喵](https://github.com/producthunt/ShareMeow)
...
# [](#the-other-interesting-part-of-the-whole-process)整个过程中另一个有趣的部分
