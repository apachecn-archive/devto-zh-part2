# 用 Hapi.js、Node.js 和 Redis 开发现代 api

> 原文：<https://dev.to/auth0/developing-modern-apis-with-hapijs-nodejs-and-redis-39ic>

在本文中，您将学习如何使用 Hapi.js 和 Node.js 开发现代 api，同时使用 Redis 作为持久层。
