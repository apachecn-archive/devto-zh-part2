...
> 原文:[https://dev . to/origamium/create-reactelectron-application-in-quickly-36nl](https://dev.to/origamium/create-reactelectron-application-in-quickly--36nl)

你好。 省去开场白，马上做。

# [](#create-application)创建应用程序

## [](#01-createreactapp)01:创建-反应-应用

首先是创建就绪应用程序。 如果没有的话请做`npm install -g create-react-app`。
如果顺利的话，用`yarn start`启动吧。 做了吗？ 确认顺利后马上停止作业吧。 再也不会执行`yarn start`了。

## [](#02-install-some-package)02:安装一些包
...
## [](#03-setting-up-electron)03:设置电子
...
## [](#04-packagejson)04: package.json
...
# [](#explanation-create-application)解释创建应用程序
...
# [](#05-delete-unnecessary-files)05 删除不必要的文件
...
## [](#07-zipping-application)07 拉链申请
...
# [](#explanation-build-and-release)解释构建和发布

## [](#why-moved-all-package-from-dependencies-to-devdependenciesits-important)为什么把所有的包从依赖项移到依赖项？(很重要！)
...
## [](#why-dont-use-raw-ignore-endraw-option-in-electronpackager)电子打包机为什么不用`--ignore`选项？
