...
> 原文:[https://dev . to/data matin/all-you-need-for-work-with-python-3-on-a-MAC-2j7b](https://dev.to/datamatin/all-you-need-for-working-with-python-3-on-a-mac-2j7b)
...
### [](#do-1-download-and-install-python-3xx)DO #1:下载并安装 Python 3.x.x
 ...
 **#### [](#gtgtgt-what-if-your-os-is-older-than-109)> > >你的 OS 比 10.9 老怎么办？
...
### [](#dont-1-install-anaconda)不要#1:安装蟒蛇
...
### [](#dont-2-install-homebrew)不要#2:安装自制软件
...
### [](#dont-3-install-pip)不要#3:安装 pip
