...
### [](#1-how-to-find-programs-for-specific-tasks)1。如何找到特定任务的程序
...
### [](#2-find-out-what-a-program-does)2。找出一个程序做什么
...
### [](#3-getting-detailed-information-about-a-program)3。获取程序的详细信息
...
### [](#4-getting-examples-for-using-a-program)4。获取使用程序的示例
