...
> 原文:[https://dev . to/kball/how-web assembly-is-accelerating-the-future-of-web-development-MNP](https://dev.to/kball/how-webassembly-is-accelerating-the-future-of-web-development-mnp)
...
### [](#webassembly-enables-extremely-fast-web-applications)WebAssembly 支持极速 Web 应用
...
### [](#webassembly-will-enable-parallelism)WebAssembly 将启用并行性
