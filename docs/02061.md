...
> 原文:[https://dev . to/krit ner/updating-Orleans-project-to-be-more-ready-for-new-Orleans-examples-41n 2](https://dev.to/kritner/updating-orleans-project-to-be-more-ready-for-new-orleans-examples-41n2)
...
#### [](#a-collection-of-orleans-features-to-list)一组新奥尔良特色列表
...
#### [](#a-way-to-display-the-features-and-a-way-to-execute-a-feature)“一种显示特征的方式”和“一种执行特征的方式”
...
#### [](#a-way-for-the-user-to-try-multiple-features-and-exit-from-the-menu)供用户尝试多种功能，并从菜单中退出
