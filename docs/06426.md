...
> 原文:[https://dev.to/ghost/level-up-unix-timestamp-5hnm](https://dev.to/ghost/level-up-unix-timestamp-5hnm)
...
# [](#what-is-the-unix-timestamp)什么是 UNIX 时间戳？
...
## [](#trials-of-working-with-timestamps)用时间戳工作的尝试

时间戳对计算机和任何协调系统来说都很好，但对人类来说就没那么容易了。因此，任何使用时间戳的人都需要注意几个陷阱。一旦你掌握了这些，你就会爱上时间戳。

### [](#pitfall-1-conversion-to-datetime)陷阱 1:日期/时间转换
...
### [](#pitfall-3-synchronization)陷阱三:同步
