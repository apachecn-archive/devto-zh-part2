...
## [](#why-do-we-need-a-buffer)我们为什么需要缓冲？
...
## [](#how-to-create-a-buffer)如何创建缓冲区
...
## [](#using-a-buffer)使用缓冲器

### [](#access-the-content-of-a-buffer)访问一个缓冲区的内容
...
### [](#get-the-length-of-a-buffer)获取一个缓冲区的长度
...
### [](#iterate-over-the-contents-of-a-buffer)迭代缓冲区的内容
...
### [](#changing-the-content-of-a-buffer)改变缓冲区的内容
