...
> 原文:[https://dev . to/juttayaya/add-hard-disk-to-VMware-centos-7-VM-22 M8](https://dev.to/juttayaya/add-hard-disk-to-vmware-centos-7-vm-22m8)
...
## [](#assign-hard-disk-in-vsphere)在 vSphere 中分配硬盘
...
## [](#configure-new-hard-disk-in-centos)以 CentOS 为单位配置新硬盘
