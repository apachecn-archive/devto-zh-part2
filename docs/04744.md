...
### [](#copy-files-from-a-pod-to-your-machine)将文件从 pod 复制到机器上
...
### [](#copy-files-to-a-pod)将文件复制到 pod
...
### [](#copy-files-from-a-docker-container-to-your-machine)将文件从 docker 容器复制到您的机器上
...
### [](#copy-files-to-a-docker-container)将文件复制到 docker 容器中
