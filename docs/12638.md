...
> 原文:[https://dev.to/raymondcamden/til 用 visual studio-code-4b6c 将节点应用程序推送到 azure](https://dev.to/raymondcamden/til---pushing-node-apps-to-azure-with-visual-studio-code-4b6c)
...
### [](#deploy-to-azure-using-app-service)[使用应用服务部署到 Azure】](https://code.visualstudio.com/tutorials/app-service-extension/getting-started)
