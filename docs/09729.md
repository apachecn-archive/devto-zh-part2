...
> 原文:[https://dev . to/markoa/setting-up-a-BDD-stack-on-a-rails-5-application-4dn 6](https://dev.to/markoa/setting-up-a-bdd-stack-on-a-rails-5-application-4dn6)
...
## [](#bootstrapping-a-rails-application)引导 Rails 应用程序
...
## [](#installing-shouldamatchers)安装匹配器
...
### [](#installing-the-database-cleaner)安装数据库清理器
...
### [](#setting-up-the-rails-controller-testing-gem)设置 Rails 控制器测试 gem
...
### [](#setting-up-continuous-integration)设置持续集成
