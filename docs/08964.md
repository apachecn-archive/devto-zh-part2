...
# [](#3-add-a-custom-splash-screen)3。添加自定义闪屏
...
# [](#4-change-the-status-bar)4。更改状态栏
...
# [](#5-give-it-a-short-name)5。给它一个简短的名字
...
## [](#62-disable-highlighting)6.2。禁用高亮显示
