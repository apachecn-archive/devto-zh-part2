...
## [](#find-the-necessary-objects-with-the-sql-query)用 SQL 查询找到需要的对象
...
## [](#functions-clobtoblob-and-getsource)函数 clob_to_blob 和 get_source
...
[![](../Images/d555b2bc2f24635314504f40ec8d2deb.png)T3】](https://res.cloudinary.com/practicaldev/image/fetch/s--49vy5Pme--/c_limit%2Cf_auto%2Cfl_progressive%2Cq_auto%2Cw_880/https://thepracticaldev.s3.amazonaws.com/i/6lx50abvfw30we4ocm32.png)