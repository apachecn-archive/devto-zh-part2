...
> 原文:[https://dev . to/take shape/publish-a-jam stack-site-to-net lify-with-take shape-4f 97](https://dev.to/takeshape/publish-a-jamstack-site-to-netlify-in-less-than-2-minutes-with-takeshape-4f97)
...
## [](#connect-your-takeshape-project-to-netlify)将您的 TakeShape 项目连接到 Netlify
...
## [](#deploy-your-static-site-to-netlify)将静态站点部署到网络
...
## [](#interested-in-cms-for-static-websites)对静态网站的 CMS 感兴趣？
