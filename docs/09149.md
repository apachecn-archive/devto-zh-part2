...
## [](#helm-and-its-security-options)舵及其安全选项
...
## [](#what-is-the-problem-with-tiller-releases)分蘖释放有什么问题？
...
## [](#kubernetes-secrets-to-the-rescue)Kubernetes 秘密营救
...
## [](#but-what-if-you-dont-have-the-luxury-to-start-from-scratch)但是如果你没有那个闲心从头开始呢？
...
## [](#using-tillerreleasesconverter)使用舵柄-释放器-转换器
