...
> 原文:[https://dev.to/joaofbantunes/episode-006-配置-aspnet-core-from-0-to-over kill-3e i8](https://dev.to/joaofbantunes/episode-006---configuration---aspnet-core-from-0-to-overkill-3ei8)
...
## [](#creating-some-configurations)创建一些配置
...
## [](#avoiding-ioptions-injection)忌碘剂注射
