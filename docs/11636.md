...
> 原文:[https://dev . to/bnevilleoneill/end-to-end-to-testing-react-apps-with-puppet er-and-jest-4c H3](https://dev.to/bnevilleoneill/end-to-end-testing-react-apps-with-puppeteer-and-jest-4ch3)
...
### [](#build-a-react-app)**打造 React app**
...
### [](#users-are-redirected-to-the-login-page-for-unauthorized-view)**用户被重定向到未授权查看的登录页面**
...
### [](#nonexistent-viewsroute-returns-a-404-page)**不存在的观点/路线返回 404 页**
