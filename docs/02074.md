...
# [](#so-what-about-heroku)那么 Heroku 呢？
...
## [](#update-herokus-remote-name)更新 Heroku 的远程名称
...
## [](#specify-the-remote-name-when-creating-a-heroku-app)创建 Heroku app 时指定远程名称
...
### [](#how-to-create-multiple-environments-for-a-new-app-)如何为一个新 app 创建多个环境:
...
### [](#in-case-you-already-have-your-dev-environment-running-in-heroku-and-want-to-add-new-envs)如果您已经在 Heroku 中运行了您的开发环境，并且想要添加新的 env:
