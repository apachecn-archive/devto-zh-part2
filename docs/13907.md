...
> 原文:[https://dev . to/anoff/automated-dev-workflow-for-use-data-science-VM-on-azure-2h 55](https://dev.to/anoff/automated-dev-workflow-for-using-data-science-vm-on-azure-2h55)
...
#### [](#signing-the-license-terms-for-data-science-vm)签署数据科学虚拟机⚖️的许可条款
...
### [](#bring-code-onto-the-vm)将代码带到虚拟机上💁‍♀️
...
### [](#run-jupyter-notebook)运行 Jupyter 笔记本📒
...
### [](#start-and-stop-the-virtual-machine)启动和停止虚拟机🎬 🛑
...
#### [](#reduce-risk-of-bankruptcy)降低破产风险💸
