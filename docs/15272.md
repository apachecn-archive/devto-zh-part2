...
> 原文:[https://dev . to/varunbarad/simplified-user-experience-for-rating-your-Android-app-jo9](https://dev.to/varunbarad/simplifying-user-experience-for-rating-your-android-app-jo9)
...
## [](#simplifying-the-user-flow)简化用户流程
...
## [](#1-displaying-rateme-option-to-user)1。向用户显示“自我评价”选项
...
## [](#2-launching-the-play-store-listing)2。推出 Play Store 列表
