...
> 原文:[https://dev . to/itachiuchiha/using-elastic search-with-python-and-flask-20e](https://dev.to/itachiuchiha/using-elasticsearch-with-python-and-flask-2i0e)
...
# [](#what-is-the-elasticsearch)什么是 Elasticsearch？
...
# [](#using-elasticsearch-with-python-and-flask)使用 Python 和 Flask 进行 Elasticsearch
...
# [](#flask-and-elasticsearch-installation-with-the-virtualenv)用 Virtualenv 搜索安装烧瓶和橡皮筋
