...
> 原文:[https://dev . to/Joel net/a-practical-solution-to-flatten-proposal-proposal-problem-smooshgate-JavaScript-jal](https://dev.to/joelnet/a-pragmatic-solution-to-flatten-proposal-problem-smooshgate-javascript--jal)
