...
> 原文:[https://dev.to/lefebvre/oop-101-understanding-classes-343p](https://dev.to/lefebvre/oop-101-understanding-classes-343p)
...
## [](#understanding-classes-instances-and-references)了解类、实例和引用
...
## [](#adding-classes-to-your-projects)向项目中添加类
...
## [](#adding-properties-to-classes)给类添加属性
