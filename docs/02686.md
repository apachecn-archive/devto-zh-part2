...
> 原文:[https://dev . to/idoko/setting-up-a-docker-based-git lab-runner-on-Alibaba-cloud-ECS-1o8g](https://dev.to/idoko/setting-up-a-docker-based-gitlab-runner-on-alibaba-cloud-ecs-1o8g)
...
### [](#installing-the-gitlab-runner)安装 Gitlab 转轮
...
### [](#registering-a-gitlab-runner)注册 Gitlab 跑步者
