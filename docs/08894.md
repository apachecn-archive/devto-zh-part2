...
> 原文:[https://dev . to/flexbox/simple-release-wor flow-for-react-native-with-Expo-16ep](https://dev.to/flexbox/simple-release-worflow-for-react-native-with-expo-16ep)

### [](#just-push-a-button)只需按一个按钮

#### [](#how-much-time-it-takes-to-release-a-react-native-application-to-the-ios-app-store-and-android-play-store)将 React 原生应用发布到 iOS 应用商店和 Android Play 商店需要多长时间
...
### [](#-raw-createreactnativeapp-endraw-versus-raw-reactnativecli-endraw-)`create-react-native-app`对`react-native-cli`

如果你负责发布你的 react 原生应用，你需要理解用你的 CLI 生成的 2 个不同的应用架构[。](https://en.wikipedia.org/wiki/Command-line_interface)

#### [](#createreactnativeapp)创建-反应-原生-应用
...
### [](#building-a-standalone-app-with-expo)用 expo 打造独立 app
