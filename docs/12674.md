...
## [](#sql-server-linked-servers)SQL Server 链接的服务器
...
## [](#building-a-linked-server-connection)建立链接服务器连接
...
## [](#accessing-your-nonsql-server-data)访问您的非 SQL server 数据
...
## [](#accessing-data-with-linked-server-objects)通过链接的服务器对象访问数据
...
## [](#global-ole-db-provider-options)全局 OLE DB 提供程序选项
