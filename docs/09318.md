...
> 原文:[https://dev . to/adrienjoly/how-to-maintain-a-collection-of-music-albums-online-using-Jekyll-and-github-pages-3hd 6](https://dev.to/adrienjoly/how-to-maintain-a-collection-of-music-albums-online-using-jekyll-and-github-pages-3hd6)
...
# [](#step-1-initialise-a-jekyll-page-on-github-pages)第一步。初始化 Github 页面上的 Jekyll 页面
...
# [](#step-2-render-a-simple-list-using-jekyll)第二步。使用 Jekyll 呈现一个简单列表
...
# [](#step-3-make-it-look-better)第三步。让它看起来更好
