...
> 原文:[https://dev.to/resir014/redux-4-打字稿-29-a 型-安全-接近-2lf4](https://dev.to/resir014/redux-4--typescript-29-a-type-safe-approach-2lf4)
...
### [](#writing-typesafe-actions-with-raw-typesafeactions-endraw-)用`typesafe-actions`编写类型安全动作
...
## [](#handling-actions-asynchronously-with-raw-reduxsaga-endraw-)与`redux-saga`异步处理动作
...
## [](#initialising-redux-store)初始化 Redux 存储
...
## [](#connecting-with-react)与 React 连接
