...
## [](#parsing-and-storing-our-data)解析并存储我们的数据
...
## [](#building-our-greedy-algorithm)构建我们的贪婪算法
...
## [](#greedy-algorithm-results)贪婪算法结果
...
## [](#building-our-dynamic-programming-algorithm)构建我们的动态规划算法
...
## [](#getting-our-optimized-item-list)获取我们的优化商品列表
...
## [](#dynamic-programming-results)动态编程结果
...
### [](#suddenly-a-rogue-weight-appears)突然...一个流氓体重出现！
...
# [](#which-approach-is-better)哪种做法比较好？
...
## [](#better-algorithm-design)更好的算法设计
