...
> 原文:[https://dev . to/levente/what-is-software-role-in-safe-manufacturing-processes-5bji](https://dev.to/levente/what-is-softwares-role-in-safe-manufacturing-processes-5bji)
...
### [](#tell-us-a-bit-about-your-role-at-eaglepicher)告诉我们一点你在 EaglePicher 的角色吧！
...
### [](#what-triggered-your-need-for-a-strictly-controlled-repository)是什么触发了你对一个严格控制的存储库的需求？
...
### [](#how-does-commit-policy-plugin-help-developers-stay-compliant)提交策略插件如何帮助开发者保持合规？
