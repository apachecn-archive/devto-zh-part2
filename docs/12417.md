...
> 原文:[https://dev.to/rpalo/ruby-concepts-独生子女-班级-oeb](https://dev.to/rpalo/ruby-concepts---singleton-classes-oeb)
...
## [](#what-is-a-singleton-class)什么是单例类？
 ...
 *## [](#what-does-this-have-to-do-with-class-methods)这和类方法有什么关系？
...
## [](#-raw-class-ltlt-self-endraw-vs-raw-def-selfmethod-endraw-vs-raw-def-petmethod-endraw-)`class << self` vs `def self.method` vs `def Pet.method`
...
## [](#using-extend-to-safely-modify-builtin-classes)使用 Extend 安全地修改内置类
