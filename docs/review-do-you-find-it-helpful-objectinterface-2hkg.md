...
> 原文：<https://dev.to/shystruk/review-do-you-find-it-helpful-objectinterface-2hkg>

有一次，我发现很难找到我们应该为这个或那个请求向服务器发送什么数据。我们还没有一个文档，所以一个好的解决方案是把需要的键移到一个接口上，每次你调用它的时候，你就有了正确的结构化数据。
