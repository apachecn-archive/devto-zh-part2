...
> 原文:[https://dev . to/node foneon/quick-start-Google-translation-API-in-rails-4j 81](https://dev.to/nodefiend/quick-start-google-translation-api-in-rails-4j81)
...
## [](#hello-world-with-google-translate)带谷歌翻译的 Hello world
...
## [](#great-now-our-rails-server-should-be-up-and-running-with-google-cloud-translation-api-)太棒了！现在我们的 rails 服务器应该已经启动并运行了 google cloud translation api！
