...
> 原文:[https://dev.to/spences10/windows-subsystem-linux-setup-1gb5](https://dev.to/spences10/windows-subsystem-linux-setup-1gb5)
...
### [](#install-node-with-raw-n-endraw-)用`n`安装节点
...
### [](#install-oh-my-fish-omf)安装哦我的鱼| OMF
...
### [](#the-start-of-the-beginning)开始的开始
