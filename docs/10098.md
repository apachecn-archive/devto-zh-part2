...
### [](#a-note-on-tutorials-and-design-choices)关于教程和设计选择的说明
...
## [](#step-three-generate-some-data-to-work-with)第三步——生成一些要处理的数据
...
## [](#step-five-insert-the-tables-into-the-document)第五步——将表格插入文档
...
## [](#step-six-include-a-summary-and-comparison)步骤六——包括总结和比较
