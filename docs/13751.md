...
> 原文:[https://dev . to/execute autotest/top-3-selenium-ide-alternatives-for-Firefox-chrome-3 hha](https://dev.to/executeautotest/top-3-selenium-ide-alternatives-for-firefox--chrome-3hha)
...
## [](#1-selenium-ide-history)**1。硒 IDE 历史**
...
## [](#2-what-is-selenium-ide-why-is-selenium-ide-so-successful)**2。什么是硒 IDE？Selenium IDE 为什么这么成功？**
...
## [](#3-the-viable-selenium-ide-alternatives)**3。可行的硒 IDE 替代品:**
