...
> 原文:[https://dev . to/bnevilleoneill/submitting-html-forms-using-JavaScript-frameworks-vue-react-hyperapp-3432](https://dev.to/bnevilleoneill/submitting-html-forms-using-javascript-frameworks-vue-react-hyperapp-3432)
...
### [](#submitting-forms-using-vue)使用 Vue 提交表单
...
### [](#submitting-forms-using-react)使用 React 提交表单
...
### [](#submitting-forms-using-hyperapp)使用 HyperApp 提交表单
