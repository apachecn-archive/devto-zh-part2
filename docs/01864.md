...
# [](#what-is-raw-htaccess-endraw-)什么是`.htaccess`？
...
# [](#limitations-and-drawbacks-of-htaccess-and-shared-hosting)局限性和弊端。htaccess(和共享主机)
...
# [](#common-use-case-cheat-sheet)常见用例备忘单
...
## [](#protect-yourself-from-bandwidth-theft)保护自己免受带宽窃取
...
## [](#seo-improvements)SEO 改进

### [](#redirect-old-pages-to-new-location)将旧页面重定向到新位置
...
### [](#enforce-raw-https-endraw-)强制执行`https`
...
### [](#dont-require-raw-html-endraw-)不要求`.html`
...
### [](#enforce-or-forcibly-remove-raw-www-endraw-)强制执行(或强行删除)`www`
...
### [](#hide-raw-git-endraw-directory)隐藏`.git`目录
...
### [](#restrict-access-to-sensitive-files)限制访问敏感文件
...
## [](#some-operation-not-allowed-here)这里有些操作不允许
