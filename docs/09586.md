...
> 原文:[https://dev . to/adrienshen/how-hidden-files-can-screw-over-when-deploying-progressive-web-apps-oc](https://dev.to/adrienshen/how-hidden-files-can-screw-you-over-when-deploying-progressive-web-apps-oc)
...
## [](#service-worker-caching)服务工作者缓存
