...
## [](#1-create-an-erd-entity-relationship-diagram)1。创建 ERD(实体关系图)
...
## [](#4-manage-permissions-to-use-the-model)4。管理使用模型的权限
...
## [](#6-create-the-controller)6。创建控制器
