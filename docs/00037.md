...
> 原文:[https://dev . to/progress telerik/the-state-of-JavaScript-2018-the-view-on-vue-2n5d](https://dev.to/progresstelerik/the-state-of-javascript-2018-the-view-on-vue-2n5d)
