...
> 原文:[https://dev . to/philnash/use-the-web-share-API-easy-with-web-components-I do](https://dev.to/philnash/use-the-web-share-api-easily-with-web-components-ido)
...
### [](#using-the-raw-ltwebsharewrappergt-endraw-)使用`<web-share-wrapper>`
...
### [](#getting-fancy-with-templates)喜欢上模板
...
## [](#installing-raw-ltwebsharewrappergt-endraw-)安装`<web-share-wrapper>`
