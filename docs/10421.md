...
> 原文:[https://dev.to/depado/cicd-with-drone-kubernetes-and-helm-第一部分-4mdp](https://dev.to/depado/cicd-with-drone-kubernetes-and-helm---part-1-4mdp)
...
## [](#creating-an-acme-issuer)创建 ACME 发行者
...
## [](#upgrade-drones-values)升级无人机的数值
