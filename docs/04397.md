...
> 原文:[https://dev . to/uilicious/the-stack-making-a-free-open-source-disposable-email-service-prototype-inbox kittencom-in-14-hours-206g](https://dev.to/uilicious/the-stack-making-a-free-open-source-disposable-email-service-prototype-inboxkittencom-in-14-hours-206g)
...
# [](#making-it-free-with-mailgun)使其自由，用射枪
...
# [](#making-it-free-with-serverless-api)通过无服务器 API 使其免费
...
# [](#interacting-with-our-api%E2%80%8A%E2%80%8Athrough-the-ui-and-even-the%C2%A0cli)与我们的 API 交互——通过 UI 甚至 CLI
...
# [](#and-making-it-opensource)并使其开源
...
# [](#with-automated-ui-testing-for-validation)用自动化 UI 测试进行验证
