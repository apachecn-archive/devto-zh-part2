...
# [](#what-is-time-complexity-anyway)究竟什么是“时间复杂度”？
...
# [](#determining-time-complexity)确定时间复杂度
...
## [](#nonpolynomial-time-complexity)非多项式时间复杂度
...
## [](#recursion-time-complexity)递归时间复杂度
...
# [](#p-vs-np-npcomplete-and-nphard)P vs NP，NP-完全，NP-硬
...
# [](#approximate-the-efficiency-of-an-algorithm-before-you-write-the-code)在你写代码之前估算一个算法的效率
...
# [](#improve-time-complexity-of-existing-code)提高现有代码的时间复杂度
