...
> 原文:[https://dev . to/Washington Steven/reacts-new-context-API-and-actions-446 o](https://dev.to/washingtonsteven/reacts-new-context-api-and-actions-446o)
...
## [](#simple-context-example)简单上下文示例

在许多这样的例子中，我们定制了一个提供者来包装 React，它有自己的状态作为`value`传入。像这样:

### [](#-raw-contextjs-endraw-)`context.js`
...
### [](#-raw-duckdeterminerjs-endraw-)`DuckDeterminer.js`
