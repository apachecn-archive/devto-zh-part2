...
## [](#convert-list-component-to-angular-module)将列表组件转换为角度模块
...
# [](#create-tile-page-by-using-card)使用卡片创建平铺页面
...
# [](#view-the-application-via-mobile-device)通过移动设备查看应用
