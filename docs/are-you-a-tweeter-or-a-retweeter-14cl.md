...
> 原文：<https://dev.to/yellzheard/are-you-a-tweeter-or-a-retweeter-14cl>
...
*   让分享变得更容易:能够直接从网站上用生成的图片起草一条推文。

*   比较结果:一个数据库的结果，并有一个(选择)收集所有生成的图形。

*   非二进制规模:而不是转发或高音可能有超级转发>转发>完美平衡>高音>超级高音，使结果更具体。

可以在这里查看[！](https://twit-original.glitch.me)

[https://glitch.com/embed/#!/embed/twit-original?path=index.html](https://glitch.com/embed/#!/embed/twit-original?path=index.html)

而且可以[混音](https://glitch.com/edit/#!/twit-original)！(glitch 上的混音本质上是制作一个分叉，并把你的旋转放在项目上)