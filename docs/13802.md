...
> 原文:[https://dev . to/roper zh/memories-of-writing-a-parser-for-man-pages-4jap](https://dev.to/roperzh/memories-of-writing-a-parser-for-man-pages-4jap)
...
### [](#how-man-pages-are-written)手册页是如何编写的
...
#### [](#contextsensitive-grammar)上下文相关语法
...
#### [](#lack-of-beginnerfriendly-resources)缺乏适合初学者的资源

真正让我困惑的是缺乏一个规范的、定义明确的、清晰的来源，网络上有很多信息，这些信息假设了很多关于读者的东西，需要花时间去理解。

### [](#interesting-macros)有趣的宏
