...
> 原文:[https://dev . to/jandedobbeleer/intercept-http-traffic-exiting-a-docker-container-3g 68](https://dev.to/jandedobbeleer/intercept-http-traffic-exiting-a-docker-container-3g68)
...
### [](#multiple-dockercompose-files)多个 docker-compose 文件
...
### [](#but-im-not-using-python-or-requests)但是我没有使用 Python 或者 Requests
