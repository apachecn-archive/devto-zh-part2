...
> 原文:[https://dev . to/runtime-revolution/react-passing-data-between-components-with-pokemon-as-a-example-37n 0](https://dev.to/runtime-revolution/react-passing-data-between-components-with-pokemon-as-an-example-37n0)
