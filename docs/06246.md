...
> 原文:[https://dev . to/wreulicke/export-application-metrics-with-micrometer-for-Prometheus-on-your-micronaut-application-gff](https://dev.to/wreulicke/export-application-metrics-with-micrometer-for-prometheus-on-your-micronaut-application-gff)
