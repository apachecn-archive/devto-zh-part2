...
> 原文:[https://dev . to/auth 0/vuejs-and-AWS-lambda-developing-production-ready-apps-part-2-2 lgf](https://dev.to/auth0/vuejs-and-aws-lambda-developing-production-ready-apps-part-2-2lgf)
