...
> 原文:[https://dev . to/adityasridhar/how-to-create-simple-rest-APIs-with-spring boot-5h9f](https://dev.to/adityasridhar/how-to-create-simple-rest-apis-with-springboot-5h9f)
