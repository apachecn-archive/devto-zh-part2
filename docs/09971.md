...
> 原文:[https://dev . to/eduardort/Hugo-and-nginx-multi-stage-build-docker file-3o 63](https://dev.to/eduardort/hugo-and-nginx-multi-stage-build-dockerfile-3o63)
...
# [](#whats-a-multistage-build)什么是多阶段构建？
...
## [](#final-dockerfile)最终 Dockerfile
