...
> 原文:[https://dev.to/zellwk/setting-up-a-git-client-44e2](https://dev.to/zellwk/setting-up-a-git-client-44e2)
...
## [](#choosing-a-git-client)选择 Git 客户端
...
### [](#the-default-source-directory)默认源目录

我喜欢 Fork 的一点是它要求你设置一个默认的源目录。

这意味着您用 Git 复制(或克隆)的项目将自动进入指定的文件夹，这使得它很容易被找到。

## [](#initializing-a-git-repository)初始化 Git 仓库
