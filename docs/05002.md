...
> 原文:[https://dev . to/jperasmus/how-to-set-firebase-security-rules-for-your-flamelink-project-23fn](https://dev.to/jperasmus/how-to-set-firebase-security-rules-for-your-flamelink-project-23fn)
...
#### [](#read-access-for-your-app-or-website)您的应用程序或网站的读取权限
...
#### [](#write-access-for-specific-users)针对特定用户的写权限
...
#### [](#firebase-custom-claims)Firebase 自定义声明
