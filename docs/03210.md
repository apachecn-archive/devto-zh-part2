...
> 原文:[https://dev . to/commons host/how-we-build-a-doh-cdn-with-20-global-edge-servers-in-10-days-1 man](https://dev.to/commonshost/how-we-built-a-doh-cdn-with-20-global-edge-servers-in-10-days-1man)
...
## [](#dns-meet-http-http-meet-dns)DNS，遇见 HTTP。HTTP，满足 DNS。
...
## [](#deploying-a-dns-resolver)部署 DNS 解析器
...
## [](#bootstrapping-doh-cdn-anycast-ip-vs-geo-dns)自举 DOH CDN:任播 IP vs 地域 DNS
...
## [](#using-commons-host-doh)使用 Commons 主机 DOH
...
## [](#one-last-thing-custom-domain-doh-resolver)最后一件事:自定义域 DOH 解析器
