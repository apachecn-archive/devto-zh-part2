...
> 原文:[https://dev . to/apcelent/JSON-we b-token-tutorial-with-example-in-python-23kb](https://dev.to/apcelent/json-web-token-tutorial-with-example-in-python-23kb)
...
## [](#understanding-with-a-similie)用比喻理解
...
## [](#creating-a-jwt-in-python)在 Python 中创建 JWT
