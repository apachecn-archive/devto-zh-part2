...
## [](#retrofit-making-deferred)改造:制作延期
...
## [](#on-generic-extension-with-associatedtype-protocol)开:带有关联类型协议的通用扩展

我喜欢扩展，我喜欢将它们归入一个公共属性下，以便于访问。这也清楚地表明，这些都属于同一功能，不要与苹果属性混淆。

### [](#grouping-all-related-extensions)分组所有相关分机
...
## [](#backchannelsdkios-using-coordinator)BackchannelSDK-iOS:使用协调器
...
## [](#kickstarter-manage-dependencies)Kickstarter:管理依赖关系
...
## [](#kickstarter-using-playground)Kickstarter:使用游乐场
...
## [](#touchbar-simulator-making-macos-app-in-code)Touchbar 模拟器:用代码制作 macOS app
...
## [](#kickstarter-input-and-output-container)Kickstarter:输入输出容器
...
## [](#suas-observing-object-deinit-in-swift)Suas:迅速观察对象定义
