...
## [](#preparing-to-customize-configuration)准备定制配置
...
## [](#setting-up-vue-and-vuera)设置 Vue 和 Vuera
...
## [](#bare-minimum-vue-in-gutenberg)古腾堡光秃秃的最小 Vue
...
## [](#using-gutenberg-builtin-components)使用古腾堡内置组件
