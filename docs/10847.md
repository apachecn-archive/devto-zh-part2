...
> 原文:[https://dev . to/dev3l/I-written-a-JavaScript-unit-test-today-spy-on-an-import-time-dependency-2f8b](https://dev.to/dev3l/i-wrote-a-javascript-unit-test-today-spy-on-an-import-time-dependency-2f8b)
...
## [](#test-1-initialize-app-is-not-called-when-firebase-has-apps)**测试#1** :当 Firebase 有 App 时，初始化 App *未被*调用
...
## [](#test-2-initialize-app-is-called-with-firebase-config-variables)**测试#2** :初始化 App *是用 Firebase 配置变量*调用的
