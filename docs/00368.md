...
> 原文:[https://dev . to/swyx/networking-essentials-traffic-engineering-13 C4](https://dev.to/swyx/networking-essentials-traffic-engineering-13c4)
...
## [](#what-is-traffic-engineering)什么是流量工程？
...
## [](#doesnt-the-network-manage-itself)网络不自我管理吗？
 ...
 **## [](#intradomain-traffic-engineering)域内流量工程
...
## [](#the-3-steps-of-traffic-engineering)流量工程的 3 个步骤
...
## [](#optimizing-for-the-link-utilization-objective)针对链路利用率目标进行优化
...
## [](#interdomain-traffic-engineering)域间流量工程
...
## [](#scaling-in-the-access-layer)在接入层缩放
...
## [](#load-balancing-across-the-data-center)跨数据中心的负载均衡
