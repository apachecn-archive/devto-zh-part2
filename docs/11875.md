...
> 原文:[https://dev . to/kingsor/deploy-aspnet-core-2-apps-with docker-598n](https://dev.to/kingsor/deploy-aspnet-core-2-apps-withdocker-598n)
...
## [](#building-a-web-api-with-aspnet-20)用 ASP.NET 2.0 构建 web api
...
## [](#adding-a-dockerfile)添加 Dockerfile
...
## [](#pushing-the-image-to-dockerhub)将图像推送到 DockerHub
