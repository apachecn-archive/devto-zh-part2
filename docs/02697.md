...
> 原文:[https://dev . to/testing news 1/soap ui-vs-postman-katalon-studio-compare-top-3-API-testing-tools-4g7p](https://dev.to/testingnews1/soapui-vs-postman-katalon-studio---compare-top-3-api-testing-tools-4g7p)
...
## [](#comparing-soapui-vs-postman-katalon-studio)对比 SoapUI vs Postman，Katalon Studio
