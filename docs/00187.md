...
> 原文:[https://dev.to/apium_hub/introduction-espresso-testing-2b4b](https://dev.to/apium_hub/introduction-espresso-testing-2b4b)
...
## [](#what-is-espresso-testing-how-does-it-work)什么是 Espresso 测试？它是如何工作的？
