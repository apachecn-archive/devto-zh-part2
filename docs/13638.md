...
> 原文:[https://dev.to/zellwk/how-to-build-a-calculatorpart-1-22io](https://dev.to/zellwk/how-to-build-a-calculatorpart-1-22io)
...
## [](#building-the-happy-path)建设幸福之路
...
## [](#when-a-user-hits-a-number-key)当用户点击数字键时
...
## [](#when-a-user-hits-the-decimal-key)当用户点击十进制键时
...
## [](#when-a-user-hits-an-operator-key)当用户点击操作键时
...
## [](#when-a-user-hits-a-number-key-after-an-operator-key)当用户在操作键之后点击数字键时
...
## [](#when-a-user-hits-the-equal-key)当用户点击等号键时
