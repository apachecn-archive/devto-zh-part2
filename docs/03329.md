...
> 原文:[https://dev . to/adamspannbauer/OOP-fractal-trees-in-r-with-R6-gg plot 2-gg animate-part-2-4l0k](https://dev.to/adamspannbauer/oop-fractal-trees-in-r-with-r6-ggplot2--gganimate-part-2-4l0k)
...
### [](#-raw-fractaltreeseq-endraw-)`fractal_tree_seq`
