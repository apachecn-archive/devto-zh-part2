...
> 原文:[https://dev . to/bright devs/implementing-in-app-language-change-4e 75](https://dev.to/brightdevs/implementing-in-app-language-change-4e75)
...
# [](#storing-user-preferences)存储用户偏好
...
# [](#initializing-localespecific-resources)初始化特定于语言环境的资源
...
# [](#providing-string-resources)提供字符串资源
