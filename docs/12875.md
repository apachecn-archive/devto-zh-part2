...
> 原文:[https://dev.to/jochemstoel/js-documentdefineelement-custom-html-elements-without-a-hypen-2 agh](https://dev.to/jochemstoel/js-documentdefineelement--custom-html-elements-without-a-hypen-2agh)
...
## [](#documentdefineelement)document.defineElement()
...
## [](#simple-clock-an-actual-example)简单时钟，一个实际例子
