...
> 原文:[https://dev . to/sanity-io/someone-created-a-post-in-sanity-make-a-server less-slack-notification-service-373 I](https://dev.to/sanity-io/someone-created-a-post-in-sanity-make-a-serverless-slack-notification-service-373i)
...
## [](#1-setting-up-the-webtask-function)1。设置 Webtask 功能
...
### [](#2-create-a-slack-incoming-webhook)2。创建一个松弛的传入 Webhook
...
### [](#3-add-your-webtask-url-to-sanity-webhooks)3。将您的 webtask URL 添加到 Sanity webhooks
