...
> 原文:[https://dev . to/kena kamu/azure-vs-GCP-part-5-storage-options-4k8p](https://dev.to/kenakamu/azure-vs-gcp-part-5-storage-options-4k8p)
...
### [](#azure-storage-types)Azure 存储类型
