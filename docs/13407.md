...
### [](#with-di-container-eg-prismforms)用 DI 容器(如. prism.forms)
...
### [](#iimageeditcreateimageasync)IImageEdit。CreateImageAsync
...
### [](#ieditableimageresize)IEditableImage。调整大小
...
### [](#ieditableimagecrop)IEditableImage。农作物
...
### [](#ieditableimagerotate)IEditableImage。辐状的
...
### [](#ieditableimagetomonochrome)砂砾石。明天罗马
...
### [](#ieditableimagetojpeg)砂砾石。ToJpeg 格式
...
### [](#ieditableimagetoargbpixels)砂砾石。烤面包片
...
### [](#ieditableimagegetnativeimage)砂砾石。getnativedimage
