...
我发现，不管你为哪个行业编程，编程的一条规则都是正确的，那就是唯一不变的就是变化。我能听到每个开发者都在喊“常量不变”。我记不清有多少次，团队领导或开发经理问我是否可以研究并实施一项公司无人利用的新技术或流程。大多数情况下，它需要一些尖端技术，而这些技术只有很少(如果有的话)的文档可供参考。

既然变化是不断的，那么这对那些考虑以程序员为职业的人来说意味着什么呢？我的经验和个人观点是，作为一名程序员，理解您正在使用的任何编程语言的语义都是重要的，但最有价值的属性是茁壮成长和推动自己沉浸在变化中的能力。我发现，毫无疑问，那些对自己的编程沾沾自喜的程序员和那些“拥有成功所需的东西”的程序员是在为即将到来的变化做志愿服务。

如果你想学习创造出谷歌、脸书或 Dropbox 等优秀软件的计算机程序员的其他技能和特质，我推荐你读一读 Edmond Lau 的[The Effective Engineer:How Leverage Your Efforts In Software Engineering to Make a unproportional and 有意义的影响](https://amzn.to/2v5jQAb)。更多类似的文章，请访问 https://goingundercoder.com/blog。