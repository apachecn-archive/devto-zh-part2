...
> 原文:[https://dev . to/neo/send-push-notifications-in-a-social-network-IOs-app-part-1-build-the-back end-ld5](https://dev.to/neo/send-push-notifications-in-a-social-network-ios-app---part-1-build-the-backend-ld5)
...
## [](#creating-our-pusher-application)创建我们的 Pusher 应用程序
...
### [](#configuring-our-database)配置数据库
...
### [](#creating-our-migrations-models-and-controllers)创建我们的迁移、模型和控制器
...
### [](#creating-our-applications-routes)创建我们应用程序的路线
...
### [](#installing-laravel-passport)安装护照
...
### [](#adding-push-notification-support)增加推送通知支持
...
## [](#building-our-ios-application-using-swift)使用 Swift 构建我们的 iOS 应用
...
### [](#how-the-storyboard-scenes-are-connected)故事板场景是如何连接的
