...
> 原文:[https://dev . to/wia io/setup-an-espressif-esp8266-and-publish-an-event-to-wia-52dh](https://dev.to/wiaio/setup-an-espressif-esp8266-and-publish-an-event-to-wia-52dh)

### [](#connecting-to-the-board)**连接到板卡**
...
#### [](#note-when-selecting-a-port)**注:选择端口时**
...
##### [](#chargeonly-usb-cables)**只充 USB 线**

端口没有显示的另一个原因可能是 USB 电缆-确保您使用的电缆不是充电专用电缆，并且没有故障。

### [](#create-the-sketch)**创建草图**

#### [](#measuring-soil-moisture-with-the-nodemcu-amica)用 NodeMCU Amica 测量土壤水分
