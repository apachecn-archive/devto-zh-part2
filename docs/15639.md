...
> 原文:[https://dev . to/kepta/a-toddles-guide-to-memory-leaks-in-JavaScript-25lf](https://dev.to/kepta/a-toddlers-guide-to-memory-leaks-in-javascript-25lf)

在本文中，我将采用一种非常简单的方法来理解内存泄漏，并尝试诊断它们。

在当今内存丰富的世界中，我们很少担心内存泄漏。但是我不想告诉你，我们生活在一个真实的世界里，没有什么是免费的。

### [](#oh-my-fancy-functional-programming)哎呀我的花式函数编程
...
### [](#alright-but-what-about-memory-leaks)好吧，但是内存泄露怎么办？？
...
### [](#give-me-some-real-life-leakages)给我一些现实生活中的漏洞
