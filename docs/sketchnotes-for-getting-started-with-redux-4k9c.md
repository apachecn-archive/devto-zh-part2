# “Redux 入门”的 Sketchnotes

> 原文：<https://dev.to/dance2die/sketchnotes-for-getting-started-with-redux-4k9c>

最近读了[迈克·罗德](http://rohdesign.com)的《草图笔记手册。

其中一个好处是通过帮助你将抽象的知识转化为可视化的表现形式来更长时间地保留知识。

以下是我在观看 Redux 入门时创建的第一个 sketchnotes。
...
如上所述，我能够理解 Redux 中每个方法背后的“为什么”。

## 👎不利方面

到目前为止，我的绘画技巧相当欠缺，因此花了 5 个多小时才完成 2 小时的课程。

## 🧐我学到了什么

用视觉的方式帮助我只提取重要的部分。我需要更多的练习和持续的努力。

## 👋离别赠言

如果你是听觉型学习者，我不推荐(但对视觉型或动力型学习者很好)。

***但不会受伤。*😎**

*帖子的“Redux 入门”Sketchnotes 最早出现在[宋的技术博客](https://www.slightedgecoder.com)上。*