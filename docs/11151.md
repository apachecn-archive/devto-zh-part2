...
## [](#1-is-there-a-rubyversion-file)1。有没有. ruby 版本的文件？
...
## [](#2-how-does-the-gemfile-look)2。gem 文件看起来怎么样？
...
### [](#are-your-gems-organized-in-groups)你的宝石是分组摆放的吗？
...
### [](#what-are-all-these-gems-used-for)这些宝石都是用来做什么的？
...
### [](#last-but-not-least-is-rubygems-installing-over-ssl)最后一点，Rubygems 是通过 SSL 安装的吗？

确保您的`Gemfile`已经:

`source 'https://rubygems.org'` ( `https://` vs `http://`)

## [](#3-what-warnings-does-bundleraudit-raise)3。bundler-audit 提出了哪些警告？
...
## [](#4-how-long-has-it-been-since-automated-tests-have-been-touched)4。自动化测试有多久没被接触过了？
...
## [](#5-are-there-security-keys-that-shouldnt-be-in-the-repository)5。是否有不应该在存储库中的安全密钥？
...
## [](#6-can-we-seed-a-local-database)6。我们能植入一个本地数据库吗？
...
## [](#7-are-there-database-indexes)7。有数据库索引吗？
...
## [](#8-todos-what-remains-to-be-done)8。待办事项:还有什么要做的？
