...
> 原文:[https://dev . to/Dan _ MCM _/visualizing-Fibonacci-for-the-music-lover-in-you-2609](https://dev.to/dan_mcm_/visualizing-fibonacci-for-the-music-lover-in-you-2609)

*第一次写文章，所以原谅错别字和错误！*

## [](#a-common-problem-programming-the-fibonacci-series)常见问题:编程斐波那契数列
...
## [](#python-which-libraries)Python -哪个库？
...
## [](#some-additional-ideas-and-experiments)一些额外的想法和实验...
