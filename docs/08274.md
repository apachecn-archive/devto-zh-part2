...
> 原文:[https://dev.to/aspittel/extreme-makeover-code-edition-k5k](https://dev.to/aspittel/extreme-makeover-code-edition-k5k)

我有点痴迷于编写干净的代码。代码应该为未来的开发人员(包括你自己)和可扩展性而编写——向应用程序添加功能和维护代码应该相对容易。如果我们为计算机写代码，我们只会写二进制代码！以下是我写更干净代码的一些建议:

## [](#1-use-clear-variable-and-function-names)1。使用清晰的变量名和函数名
...
## [](#2-write-short-functions-that-only-do-one-thing)2。编写只做一件事的简短函数
...
### [](#to-summarize-my-tips-for-functions)总结我对函数的提示...
...
### [](#to-summarize-the-sandi-metz-rules)总结桑迪梅茨规则...
...
## [](#6-keep-your-code-dry)6。保持你的代码干燥
...
## [](#7-encapsulation-modularization)7。封装+模块化
