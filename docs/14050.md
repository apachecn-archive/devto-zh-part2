...
> 原文:[https://dev.to/booyaa/tunnelling-tcp-over-dns-in-2018-jkp](https://dev.to/booyaa/tunnelling-tcp-over-dns-in-2018-jkp)
...
## [](#setting-up-iodine)设置碘:

### [](#provision-a-server-via-digitalocean-et-al)配置服务器(通过 DigitalOcean 等)。
...
### [](#create-dns-records-to-point-to-your-server)创建指向你的服务器的 DNS 记录
...
### [](#install-the-client-mac-os)安装客户端(mac OS)
