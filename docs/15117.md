...
> 原文:[https://dev . to/vboykis/building-a-Twitter-art-bot-with-python-AWS-and-art-74p](https://dev.to/vboykis/building-a-twitter-art-bot-with-python-aws-and-art--74p)
...
# [](#why-build-an-art-bot)为什么要造美术机器人？
...
## [](#why-socialist-realism)为什么是社会主义现实主义
...
# [](#breaking-a-project-into-chunks)把一个项目分成几块
...
# [](#requirements-and-design-highlevel-bot-architecture)需求与设计:高层 Bot 架构
...
# [](#development-pulling-paintings-from-wikiart)开发:从维基上拉画
...
# [](#development-processing-paintings-and-metadata-locally)开发:本地处理绘画和元数据
...
# [](#development-using-s3-and-lambdas)开发:使用 S3 和兰达斯
...
## [](#development-scheduling-the-lambda)开发:调度λ
...
# [](#deployment-bot-tweets)部署:Bot 推文！
