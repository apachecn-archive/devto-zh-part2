...
> 原文:[https://dev.to/satansdeer/react-native-mobx-tutorial-第二部分-12 公里](https://dev.to/satansdeer/react-native-mobx-tutorial---part-2--12km)
...
## [](#getting-data-from-api)从 API 获取数据
