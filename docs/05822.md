...
> 原文:[https://dev . to/Linda _ ikechukwu/why-web-performance-optimization-matters-and-what-you-can-do-1 BFF](https://dev.to/linda_ikechukwu/why-web-performance-optimization-matters-and-what-you-can-do-1bff)
...
### [](#why-web-performance-matters)为什么网络性能很重要

#### [](#retaining-users-amp-promoting-user-experience-)留住用户&提升用户体验:
...
#### [](#2-minify-text-assetshtml-css-js)2。缩小文本资源(HTML/ CSS/ JS):
