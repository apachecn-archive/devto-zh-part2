...
### [](#2-assert-that-two-string-objects-are-equal)2。断言两个字符串对象相等。
...
### [](#3-assert-that-two-string-objects-are-not-equal)3。断言两个字符串对象不相等。
...
### [](#4-assert-that-string-is-always-matched)4。断言字符串总是匹配的。
...
### [](#5-assert-that-string-is-always-marched-with-specified-value)5。断言字符串总是以指定的值行进
...
### [](#6-assert-that-string-starts-with-an-expected-value)6。断言字符串以预期值开始。
...
### [](#7-assert-that-string-contains-an-expected-value)7。断言字符串包含预期值。
...
### [](#8-assert-that-string-ends-with-an-expected-value)8。断言字符串以期望值结尾。
...
### [](#9-assert-that-string-is-equal-to-an-expected-value-but-ignores-case)9。断言字符串等于预期值，但忽略大小写。
...
### [](#10-assert-that-string-is-equal-to-an-expected-value-but-ignores-white-spaces)10。断言字符串等于预期值，但忽略空白。
...
### [](#11-assert-that-string-object-is-empty)11。断言字符串对象为空。
...
### [](#12-assert-that-string-object-is-empty)12。断言字符串对象为空。
...
### [](#13-assert-that-string-object-is-null)13。断言字符串对象为空。
...
### [](#14-assert-that-string-contains-expected-value-in-order)14。断言字符串按顺序包含预期值。
