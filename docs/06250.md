...
> 原文:[https://dev . to/fabiorosado/weather-app-using-vue-and-axios-4ia 6](https://dev.to/fabiorosado/weather-app-using-vue-and-axios-4ia6)
...
## [](#getting-the-weather-data-with-axios)用 Axios 获取天气数据
...
## [](#creating-the-vue-app)创建 Vue 应用
...
## [](#building-the-weather-app)打造天气 App
...
#### [](#getting-api-data-with-axios)用 Axios 获取 API 数据
