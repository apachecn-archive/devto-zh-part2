...
> 原文:[https://dev . to/samw software/say-hello-to-your-own-Amazon-lex-chat-bot-1n 63](https://dev.to/samwsoftware/say-hello-to-your-own-amazon-lex-chat-bot-1n63)

#### [](#build-your-own-chat-bot-using-amazon-lex-and-teach-it-to-say-whatever-you-want)用亚马逊 Lex 打造自己的聊天机器人，教它说任何你想说的话。
...
### [](#building-and-testing-the-bot)构建和测试机器人
...
### [](#improving-the-hello-intent)提高招呼意向

让你的机器人回复“你好”或“你好，T2”是非常酷的，但这不算是一个对话。我们要改变这种状况。

#### [](#new-hello-intent)新增你好意向
...
### [](#other-way-to-populate-the-slots)其他方式来填充插槽
...
### [](#writing-your-own-intents)书写自己的意图
