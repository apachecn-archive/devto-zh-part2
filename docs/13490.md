...
## [](#step-1-downloading-and-configuring-pyfilter)步骤 1 —下载并配置 PyFilter
...
## [](#step-2-running-pyfilter)步骤 2 —运行 PyFilter
...
## [](#step-3-creating-a-service-for-pyfilter)步骤 3 —为 PyFilter 创建服务
...
## [](#step-4-configuring-pyfilter-for-cross-server-ban-syncing-optional)步骤 4 —为跨服务器 Ban 同步配置 PyFilter(可选)
...
## [](#step-5-configuring-pyfilter-to-gather-location-data-about-ip-addresses-optional)步骤 5 —配置 PyFilter 以收集关于 IP 地址的位置数据(可选)
...
## [](#step-6-unbanning-ip-addresses)第 6 步—取消禁止 IP 地址
