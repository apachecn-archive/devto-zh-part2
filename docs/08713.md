...
# [](#algunas-buenas-practicas-para-serverless-framework)无服务器框架的一些良好做法

虽然我用[【无服务器】](http://serverless.com)的时间很短，但我一直尝试着去写一套写模板的练习。我在这里分享给像我一样刚起步的人。

## [](#reducir-la-dependencia-de-valores-externos)减少对外部价值的依赖。
...
## [](#contenido-en-la-plantilla-seg%C3%BAn-condiciones)按条件包含在模板中。
