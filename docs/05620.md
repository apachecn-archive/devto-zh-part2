...
## [](#the-humble-object-pattern)...卑微的对象模式
...
## [](#enter-presenter-stage-left)进入演示者，舞台左侧
...
## [](#level-up-raw-makechoice-endraw-)等级提升:`makeChoice()`
...
## [](#testing-the-presenter-and-template)测试演示者和模板
