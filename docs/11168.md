...
> 原文:[https://dev . to/sait/how-to-improve-web-performance-by-using preload-preconnect-prefetch-1pc 1](https://dev.to/sait/how-to-improve-web-performance-by-usingpreload-preconnect-prefetch-1pc1)
...
## [](#after-im-using-the-preconnect-and-preload)我在使用预连接和预加载之后。
