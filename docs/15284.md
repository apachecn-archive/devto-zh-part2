...
> 原文:[https://dev . to/nylas/lessons-learned-syncing-8 亿-contacts-to-our-database-4ff 4](https://dev.to/nylas/lessons-learned-syncing-800-million-contacts-to-our-database-4ff4)
...
### [](#put-your-product-to-the-test)测试您的产品。
