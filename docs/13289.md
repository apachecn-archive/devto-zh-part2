...
> 原文:[https://dev . to/buffer ings/tryed-zalenium-to-run-selenium-tests-on-scalable-containers-2n7c](https://dev.to/bufferings/tried-zalenium-to-run-selenium-tests-on-scalable-containers-2n7c)
