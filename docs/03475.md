...
> 原文:[https://dev . to/yelouafi/a-gentle-introduction-to-parser-combinators-21a 0](https://dev.to/yelouafi/a-gentle-introduction-to-parser-combinators-21a0)

在本教程中，我们将构建一组解析器组合子。

## [](#what-is-a-parser-combinator)什么是解析器组合子？
