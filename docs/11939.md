...
> 原文:[https://dev . to/app signal/client-side-caching-in-rails-conditional-get-requests-ck5](https://dev.to/appsignal/client-side-caching-in-rails-conditional-get-requests-ck5)
...
## [](#-raw-freshwhen-endraw-and-raw-stale-endraw-)`fresh_when`和`stale?`
