...
> 原文:[https://dev.to/techcommunity/configuration-management-2dak](https://dev.to/techcommunity/configuration-management-2dak)

# [](#using-opencm-to-govern-your-digital-business-platform-landscape)使用 OpenCM 管理您的数字业务平台
...
## [](#auditing-differences-and-reporting)审计差异和报告
