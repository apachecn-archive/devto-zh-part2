...
# [](#10-interview-questions-in-react)+10 面试问题在 react

让我们再深入一点

> ### [](#11-what-do-you-understand-by-refs-in-react)11。 **What's your understanding of the referee's reaction?**
...
> ### [](#12-when-you-need-refs-instead-of-ids-)12。 **When you need a referee instead of a referee?**
...
> ### [](#13-when-is-the-ref-value-first-set)13。 **When was T3】 ref value first set?**

ref 首先在第一次 render()之后，但在 componentDidMount()之前设置。

> ### [](#14-use-ref-only-if-its-must-otherwise-not-why)14。 **Use ref only when necessary, otherwise don't use it ... Why?**
...
> ### [](#15-what-is-an-event-in-react)15。 **What is an event in React?**
...
> ### [](#16-how-do-you-create-an-event-in-react)16。 **How do you create an event in React? .**
...
> ### [](#17-what-are-synthetic-events-in-react)17。 **What are the composite events in React?**
...
> ### [](#18-why-is-it-that-react-sometimes-requires-a-key-property-to-be-specified)18。 **Why React sometimes needs to specify a key attribute.**

因为这是 React 处理最小 DOM 变化的方式。我们应该为每个孩子以及孩子内部的每个元素添加一个键。

> ### [](#19-what-are-the-two-types-of-components-in-react)19。 **What are the two types of components T3】 React 【T4]**
...
> ### [](#18-what-is-the-difference-between-a-container-and-a-component)18。 **What's the difference between containers and components?**
...
> ### [](#19-what-is-a-higher-order-component-put-an-examples)19。 **What is the higher-order component? For example,**
...
> ### [](#20-what-can-you-do-with-hoc)20。 **What can you do with HOC?**
