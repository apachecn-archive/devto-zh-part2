...
我更喜欢在命令行上使用 Git。我有一组 Git 命令序列，我一直都在使用它们，我已经记住了它们，但是每次都要打出来，这很麻烦；还有一组命令序列，我经常需要它们，但是必须一直查找。为了改善我个人的 Git 用户体验，我创建了[](https://github.com/kahlil/belly)*。*

 *belly 是一个 cli 工具，为一些常见的 Git 命令序列提供了更好的用户体验:

## [](#commit-amp-push)提交&推送
...
## [](#git-checkout-branch-or-create-and-checkout)Git 结帐分支或创建并结帐
...
## [](#set-and-delete-tags-locally-and-on-remote)本地和远程设置和删除标签
...
## [](#rename-a-branch-locally-and-remote)本地和远程重命名分支
...
## [](#forcepush-the-right-way)力-推动正确的方式
