...
> 原文:[https://dev . to/obahareth/indexing-pdf-for-search-using-tika-noko giri-and algolia-PHC](https://dev.to/obahareth/indexing-pdf-for-searching-using-tika-nokogiri-andalgolia-phc)

*本[中岗位](https://stories.algolia.com/indexing-pdf-or-other-file-contents-for-searching-b2499c23568f)的镜子。*

### [](#figuring-out-where-to-start-from)弄清楚从哪里开始
...
### [](#extracting-pdf-contents)提取 PDF 内容
...
### [](#using-tika-in-ruby)在 Ruby 中使用 Tika
...
### [](#parsing-html-using-nokogiri)使用 Nokogiri 解析 HTML
...
### [](#getting-the-pdf-contents-into-algolia)将 PDF 内容导入 Algolia
