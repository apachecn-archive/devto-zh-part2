...
## [](#typically-example)典型例子

首先，我解释典型案例。

### [](#case-01-i-want-to-output-to-standard-output)案例 01:“我要输出到标准输出”
...
### [](#case-02-i-want-to-use-random-number)案例 02:“我要用随机数”
...
### [](#case-03-i-want-to-calcurate-calendar-like-tomorrow-1-year-ago-or-later)案例 03:“我想计算明天、1 年前或以后的日历”
...
### [](#case-04-i-want-to-manage-file-io)案例 04:“我想管理文件 I/O”
...
### [](#sepalate-logic-and-io)分离逻辑和输入输出
...
### [](#dont-initilze-uncontrolled-values-directly)不要直接初始化不受控制的值
