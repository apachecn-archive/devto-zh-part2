...
> 原文:[https://dev . to/yemi webby/building-a-chat-bot-using-nestjs-and-telegram-4i2h](https://dev.to/yemiwebby/building-a-chat-bot-using-nestjs-and-telegram-4i2h)
...
### [](#installing-server-dependencies)安装服务器依赖关系
...
### [](#creating-a-telegram-bot)创建电报机器人
...
### [](#initialize-the-application-controller)初始化应用控制器
...
### [](#configure-the-bot-service)配置 bot 服务
