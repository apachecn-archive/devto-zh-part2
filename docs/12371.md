...
> 原文:[https://dev . to/whoisryosuke/how-to-deploy-a-laravel-oauth 2-API-on-heroku-for-free-4 LPF](https://dev.to/whoisryosuke/how-to-deploy-a-laravel-oauth2-api-on-heroku-for-free-4lpf)
...
## [](#a-free-api-for-user-authentication)一个用于用户认证的(免费)API
...
## [](#setting-up-an-authentication-api)设置认证 API
...
## [](#connecting-to-your-new-api)连接到您的新 API
