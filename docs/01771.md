...
> 原文:[https://dev . to/on myway 133/how-to-structure-your-project-and-manage-static-resources-in-react-native-2m34](https://dev.to/onmyway133/how-to-structure-your-project-and-manage-static-resources-in-react-native-2m34)
...
### [](#as-few-dependencies-as-possible)尽可能少的依赖
...
> # [](#mobile-apps-are-rarely-made-up-of-a-single-screen-managing-the-presentation-of-and-transition-between-multiple-screens-is-typically-handled-by-what-is-known-as-a-navigator)Mobile phone applications rarely consist of a single screen. Managing the presentation of multiple screens and the conversion between multiple screens is usually handled by a so-called navigator.

### [](#indexjs-or-not)index.js 还是不是？
...
### [](#use-packagejson-to-avoid-relative-path)使用 package.json 避开相对路径
...
### [](#group-colors-images-fonts-with-palette)用调色板分组颜色、图像、字体
...
### [](#how-about-custom-fonts)自定义字体怎么样
...
> # [](#238-use-pascalcase-when-you-export-a-constructor-class-singleton-function-library-bare-object)[23.8](https://github.com/airbnb/javascript#naming--PascalCase-singleton) Use PascalCase when exporting constructor/class/singleton/function library/naked object.
