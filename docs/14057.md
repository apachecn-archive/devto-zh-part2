...
> 原文:[https://dev . to/thadevelounknow/git-branching-step-by-step-2 PCC](https://dev.to/thadevelyouknow/git-branching-step-by-step-2pcc)
...
##### 
 [](#it-is-highly-recommended-that-you-install-some-kind-of-decorator-for-your-shell-bash-or-zsh-it-will-help-you-always-know-what-branch-youre-in-and-its-easier-on-the-eyes-many-use-iterm-i-install-ohmyzsh-with-curl-visit-zsh) 
