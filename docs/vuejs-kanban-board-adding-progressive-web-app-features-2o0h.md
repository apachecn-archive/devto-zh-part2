# Vue.js 看板:添加渐进式 Web 应用程序功能

> 原文：<https://dev.to/auth0/vuejs-kanban-board-adding-progressive-web-app-features-2o0h>

在本文中，我们将继续开发本系列第 1 部分中的[看板应用程序，以添加基本的数据持久性和渐进式 Web 应用程序特性，比如离线支持和添加到您的移动主屏幕。](https://auth0.com/blog/vuejs-kanban-board-the-development-process/)
