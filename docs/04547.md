...
## [](#firing-up-a-local-kafka-cluster)点燃了当地的卡夫卡集群
...
## [](#enter-the-fraud-detection-system)进入:欺诈检测系统
...
## [](#isolating-the-kafka-cluster)孤立卡夫卡集群
...
## [](#building-the-transaction-generator)构建交易生成器
...
## [](#trying-out-the-transaction-generator)试用事务生成器
...
## [](#building-the-fraud-detector)构建欺诈检测器
...
## [](#trying-out-the-fraud-detector)试用欺诈检测器
