...
> 原文:[https://dev . to/pedrammarandi/libraries-you-need-to-use-with-your-graphql-stack-hag](https://dev.to/pedrammarandi/libraries-you-need-to-use-with-your-graphql-stack-hag)
...
### [](#reuse-graphql-files)重用 Graphql 文件
...
### [](#query-batching-amp-caching)查询批处理&缓存
