...
> 原文:[https://dev . to/bnevilleoneill/an-impressive-guide-to-forms-in-react-5162](https://dev.to/bnevilleoneill/an-imperative-guide-to-forms-in-react-5162)
...
### [](#forms-and-events-in-react)对形式和事件做出反应
