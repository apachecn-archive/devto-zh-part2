...
> 原文：<https://dev.to/thepracticaldev/the-7-most-popular-dev-posts-from-the-past-week--615>
...
#agile #scrum #estimations #git](/dmelidonis/how-long-will-it-take-git-knows--32hm)

# 2。是不是超？还是 iterm？还是 xterm 什么的？
...
#heroku #security #mozilla #staticbuildpack](/heroku/using-http-headers-to-secure-your-site-2no0)
...
#react](/swyx/a-walkthrough-of-that-react-suspense-demo--4j6a)
...
#discuss #javascript](/ycmjason/is-this-in-javascript-bad--3bhc)
...
#productivity #linux #ubuntu](/lobo_tuerto/you-need-to-know-about-i3-363c)
...
#react #discuss #javascript](/elaziziyoussouf/tools-you-need-to-use-in-your-react-components-development--13a7)
