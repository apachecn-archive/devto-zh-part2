...
> 原文:[https://dev . to/jpomykala/setup-custom-code build-environment-with-Amazon-ECR-4a1e](https://dev.to/jpomykala/setup-custom-codebuild-environment-with-amazon-ecr-4a1e)
...
## [](#codebuild-configuration)CodeBuild 配置
