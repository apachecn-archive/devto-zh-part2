...
> 原文:[https://dev . to/vinhnglx/migration-scripts-migrateroll back seeding-database-when-releasing-a-phoenixotp-app-by-distillery-1f1h](https://dev.to/vinhnglx/migration-scripts-migraterollbackseeding-database-when-releasing-a-phoenixotp-app-by-distillery-1f1h)
