...
> 原文:[https://dev . to/bertilmuth/kissing-the-state-machine-goodbye-34n 9](https://dev.to/bertilmuth/kissing-the-state-machine-goodbye-34n9)
...
## [](#state-machine-to-the-rescue)国家机器来救援
...
## [](#when-to-use-requirements-as-code)何时使用需求作为代码
...
## [](#how-the-credit-card-application-works-now)信用卡申请现在如何运作
