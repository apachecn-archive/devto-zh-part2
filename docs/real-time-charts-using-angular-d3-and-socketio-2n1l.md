# 使用 Angular、D3 和 Socket 的实时图表。超正析象管(Image Orthicon)

> 原文：<https://dev.to/auth0/real-time-charts-using-angular-d3-and-socketio-2n1l>

在任何商业应用中，图表都是最吸引人的部分。实时更新的图表更加吸引人/有用，并为用户增加了巨大的价值。在这里，您将看到如何使用 Angular、D3 和 Socket.IO 创建实时图表。
