...
> 原文:[https://dev . to/aibolik/create-your-own-virtual-DOM-to-understand-it-part-1-3g4e](https://dev.to/aibolik/create-your-own-virtual-dom-to-understand-it-part-1-3g4e)
...
> 虚拟 DOM 是 DOM 作为对象的表示。当应用程序的状态发生变化时，新的虚拟 DOM 将与 DOM 进行比较(应用[](https://reactjs.org/docs/reconciliation.html)**)并且仅反映变化，而不会导致 DOM 的完全重新呈现。**
...
### [](#hyperscript-implementation)HyperScript 实现
...
#### [](#creating-application-with-hyperscript)使用 Hyperscript 创建应用程序
...
#### [](#implement-vdom-rendering)实现 vDOM 渲染
