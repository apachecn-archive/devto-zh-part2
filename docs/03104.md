...
> 原文:[https://dev . to/shanalikhan/enable-application-mode-in-dynamics-365-and-retail-server-b](https://dev.to/shanalikhan/enable-application-mode-in-dynamics-365-and-retail-server-b)
...
#### [](#create-application-in-azure-active-directory)在 Azure Active Directory 中创建应用程序
...
#### [](#add-application-detail-into-retail-server-white-list)将应用详细信息添加到零售服务器白名单中
