...
> 原文:[https://dev . to/dced dia/perfect-pulled-pork-with-react-native-Expo-and-express-2dag](https://dev.to/dceddia/perfect-pulled-pork-with-react-native-expo-and-express-2dag)
...
## [](#grand-plans-the-system-layout)宏伟计划:系统布局
...
#### [](#install-expo-on-computer-and-phone)在电脑和手机上安装 Expo
...
### [](#finally-taking-a-picture)最后:拍照
...
## [](#taking-photos-on-a-timer)用定时器拍照
