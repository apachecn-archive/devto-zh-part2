...
### [](#the-user-messages-app)用户消息 App
...
### [](#refactoring-the-serializer)重构序列化程序
...
### [](#preventing-user-impersonation-amp-protecting-user-privacy)防止用户假冒&保护用户隐私
