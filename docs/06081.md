...
> 原文:[https://dev . to/oktadev/use-nginx-to-add-authentic ation-to-any-application-4b1o](https://dev.to/oktadev/use-nginx-to-add-authentication-to-any-application-4b1o)
...
## [](#why-authenticate-at-the-web-server)为什么要在 Web 服务器上认证？
...
## [](#using-the-nginx-authrequest-module)使用 nginx auth_request 模块
...
## [](#configure-your-protected-nginx-host)配置您受保护的 nginx 主机
...
## [](#configure-a-server-block-for-lasso)为 Lasso 配置一个服务器块
...
## [](#configure-and-deploy-lasso)配置和部署套索
...
## [](#learn-more-about-oauth-20-and-secure-user-management-with-okta)了解有关 OAuth 2.0 和 Okta 安全用户管理的更多信息
