...
> 原文:[https://dev . to/datawireio/deploying-Java-apps-with-kubernetes-and-the-ambassador-API-gateway-6pn](https://dev.to/datawireio/deploying-java-apps-with-kubernetes-and-the-ambassador-api-gateway--6pn)
...
## [](#a-quick-recap-architecture-and-deployment)快速回顾:架构和部署
...
## [](#quick-aside-why-use-an-api-gateway)快速旁白:为什么要使用 API 网关？
...
## [](#getting-started-nodeports-and-loadbalancers-101)入门:节点端口和负载平衡器 101
...
## [](#deploying-the-ambassador-api-gateway)部署大使 API 网关
