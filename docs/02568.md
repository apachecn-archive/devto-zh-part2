...
> 原文:[https://dev . to/lkopacz/3-simple-tips-to-improve-keyboard-accessibility-5hc 8](https://dev.to/lkopacz/3-simple-tips-to-improve-keyboard-accessibility-5hc8)
...
## [](#what-is-keyboard-accessibility)什么是键盘辅助功能
...
## [](#tip-1-stop-using-divs-and-use-semantic-html)技巧 1:停止使用 divs，使用语义 HTML
...
## [](#tip-2-always-provide-an-option-to-skip-the-main-navigation)提示 2:始终提供一个跳过主导航的选项
...
## [](#tip-3-dont-remove-focus-indicators)提示 3:不要移除焦点指示器
