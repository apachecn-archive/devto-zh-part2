...
# [](#part-2-adding-guardian-authentication)第二部分:添加监护人认证
...
## [](#add-the-guardian-dependency)添加监护人依赖关系
...
## [](#generate-the-jwt-tokens)生成 JWT 代币
...
## [](#configure-the-routes-to-our-users-api)配置路由给我们的用户 API
