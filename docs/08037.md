...
> 原文:[https://dev . to/js guru _ io/dos-and-donts-for-JavaScript-newbies-5dkl](https://dev.to/jsguru_io/dos-and-donts-for-javascript-newbies--5dkl)
...
### [](#let-or-const-instead-of-var)用 LET 或 CONST 代替 VAR
...
#### [](#1-fetching-dom-elements)1。获取 DOM 元素
...
#### [](#2-dom-manipulation-in-the-loop)2。循环中的 DOM 操作
