...
> 原文：<https://dev.to/datawireio/using-api-gateways-to-facilitate-your-transition-from-monolith-to-microservices-4n4g>
...
正如我在以前的文章“[连续交付:API 网关如何帮助(或阻碍)](https://blog.getambassador.io/continuous-delivery-how-can-an-api-gateway-help-or-hinder-1ff15224ec4d)中所写的，“舞动的骨架”这样的模式可以极大地帮助证明新应用程序和基础设施的端到端可行性。然而，绝大多数潜在的客户交互都是通过系统内的单点(入口或边缘网关)进行的，因此，要对现有系统进行试验和改进，您需要在这方面投入大量的时间和精力。
...
*本文最初由[丹尼尔·布莱恩特](https://www.twitter.com/danielbryantuk)* 发表在[大使博客](https://blog.getambassador.io/using-api-gateways-to-facilitate-your-transition-from-monolith-to-microservices-5e630da24717)上