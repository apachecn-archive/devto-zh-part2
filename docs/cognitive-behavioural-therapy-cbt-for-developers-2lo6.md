...
> 原文：<https://dev.to/himashi99/cognitive-behavioural-therapy-cbt-for-developers-2lo6>

前几天，我参加了一个非常有趣的聚会，名为认知行为疗法(CBT ),是为技术领导者举办的。这个讲座由 Jamie Strachan 主持，他做了 15 年的开发人员，现在在 Info-Tech Research Group 管理一个开发团队。在与自己的抑郁症作斗争的过程中，他接触到了大卫·D·伯恩斯的书《感觉良好》,在那里他发现了认知行为疗法。
...
情感推理——我们相信我们的感觉必然是真实的。我们相信这些不健康的情绪反映了事情的真实情况。

因为我感到不知所措，我一定是面对了什么压倒一切的事情。

全有或全无思维——如果我们在某个领域表现不佳，我们会认为自己是个彻底的失败者。

我不能很快地学会这种语言，因此作为一名开发者我是失败的。

“应该”陈述——我们有一套关于我们应该如何表现的严格规则。我们认为这些话在针对我们自己的时候是激励人心的，然而它们经常会留下内疚、沮丧和失败的感觉。

我真的应该运动了。

妄下结论(读心术，算命师的错误)——即使没有确凿的事实令人信服地支持我们的结论，我们也会得出否定的结论。
...
灾难化/放大或最小化——我们预计最糟糕的情况会发生在一个本来不是大问题的小事件上。

我犯了一个错误，现在整个项目都毁了，我会被解雇。

标签——我们将一两个品质归纳为负面的整体判断。
