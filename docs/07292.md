...
> 原文:[https://dev . to/Hugo _ _ df/abiling-jest-snapshot-tests-some-nice-use-cases-ncn](https://dev.to/hugo__df/abusing-jest-snapshot-tests-some-nice-use-cases--ncn)
...
## [](#database-models)数据库型号🏬

### [](#setup-%F0%9F%8F%97)设置🏗
...
## [](#pug-or-handlebars-templates)帕格或车把模板
...
### [](#if-you-can-do-a-full-match-do-it)如果能做到完全匹配，就去做
...
### [](#try-to-cover-the-same-codefeature-with-another-type-of-test)尝试用另一种类型的测试✌️覆盖相同的代码/特性
