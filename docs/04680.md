...
> 原文:[https://dev.to/jamesmh/refactoring-legacy-monoliths-第三部分-游戏计划和重构-提示-c56](https://dev.to/jamesmh/refactoring-legacy-monoliths---part-3-game-plan-and-refactoring-tips-c56)
...
# [](#does-refactoring-mean-a-rewrite)重构是否意味着重写？
...
# [](#dealing-with-dependencies)处理依赖关系
...
# [](#dependency-breaking-and-refactoring-tips)依赖打破和重构技巧

让我们看看几个打破依赖的重构技巧。

### [](#1-turn-globals-into-interfaces-then-inject-them)1。把全局变成接口。然后给他们注射。
