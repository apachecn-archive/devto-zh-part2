...
> 原文:[https://dev . to/piczmar _ 0/spring-cloud-step-by-step-part-2-12o 2](https://dev.to/piczmar_0/spring-cloud-step-by-step-part-2-12o2)
...
### [](#configuring-config-service)配置配置服务
...
### [](#configuring-config-client)配置配置客户端
