...
> 原文:[https://dev . to/PS nebc/install-docker-compose-on-Linux-fedora-27-workstation-4c JC](https://dev.to/psnebc/install-docker-compose-on-linux-fedora-27-workstation-4cjc)
