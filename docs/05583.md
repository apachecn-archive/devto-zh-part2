...
> 原文:[https://dev . to/whoisryosuke/adding-testing-林挺和 docs-to-a-design-system-47nf](https://dev.to/whoisryosuke/adding-testing-linting-and-docs-to-a-design-system--47nf)
...
***   [**巴别塔**T3】](https://babeljs.io/)*   [**ESLint**](https://eslint.org/)*   [](https://github.com/prettier/prettier)***   [**React-Styleguidist**](https://react-styleguidist.js.org/)。****
...
## [](#installing-jest-enzyme-%E2%80%8D)安装 Jest +酵素🧙‍
...
## [](#creating-your-first-test)创建您的第一个测试⚙️
...
### [](#installing-reactstyleguidist)安装 React-Styleguidist
...
### [](#but-wait-it-doesnt-work-with-my-jss-theme)但是等等！它和我的 JSS 主题不搭配？😭
...
## [](#testing-linting-docs-done)测试，林挺，文档完成！🙌
