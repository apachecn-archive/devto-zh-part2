...
> 原文:[https://dev . to/nylas/speeding-up-our-web hooks-system-60x-2 idh](https://dev.to/nylas/speeding-up-our-webhooks-system-60x-2idh)
...
## [](#detour-a-brief-introduction-to-the-nylas-transaction-log)绕道:Nylas 事务日志简介
...
## [](#how-our-legacy-webhook-system-worked)我们的传统 webhook 系统是如何工作的
...
## [](#rebuilding-webhooks)重建 webhooks
...
## [](#the-phantom-reads-problem)幻影读题
