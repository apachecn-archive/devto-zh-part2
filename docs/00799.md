...
> 原文:[https://dev . to/kenwalger/visualizing-your-data-with-MongoDB-charts-3eo 2](https://dev.to/kenwalger/visualizing-your-data-with-mongodb-charts-3eo2)
...
#### [](#mongodb-charts-benefits)MongoDB 图表的好处
...
### [](#analyzing-airbnb-data-with-mongodb-charts)用 MongoDB 图表分析 Airbnb 数据
