...
> 原文:[https://dev . to/bnevilleoneill/how-and-when-to-use-reactions-new-context-API-131 o](https://dev.to/bnevilleoneill/how-and-when-to-use-reacts-new-context-api-131o)
...
### [](#what-problem-does-context-api-solve)**上下文 API 解决什么问题？**
...
### [](#what-happened-to-the-current-context-api)**当前上下文 API 怎么了？**
...
### [](#using-react-context-api)使用 React 上下文 API
...
### [](#is-it-a-redux-killer)**难道是 Redux 杀手？**
...
### [](#when-should-you-use-react-context)什么时候应该使用 React 上下文？
