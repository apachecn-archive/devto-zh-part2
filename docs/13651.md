...
## [](#what-if-raw-fetch-endraw-succeeds)如果`fetch`成功了呢？
...
## [](#what-if-raw-fetch-endraw-fails)万一`fetch`失败了怎么办？
...
## [](#clean-things-up)收拾东西

### [](#redundant-function)冗余功能
...
## [](#es7-asyncawait-recursive)ES7 异步/等待递归
...
## [](#es7-asyncawait-forloop)ES7 异步/等待循环
