...
> 原文:[https://dev . to/acro 5 piano/how-nice-雄辩-API-resources-add-to-laravel-55-6 a3](https://dev.to/acro5piano/how-nice-eloquent-api-resources-added-to-laravel-55-6a3)

这是一篇有点晚的文章，但是我发现 Laravel 5.5 的雄辩的 API 资源是一个非常好的特性。

# [](#when-to-use-eloquent-api-resources)何时使用雄辩的 API 资源
...
# [](#fractal-for-larave-54)分形为 Larave ~5.4
