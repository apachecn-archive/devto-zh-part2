...
> 原文:[https://dev . to/mason ite/deploying-mason ite-to-python anywhere-26lj](https://dev.to/masonite/deploying-masonite-to-pythonanywhere-26lj)
...
# [](#adding-our-web-app)添加我们的 Web 应用程序
...
# [](#configuring-your-web-app)配置您的 Web 应用程序
