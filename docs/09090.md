...
> 原文:[https://dev . to/mariorodeghiero/JSON-server-with-react js-3c HD](https://dev.to/mariorodeghiero/json-server-with-reactjs-3chd)

# [](#json-server-with-reactjs)带有 ReactJS 的 jSON 服务器
...
## [](#creating-the-json-file)创建 JSON 文件
...
## [](#configuring-the-appjs-file)配置 App.js 文件
