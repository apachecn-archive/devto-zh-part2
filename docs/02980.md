...
> 原文:[https://dev . to/Jones Russell/docker-for-legacy-Drupal-development-2 IgM](https://dev.to/jonesrussell/docker-for-legacy-drupal-development-2igm)

#### [](#leveraging-linux-containers-for-migrating-drupal-6-to-drupal-8)利用 Linux 容器将 Drupal 6 迁移到 Drupal 8
...
*myDropWizard.com*[](https://www.mydropwizard.com/blog/drupal-6-year-2020-and-php-7-support)**的乡亲们正勇敢地支持着 D6，直到母牛回家，为他们喝彩！我和他们没有任何联系，我只是被他们* [*的承诺*](https://www.mydropwizard.com/blog/drupal-6-2019-yes-really) *的水平震惊了。**
...
### [](#vms-and-containers-compared)虚拟机和容器对比
...
#### [](#pull-apachephp-image)拉 Apache/PHP 图片
...
#### [](#documentroot-and-incoming-port)文档根和传入端口
