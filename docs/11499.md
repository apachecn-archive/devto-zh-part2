...
> 原文:[https://dev . to/green coder/build-your-own-transducer-and-impress-your-cat-part-4-2bp 8](https://dev.to/greencoder/build-your-own-transducer-and-impress-your-cat---part-4-2bp8)
...
# [](#early-termination-and-raw-reduced-endraw-values-in-transducers)提前终止和`reduced?`传感器中的值
...
## [](#there-is-a-function-for-that-rich-hickey)“有这样一个函数”——里奇·希基
