...
> 原文：<https://dev.to/adityasridhar/an-introduction-to-git-what-it-is-and-how-to-use-it-43m4>

**本帖原载于[medium.freecodecamp.org](https://medium.freecodecamp.org/what-is-git-and-how-to-use-it-c341b049ae61)T3】**
...
*   **分布式版本控制系统**:在 Git 中，每个开发人员的计算机都有一个本地 repo，它拥有包含变更历史的完整代码副本。Git 不一定需要一个中央服务器来工作。但是在大多数项目中，git 是和 github、gitlab、bitbucket 等等提供的远程存储库一起使用的。将在本帖中解释更多关于本地和远程存储库的内容。

**Git 本身是不要和 github，gitlab，bitbucket 等等混为一谈的。**
...
分支只不过是指向 Git 存储库中最新提交的指针。所以目前我们的主分支是第二次提交的指针`“demo.txt file is modified”`。
...
`git clone`用于将现有的远程存储库克隆到您的计算机中。
该命令为:
