...
> 原文:[https://dev . to/riccardo _ cardin/template-method-pattern-revised-3d 3](https://dev.to/riccardo_cardin/template-method-pattern-revised-3od3)
...
## [](#template-method-pattern-the-right-way)模板方法模式:正确的方式
...
### [](#the-programmable-template-method)可编程模板法
...
#### [](#functional-programming-currying-and-partial-application)函数编程:currying 和局部应用
