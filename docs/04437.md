...
> 原文:[https://dev . to/on myway 133/using-bit rise-ci-for-Android-apps-5e3k](https://dev.to/onmyway133/using-bitrise-ci-for-android-apps-5e3k)
...
## [](#bump-version-code-automatically)自动撞版码
