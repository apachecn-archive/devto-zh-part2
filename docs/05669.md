...
> 原文:[https://dev . to/John Carroll/r schedule-a-JavaScript-recurring-dates-library-51c 6](https://dev.to/johncarroll/rschedule-a-javascript-recurring-dates-library-51c6)
...
### [](#occurrence-stream-operators)出现流运算符
...
# [](#to-learn-more-check-out-the-rschedule-repo)[欲了解更多，请查看 rSchedule repo。](https://gitlab.com/john.carroll.p/rschedule)