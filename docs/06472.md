...
> 原文:[https://dev.to/zellwk/pushing-to-a-git-remote-1ck8](https://dev.to/zellwk/pushing-to-a-git-remote-1ck8)
...
## [](#creating-a-repository-on-github)在 Github 上创建资源库
...
## [](#linking-the-local-repository-to-the-remote-repository)将本地存储库链接到远程存储库
...
## [](#pushing-to-the-remote-for-the-first-time)第一次推送到远程
...
## [](#pushing-for-the-second-time)第二次出招
