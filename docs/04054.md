...
# [](#install-asposediagram-using-maven-in-eclipse-ide)安装 Aspose。在 Eclipse IDE 中使用 Maven 的图表
...
# [](#input-microsoft-visio-files-used-inside-code)输入 Microsoft Visio 文件内部使用的代码

本节介绍并解释示例代码中使用的输入 Microsoft Visio 文件。

## [](#template-microsoft-visio-file)模板 Microsoft Visio 文件
...
## [](#stencil-microsoft-visio-file-containing-master-shapes)包含主控形状的模具 Microsoft Visio 文件
