...
> 原文:[https://dev . to/bright devs/adding-features-to-your-chart-on-Android-ekp](https://dev.to/brightdevs/adding-features-to-your-chart-on-android-ekp)
...
## [](#custom-handling-of-chart-tap-event)自定义处理图表点击事件
