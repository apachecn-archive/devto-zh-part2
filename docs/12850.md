...
> 原文:[https://dev . to/sait/why-web-performance-is-really-matters-2gb](https://dev.to/sait/why-web-performance-is-really-matters-2ogb)
...
## [](#what-really-happens-when-we-hit-an-url-on-the-tab)当我们点击标签上的一个 URL 时，会发生什么
