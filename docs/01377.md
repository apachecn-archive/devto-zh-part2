...
> 原文:[https://dev . to/jcoelho/how-to-deploy-email-signatures-through-group-policies-4aj 1](https://dev.to/jcoelho/how-to-deploy-email-signatures-through-group-policies-4aj1)
...
## [](#group-policies-to-the-rescue)组织政策救援
...
### [](#1-creating-a-signature-template)1。创建签名模板
...
### [](#2-powershell-script)2。PowerShell 脚本
...
### [](#3-we-got-a-signature)3。我们得到了一个签名
...
### [](#4-set-up-a-group-policy)4。设置组策略
