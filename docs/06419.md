...
> 原文:[https://dev . to/whoisryosuke/creating-a-design-system-for-reactjs-from-scratch-4a ca](https://dev.to/whoisryosuke/creating-a-design-system-for-reactjs-from-scratch-4aca)
...
## [](#requirements-for-a-design-system)对设计系统的要求
...
### [](#my-css-in-js-choice)我的 CSS 在 JS 中选择
...
## [](#setting-up-the-dev-environment)设置开发环境
...
## [](#running-your-storybook)运行你的故事书
