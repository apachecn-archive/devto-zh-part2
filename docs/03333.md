...
> 原文:[https://dev . to/benny powers/bonus-solution-problems-in-vue-with web-components-2582](https://dev.to/bennypowers/bonus-solving-problems-in-vue-with-web-components-2582)
...
## [](#defining-raw-ltpopuptooltipgt-endraw-)定义`<popup-tooltip>`
...
## [](#connecting-to-the-vue-wrapper)连接到 Vue 包装器
