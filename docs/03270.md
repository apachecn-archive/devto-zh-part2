...
> 原文:[https://dev.to/bnevilleoneill/react-datepicker-2oc6](https://dev.to/bnevilleoneill/react-datepicker-2oc6)
...
#### [](#include-bootstrap-css)包含自举 CSS
...
### [](#calendar-helpers-module)日历助手模块

#### [](#basic-constants-and-helpers)基本常量和助手
...
#### [](#building-the-calendar-component)构建日历组件
...
#### [](#rendering-parts-of-the-calendar-component)渲染部分日历组件
...
#### [](#building-the-datepicker)构建日期选择器
...
#### [](#rendering-the-datepicker)渲染日期选择器
...
#### [](#styling-the-datepicker)设置日期选择器的样式
