...
> 原文:[https://dev . to/nes HAZ/structure-of-a-sailsjsgraphql-application-3d6o](https://dev.to/neshaz/structure-of-a-sailsjsgraphql-application-3d6o)
...
首先，你将生成 sails 应用程序(我假设你已经安装了[](https://kolosek.com/install-nodejs-on-ubuntu/)**和 **Sails** ，如果没有，这里有一点帮助[如何开始](https://sailsjs.com/get-started)):**
