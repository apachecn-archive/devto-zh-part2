...
> 原文:[https://dev . to/javin Paul/should-Android-developers-learn-kot Lin-or-Java-13k 7](https://dev.to/javinpaul/should-android-developers-learn-kotlin-or-java-13k7)
...
### [](#java-programmers-should-learn-kotlin)Java 程序员应该学习 Kotlin
...
如果你是一名 Java 开发人员，那么你最好开始学习 Kotlin，这不仅可以提高你的生产率，还可以帮助你成为了解 Kotlin 的 Java 开发人员中利润丰厚的一员，这可能会让你在就业市场上具有竞争优势。它也是我列出的 Java 开发者应该学习的三种 JVM 语言[](http://javarevisited.blogspot.sg/2018/02/top-3-jvm-languages-java-programmer-learn.html)**之一。**
