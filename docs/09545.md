...
## [](#writing-a-very-basic-unit-test-framework)编写一个非常基本的单元测试框架
...
## [](#moving-my-function-to-a-separate-file)将我的函数移动到一个单独的文件
...
## [](#creating-my-test-file)创建我的测试文件
...
### [](#simple-effective-test-organization)简单、有效的测试组织
...
### [](#but-it-failed-shouldnt-that-mean-anything)但是失败了，那不应该意味着什么吗？
