...
> 原文:[https://dev . to/muak _ x/creating-custom-image source-in-xamarinforms-and-displaying-an-SVG-image-to-default-image-control-4dn 7](https://dev.to/muak_x/creating-custom-imagesource-in-xamarinforms-and-displaying-an-svg-image-to-default-image-controll-4dn7)
...
## [](#procedure-of-adding-custom-imagesource)添加自定义图像源的步骤
...
## [](#define-custom-imagesource)定义自定义图像源
...
## [](#implementing-iimagesourcehandler-for-ios)为 iOS 实现 IImageSourceHandler
...
## [](#registers-custom-imagesource-and-imagesourcehandler)注册自定义 ImageSource 和 ImageSourceHandler
