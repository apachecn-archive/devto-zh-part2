# 基于角色的访问控制(RBAC)和 React 应用

> 原文：<https://dev.to/auth0/role-based-access-control-rbac-and-react-apps-1bhc>

在本文中，您将了解如何在 React 应用程序中正确实现基于角色的访问控制(RBAC)。首先，您将简要了解什么是授权和身份验证。然后，您将看到一个在保护 React 应用程序时经常使用的简单策略。最后，您将了解什么是 RBAC，看到工作示例，了解什么使它成为更好的策略，以及如何在 React 中实现它。
