...
> 原文:[https://dev . to/JPDA/using-azure-managed-service-identities-with-your-apps-37cl](https://dev.to/jpda/using-azure-managed-service-identities-with-your-apps-37cl)
...
### [](#adding-our-msi-to-the-approle)将我们的 MSI 添加到 appRole
