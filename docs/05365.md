...
> 原文:[https://dev.to/mostlyjason/error-monitoring-in-ios-2ddi](https://dev.to/mostlyjason/error-monitoring-in-ios-2ddi)
...
## [](#error-monitoring-with-rollbar)用滚动条进行错误监控
...
## [](#how-to-set-up-an-ios-project-on-rollbar)如何在滚动条上设置 iOS 项目
...
## [](#adding-rollbar-in-your-code)在代码中添加滚动条
...
## [](#upload-debugging-symbols-to-rollbar)上传调试符号到滚动条
...
## [](#test-rollbar-with-an-example-ios-app)用一个 iOS 应用实例测试滚动条
