...
# [](#setting-up-the-dependencies-in-gradle)在 gradle 中设置依赖关系
...
# [](#notes-on-how-to-make-intellij-work-with-this)关于如何让 IntelliJ 工作的说明
...
# [](#setting-up-a-null-binding-as-your-first-implementation)设置空绑定作为您的第一个实现
...
# [](#making-the-http-tests-work-after-we-add-the-dataservice-constructor-dependency)在我们添加了数据服务构造函数依赖之后，让 HTTP 测试工作起来
...
# [](#bonus-how-to-log-exceptions-in-jersey)奖励:如何在泽西记录异常
