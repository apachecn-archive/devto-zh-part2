...
> 原文:[https://dev . to/florimondmanca/restful-API-design-13-best-practices-to-make-your-users-happy-ag6](https://dev.to/florimondmanca/restful-api-design-13-best-practices-to-make-your-users-happy-ag6)
...
## [](#1-learn-the-basics-of-http-applied-to-rest)1。学习应用于 REST 的 HTTP 基础知识
...
## [](#2-dont-return-plain-text)2。不要返回纯文本
...
## [](#3-avoid-using-verbs-in-uris)3。在 URIs 避免使用动词
...
## [](#4-use-plural-resource-nouns)4。使用复数资源名词
...
## [](#5-return-error-details-in-the-response-body)5。在响应正文中返回错误详细信息
...
## [](#6-pay-attention-to-status-codes)6。请注意状态代码
...
## [](#7-use-status-codes-consistently)7。一致地使用状态代码
...
## [](#8-dont-nest-resources)8。不要嵌套资源
...
## [](#9-handle-trailing-slashes-gracefully)9。优雅地处理尾随斜线
...
## [](#10-make-use-of-the-querystring-for-filtering-and-pagination)10。利用 querystring 进行过滤和分页
...
## [](#12-make-good-use-of-raw-202-accepted-endraw-)12。好好利用`202 Accepted`
...
## [](#13-use-a-web-framework-specialised-in-rest-apis)13。使用专门针对 REST APIs 的 web 框架
...
## [](#lets-give-rest-a-great-name)让我们给 REST 起个伟大的名字吧！
