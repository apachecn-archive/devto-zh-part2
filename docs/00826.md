...
> 原文:[https://dev . to/Alex _ barashkov/tips-and-tricks-for-scalable-cicd-flow-49b 7](https://dev.to/alex_barashkov/tips-and-tricks-for-scalable-cicd-flow--49b7)
...
### [](#define-your-vcs-flow)定义你的 VCS 流
...
### [](#specify-your-environments)指定您的环境
...
### [](#define-docker-image-names-convention)定义 Docker 图像命名约定
