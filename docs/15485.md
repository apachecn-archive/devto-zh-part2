...
> 原文:[https://dev . to/rounakpolley/building-my-very-first-minimum-value-product-dn5](https://dev.to/rounakpolley/building-my-very-first-minimum-value-product--dn5)
...
## [](#features-of-this-mvp)本 MVP 的特点
...
## [](#creating-the-ui-using-reactjs-and-materialui)使用 ReactJS 和 Material-UI 创建 UI
