...
## [](#-raw-documentqueryselectorall-endraw-)`Document.querySelectorAll()`
...
## [](#commonjs-amd-requirejs-modules)CommonJS，AMD，Requirejs，模块

### [](#serverside-story)服务器端故事
...
## [](#i-see-a-pattern-here)我在这里看到一个模式
