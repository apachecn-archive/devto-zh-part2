...
> 原文:[https://dev . to/robertcoopercode/from-idea-to-app-store-building-my-first-IOs-app-with-react-native-1ej 7](https://dev.to/robertcoopercode/from-idea-to-app-store-building-my-first-ios-app-with-react-native-1ej7)
...
#### [](#app-store-submission)App Store 提交
