...
> 原文:[https://dev . to/bright devs/how-to-call-a-load-balanced-ECS-service-428d](https://dev.to/brightdevs/how-to-call-a-load-balanced-ecs-service--428d)
...
# [](#deploy-an-ecs-service-to-multiple-hosts)将一个 ECS 服务部署到多台主机
...
# [](#a-private-load-balancer)私有负载均衡器
...
# [](#attach-ecs-service-to-an-application-load-balancer)将 ECS 服务附加到应用程序负载平衡器
...
# [](#a-private-dns-record)一条私有 DNS 记录
