...
## [](#using-raw-mobxfirebasedatabase-endraw-with-vanilla-js)用`mobx-firebase-database`搭配香草 JS
...
## [](#using-raw-mobxfirebasedatabase-endraw-with-reactjs)使用`mobx-firebase-database`与 ReactJS
