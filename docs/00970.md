...
> 原文:[https://dev . to/essential developer/小心 singleton-lookalikes-way-too-common-2hl 5](https://dev.to/essentialdeveloper/careful-with-singleton-lookalikes-way-too-common-2hl5)
...
## [](#what-is-a-singleton-with-a-lowercase-s)小写“s”的 singleton 是什么？
...
## [](#singletons-vs-global-mutable-shared-state)单态 vs .全局可变共享状态
...
## [](#examples-of-good-singleton-candidates)优秀单身候选人的例子
...
## [](#examples-of-bad-singleton-candidates)糟糕的单身候选人的例子
