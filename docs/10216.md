...
# [](#quick-intro-to-hoodie-and-offlinefirst)快速介绍帽衫和*离线-第一次*
...
# [](#login-and-register-functionality-with-hoodie)用连帽衫登录和注册功能
...
# [](#transpiling-our-code-for-increased-browser-support)传输我们的代码以增加浏览器支持
...
# [](#saving-the-shopping-list-and-viewing-history)保存购物清单和查看历史记录
...
## [](#create-a-service-worker-script)创建服务工作者脚本
...
## [](#modifying-our-service-worker)修改我们的服务人员
