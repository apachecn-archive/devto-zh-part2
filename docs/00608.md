...
> 原文:[https://dev . to/content ful _ blog/how-to-automatically-watermark-content ful-assets-using-a-server less-function-6j 3](https://dev.to/contentful_blog/how-to-automatically-watermark-contentful-assets-using-a-serverless-function-6j3)
...
### [](#why-is-an-http-endpoint-such-a-big-deal)为什么一个 HTTP 端点这么重要？
...
## [](#the-main-flow-webhooks-triggering-serverless-functions)主流程——触发无服务器功能的 webhooks
...
### [](#getting-started-with-the-serverless-framework)无服务器框架入门
...
### [](#make-the-function-executable-via-http)通过 HTTP 使功能可执行
...
## [](#manipulating-images-in-a-serverless-function-using-jimp)使用 Jimp 在无服务器功能中操作图像
...
### [](#adding-npm-dependencies-to-your-serverless-project)向无服务器项目添加 npm 依赖项
...
### [](#the-composition-of-two-images-with-jimp)用 Jimp 合成两幅图像
...
### [](#read-the-webhook-payload-and-watermark-the-uploaded-image)读取 webhook 有效载荷，对上传的图片进行水印处理
...
### [](#uploading-the-new-watermarked-asset-to-contentful)将新的水印资产上传到 Contentful
...
### [](#additional-comments-and-notes)附加注释和说明

#### [](#how-to-develop-lambda-functions-locally)如何局部开发 Lambda 函数？
