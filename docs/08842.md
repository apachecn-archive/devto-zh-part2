...
> 原文:[https://dev . to/tech community/automated-screen-testing-for-devo PS-success-3bp 1](https://dev.to/techcommunity/automated-screen-testing-for-devops-success-3bp1)

# [](#for-devops-success)为 DevOps 成功
...
## [](#the-role-of-testing-in-devops)测试在 DevOps 中的作用
...
## [](#screenbased-test-automation-for-business-functions)基于屏幕的业务功能自动化测试
...
## [](#automate-once-and-done)自动化一次完成
...
## [](#benefits-of-automated-screen-testing)自动化屏幕测试的好处
