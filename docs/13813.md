...
> 原文:[https://dev . to/quii/learn-go-by-writing-tests-structs-methods-interfaces-table-driven-tests-1p 01](https://dev.to/quii/learn-go-by-writing-tests-structs-methods-interfaces--table-driven-tests-1p01)
...
# [](#structs-methods-and-interfaces)结构、方法和接口
