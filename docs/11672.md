...
> 原文:[https://dev . to/norus/keeping-track-of-my-maestro-card-transactions-with-AWS-4c 8](https://dev.to/norus/keeping-track-of-my-maestro-card-transactions-with-aws-4c8)
...
### [](#required-aws-components)所需的 AWS 组件
