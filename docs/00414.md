...
> 原文:[https://dev . to/take shape/use-gatsbyjs-and-take shape-to-make-your-jam stack-site-sweeter-51og](https://dev.to/takeshape/use-gatsbyjs-and-takeshape-to-make-your-jamstack-site-sweeter-51og)
...
## [](#the-bold-and-adventurous-should-continue)大胆和冒险应该继续
...
## [](#connect-gatsby-to-takeshape)将盖茨比连接成一个形状
...
## [](#migrating-from-nunjucks-to-react)从双节棍迁徙中反应过来
...
#### [](#creating-your-project-path)创建您的项目路径
...
#### [](#creating-your-project-component-and-query)创建您的项目组件并查询
...
## [](#preview-your-production-site)预览您的生产现场
...
## [](#deploy-your-fancy-new-site-to-netlify)将您的新网站部署到网络生活中
...
## [](#interested-in-headless-cms-for-gatsbyjs)对 Gatsby.js 的无头 CMS 感兴趣？
