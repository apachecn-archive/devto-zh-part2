...
# [](#creating-a-new-vuejs-app)创建新的 Vue.js 应用
...
# [](#asynchronous-route-loading)异步路线加载
...
# [](#dynamic-component-rendering)动态组件渲染

这个在 Vue.js 里太容易了…自己看看就判断了。

## [](#defining-new-components)定义新组件
...
# [](#async-loading-dynamic-rendering)异步加载+动态渲染
