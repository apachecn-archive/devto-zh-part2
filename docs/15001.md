...
> 原文:[https://dev . to/neo/how-to-build-message-delivery-status-in-IOs-using-pusher-2d0l](https://dev.to/neo/how-to-build-message-delivery-status-in-ios-using-pusher--2d0l)
...
## [](#creating-the-views-for-our-ios-application)为我们的 iOS 应用创建视图
...
## [](#coding-the-message-delivery-status-for-our-ios-application)为我们的 iOS 应用程序编码消息传递状态
