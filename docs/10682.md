...
> 原文:[https://dev . to/bnevilleoneill/rendering-large-lists-with-react-virtualized-2p8b](https://dev.to/bnevilleoneill/rendering-large-lists-with-react-virtualized-2p8b)
...
### [](#autoresizing-a-virtualized-list)自动调整虚拟化列表
...
### [](#calculating-the-height-of-a-row-automatically)自动计算一行的高度
...
### [](#syncing-scrolling-between-two-lists)同步两个列表之间的滚动
