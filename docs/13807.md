...
> 原文:[https://dev.to/risdenk/apache-livy-简化-阿帕奇-火花-集成-4b77](https://dev.to/risdenk/apache-livy---simplified-apache-spark-integration-4b77)
...
### [](#apache-livy-architecture)阿帕奇李维架构
...
### [](#integration-with-apache-livy)与 Apache Livy 整合
