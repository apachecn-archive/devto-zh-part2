...
# [](#angularjs-angular-v6-hybrid-finally)AngularJS + Angular (v6)混血儿(终于！)
...
## [](#create-a-new-angular-cli-project)创建新的 Angular CLI 项目

因为没有人想重新发明轮子，遵循这个“官方”指南来创建一个新项目:[https://angular.io/guide/quickstart](https://angular.io/guide/quickstart)

## [](#copy-amp-convert-all-javascript-files-to-typescript)复制&将所有 JavaScript 文件转换成 TypeScript
...
## [](#replacing-the-absolute-template-urls-in-with-relative-urls)用相对 URL 替换模板中的绝对 URL
...
## [](#tweaking-the-angular-cli-settings-to-accommodate-for-angularjs)调整角度 CLI 设置以适应角度
...
## [](#including-angularjs-in-your-angular-app)在您的 Angular app 中包含 AngularJS
