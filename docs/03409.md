...
> 原文:[https://dev . to/c33s/why-is git-on-windows-so-slow-with-a-1-week-114g](https://dev.to/c33s/why-is-git-on-windows-so-slow-with-gitlabcom-since-a-1-week-114g)
...
### [](#push-to-again-no-changes)再次推至(无变化)
...
### [](#pull-with-gittrace1)拉取 GIT_TRACE=1
