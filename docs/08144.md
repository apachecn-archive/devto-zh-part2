...
# [](#yaml-build-definitions)YAML 建立定义
...
# [](#welcome-to-sparrowdo-vsts-family)欢迎来到斯帕罗多 VSTS-*家族
...
# [](#turing-sparrowdo-into-task-runner)将 Sparrowdo 转入任务运行器
...
# [](#let-write-code-to-create-a-code)让编写代码创建一个代码
...
## [](#install-nuget-and-nuget-dependencies)安装 nuget 和 nuget 依赖项
