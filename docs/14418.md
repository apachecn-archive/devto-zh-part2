...
> 原文:[https://dev . to/heroku/a-house-of-cards-an-exploration-of-security-when-building-docker-containers-33in](https://dev.to/heroku/a-house-of-cards-an-exploration-of-security-when-building-docker-containers--33in)
...
## [](#attacking-the-build-vulnerability-found)攻击构建:发现漏洞
...
### [](#when-dockerfiles-attack)当 Dockerfiles 攻击
