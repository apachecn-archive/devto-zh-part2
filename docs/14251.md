...
> 原文:[https://dev . to/惠晶/learning-Cordova-while-writing-an-app-3i7e](https://dev.to/huijing/learning-cordova-while-rewriting-an-app-3i7e)
...
## [](#hey-so-we-have-this-demo)嘿，所以我们有这个演示…
...
## [](#native-app-but-im-so-foreign)原生 app？但是我太洋气了…
...
## [](#gulpifying-cordova-development)囿于科尔多瓦的发展
...
## [](#accessing-device-apis-with-cordova-plugins)使用 Cordova 插件访问设备 API
...
## [](#removing-jquery-is-cathartic)删除 jQuery 是一种宣泄
