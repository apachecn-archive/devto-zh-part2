...
> 原文:[https://dev . to/ampli fr/outsided-browser-detection-with-browsers list-10co](https://dev.to/amplifr/outdated-browser-detection-with-browserslist-10co)
...
## [](#separated-frontend-and-backend-projects)分离前端和后端项目
