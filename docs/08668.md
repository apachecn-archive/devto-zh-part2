...
## [](#use-and-understand-propertymap)使用并理解 PropertyMap
...
### [](#use-tdd-when-defining-mappings)定义映射时使用 TDD
...
### [](#modelmappervalidate)ModelMapper.validate()
...
### [](#example-of-effective-unit-test)有效单元测试的例子
