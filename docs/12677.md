...
> 原文:[https://dev . to/bright devs/how-to-publish-a-library-to-a-maven-repository-with-the-maven-publish-plugin-4gpf](https://dev.to/brightdevs/how-to-publish-a-library-to-a-maven-repository-with-the-maven-publish-plugin-4gpf)
...
# [](#define-maven-publishing)定义 Maven 发布
