...
> 原文:[https://dev . to/lauragift 21/setup-continuous-integration-with-Travis-ci-in-your-nodejs-app-26i 2](https://dev.to/lauragift21/setup-continuous-integration-with-travis-ci-in-your-nodejs-app-26i2)
...
### [](#integrate-travis-with-github)*将 Travis 与 GitHub 整合*
