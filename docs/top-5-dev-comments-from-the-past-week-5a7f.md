...
> 原文：<https://dev.to/devteam/top-5-dev-comments-from-the-past-week-5a7f>

这是你可能已经错过的令人敬畏的开发者评论的每周综述。欢迎并鼓励你使用 **[#bestofdev](https://dev.to/t/bestofdev)** 标签来发表帖子和评论。

[@davidk01](https://dev.to/davidk01) 跳进 **[有什么概念你现在明白了，但却花了你一辈子去领会？](https://dev.to/ben/whats-a-concept-you-understand-now-but-took-you-forever-to-grasp-4g06)** 用这颗智慧之珠穿线:
...
说说你对运动员的看法，但他们知道如何在团队中工作，他们的团队由知道如何领导的人领导。

你见过新的编程主管或高级开发人员接受领导力培训吗？团队动力方面的培训？心理学？管理人员？有效沟通？教练？

另一个例子:军队都在研究这个东西，因为他们知道作为一个团队工作的重要性。也许有一天我们的职业会流行起来。
...
*   你可以在 1 分钟内对你的网站进行全面分析(谷歌分析)。
*   你可以通过免费的 CDN 向你的网站访问者提供字体，哦，它还可以通过用户代理为访问者优化字体。(谷歌字体)
*   只需点击 3 下鼠标，你就可以展示你公司的位置(谷歌地图)
*   你可以在 1 分钟内运行一个完整的服务器(谷歌云)(付费)
*   您可以存储无限数量的照片(Google 相册)
*   您可以存储 10GB 数据(Google Drive)等...

哦，所有这些都在我的手机和台式机上同步。我可以通过谷歌浏览器轻松同步。

我们不能关闭谷歌和脸书。它们确实让我们的生活变得更加轻松。是的，他们收集了很多关于我们的信息。多亏了 GDPR，我们现在可以控制这一切，但问题是:

如果这些服务能够提供完全的隐私保护和零数据收集，您会为它们付费吗？

我打赌你不会，因为你喜欢免费服务。

你知道这些要花你多少钱吗？(不要说有 Dropbox 和其他免费的替代品，因为它们也会收集你的所有信息)
...
对于我的国家(印度)的许多学生来说，学校里没有电脑。大学是第一次接触电脑。为此惩罚人们似乎充其量只能起到反作用。

> *所有编程经验都在简历上*

这忽略了那些在国防和航空领域工作的人。对于这样的候选人，显示专业知识的唯一方法就是在简历中提及

> *乐于使用您选择的任何技术，“所有技术都是好的”*

最终，专业开发人员会解决业务问题。工具和技术是达到目的的手段，而不是目的本身。沉迷于特定的工具可能会让你偏离解决问题的轨道。的确，有些工具更适合特定的情况，但是在很多地方你没有决定的自由。

> *编程只是一项日常工作*

这是假设程序员没有编程之外的生活。一个人可以有编码之外的其他爱好。
