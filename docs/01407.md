...
> 原文:[https://dev.to/joaofbantunes/episode-005-依赖-注入-aspnet-core-from-0-to-over kill-50e 7](https://dev.to/joaofbantunes/episode-005---dependency-injection---aspnet-core-from-0-to-overkill-50e7)
...
## [](#extracting-logic-from-the-controller)从控制器中提取逻辑
...
## [](#using-the-builtin-container)使用内置容器

### [](#registering-the-service)注册服务
...
## [](#using-third-party-containers)使用第三方容器
...
### [](#using-other-container-features)使用其他容器特性
