...
> 原文:[https://dev . to/kayis/render-props-and-higher-order-components-5628](https://dev.to/kayis/render-props-and-higher-oder-components-5628)

*[封面图片由涂鸦拍照者拍摄，在 Flickr 上](https://www.flickr.com/photos/graffiti-picture-taker/)*

上周，我参加了有史以来第一次开发竞赛，并提交了一个无服务器的多人点击器游戏。

### [](#it-would-be-awesome-to-get-your-amp-on-my-entrypost)[要是能拿到你的❤️就太棒了&🦄在我的入门帖上](https://dev.to/kayis/startup-clix-serverless-pusher-contest-entry-written-in-javascript-1jai)
...
### [](#i-would-appreciate-your-amp-on-my-entrypost)[我很欣赏你的❤️ &🦄在我的入门帖上](https://dev.to/kayis/startup-clix-serverless-pusher-contest-entry-written-in-javascript-1jai)