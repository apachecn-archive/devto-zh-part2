...
> 原文：<https://dev.to/nabbisen/cinnamon-desktop-alt--tab-switcher-style-5dgc>

### 总结

是一个关于 [Cinnamon 桌面环境](https://en.wikipedia.org/wiki/Cinnamon_(software))的小技巧，也就是众所周知的 [Linux Mint](https://www.linuxmint.com/) 的标准。

最近从 [Mate](https://mate-desktop.org/) 转到了肉桂。
(嗯，我喜欢 Mate，因为它在轻量级和实用性之间取得了很好的平衡。)

肉桂有很多有用的功能和优雅的效果，大部分都让我满意。“alt + tab”窗口切换器的默认样式是少数例外之一。
