...
### [](#building-the-rails-cat-facts-app)构建 Rails Cat Facts app
...
### [](#adding-sms-notifications)添加短信通知

现在我们已经有了应用程序的基础，我们可以将它连接到我们的 Twilio 帐户，让人们订阅接收通知。

#### [](#configure-our-app)配置我们的 app
...
#### [](#twimldee-twimldum)TwiML-dee TwiML-dum
