...
> 原文:[https://dev.to/apium_hub/demystifying-redux-3p47](https://dev.to/apium_hub/demystifying-redux-3p47)
...
## [](#demystifying-redux-setup)揭秘 redux:设置
...
## [](#demystifying-redux-init-store)解密 redux: Init Store
...
## [](#demystifying-redux-actions)揭秘 redux:动作
...
## [](#demystifying-redux-reducers)揭秘 redux: reducers
...
## [](#demystifying-redux-store-subscriptions)揭秘 redux:商店订阅
...
## [](#demystifying-redux-vizualization)去神秘化还原:虚拟化
...
## [](#demystifying-redux-conclusion)揭秘雷杜:结论
