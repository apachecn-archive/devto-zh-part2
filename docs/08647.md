...
> 原文:[https://dev . to/atability/local-development-with-https-on-OS x-1 jpb](https://dev.to/tability/local-development-with-https-on-osx-1jpb)
...
## [](#option-1-generating-certificates-ourselves)选项一:自己生成证书
...
## [](#option-2-using-ngrok)选项二:使用 [ngrok](https://ngrok.com)
...
## [](#option-3-localsslproxy-dnsmasq)选项三:本地-SSL-代理+ dnsmasq
...
#### [](#localsslproxy)[本地-SSL-代理](https://github.com/cameronhunter/local-ssl-proxy)
...
#### [](#dnsmasq)[dnsmasq](http://www.thekelleys.org.uk/dnsmasq/doc.html)
...
### [](#bypassing-the-ssl-certificate-errors)绕过 SSL 证书错误
