...
# [](#1-up-and-running-with-react)1。使用 React 启动并运行
...
### [](#install-create-react-app-globally)全球安装 Create React App

`yarn global add create-react-app`

### [](#create-example-application-with-create-react-app-cli)使用 Create React App CLI 创建示例应用程序
...
### [](#view-your-example-app-in-the-browser)在浏览器中查看您的示例应用
...
# [](#2-prepping-for-electron)2。为电子做准备
...
### [](#move-into-the-raw-public-endraw-directory-and-create-a-new-file-called-raw-electronjs-endraw-)移动到`public`目录下，创建一个名为`electron.js`的新文件:

`cd public && touch electron.js`

### [](#populate-the-contents-of-your-raw-electronjs-endraw-file-with-the-following)用以下内容填充`electron.js`文件的内容:
...
# [](#3-modifying-our-packagejson-file)3。修改 package.json 文件
...
# [](#4-preparing-for-distribution)4。准备分发
...
### [](#adding-entitlements-files)添加权利文件
...
# [](#5-debugging-amp-resources)5。调试&资源
...
# [](#6-the-asar-file-amp-what-it-does)6。ASAR 文件&它做什么
