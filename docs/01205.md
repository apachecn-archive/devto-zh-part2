...
> 原文:[https://dev.to/joelnet/functional-javascript-函子-单子-承诺-1 波尔](https://dev.to/joelnet/functional-javascript---functors-monads-and-promises-1pol)
...
# [](#why-cant-anyone-explain-a-monad)为什么没人能解释一个单子？
...
# [](#are-we-ready-to-understand-a-functor)我们准备好理解一个函子了吗？
...
# [](#categories-object-and-maps-morphisms)类别、对象和贴图(态射)
