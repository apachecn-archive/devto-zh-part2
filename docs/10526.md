...
## [](#step-i-download-theme-package-to-local-pc)第一步-下载主题包到本地电脑

首先你需要下载主题安装包。通常主题会附带安装指南，并提供几种安装方式(手动、通过插件等)，所以在开始使用主题之前，请务必查看指南。

然后，提取下载的文件。

## [](#step-ii-import-theme-into-website)第二步——将主题导入网站
...
## [](#step-iii-activate-prestashop-theme)第三步-激活预铺主题

现在回到设计>主题和徽标页面，找到新安装的主题。悬停主题缩略图并点击“使用此主题”来激活默认主题的主题。

## [](#step-iv-install-sample-data)第四步-安装样本数据
