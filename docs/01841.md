...
> 原文:[https://dev . to/bnevilleoneill/lazy-loading-components-in-react-16-6-48n 0](https://dev.to/bnevilleoneill/lazy-loading-components-in-react-16-6-48n0)

#### [](#codesplitting-and-lazyloading-react-components-with-suspense-and-reactlazy)代码拆分和惰性加载 React 组件用 Suspense 和 React.lazy()
...
### [](#codesplitting-react-components)代码分解反应组件
...
### [](#using-suspense-and-reactlazy)利用悬念和 React.lazy()
