...
> 原文:[https://dev . to/ghost/using-multiple-docker-containers-to-setup-nginx-flask-and-postgres-2 kch](https://dev.to/ghost/using-multiple-docker-containers-to-setup-nginx-flask-and-postgres-2kch)
...
#### [](#docker-compose-buildrun)Docker 构建构建/运行
