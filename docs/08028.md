...
## [](#how-does-this-differ-from-virtualization)这和虚拟化有什么区别？
...
## [](#why-do-we-need-docker)我们为什么需要 Docker？
...
# [](#faster-development-process)发展过程更快
...
# [](#handy-application-encapsulation)便捷的应用封装
...
# [](#same-behaviour-on-local-machine-dev-staging-production-servers)本地机器/开发/暂存/生产服务器上的相同行为
...
# [](#easy-and-clear-monitoring)轻松清晰的监控
...
## [](#example-1-hello-world)例 1: hello world
...
## [](#example-2-environment-variables-and-volumes)例 2:环境变量和体积
...
# [](#what-best-practices-for-creating-images)创建图像的最佳实践是什么
...
## [](#example-4-connection-between-containers)例 4:容器间的连接
