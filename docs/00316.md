...
> 原文:[https://dev . to/saltyshiomix/create-nextron-app-create-an-electron-with-nextjs-app-in-one-command-4 edn](https://dev.to/saltyshiomix/create-nextron-app-create-an-electron-with-nextjs-app-in-one-command-4edn)
...
## [](#prs-and-contributions-are-welcome)欢迎 pr 和投稿
