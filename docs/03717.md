...
> 原文:[https://dev . to/ampli fr/stress less-pull-request-watching-with-Google-mail-2b 9](https://dev.to/amplifr/stressless-pull-request-watching-with-google-mail-2ob9)
...
# [](#google-mail-features-in-action)谷歌邮件功能在行动
