...
> 原文:[https://dev . to/tylermcginnis/the-evolution-of-async-JavaScript-from-callbacks-to-promises-to-async await-34 h1](https://dev.to/tylermcginnis/the-evolution-of-async-javascript-from-callbacks-to-promises-to-asyncawait-34h1)
...
##### [](#1-how-do-you-create-a-promise)1)你如何创造承诺？
...
#### [](#async-functions-return-a-promise)异步函数返回承诺
...
#### [](#await-without-async-is-bad)无异步等待不好
