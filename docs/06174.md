...
## [](#from-the-heroku-cli)来自 Heroku CLI
...
## [](#from-the-heroku-dashboard-web)来自 Heroku 仪表盘(网络)
...
## [](#how-do-i-know-which-is-the-correct-tz-value)我怎么知道哪个是正确的 TZ 值

点击此[链接](https://en.wikipedia.org/wiki/List_of_tz_database_time_zones)查看时区的完整列表

## [](#check-the-new-tz-value)检查新的 TZ 值
...
### [](#for-more-info-about-heroku)了解更多关于 Heroku 的信息
