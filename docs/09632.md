...
#### [](#2-converting-an-array-of-objects-into-a-map-using-a-specific-property-key-of-the-objects)2。使用对象的特定属性/键将对象数组转换为映射
...
#### [](#3-flatten-an-array-of-arrays)3。展平数组的数组
...
#### [](#4-doing-the-job-of-raw-filter-endraw-quite-unnecessary-)4。做`filter()`的工作——完全没有必要:)
...
#### [](#5-a-deep-raw-objectassign-endraw-)5。低沉的`Object.assign`
