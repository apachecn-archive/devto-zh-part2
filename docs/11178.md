...
> 原文:[https://dev . to/iwilsonq/how-to-build-sturdy-react-apps-with-TDD-using-jest-the-react-testing-library-52cn](https://dev.to/iwilsonq/how-to-build-sturdy-react-apps-with-tdd-using-jest-the-react-testing-library-52cn)

# [](#build-react-apps-with-tdd-and-the-react-testing-library)用 TDD 和 React 测试库构建 React 应用
...
# [](#building-the-comment-feed-with-tdd)用 TDD 构建评论提要
...
## [](#the-first-implementation-code)第一个实现代码
