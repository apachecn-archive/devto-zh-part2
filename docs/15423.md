...
> 原文:[https://dev.to/huijing/making-sense-of-digital-fonts-19f0](https://dev.to/huijing/making-sense-of-digital-fonts-19f0)
...
## [](#increasing-layers-of-abstraction)增加抽象层次
...
## [](#a-bit-about-bits-and-bytes)关于比特和字节的一点
...
## [](#understanding-font-formats)了解字体格式
