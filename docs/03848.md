...
> 原文:[https://dev . to/pauloxnet/updating-a-django-query set-with-annotation-and subquery-48 G1](https://dev.to/pauloxnet/updating-a-django-queryset-with-annotation-andsubquery-48g1)
