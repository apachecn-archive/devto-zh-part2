...
> 原文:[https://dev . to/achowba/build-a-simple-app-using-node-js-and-MySQL-19me](https://dev.to/achowba/build-a-simple-app-using-node-js-and-mysql-19me)
...
## [](#creating-the-directory-for-the-project)为项目创建目录
...
## [](#install-required-modules)安装需要的模块。
...
## [](#creating-the-database-for-the-app)为 app 创建数据库
...
## [](#connecting-the-routes-and-the-views)连接路线和视图
