# 更改您使用 LogChimp 登录的方式🐵

> 原文：<https://dev.to/logchimp/change-the-way-you-log-with-logchimp--172l>

> 使用 LogChimp 让客户了解➰关于您产品的信息。
...
是时候抛弃`changelog.md`文件，通过克隆这个库开始使用 LogChimp 了。
...
1.  网址:[https://logchimp.now.sh/](https://logchimp.now.sh/)
2.  演示:[https://mittalyashu.gitlab.io/jasper-changelog/](https://mittalyashu.gitlab.io/jasper-changelog/)
3.  LogChimp 入门套件:[https://gitlab.com/codecarrot/logchimp/logchimp-starter-kit](https://gitlab.com/codecarrot/logchimp/logchimp-starter-kit)

*此博客最初发表于 [CodeCarrot 博客](https://blog.codecarrot.net/logchimp-a-new-way-to-changelog/)T3*