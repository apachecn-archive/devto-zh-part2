# 软件工程师个人网站精彩的个人网站以及如何制作它们

> 原文：<https://dev.to/amandasopkin/fantastic-personal-websites-and-how-to-make-them--22om>

对于未来的软件工程师、设计师或产品经理来说，个人网站正变得几乎和简历一样标准——这是有充分理由的。个人网站是展示技术或设计悟性的好方法，提供了比标准简历更个性化、更有趣的格式(而且你也可以把简历放在你的网站上)。一个网站比一张纸更具互动性，会让你脱颖而出，也能打开潜在的话题。创建个人网站有很多方法，你应该仔细考虑你的方法——这将是你在招聘人员和许多谷歌或 linkedin 临时搜索者面前的互联网形象。

接下来，我们将看看特别令人难忘的个人网站(前面是视觉糖果),并浏览一些创建或更新你自己的网站的建议。

### 个人网站的不同用途

个人网站有许多不同的用途。我已经在下面介绍了一些更大的类别。
...
如果你是一名应届毕业生或正在进行职业转型，一个个人网站会吸引科技招聘人员的注意。早在 2013 年，《福布斯》报道称，56%的招聘经理表示，候选人的个人网站比任何其他品牌工具都更让他们印象深刻。

作为一名未来的设计师或软件工程师，你可以在页面上展示你的技术能力！即使你不做一些技术性的事情，网站也比纸质简历更吸引眼球和更个性化，所以这是一个简单的“在 i-am-the-bomb.com 上查看我的简历”的好方法
...
随着时间的推移维护你的网站，当你开始另一份工作的时候，很容易简单地刷新你的网站，这也是吸引意想不到的机会和联系的好方法。我曾经有一个我不知道存在的表弟通过个人网站联系我-你永远不知道！

### 入门

现在制作一个网站比以往任何时候都容易。那里有一些很棒的入门教程。如果你想快速上手，我推荐这些来自 [WordPress](http://www.wpbeginner.com/guides/) 或 [SquareSpace](https://developers.squarespace.com/beginner-tutorial/) 的教程。如果你想建立和托管你自己的，这个来自 [Github Pages](https://guides.github.com/features/pages/) 的指南是一个很好的起点。如果你想做一些构建、托管和服务的工作，这是一个很好的学习方法！以下是一些可能有用的资源:

*   均值首发网站[回购](https://github.com/manishrw/mean-starter-website)
*   Jekyll starter kit [repo](https://github.com/nirgn975/generator-jekyll-starter-kit)
*   Github 自己的 web starter it [repo](https://github.com/google/web-starter-kit)
*   [关于工具和框架的实用开发线程](https://dev.to/nayeonkim/what-toolframeworkcmsetc-do-you-use-to-build-your-own-personal-website)
*   [Twitter 帖子](https://twitter.com/thepracticaldev/status/894161129492156416)对应实际开发文章

### 一般建议

1.  从某处开始。很容易对一个网站感到兴奋，做好工作获得一个域名，将其添加到您的 bios 中，在页面上贴上“正在进行”的标签，然后完全忘记它。大约 10-20%的时间我点击某人的个人网站，它要么完全关闭，要么一次“进行中”几个月或几年。不要被外面那些令人惊奇的网站吓倒。作为一个初学者，至少把你的相关账户和你的名字的链接放在大的文本中——这比看起来像一个不能完成他们开始的事情的人要好得多。

2.  用批判的眼光审视你放在网站上的东西。虽然 twitter 和 linkedin 账户很棒，但如果你不想让招聘人员看到你在 tumblr 上关于野猫的页面，就不要链接到那里。同样，如果你认为你在一个更好的 Tinder 上的 hackathon 项目对公司来说很棒，但可能会让你的父母不高兴，那就把你的个人网站从你的 facebook 公开资料中删除。有时我们都可以用提醒，互联网是公共的！
