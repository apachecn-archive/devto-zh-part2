...
> 原文:[https://dev . to/melezhik/distributing-portable-scripts-with-sparrow-8 F4](https://dev.to/melezhik/distributing-portable-scripts-with-sparrow-8f4)
...
# [](#defining-default-values-for-input-parameters)定义输入参数的默认值。
...
# [](#defining-script-metadata)定义脚本元数据
...
# [](#overriding-default-values-for-configuration-file)覆盖配置文件的默认值
...
# [](#save-script-and-configuration-data)保存脚本和配置数据
