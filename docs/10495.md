...
> 原文:[https://dev.to/yazanaabed/is-learning-reactjs-for-you-lng](https://dev.to/yazanaabed/is-learning-reactjs-for-you-lng)
...
### [](#components-contain-two-primary-weapons)组件包含两件初级武器
...
#### [](#the-problem-with-manual-change-for-dom)手动更改 DOM 的问题:
...
### [](#steps-to-build-react-project)构建 react 项目的步骤
