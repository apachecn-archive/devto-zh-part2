...
> 原文:[https://dev . to/vinay jn/how-haptik-generates-on-the-fly-images with-python-1 pnl](https://dev.to/vinayjn/how-haptik-generates-images-on-the-fly-with-python--1pnl)
...
### [](#where-are-we-using-pillow-with-python)我们在哪里用 Python 做枕头？
