...
> 原文:[https://dev.to/annarankin/ways-of-seeing-orms-SQL-views-562o](https://dev.to/annarankin/ways-of-seeing-orms--sql-views-562o)
...
## [](#what-is-a-sql-view)什么*是 SQL 视图？*
...
### [](#overzealous-viewification)过分热心的观察
...
### [](#too-many-levels-of-cascading-views)层叠视图层次过多
...
### [](#propagated-inefficiency)传播效率低下
