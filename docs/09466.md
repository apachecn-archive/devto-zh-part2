...
如果你喜欢这篇文章，请通过查看[](https://pullreminders.com/?utm_source=devto&utm_medium=react-errors)**来支持我，这是一个 Slack 机器人，它会为 GitHub 拉请求向你的团队发送自动提醒。**
...
## [](#adding-error-codes-to-graphql-responses)向 GraphQL 响应添加错误代码
...
## [](#rendering-error-pages-with-react-error-boundaries)渲染带有 React 错误边界的错误页面
