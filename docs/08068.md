...
> 原文:[https://dev.to/silkster/why-you-should-use-a-framework-1ga 2](https://dev.to/silkster/why-you-should-use-a-framework--1ga2)
...
## [](#is-it-easier-for-beginners-to-use-a-framework)初学者使用框架是否更容易？
...
## [](#is-it-really-hard-without-a-framework)没有框架真的很难吗？
...
## [](#shouldnt-i-learn-the-basics-not-someones-abstraction)我不应该学基础的，而不是某个人的抽象吗？
...
## [](#everyone-has-an-opinion)每个人都有自己的看法
