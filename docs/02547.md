...
> 原文:[https://dev.to/ulisesac4/importing-data-in-rethinkdb-4ijb](https://dev.to/ulisesac4/importing-data-in-rethinkdb-4ijb)
...
## [](#importing-the-json-file)导入 JSON 文件
...
## [](#importing-the-csv-file)导入 CSV 文件
