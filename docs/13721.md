...
> 原文:[https://dev . to/albinotonnina/speak-of-web-layouts-introducing-the-magic-hat-technique-5220](https://dev.to/albinotonnina/speaking-of-web-layouts-introducing-the-magic-hat-technique--5220)
...
## [](#procrastination-to-the-rescue)拖延救援！
...
## [](#by-the-way-why-this-name-the-magic-hat-technique)对了为什么这个名字，魔帽术？

所以我可以同时使用这两个表情符号🎩✨:就像这样:在一个视图中，用户可以选择下一个要显示在屏幕上的东西。差不多就是它了。

## [](#%F0%9F%8F%96-the-code-sandbox)🏖代码沙箱
...
## [](#%F0%9F%9B%A0-the-react-library)🛠《反应库》

如果没有一个 UI 框架，比如 React、Vue 或者下一个，这是我做梦都想不到的。

> # [](#introducing-reactmagichat)Introduction to [Reaction-Magic-Hat](https://github.com/albinotonnina/react-magic-hat)
