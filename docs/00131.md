...
> 原文:[https://dev . to/yk yuen/setup-nested-html-template-in-go-echo-we b-framework-e9b](https://dev.to/ykyuen/setup-nested-html-template-in-go-echo-web-framework-e9b)
...
## [](#a-basic-echo-project-setup)基本回声项目设置

### [](#create-the-project-folder-under-proper-gopath)在适当的 GOPATH 下创建项目文件夹
...
### [](#download-the-echo-package-using-dep)使用 dep 下载 Echo 包
...
### [](#run-the-hello-world)运行 hello world
...
## [](#return-a-json-response)返回一个 JSON 响应
...
### [](#render-html-using-template-engine)使用模板引擎渲染 HTML
