...
> 原文:[https://dev.to/dvdmuckle/making-a-racket-with-openfaas-4 MMF](https://dev.to/dvdmuckle/making-a-racket-with-openfaas--4mmf)
...
#### [](#deploying-openfaas)部署 OpenFaaS
...
### [](#creating-our-racket-function)创建我们的球拍功能
...
### [](#building-and-deploying-the-function)构建和部署功能
