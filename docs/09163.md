...
> 原文:[https://dev . to/mason ite/mason ite-framework-tutorial-series-part-2-routing-1ak 3](https://dev.to/masonite/masonite-framework-tutorial-series-part-2---routing-1ak3)
...
# [](#deeper-module-controller)更深模块控制器
...
# [](#class-based-controllers)基于类的控制器
