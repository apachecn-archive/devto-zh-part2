...
> 原文:[https://dev . to/Hugo _ _ df/detecting-object-vs-array-in-JavaScript-by-example-297d](https://dev.to/hugo__df/detecting-object-vs-array-in-javascript-by-example-297d)
