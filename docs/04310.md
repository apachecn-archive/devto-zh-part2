...
> 原文:[https://dev . to/Jorge _ rockr/my-development-environment-setup-part-1-4a 33](https://dev.to/jorge_rockr/my-development-environment-setup-part-1-4a33)
...
## [](#1-install-essential-tools)1。安装必要的工具
...
## [](#3-install-oh-my-zsh)3。安装哦我的 Zsh
...
## [](#4-start-using-zsh-by-default)4。默认开始使用 zsh
