...
## [](#write-test-for-uploading-api)为上传 API 编写测试
...
### [](#setup-the-corresponding-modules-for-different-environments)为不同的环境设置相应的模块
...
### [](#create-a-mocking-module)创建嘲讽模块
