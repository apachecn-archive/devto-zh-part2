...
> 原文:[https://dev . to/Jon hilt/want-to-move-to-full-stack-development-but-not-sure-where-to-start-56pi](https://dev.to/jonhilt/want-to-move-to-full-stack-development-but-not-sure-where-to-start-56pi)
...
## [](#minification-and-bundling)缩小和捆绑
...
## [](#webpack-parcel-and-other-application-bundlers)网袋、包裹等应用捆扎机
...
## [](#javascript-frameworks-to-the-rescue)Javascript 框架来拯救
