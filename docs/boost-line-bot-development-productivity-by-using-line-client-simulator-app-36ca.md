# 使用 LINE Client Simulator 应用程序提高 LINE Bot 开发效率

> 原文：<https://dev.to/kenakamu/boost-line-bot-development-productivity-by-using-line-client-simulator-app-36ca>

在这篇文章中，我为 bot 开发者解释了线路模拟器。它运行良好，但它是一个 web 应用程序，对于 Mac 或 PC 来说并不完美。

这一次，我把解决方案转移到电子应用程序，使其成为 Mac 和 PC 上的原生应用程序。

# 安装

进入我的 GitHub repo 的[发布](https://github.com/kenakamu/LINESimulator/releases)下载 app。对于 Mac，下载 zip 文件并解压缩。对于 Windows，下载 setup.exe 并运行安装程序。
...
4.  单击连接。(如果您想使用 POC 模式，也可以使用 POC)
...
这个应用程序还远远没有完成，需要你的反馈。请玩它，让我知道任何问题或建议。
