...
> 原文:[https://dev . to/amejiarosario/self-balanced-binary-search-trees-with-AVL-in-JavaScript-3c KF](https://dev.to/amejiarosario/self-balanced-binary-search-trees-with-avl-in-javascript-3ckf)
...
# [](#balanced-vs-unbalanced-binary-search-tree)平衡与不平衡二叉查找树
...
# [](#when-a-tree-is-balancednonbalanced)一棵树什么时候平衡/不平衡？
...
## [](#tree-with-multiple-nodes)有多个节点的树
...
# [](#avl-tree-insertion-and-deletion)AVL 树的插入和删除
