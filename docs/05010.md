...
> 原文:[https://dev . to/dotnetcoreblog/提高 web 应用安全性的三步曲-3clg](https://dev.to/dotnetcoreblog/three-steps-for-increasing-the-security-of-your-web-apps-3clg)
...
### [](#stop-using-raw-unsafeeval-endraw-)停止使用`unsafe-eval`
