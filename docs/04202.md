...
> 原文:[https://dev . to/tze he/dev-recipes-integrate-react-frontend-in-a-Java-corporate-environment-2e 43](https://dev.to/tzehe/dev-recipes-integrate-react-frontend-in-a-java-corporate-environment-2e43)
...
## [](#add-frontendmavenplugin-to-your-pomxml)将 frontend-maven-plugin 添加到 pom.xml 中
...
## [](#connecting-react-app-with-backend)连接 React 应用和后端
...
## [](#create-a-npmrc-file)创建一个. npmrc 文件

如果您的公司使用私有 npm 注册表来防止在获取依赖项时出现 npm 404 错误，这是必要的

## [](#example-npmrc)举例。npmrc
...
## [](#build-and-run-application)构建并运行应用程序
