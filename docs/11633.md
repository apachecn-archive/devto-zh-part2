...
> 原文:[https://dev . to/on myway 133/learning-VoIP-RTP-and-sip-aka-awesome-pjsip-9 D1](https://dev.to/onmyway133/learning-voip-rtp-and-sip-aka-awesome-pjsip-9d1)

# [](#learning-voip-rtp-and-sip-aka-awesome-pjsip)学习 VoIP、RTP 和 SIP(又名牛逼 pjsip)
...
## [](#building-pjsip-for-windows-phone-8)为 Windows Phone 8 构建 pjsip
...
## [](#porting-openssl-to-windows-phone-8)将 OpenSSL 移植到 Windows Phone 8
