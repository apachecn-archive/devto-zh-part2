...
## [](#building-out-authentication-redux-based)构建基于身份验证-冗余
...
### [](#relation-between-tokens-and-states)记号与状态的关系。
...
### [](#redux-setup-with-promises)用承诺还原设置。
