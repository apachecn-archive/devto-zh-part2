...
> 原文:[https://dev.to/goyder/automatic-reporting-in-python-第一部分-从计划到问候世界-32n1](https://dev.to/goyder/automatic-reporting-in-python---part-1-from-planning-to-hello-world-32n1)
...
### [](#how-is-this-guide-presented)这个指南是怎么呈现的？
...
## [](#step-zero-stop-for-a-minute)零步停一分钟
...
### [](#some-key-learnings-from-early-planning)早期规划的一些重要经验
...
## [](#step-one-lay-a-foundation)第一步——打基础
...
### [](#set-up-a-virtual-environment)建立虚拟环境
...
### [](#set-up-a-gitgithub-repo)设置 Git/Github 回购
...
### [](#building-hello-world-functionality)构建‘你好，世界’功能
