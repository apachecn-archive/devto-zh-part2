...
> 原文:[https://dev.to/bugsnag/anatomy-of-source-maps-22dk](https://dev.to/bugsnag/anatomy-of-source-maps-22dk)
...
#### [](#concatenation-and-minification)串联和缩小
...
#### [](#using-new-or-extended-js-features)使用新的(或扩展的)JS 特性
...
#### [](#writing-in-a-totally-different-language)用完全不同的语言写作
...
## [](#debugging-javascript-errors-using-source-maps)使用源码图调试 JavaScript 错误
...
## [](#whats-in-a-source-map)一个源图里有什么？
...
### [](#examining-a-source-map-from-minification-uglifyjs)检查缩小的源地图(UglifyJS)
...
### [](#examining-a-source-map-from-compiling-typescript)检查来自编译类型脚本的源地图
...
### [](#examining-a-future-js-source-map)查看未来 JS 源图
...
#### [](#array-destructuring-restspread-classes)数组析构，剩余/扩散，类
...
## [](#source-maps-bugsnag)来源图+ Bugsnag
