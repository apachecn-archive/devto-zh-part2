...
> 原文:[https://dev . to/anoff/building-real time-apps-with-vue-and-nodejs-33ol](https://dev.to/anoff/building-realtime-apps-with-vue-and-nodejs-33ol)
...
## [](#set-up-a-basic-nodejs-server)设置一个基本的 Node.js 服务器
...
## [](#initialize-vuejs-project)初始化 Vue.js 项目
...
## [](#adding-material-design-library)添加材料设计库
...
## [](#bring-in-websockets)引入 websockets
...
### [](#frontend-vuesocketio)前端:vista socket . io
...
### [](#backend-socketio-serverjs)后端:socket-io / server.js
