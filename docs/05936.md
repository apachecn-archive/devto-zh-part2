...
> 原文:[https://dev . to/ignore intuition/binding-data-to-charts-using-vue-components-and-D3-4 i27](https://dev.to/ignoreintuition/binding-data-to-charts-using-vue-components-and-d3-4i27)
