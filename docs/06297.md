...
> 原文:[https://dev . to/datawireio/from-monolith-to-service-mesh-via-a-front-proxy-learning-from-stories-of-building-the-envoy-proxy-2g da](https://dev.to/datawireio/from-monolith-to-service-mesh-via-a-front-proxy---learnings-from-stories-of-building-the-envoy-proxy-2gda)
...
## [](#observability-observability-observability)可观性，可观性，可观性
