...
> 原文:[https://dev . to/dianamaltseva 8/using-cloud flare-and-AWS-auto scaling-group-for-remeding-DDOS-5fpd](https://dev.to/dianamaltseva8/using-cloudflare-and-aws-autoscaling-group-for-mitigating-ddos--5fpd)
