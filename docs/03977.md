...
## [](#arent-you-comparing-apples-and-oranges)你不是在比较苹果和橘子吗？
...
### [](#activerecord-creating-the-users-table)ActiveRecord:创建用户表
...
### [](#ecto-creating-the-users-table)Ecto:创建用户表
...
### [](#activerecord-creating-the-raw-invoices-endraw-table)ActiveRecord:创建`invoices`表格
...
### [](#ecto-creating-the-raw-invoices-endraw-table)Ecto:创建`invoices`表格
...
## [](#activerecord-data-mapping-amp-associations)ActiveRecord:数据映射&关联
...
### [](#ecto-data-mapping-amp-associations)Ecto:数据映射&关联
