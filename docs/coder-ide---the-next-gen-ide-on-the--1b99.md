# 编码器集成开发环境——☁️的下一代集成开发环境

> 原文：<https://dev.to/sethusenthil/coder-ide---the-next-gen-ide-on-the--1b99>
...
是的，如果你是 Node、Go、Java、Python 或者只是一个静态网页开发者，你应该试一试。无论你在什么电脑上，包括具有云计算能力的 Chromebook，你都可以在没有性能问题或兼容性问题的情况下编码。这一切都是假设你有稳定的，适度的互联网连接，每月至少有 5g 的带宽。在像印度这样每个手机信号塔都有大量流量的国家的移动热点工作，真的不是一次愉快的经历。

# 这只是开始

我们的云 IDE 之旅才刚刚开始，不要轻举妄动，因为我们可能会看到微软的 Github 更多的尝试，可能会将 VS 代码完全免费地放在云上，以展示微软 azure 的强大。或者从 Google Cloud，其实他们得到了类似的东西，命名为 Google Cloud Shell。也许，也许，我们可以从苹果那里看到一些谷歌云支持 Xcode 上线的东西，因为他们是他们的首选供应商。不管怎样，我明年将使用的 IDE 最有可能是由云驱动的...还有电。

链接:
[编码器 IDE](https://coder.com/)