...
> 原文：<https://dev.to/bauripalash/anonymous-blogging---how-and-where-41b4>
...
由著名的私人信息应用 **Telegram** 背后的人制作，我想我已经说了足够多的隐私了😉。Telegraph 是一个简单易用的匿名博客平台。

**👍我强烈推荐**

## 

 **它可能是功能最丰富的匿名博客平台。它不跟踪你，不记录你的 IP 地址，你甚至可以使用他们的 Tor 隐藏服务发布。

**👍我强烈推荐**

## [**txt . FYI**](https://txt.fyi)

我认为这是最简单的博客平台。无需注册，也没有跟踪。你只需要发布。简单小巧的设计，易于使用。
