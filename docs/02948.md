...
### [](#%E2%9A%99-what-are-we-building)⚙我们在建造什么？！
...
### [](#step1-set-up-microsoft-azure-amp-vscode)第一步:设置微软 Azure & VSCode
...
### [](#step2-create-a-new-function-app-project)第二步:新建一个函数 App 项目
...
### [](#step3-create-an-httptriggered-azure-function)第三步:创建一个 HTTP 触发的 Azure 函数
