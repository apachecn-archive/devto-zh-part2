...
> 原文:[https://dev . to/Joshua/the-state-of-state-react-state-management-in-2018-200c](https://dev.to/joshua/the-state-of-the-state-react-state-management-in-2018-2l0c)
...
# [](#reacts-setstate)React 的 setState()
...
## [](#apollo%C2%A0link-state)阿波罗链接状态
