...
> 原文:[https://dev . to/bnevilleoneill/using-trampolines-to-manage-large-recursive-loops-in-JavaScript-55jo](https://dev.to/bnevilleoneill/using-trampolines-to-manage-large-recursive-loops-in-javascript-55jo)
...
### [](#the-problem-with-recursion)递归问题
...
### [](#optimizing-with-proper-tail-calls)通过适当的尾部调用进行优化
