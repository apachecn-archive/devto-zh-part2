...
## [](#why-commonjs-instead-of-es-modules)为什么是 CommonJS 而不是 ES 模块？
...
## [](#commonjs-webpack-and-raw-vuejest-endraw-woes)CommonJS、Webpack 和`vue-jest`灾难
...
## [](#fixing-raw-vuejest-endraw-webpack-commonjs-handling-with-a-jest-preprocessor)用 Jest 预处理器修复`vue-jest` /Webpack CommonJS 处理
...
# [](#thoughts-on-running-vue-inside-angularjs-%E2%80%8D)关于跑穴内角的思考🏃‍
