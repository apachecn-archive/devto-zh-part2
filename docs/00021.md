...
> 原文:[https://dev . to/krit ner/Microsoft-Orleans reminders-and-grains-calling-grains-1ip 5](https://dev.to/kritner/microsoft-orleansreminders-and-grains-calling-grains-1ip5)

### [](#microsoft-orleans%E2%80%8A%E2%80%94%E2%80%8Areminders-and-grains-calling-grains)微软奥尔良—提醒和谷物呼叫谷物
...
#### [](#to-build-the-everything%E2%80%99s-ok-alarm,-we%E2%80%99ll-need-to-do-a-few-things:)要建立一切正常的警报，我们需要做几件事:
...
### [](#enable-the-reminder-service)启用提醒服务
...
#### [](#anyway%E2%80%A6-our-grain-interface:)反正……我们的纹界面:
...
### [](#new-grain-menu-option)新增谷物菜单选项
