...
> 原文:[https://dev . to/neo/how-to-build-a-real time-users-status-update-in-IOs-3304](https://dev.to/neo/how-to-build-a-realtime-users-status-update-in-ios--3304)
...
## [](#creating-the-user-interface-of-our-realtime-ios-application)创建实时 iOS 应用程序的用户界面
...
## [](#creating-the-functionality-of-our-realtime-ios-application)创建实时 iOS 应用程序的功能
...
## [](#using-pusher-to-add-a-realtime-update-status-to-our-ios-application)使用 Pusher 向我们的 iOS 应用程序添加实时更新状态
