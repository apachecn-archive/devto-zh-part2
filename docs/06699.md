...
> 原文:[https://dev . to/Dan _ starner/using-python-type-annotations-4 cfe](https://dev.to/dan_starner/using-pythons-type-annotations-4cfe)
...
## [](#what-are-type-annotations)什么是类型标注？
...
## [](#annotating-functions-amp-methods)标注函数&方法
...
### [](#type-hints-with-methods)键入提示与方法
...
### [](#multiple-possible-return-types)多种可能的退货类型
...
## [](#working-with-dataclasses)使用数据类
