...
> 原文:[https://dev . to/kwbtsts/try-ASM-DOM-tha-is-virtual-DOM-library-by-using-web assembly-1 mli](https://dev.to/kwbtsts/try-asm-dom-that-is-virtual-dom-library-by-using-webassembly--1mli)
...
# [](#the-code-for-measuring)用于测量的代码
