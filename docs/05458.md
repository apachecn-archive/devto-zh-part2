...
> 原文:[https://dev . to/markoa/how-to-build-rock-solid-ruby-on-rails-apps-with-BDD-4jg 9](https://dev.to/markoa/how-to-build-rock-solid-ruby-on-rails-apps-with-bdd-4jg9)
...
## [](#understanding-the-behavior-point-of-view)理解“行为”的观点
...
## [](#the-given-when-then-communication-pattern)“给定/何时/然后”的沟通模式
...
## [](#the-bdd-cycle-in-rails)钢轨中的 BDD 循环
