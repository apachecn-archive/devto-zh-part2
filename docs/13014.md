...
## [](#what-is-an-oauth-20-grant-type)什么是 OAuth 2.0 授权类型？
...
## [](#the-authorization-code-flow)授权码流程
...
### [](#get-the-users-permission)获得用户的权限
...
### [](#redirect-back-to-the-application)重定向回应用程序
...
### [](#exchange-the-authorization-code-for-an-access-token)用授权码换接入令牌
...
## [](#when-to-use-the-authorization-code-flow)何时使用授权码流程
...
## [](#learn-more-about-oauth-and-okta)了解更多关于 OAuth 和 Okta
