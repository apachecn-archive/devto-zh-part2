...
> 原文:[https://dev . to/kena kamu/azure-vs-GCP-part-17-mobile-app-development-4j5k](https://dev.to/kenakamu/azure-vs-gcp-part-17-mobile-app-development-4j5k)
...
### [](#configure-facebook-login)配置脸书登录。
...
### [](#create-and-configure-notification-hub-for-the-application)为应用程序创建和配置通知中心
