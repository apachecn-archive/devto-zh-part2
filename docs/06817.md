...
### [](#a-loop-for-every-operator)为每个操作者的一个循环
...
### [](#many-operators-one-loop)多个操作符，一个循环
...
## [](#which-way-does-kotlin-do-it)科特林是用哪种方式做的？
...
## [](#are-kotlin-list-operators-efficient)科特林列表算子是否高效？
