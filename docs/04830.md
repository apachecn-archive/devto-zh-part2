...
> 原文:[https://dev . to/johnbwoodruf/component-libraries-with-stenciljs-getting-started-4jej](https://dev.to/johnbwoodruff/component-libraries-with-stenciljs---getting-started-4jej)
