...
> 原文:[https://dev . to/oktadev/build-an-ionic-app-with user-authentic ation-4ig 1](https://dev.to/oktadev/build-an-ionic-app-with-user-authentication-4ig1)
...
## [](#create-an-ionic-application)创建一个离子应用程序
...
## [](#deploy-to-a-mobile-device)部署到移动设备
