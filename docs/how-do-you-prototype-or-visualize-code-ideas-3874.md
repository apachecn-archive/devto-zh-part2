...
我通常会从一些写在草稿纸上的伪代码开始，但当涉及到实际的语法正确的代码时，我会启动编辑器并将其打印出来，看看它看起来是什么样子。我这样做是为了数据类型或对象，或函数或方法，或接口，或诸如此类的东西。

然后我最终得到一个 scratch 目录，其中包含诸如“scratch.go”、“scratch1.go”、“coord.go”和其他随机名称的文件。

我甚至考虑过，甚至尝试过使用源代码控制来保存想法，即使是在我有了更好的想法之后。

有一点很有帮助，那就是使用带有语法或 lint 检查的编辑器，比如 vim 或 vscode。
