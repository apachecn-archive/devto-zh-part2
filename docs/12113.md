...
> 原文:[https://dev . to/ismail9k/CSS-percentage-unit-the-evil-parts-1g 29](https://dev.to/ismail9k/css-percentage-unit-the-evil-parts-1g29)
...
## [](#step-1-set-slides-with-and-height)第一步:设置幻灯片的高度
...
## [](#step-2-align-slider-indicators)第二步:对齐滑块指示器
...
## [](#step-3-align-slider-controller-next-button)第三步:对齐滑块控制器下一步按钮
...
### [](#i-introduce-to-you-the-ultimate-solution-say-welcome-to-the-superhero-transform)我向你介绍终极解决方案，说欢迎来到超级英雄变身。
...
## [](#step-4-align-slider-controller-prev-button)第四步:对齐滑块控制器上一个按钮
