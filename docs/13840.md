...
> 原文:[https://dev.to/risdenk/apache-ranger-hive-over-HDFS-审计-日志-m6](https://dev.to/risdenk/apache-ranger---hive-over-hdfs-audit-logs-m6)
...
### [](#creating-the-hive-table-over-ranger-audit-logs-on-hdfs)在 HDFS 的 Ranger 审计日志上创建 Hive 表
...
### [](#using-hive-to-query-ranger-audit-logs-on-hdfs)使用 Hive 查询 HDFS 上的 Ranger 审计日志
