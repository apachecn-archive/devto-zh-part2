...
> 原文:[https://dev . to/bnevilleoneill/custom-polymorphic-code-snippets-in-vs-code-1g6i](https://dev.to/bnevilleoneill/custom-polymorphic-code-snippets-in-vs-code-1g6i)
...
### [](#creating-a-basic-snippet)创建基本片段
...
### [](#going-further-with-code-snippets)用代码片段更进一步
...
### [](#polymorphic-code-snippets)多态代码片段
