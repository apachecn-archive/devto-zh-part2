...
> 原文:[https://dev . to/tailomateus/testing-applications-with cypress-3dc 7](https://dev.to/tailomateus/testing-applications-withcypress-3dc7)
...
### [](#running-our-first-test)运行我们的第一个测试
...
### [](#checking-an-element-on-the-page)检查页面上的一个元素
...
### [](#credits-and-references)演职员表及参考资料:
