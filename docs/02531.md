...
> 原文:[https://dev.to/marpme/stealth-addressing-in-depth-13-7jk](https://dev.to/marpme/stealth-addressing-in-depth-13-7jk)
...
## [](#how-to-generate-a-stealth-addresses)如何生成隐形地址？
...
### [](#stepbystep-creation-of-a-verge-based-stealth-address)逐步创建基于边界的隐藏地址
...
## [](#stealth-addressing-with-javascript)用 JavaScript 隐身寻址
