# 使用 OpenID Connect 和 OAuth 2.0 保护电子应用

> 原文：<https://dev.to/auth0/securing-electron-applications-with-openid-connect-and-oauth-20-1754>

在本文中，您将了解如何使用 OpenID Connect 和 OAuth 2.0 保护电子应用程序。您不需要成为这些技术中的任何一个方面的专家来理解这篇文章，因为说明将引导您完成整个过程。
