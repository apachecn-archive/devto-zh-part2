...
> 原文:[https://dev.to/andremare/homebrew-基础知识-备忘单-3a3n](https://dev.to/andremare/homebrew---basics--cheatsheet-3a3n)
...
### [](#brew-search-install-remove)Brew 搜索、安装、删除
...
## [](#installation-articles)安装篇

本节包含一系列文章，解释了如何利用 Homebrew 在 macOS 上安装应用程序和命令行工具。

### [](#command-line-tools-and-applications)命令行工具及应用
