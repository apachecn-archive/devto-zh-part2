...
> 原文:[https://dev . to/elemarjr/let-me-help-you-to-start-using-ravendb 4-oa0](https://dev.to/elemarjr/let-me-help-you-to-start-using-ravendb4-oa0)

是时候开始学习 RavenDB 4 了。即使你知道 RavenDB 以前的版本，你也可能会得到很好的惊喜，并学到一些新的技巧。例如，您知道 RavenDB 有社区(免费)许可证吗？

在这篇文章中，你将学习如何在你的电脑上安装并开始使用它。

## [](#getting-ravendb-up-and-running)启动并运行 RavenDB

在这篇文章中，我假设你是一名开发人员，试图在你的计算机上安装并运行一个 RavenDB 实例。我不会讨论如何处理生产场景(至少暂时不会)。如果您需要关于如何为生产设置 RavenDB 的信息，我建议您阅读在线文档。

### [](#running-on-the-live-demo-instance)运行在现场演示实例上
...
### [](#running-on-docker)运行在 Docker 上
...
### [](#running-on-windows-linux-or-macos)运行在 Windows、Linux 或 MacOS 上
...
## [](#understanding-the-raw-document-endraw-concept)理解`Document`概念
...
## [](#understanding-the-raw-collection-endraw-concept)理解`Collection`概念
...
## [](#exploring-the-northwind-collections)探索北风系列
