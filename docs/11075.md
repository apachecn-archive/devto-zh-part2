...
> 原文:[https://dev . to/MW ltr/magento 2-modules-outside-of-magento-root-3hbb](https://dev.to/mwltr/magento2-modules-outside-of-magento-root-3hbb)
...
# [](#adding-modules-from-src)从 src 添加模块

要包含 magento-root `my-project/magento`之外的模块，您必须执行以下步骤。

## [](#add-local-repository)添加本地知识库
...
## [](#issues-with-view-or-themes)带有观点或主题的问题
