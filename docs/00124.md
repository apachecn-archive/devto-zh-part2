...
> 原文:[https://dev . to/bnevilleoneill/what-s-new-in-create-react-app-2-pp2](https://dev.to/bnevilleoneill/what-s-new-in-create-react-app-2-pp2)
...
#### [](#service-workers-are-unregistered-by-default)服务人员默认不注册
...
#### [](#sass-css-modules-and-postcss)Sass、CSS 模块和 PostCSS
