...
## [](#serverless-mapreduce)无服务器 MapReduce
...
## [](#selfdeploying-applications)自部署应用程序
...
## [](#treating-s3-like-a-file-system)像对待文件系统一样对待 S3
...
## [](#memory-management-in-lambda)内存管理中的 Lambda
...
## [](#when-lambda-becomes-expensive)当λ变贵
