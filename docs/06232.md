...
> 原文:[https://dev.to/egrajeda/my-python-serverless-setup-ca1](https://dev.to/egrajeda/my-python-serverless-setup-ca1)
...
## [](#package-each-function-individually)单独封装每个功能
