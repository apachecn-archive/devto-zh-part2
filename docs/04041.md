...
> 原文:[https://dev.to/bnevilleoneill/javascript-typeof-4a9l](https://dev.to/bnevilleoneill/javascript-typeof-4a9l)

#### [](#understanding-typechecking-in-javascript)理解 JavaScript 中的类型检查
...
### [](#typechecking-using-typeof)使用 typeof 进行类型检查
