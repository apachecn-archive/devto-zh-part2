...
## [](#generando-contrase%C3%B1as-para-humanos)生成人类密码
...
## [](#determinismo-y-predictibilidad)决定论和可预测性
...
#### [](#extrayendo-la-aleatoridad-de-nuestra-clase)抽取我们班的随机性
...
## [](#generando-un-password-legible)生成可读密码
...
### [](#a%C3%B1adiendo-otro-nivel-de-indirecci%C3%B3n)增加另一个指示水平
...
#### [](#un-generador-de-s%C3%ADlabas)音节发生器
...
#### [](#programando-el-mock-de-raw-randomnessengine-endraw-)编程`RandomnessEngine`的 mock
...
### [](#a%C3%B1adiendo-consonantes-al-principio-de-la-s%C3%ADlaba)在音节的开头加上辅音
...
### [](#y-ahora-s%C3%ADlabas-terminadas-en-consonante)而现在，连字符按顺序结束
 ...
 **### [](#testear-el-azar-mediante-propiedades)通过性质测试随机
...
## [](#probamos-nuestro-generador-de-constrase%C3%B1as)我们测试了我们的建设者
...
### [](#contrase%C3%B1as-m%C3%A1s-cortas-con-la-misma-especificaci%C3%B3n)具有相同规格的较短密码
...
## [](#queremos-contrase%C3%B1as-m%C3%A1s-dif%C3%ADciles)我们想要更难的密码
...
### [](#hackerizando-la-contrase%C3%B1a)黑客密码
...
## [](#decorar-es-extender-por-composici%C3%B3n)装饰是按成分展开的
...
### [](#decorador-con-may%C3%BAsculas)大写装饰家
...
## [](#veamos-c%C3%B3mo-usarlo)让我们看看如何使用
