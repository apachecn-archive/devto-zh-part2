...
> 原文:[https://dev . to/nick Parsons/simple-steps-to-optimize-your-app-performance-1a 70](https://dev.to/nickparsons/simple-steps-to-optimize-your-app-performance-1a70)
...
# [](#visualizing-amp-optimizing-api-calls)可视化&优化 API 调用
...
# [](#optimizing-our-mongodb-database)优化我们的 MongoDB 数据库
...
# [](#use-dedicated-solutions)使用专用解决方案
