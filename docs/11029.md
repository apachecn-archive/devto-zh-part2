...
> 原文:[https://dev . to/bnevilleoneill/extending-a-client-with-language-server-protocol-2o 74](https://dev.to/bnevilleoneill/extending-a-client-with-the-language-server-protocol-2o74)
...
### [](#language-server-history)语言服务器历史
...
### [](#language-server-basics)语言服务器基础知识
...
#### [](#the-question-now-how-is-jsonrpc-used-in-the-lsp)现在的问题是:JSON-RPC 是如何在 LSP 中使用的？
