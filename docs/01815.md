...
> 原文:[https://dev . to/oktadev/build-a-basic-crud-app-with-angular-and-node-1818](https://dev.to/oktadev/build-a-basic-crud-app-with-angular-and-node-1818)
...
## [](#start-your-basic-angular-client-application)启动基本的 Angular 客户端应用程序
...
## [](#add-authentication-to-your-node-angular-app)为您的 Node + Angular App 添加认证
...
## [](#implement-a-node-rest-api)实现一个节点 REST API
...
## [](#finish-your-angular-client)完成你的棱角客户端
...
## [](#learn-more-about-angular-node-and-express)了解更多关于角形、节点和 Express
