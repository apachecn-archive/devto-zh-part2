...
[![](img/177ed029986e4537d5ef7d6a106e2e6a.png)T2】](https://jermdavis.files.wordpress.com/2018/06/defaultlanguage.png)

它是在配置中设置的:

[![](img/465c537af9ff4fc4452fa21516e55f78.png)T2】](https://jermdavis.files.wordpress.com/2018/06/sitelanguageconfig.png)

我很乐意通过闪亮的新表单编辑器创建一个新表单，并保存它:

[![](img/fb6fe3f23c195c4ead0de356747b8068.png)T2】](https://jermdavis.files.wordpress.com/2018/06/savenewform.png)

表单将出现在内容树中:

[![](img/7a925b5037490a1e11a07527304dba81.png)T2】](https://jermdavis.files.wordpress.com/2018/06/formiscreated.png)

但是当您回到设计器中的“选择要编辑的表单”视图时:

[![](img/0978d921793d09309537684e47e21d0e.png)T2】](https://jermdavis.files.wordpress.com/2018/06/formismissing.png)
...
[![](img/35dae5119bc5e0a5026f2be27238003a.png)T2】](https://jermdavis.files.wordpress.com/2018/06/actuallanguages.png)

那么，如果我们只是在“`en`”语言中添加一个版本会发生什么呢？很快，我们可以看到:

[![](img/d2db09f61f43ebf14d902172c5eafc5e.png)T2】](https://jermdavis.files.wordpress.com/2018/06/formappears.png)

成功！

现在，只有表单的根项需要更新，以使表单可见:

[![](img/a57de27d9cb83daec4d6aa31f1274f7c.png)T2】](https://jermdavis.files.wordpress.com/2018/06/rootformitem.png)

如果您实际上想要表单本身具有适当的语言变体，您可以使用表单编辑 UI 来决定您想要编辑哪种语言:

[![](img/e7c41a48d8e7f609ed08aeb2aca13446.png)T2】](https://jermdavis.files.wordpress.com/2018/06/formlanguagechoice.png)

您不需要通过内容编辑器手动创建任何其他版本。但是当然你首先需要表单在表单编辑器中是可见的，这样才能工作…

现在，在 Sitecore 的表单编辑器文档中提到了这个问题:

[![](img/006d6c9118e693e6a65f16a464d61dc2.png)T2】](https://jermdavis.files.wordpress.com/2018/06/formsdocmention.png)
