...
> 原文:[https://dev . to/pmbanugo/from-vanillajs-to-vue js-a-guide-to-vue-essentials-5gii](https://dev.to/pmbanugo/from-vanillajs-to-vuejs-a-guide-to-vue-essentials-5gii)
...
# [](#displaying-saved-items)显示保存的项目
