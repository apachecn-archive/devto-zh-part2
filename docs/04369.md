...
> 原文:[https://dev.to/mornir/three-neat-css-features-496h](https://dev.to/mornir/three-neat-css-features-496h)

这里有三个我不知道的 CSS 特性，并且很高兴知道它们的存在。

# [](#1-caretcolor)1。插入符号颜色
...
# [](#2-nthchildodd-amp-nthchildeven)2。第 n 个孩子(奇数)&第 n 个孩子(偶数)
...
# [](#3-gaps-in-flexbox)3。Flexbox 中的缺口！
