...
## [](#when-are-tree-data-structures-used-)什么时候使用树形数据结构？
...
### [](#creating-a-self-reference)创建自我引用
...
### [](#adding-a-relationship-to-fetch-the-child-comments)添加一个[关系](https://docs.hasura.io/0.15/manual/data/relationships/index.html)来获取子注释
...
## [](#fetching-and-adding-comments)获取和添加注释
...
## [](#working-with-unknown-levels-of-nesting)处理未知层次的嵌套
