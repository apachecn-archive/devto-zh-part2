...
> 原文:[https://dev . to/leosl/keeping-your-es6-JavaScript-code-simple-5aln](https://dev.to/leosl/keeping-your-es6-javascript-code-simple-5aln)
...
### [](#day-1-using-es6-class-syntax-aka-object-prototype-pattern-wrapper)第 1 天——使用 ES6 类语法(又名对象原型模式包装器)
...
### [](#day-2-code-review-begins-getting-rid-of-class-boilerplate-code)第二天-(代码评审开始)-清除类样板代码
...
### [](#day-3-removing-es5-old-practices-and-isolating-responsibilities-even-more)第三天——去除旧的做法，进一步分离责任
...
### [](#day-4-code-review-ends-avoiding-dom-sloppy-manipulation)第 4 天-(代码评审结束)-避免 DOM 草率操作
...
#### [](#finally-to-wrap-up-and-write-down)最后，总结一下，写下:
