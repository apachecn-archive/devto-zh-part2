...
> 原文:[https://dev . to/domy see/using-scripting-to-quick-execute-repetitive-tasks-cp2](https://dev.to/domysee/using-scripting-to-quickly-execute-repetitive-tasks--cp2)
