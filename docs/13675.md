...
> 原文:[https://dev . to/martyndavies/building-an-image-search-with-algolia-Google-vision-API-37gm](https://dev.to/martyndavies/building-an-image-search-with-algolia--googles-vision-api-37gm)
...
### [](#setting-up-instantsearch)设置即时搜索
