...
## [](#declarative-vs-imperative)陈述句与祈使句
...
## [](#the-holy-trinity-of-functional-programming)三位一体的函数式编程
...
## [](#initeachhash-gt-mash)Init+each+hash - > mash
...
## [](#more-advanced-applications-of-functional-concepts)功能概念的更高级应用
