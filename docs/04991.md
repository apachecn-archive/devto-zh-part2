...
> 原文:[https://dev . to/rdlauer/using-azure-cognitive-services-with-native script-3 iao](https://dev.to/rdlauer/using-azure-cognitive-services-with-nativescript-3iao)
...
## [](#brief-intro-to-nativescript)简介 NativeScript
...
## [](#building-a-nativescript-app)构建 NativeScript 应用
...
### [](#photo-details-with-facial-attributes)带有面部属性的照片细节
