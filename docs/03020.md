...
> 原文:[https://dev . to/ge shan/3-simple-rules-for-less-or-no-git-conflicts-1h 30](https://dev.to/geshan/3-simple-rules-for-less-or-no-git-conflicts-1h30)
...
## [](#rule-2-rebase-with-your-main-branch-generally-master-when-it-changes)规则二:当你的主分支(一般是 master)发生变化时，用你的主分支(一般是 master)重新定基
...
## [](#rule-3-review-pull-requests-faster-and-merge-them-to-the-main-branch)规则 3:更快地审查拉请求，并将它们合并到主分支
