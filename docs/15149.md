...
> 原文:[https://dev . to/swyx/scraping-my-Twitter-social-graph-with-python-and-selenium-hn8](https://dev.to/swyx/scraping-my-twitter-social-graph-with-python-and-selenium--hn8)
...
# [](#automation-scraping-twitter)自动化-抓取推特
...
## [](#a-basic-infinite-scroll-strategy)一个基本的无限滚动策略
...
## [](#a-dynamic-infinite-scroll-strategy)一种动态无限滚动策略
...
## [](#collecting-deeper-data-for-first-degree-follows)收集更深一级数据如下
...
# [](#the-top-50-js-dev-twitter-accounts)排名前 50 的 JS Dev Twitter 账户
