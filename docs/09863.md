...
> 原文:[https://dev.to/nitya/3 建造一个更复杂的 app-436h](https://dev.to/nitya/3--build-a-more-complex-app-436h)
...
### [](#step1-goal-startup-namer-app)第一步:目标=启动命名应用
...
### [](#step2-starting-point-scaffolded-app)第二步:起点=脚手架 App
...
### [](#step3-dependencies-add-external-package)第 3 步:依赖关系=添加外部包
...
### [](#step3-stateful-widget-add-new)步骤 3:有状态小部件=添加新部件
...
### [](#step4-list-view-infinite-scroll)第四步:列表视图=无限滚动
...
### [](#step5-interactivity-event-handling)第五步:交互性=事件处理
...
### [](#step6-navigation-route-handling)第六步:导航=路线处理
...
### [](#step7-theming-changing-look-amp-feel)第七步:主题化=改变外观&感觉
...
### [](#error-how-do-you-know-somethings-wrong)错误:怎么知道不对劲？
