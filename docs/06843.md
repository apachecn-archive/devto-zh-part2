...
> 原文:[https://dev . to/aribornstein/one-click-tensorflowjs-with-azure-2 iib](https://dev.to/aribornstein/one-click-tensorflowjs-with-azure-2iib)
...
### [](#click-the-deploy-button-to-get-started)点击部署按钮开始！
...
# [](#what-is-tensorflowjs)什么是张量流。JS？
