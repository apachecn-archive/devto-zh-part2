...
> 原文:[https://dev.to/mitchjacksontech/trac-install-guide-588e](https://dev.to/mitchjacksontech/trac-install-guide-588e)
...
### [](#configure-dns-for-your-trac-server)为您的跟踪服务器配置 DNS
...
### [](#configure-hostname-and-domain-name-on-your-server)在您的服务器上配置主机名和域名
...
#### [](#install-and-enable-firewalld)安装并启用防火墙
...
### [](#get-a-free-ssl-certificate-free-from-lets-encrypt)从 Lets Encrypt 获得免费 SSL 证书
...
#### [](#use-certbot-to-request-an-ssl-certificate)使用 certbot 请求 SSL 证书
...
### [](#configure-a-local-mail-server-so-trac-can-send-emails)配置本地邮件服务器，以便 Trac 可以发送电子邮件
...
## [](#install-software-and-dependencies)安装软件和依赖项
...
## [](#create-a-bare-git-repository)创建一个空的 Git 仓库
...
### [](#initialize-a-trac-project)初始化一个跟踪项目
...
### [](#generate-static-files-python-cache)生成静态文件，python 缓存
...
## [](#configure-apache-to-serve-trac-via-wsgi)配置 Apache 通过 WSGI 服务 Trac
...
## [](#log-in-and-configure-trac)登录并配置 Trac
...
### [](#anonymous-user-permissions)匿名用户权限
