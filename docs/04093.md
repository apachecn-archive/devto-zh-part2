...
## [](#ensure-that-script-exit-code-is-raw-0-endraw-)确保脚本退出代码为`0`
...
# [](#ensure-that-script-outputs-some-string-to-stdout)确保脚本向 STDOUT 输出一些字符串
...
# [](#splitting-tests-for-different-cases)针对不同情况进行拆分测试
...
# [](#quit-test-for-some-environment)退出对某些环境的测试
...
## [](#decentralized-or-centralized-testing-model)分散或集中测试模式
