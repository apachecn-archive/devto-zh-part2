...
> 原文:[https://dev . to/auth 0/auth 0-architecture-running-in-multiple-cloud-providers-and-regions-1l3o](https://dev.to/auth0/auth0-architecture-running-in-multiple-cloud-providers-and-regions-1l3o)
