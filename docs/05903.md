...
### [](#nginx-subrequests-to-the-rescue)nginx 子请求救援
...
### [](#overengineering-is-my-biggest-strength)过度工程是我最大的优势
...
### [](#the-discovery-of-slowness)慢度的发现
...
### [](#bad-performance-theres-cache)表现不好？有缓存！
