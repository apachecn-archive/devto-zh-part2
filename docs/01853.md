...
> 原文:[https://dev.to/progresstelerik/why-xaml-why-now-1ifl](https://dev.to/progresstelerik/why-xaml-why-now-1ifl)
...
### [](#windows-presentation-foundation-wpf)Windows 演示基础(WPF)
...
### [](#xamarinforms-heads)Xamarin。表单头
