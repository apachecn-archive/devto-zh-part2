...
> 原文:[https://dev . to/issart company/building-waypoints-using-augmented-reality-43 ng](https://dev.to/issartcompany/building-waypoints-using-augmented-reality-43ng)
...
## [](#working-with-google-service)使用谷歌服务
...
## [](#implementing-augmented-reality)实现增强现实
...
## [](#implementing-position-calculations)实现位置计算
