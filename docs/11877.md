...
> 原文:[https://dev . to/oktadev/the-lazy-developers-guide-to-authentic ation-with-vuejs-1m8f](https://dev.to/oktadev/the-lazy-developers-guide-to-authentication-with-vuejs-1m8f)
...
## [](#add-okta-for-authentication)添加 Okta 进行身份验证
...
## [](#auditing-your-progressive-web-app)审核您的渐进式 Web 应用程序
