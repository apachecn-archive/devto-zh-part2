...
> 原文:[https://dev . to/ivanmisuno/envelope net work-or-how-to-abstract-alamofire-and-provide-strong-typed-mock-responses-in-unit-tests-rx swift-bindings-22 m2](https://dev.to/ivanmisuno/envelopenetwork-or-how-to-abstract-alamofire-and-provide-strongly-typed-mock-responses-in-unit-tests--rxswift-bindings-22m2)
...
# [](#defining-protocols-of-the-networking-layer)定义网络层的协议
...
# [](#providing-default-implementation-using-alamofire)使用 Alamofire 提供默认实现
...
# [](#testing-swift-code-with-manual-mocks)用手动模拟测试 Swift 代码
...
# [](#an-icing-on-the-cake-rxswift-bindings)锦上添花:RxSwift 绑定
...
# [](#next-steps-for-developing-the-library)开发库的后续步骤:
