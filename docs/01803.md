...
> 原文:[https://dev . to/mygnu/auth-web-microservice-with-rust-using-actix-web-complete-tutorial-part-2-k3a](https://dev.to/mygnu/auth-web-microservice-with-rust-using-actix-web---complete-tutorial-part-2-k3a)

###### [](#originally-posted-on-gillnetin)原贴于 [gill.net.in](https://gill.net.in)
...
##### [](#welcome-back-to-part-2-of-the-tutorial)欢迎回到教程的第 2 部分
...
##### [](#verify-user-email-or-not)是否验证用户邮箱？
...
##### [](#error-handling-and-the-raw-from-endraw-trait)错误处理和`From`特质
...
##### [](#parsing-url-parameters)解析 url 参数
...
##### [](#test-your-implementation)测试你的实现
...
##### [](#implementing-a-protected-route)实现受保护的路由
