...
> 原文:[https://dev . to/whoisryosuke/automating-react-documentation-using-react-doc gen-3 mgh](https://dev.to/whoisryosuke/automating-react-documentation-using-react-docgen--3mgh)
...
## [](#tooling-script-gatsby-output)工具脚本+盖茨比输出
...
## [](#getting-documentation-down)将文档记录下来
