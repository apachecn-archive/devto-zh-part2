...
> 原文:[https://dev.to/atlassian/preventing-git-rebase-fights-4hd4](https://dev.to/atlassian/preventing-git-rebase-fights-4hd4)
...
### [](#whats-a-git-rebase-fight)什么是 Git Rebase 战斗？
...
### [](#solution-optimistic-build-status-propagation)解决方案:乐观构建状态传播
...
### [](#what-causes-git-rebase-fights)什么原因导致 Git 返基大战？
...
### [](#tripledotdiff-and-git-patchid)三点差分和“git 补丁标识”
