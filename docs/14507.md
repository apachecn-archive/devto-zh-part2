...
> 原文:[https://dev . to/scastiel/bootstrap-a-reason-react-project-with-parcel-13fj](https://dev.to/scastiel/bootstrap-a-reason-react-project-with-parcel--13fj)
...
## [](#start-a-basic-parcel-project)开始一个基本的宗地项目
