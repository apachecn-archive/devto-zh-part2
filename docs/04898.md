...
## [](#inline-and-blocked-elements)内嵌和阻塞元素
...
## [](#wrapping-overlapping-elements)包裹重叠元素
...
## [](#centering-things-inside-an-element)将事物放在一个元素的中心
...
## [](#additional-learnings)其他学习

### [](#use-substitute-fonts-when-the-original-font-is-not-available)当原始字体不可用时，使用替代字体
...
### [](#avoid-using-height-on-divs-to-prevent-overlapping-content-on-smaller-screens)避免在 div 上使用高度，以防止较小屏幕上的内容重叠
