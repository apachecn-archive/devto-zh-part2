...
> 原文:[https://dev . to/bnevilleoneill/create-react-app-a-quick-setup-guide-36cl](https://dev.to/bnevilleoneill/create-react-app-a-quick-setup-guide-36cl)
...
### [](#upgrading-the-versions-of-the-dependencies)升级依赖项的版本
...
### [](#adding-images-and-styles)添加图片和样式
...
### [](#proxying-server-requests)代理服务器请求
...
### [](#configuring-a-progressive-web-app)配置渐进式 web 应用程序
