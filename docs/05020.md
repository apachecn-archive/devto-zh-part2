...
# [](#mutually-exclusive-workers-using-golang-and-consul)互斥工人利用戈朗和执政官
...
## [](#the-solution-mutually-exclusive-workers-distributed-locks)解-互斥工人(分布式锁)
...
### [](#client-side-leader-election)客户端领导人选举
...
#### [](#step-1-creating-the-session)*步骤 1:* 创建会话
...
#### [](#step-2-acquire-the-session)*第二步:*获取会话
