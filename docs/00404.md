...
> 原文:[https://dev . to/code prototype/mimic-IOs xcode-stack view-in-Android-studio-layout-editor-507h](https://dev.to/codeprototype/mimic-iosxcode-stackview-in-android-studio-layout-editor--507h)
