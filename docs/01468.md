...
> 原文:[https://dev . to/pongsatt/deploy-back-end-API-application-with-the-kubernetes-cluster-with-Jenkins-CD-51j 7](https://dev.to/pongsatt/deploy-back-end-api-application-with-database-to-the-kubernetes-cluster-with-jenkins-cd-51j7)
...
### [](#2-build-graphql-api)2。构建 graphql api
...
### [](#3-test-graphql-api)3。测试 graphql api
...
# [](#add-jenkins-pipeline-to-project)将詹金斯管道添加到项目中

api 应用程序管道将需要 Dockerfile、kubernetes 和 Jenkins 管道配置。

### [](#1-dockerfile)1。Dockerfile 文件
...
### [](#1-kubernetes-for-database)1。用于数据库的 Kubernetes
...
### [](#5-publish-project-to-git-repository)5。将项目发布到 git 存储库

你可以推给任何一个饭桶。我们将在下一步使用它来配置 Jenkins。

# [](#configure-kubernetes-for-docker-private-registry)为 docker 私有注册表配置 kubernetes
...
# [](#create-jenkins-pipeline)创建詹金斯管道
