...
> 原文:[https://dev.to/lloople/running-old-sites-in-laravel-valet-环境-变量-4k96](https://dev.to/lloople/running-old-sites-in-laravel-valet---environment-variables-4k96)
...
### [](#ignoring-the-file-from-repositories-optional)忽略存储库中的文件(可选)
