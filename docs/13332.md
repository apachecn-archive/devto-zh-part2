...
> 原文:[https://dev . to/bnevilleoneill/how-to-build-a-server-rendered-react-app-with-next-express-fcl](https://dev.to/bnevilleoneill/how-to-build-a-server-rendered-react-app-with-next--express-fcl)
...
### [](#what-is-serverside-rendering-exactly)到底什么是服务器端渲染？
...
### [](#getting-started-with-next)下一步入门
...
### [](#serving-and-exporting-your-app)服务和导出您的应用程序
