...
## [](#adding-and-debugging-a-browser-extension-locally)在本地添加和调试浏览器扩展
...
## [](#cross-browser-extension-using-a-polyfill)使用聚合填充的跨浏览器扩展
...
### [](#chrome-brave-vivaldi)铬/勇敢/维瓦尔第
...
## [](#example-of-a-popup-extension)弹出扩展的例子
