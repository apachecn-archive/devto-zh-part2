...
### [](#throwing-exceptions-is-dishonest)抛出异常就是不诚实
...
### [](#exception-handling-is-a-poor-way-to-control-the-flow-of-execution)异常处理是一种控制执行流程的拙劣方法
...
# [](#life-without-exception-handling)生活无异常处理

### [](#this-is-not-a-post-about-railway-programming)这不是一个关于铁路编程的帖子。
...
### [](#an-old-favorite-the-result-class)一个旧的最爱，结果类
...
### [](#getting-something-back-with-result)拿回某物，有结果
