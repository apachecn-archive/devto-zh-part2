...
> 原文:[https://dev . to/ronpowelljr/setting-up-continuous-integration-with-github-2 APD](https://dev.to/ronpowelljr/setting-up-continuous-integration-with-github-2apd)
...
## [](#creating-a-simple-python-app)创建一个简单的 Python 应用
...
## [](#circleci-config-file)CircleCI 配置文件
...
## [](#configuring-circleci)配置 CircleCI
