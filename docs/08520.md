...
### [](#1-get-vs-code-color-theme-settings)🍀 1.获取 VS 代码颜色主题设置
...
### [](#2-open-codesandbox-preference)🍀 2.打开 CodeSandBox 首选项
...
# [](#%E2%9A%A0-a-word-of-caution)⚠的一句告诫
