...
> 原文:[https://dev.to/mattsparks/how-to-use-php-traits-459m](https://dev.to/mattsparks/how-to-use-php-traits-459m)

PHP 特性是代码重用的一个很好的工具。它们允许开发人员编写可以在任意数量的类中使用的方法，使您的代码保持干爽，更易于维护。

## [](#define-a-php-trait)定义一个 PHP 特征
...
## [](#a-php-trait-example)一个 PHP Trait 例子
