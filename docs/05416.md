...
> 原文:[https://dev . to/ade lowo/service-discovery-and-load balancing-with-consul-and-Fabio-fj4](https://dev.to/adelowo/service-discovery-and-loadbalancing-with-consul-and-fabio-fj4)
...
### [](#service-discovery-all-the-way)一路服务发现
...
### [](#register-a-service-in-consul)在领事处注册服务
