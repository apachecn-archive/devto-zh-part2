...
> 原文:[https://dev . to/letsbsocial 1/installing-pg admin-only-after-installing-PostgreSQL-with-home brew-2hg 0](https://dev.to/letsbsocial1/installing-pgadmin-only-after-installing-postgresql-with-homebrew-2hg0)
