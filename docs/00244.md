...
> 原文:[https://dev . to/neo/build-a-photo-feed-with-go-and-vue js-33 B3](https://dev.to/neo/build-a-photo-feed-with-go-and-vuejs-33b3)
...
## [](#getting-a-pusher-channels-application)获取推焦渠道申请
...
## [](#creating-our-go-application)创建我们的 Go 应用
...
### [](#importing-external-go-packages)导入外部 Go 包
...
### [](#creating-our-database-management-functions)创建我们的数据库管理功能
...
### [](#creating-our-data-structures)创建我们的数据结构
...
### [](#creating-our-route-handler-functions)创建我们的路线处理函数
...
### [](#adding-realtime-support-to-our-go-application)为我们的 Go 应用程序添加实时支持
