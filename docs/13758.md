...
> 原文:[https://dev . to/xngwng/graph QL-stack-in-nodejs-tools-libraries-and-framework-explained-and-comparated-2m 51](https://dev.to/xngwng/graphql-stack-in-nodejs-tools-libraries-and-frameworks-explained-and-compared-2m51)
...
## [](#tools-for-building-and-defining-the-schema)用于构建和定义模式的工具
...
### [](#connect-to-the-data-layer)连接到数据层
...
### [](#hooking-up-to-the-http-server)挂接 HTTP 服务器
...
### [](#making-the-queries-clientside)制作查询客户端
...
### [](#clientside-binding-the-query-to-ui)客户端:将查询绑定到 UI。
...
## [](#boilerplates-or-frameworks)样板文件或框架
