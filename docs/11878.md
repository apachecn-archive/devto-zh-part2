...
> 原文:[https://dev . to/auth 0/adding-salt-to-hashing-a-better-way-to-store-passwords-3i6i](https://dev.to/auth0/adding-salt-to-hashing-a-better-way-to-store-passwords-3i6i)
