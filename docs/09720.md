...
### [](#get-your-raspberry-pis-ip-address)**获取你的树莓派的 IP 地址**

#### [](#option-1-login-to-your-router)选项 1 -登录您的路由器
...
#### [](#option-2-scan-using-nmap)选项 2 -使用 Nmap 扫描
...
#### [](#option-3-use-the-hostname)选项 3 -使用主机名

默认情况下，`Raspberry Pi`的主机名是 raspberrypi。如果您无法获得您的 IP 地址，您可以尝试使用`raspberrypi.local`来代替。

### [](#connecting-to-raspberry-pi-via-ssh)**通过 SSH 连接到树莓 Pi**

##### [](#on-mac-and-linux)在 Mac 和 Linux 上
