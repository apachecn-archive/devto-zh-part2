...
## [](#check-if-a-symbolic-link-exists)检查(符号)链接是否存在
...
## [](#check-if-environment-variable-is-set)检查是否设置了环境变量
...
## [](#switch-over-an-environment-variable)切换环境变量
...
### [](#slap-your-env-files-into-your-environment)掴你的。env 文件到您的环境中
