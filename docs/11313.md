...
> 原文:[https://dev . to/kbk 0125/web-servers-explained-by-running-a-micro brewery-48ie](https://dev.to/kbk0125/web-servers-explained-by-running-a-microbrewery-48ie)
...
## [](#the-clientserver-model)客户端-服务器模式
...
## [](#an-explanation-of-ports)对端口的解释
...
## [](#where-does-the-database-fit-in)数据库适合在哪里？
...
## [](#reallife-example-of-databases-servers)数据库+服务器的真实例子
