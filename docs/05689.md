...
> 原文:[https://dev . to/lad vien/recording-brain-waves-mongo-database-with-a-nodejs-API-5h 50](https://dev.to/ladvien/recording-brain-waves-mongo-database-with-a-nodejs-api-5h50)

# [](#saving-brain-waves-to-remote-mongodb-by-way-of-node-rest-api)通过节点 REST API 将脑电波保存到远程 MongoDB
...
## [](#1-install-mongodb)1。安装 MongoDB
...
## [](#3-install-nodejs-and-npm)3。安装 NodeJS 和 npm
...
## [](#4-clone-install-and-run-the-mindwavejournalserver)4。克隆、安装和运行意识波期刊服务器
...
## [](#5-testing-mindwavejournalserver-with-postman)5。用邮递员测试意识波日志服务器
