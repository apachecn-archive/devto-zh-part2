...
## [](#introduction-to-progressive-web-apps)渐进式网络应用简介
...
## [](#push-notifications-on-the-web)在网络上推送通知
...
## [](#scope-of-service-workers)服务人员范围
...
## [](#why-use-indexeddb)为什么要用 IndexedDB？
...
### [](#store-geolocation-in-indexeddb)在 IndexedDB 中存储地理位置
...
### [](#notes-on-geolocation-api)地理定位 API 注释
...
## [](#contrived-use-case-example)做作用例示例
...
## [](#accessing-indexeddb-in-push-event)在推送事件中访问 IndexedDB
...
## [](#show-notification-in-eventwaituntil)在 event.waitUntil()中显示通知
