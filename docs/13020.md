...
> 原文:[https://dev . to/ptasker/nginx-lets-encrypt-and-taking-my-own-server-down-34 a2](https://dev.to/ptasker/nginx-lets-encrypt-and-taking-my-own-server-down--34a2)
