...
> 原文:[https://dev . to/letsbsocial 1/installing-pg admin-only-after-installing-PostgreSQL-with-home brew-part-2-4k 44](https://dev.to/letsbsocial1/installing-pgadmin-only-after-installing-postgresql-with-homebrew-part-2-4k44)
...
#### [](#uninstalling-the-postgresqlorg-install)卸载 postgresql.org 安装
...
#### [](#installing-postgresql-with-homebrew)用自制软件安装 PostgreSQL
...
#### [](#creating-the-default-postgres-user-needed-for-pgadmin)创建 pgAdmin 所需的默认 postgres 用户
...
#### [](#logging-into-pgadmin)登录 pgAdmin
