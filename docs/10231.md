...
> 原文:[https://dev . to/Khaled _ gar baya/moving-from-create-react-app-to-gatsbyjs-447 c](https://dev.to/khaled_garbaya/moving-from-create-react-app-to-gatsbyjs-447c)
...
## [](#why-moving-to-gatsby)为什么要搬到盖茨比身边？
...
## [](#gatsbyjs-project-folder-structure)Gatsby.js 项目文件夹结构
...
## [](#from-react-routes-to-gatsby-pages)从 React Routes 到 Gatsby 页面
...
## [](#from-the-react-state-to-graphql)从 React 状态到 GraphQL
