...
> 原文:[https://dev . to/mika mai/effective-service-objects-in-ruby-2ga 0](https://dev.to/mikamai/effective-service-objects-in-ruby-2ga0)
...
# [](#lets-build-a-service-object)让我们构建一个服务对象
...
# [](#applying-business-logic)应用业务逻辑
...
# [](#commands-for-repetitive-tasks)用于重复性任务的命令
