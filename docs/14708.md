...
> 原文:[https://dev.to/neo/how-to-build-a-realtime-chart-in-ios-42g 5](https://dev.to/neo/how-to-build-a-realtime-chart-in-ios--42g5)
...
## [](#requirements-for-building-a-realtime-chart-in-ios)在 iOS 中构建实时图表的要求
...
## [](#preparing-to-create-our-realtime-chart-application-in-xcode)准备在 Xcode 中创建实时图表应用程序
...
## [](#creating-our-realtime-chart-application-views-in-xcode)在 Xcode 中创建我们的实时图表应用视图
...
## [](#adding-basic-functionality-to-our-ios-chart-application)向我们的 iOS 图表应用程序添加基本功能
...
## [](#adding-realtime-functionality-to-our-ios-chart-application)为我们的 iOS 图表应用程序添加实时功能
...
## [](#creating-the-backend-service-for-our-realtime-ios-chart-application)为我们的实时 iOS 图表应用程序创建后端服务
