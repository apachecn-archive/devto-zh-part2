...
> 原文:[https://dev . to/jeremylikness/get-started-with-angular-onnet-core-21-part-one-27 l5](https://dev.to/jeremylikness/get-started-with-angular-onnet-core-21-part-one-27l5)

### [](#get-started-with-angular-on-net-core-21-part-one)上手有角。网络核心 2.1(第一部分)

#### [](#crossplatform-clientside-javascript-spa-framework-meet-crossplatform-serverside-net-core-framework)跨平台客户端 JavaScript SPA 框架，满足跨平台服务器端。NET 核心框架。
...
#### [](#approach-one-gotta-keep-em-separated)方法一:“必须把他们分开”
