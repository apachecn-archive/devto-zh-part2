...
## [](#making-objects-enumerable)使对象可枚举
...
## [](#implementing-raw-each-endraw-)实施`#each`
...
### [](#linked-lists-lists-without-arrays)链表:没有数组的列表
...
## [](#returning-raw-enumerator-endraw-instances)返回`Enumerator`实例
...
## [](#nine-lines-of-code-and-an-include)九行代码和一个包含
