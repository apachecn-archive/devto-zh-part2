...
> 原文:[https://dev . to/paigen 11/password-reset-emails-in-your-react-app-made-easy-with node mailer-2g 01](https://dev.to/paigen11/password-reset-emails-in-your-react-app-made-easy-with-nodemailer-2g01)
...
## [](#nodemailer-the-magic-bullet)节点邮件程序:神奇的子弹
...
### [](#implementation-of-nodemailer-in-my-code-frontend-and-backend)我的代码中 Nodemailer 的实现(前端和后端)
...
### [](#frontend-code-client-folder-send-reset-email)前端代码(客户端文件夹):发送重置邮件
...
### [](#backend-code-api-folder-send-reset-email)后端代码(API 文件夹):发送重置邮件
...
### [](#enabling-gmail-to-send-reset-emails)启用 Gmail 发送重置邮件
...
### [](#frontend-code-update-password-screen)前端代码:更新密码画面
...
### [](#backend-code-reset-password-amp-update-password)后端代码:重置密码&更新密码
