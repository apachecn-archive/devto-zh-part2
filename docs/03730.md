...
> 原文:[https://dev . to/einen lum/testing-your-app-with-docker-compose-on-circle ci-1ll](https://dev.to/einenlum/testing-your-app-with-docker-compose-on-circleci-1ll)
