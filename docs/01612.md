...
#### [](#middle-level-query-builder)中间层:查询生成器
...
### [](#reason-1-youre-learning-the-wrong-thing)原因 1:你学错了东西
...
### [](#reason-2-complex-orm-calls-can-be-inefficient)原因 2:复杂的 ORM 调用可能效率低下
...
#### [](#handwritten-with-pg-driver)用“pg”驱动手写:
...
#### [](#generated-with-knex-query-builder)用" knex "查询生成器生成:
...
#### [](#generated-with-sequelize-orm)用“顺序化”生成 ORM:
...
### [](#reason-3-an-orm-cant-do-everything)原因三:一个 ORM 不能做所有的事情
...
### [](#query-builders-the-sweet-spot)查询构建者:最佳位置
