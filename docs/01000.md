...
> 原文:[https://dev.to/basedenergy/what-is-this-4onl](https://dev.to/basedenergy/what-is-this-4onl)

## [](#simplifying-the-this-javascript-keyword)简化了**【本】** Javascript 关键字
...
#### [](#conveniently-there-are-four-simple-rules-to-help-determine-the-value-of-this)方便的说，有四个简单的规则可以帮助确定“这个”的值！

### [](#rule-1-default-binding)规则 1:默认绑定
...
### [](#rule-2-implicit-binding)规则二:隐式绑定
...
### [](#the-arrow-function-exception)箭头功能异常！
