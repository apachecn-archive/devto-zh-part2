...
> 原文:[https://dev . to/Owen Davies/get-latest-azure-API-version-in-arm-templates-3 IBC](https://dev.to/owendavies/get-latest-azure-api-version-in-arm-templates-3ibc)
...
## [](#examples-of-where-it-looks)看上去哪里的例子
