...
> 原文:[https://dev . to/KTA mura/memory-leak-redirect-loop-deadlock-XSS-csrf-xee-understanding-bugs-by-using-too-bug-web-application-2g Mn](https://dev.to/ktamura/memory-leak-redirect-loop-deadlock-xss-csrf-xee--understanding-bugs-by-using-too-buggy-web-application-2gmn)
