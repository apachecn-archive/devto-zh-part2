...
> 原文:[https://dev . to/michaeljolley/automating-release-notes-with-github-app veyor-and-octopus-deploy-43e 8](https://dev.to/michaeljolley/automating-release-notes-with-github-appveyor-and-octopus-deploy-43e8)
...
#### [](#skipping-commit-messages)跳过提交消息
...
### [](#download-the-full-script)下载完整脚本
