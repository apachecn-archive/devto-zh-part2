...
> 原文:[https://dev . to/tmidi/getting-started-with-ha proxy-install-from-code-source-5c4g](https://dev.to/tmidi/getting-started-with-haproxy-install-from-code-source-5c4g)
