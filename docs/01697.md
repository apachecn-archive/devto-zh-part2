...
### [](#step-2-convert-vdi-image-to-raw-image-for-gce-and-compress-it-to-upload)第二步:将 VDI 图像转换为 GCE 的 RAW 图像并压缩上传
...
### [](#step-3-upload-the-image-to-google-cloud-storage)第三步:上传图片到谷歌云存储
...
### [](#step-4-create-an-instance-on-gce)第四步:在 GCE 上创建一个实例
...
#### [](#option-a-small-unsolved-question-left-to-me)选项:留给我的一个未解小题
