# 浏览器还应该允许用户禁用 JavaScript 吗？

> 原文：<https://dev.to/ben/should-browsers-still-allow-users-to-disable-javascript--211d>

我们问了一个问题“浏览器是否还应该允许用户禁用 JavaScript？”在网络调查的[阶段，我们刚刚完成了](https://dev.to/devteam/state-of-the-web-data---call-for-analysis-2o75)，结果可能会令人惊讶。
