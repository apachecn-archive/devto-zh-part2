...
> 原文:[https://dev . to/bnevilleoneill/a-complete-guide-to-default-props-in-react-1o8o](https://dev.to/bnevilleoneill/a-complete-guide-to-default-props-in-react-1o8o)
...
### [](#hello-react-component)你好，反应过来的分量
...
### [](#reactcreateclass)反应。createClass()
...
### [](#using-higherorder-components)使用高阶元件
