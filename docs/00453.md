...
> 原文:[https://dev . to/deadly byte/CSS-animations-inspired-by-bbcs-match-of-the-day-192 o](https://dev.to/deadlybyte/css-animations-inspired-by-bbcs-match-of-the-day-192o)
...
# [](#creating-the-animation-sequence)创建动画序列
...
### [](#animation-css-properties)动画 <abbr title="Cascading Style Sheets">CSS</abbr> 属性
...
## [](#displaying-initial-data-animation-part-i)显示初始数据动画-第一部分
...
### [](#animation-delay-css-property)动画延迟 <abbr title="Cascading Style Sheets">CSS</abbr> 属性
...
### [](#animation-fill-mode-css-property)动画填充模式 <abbr title="Cascading Style Sheets">CSS</abbr> 属性
...
## [](#displaying-initial-data-animation-part-ii)显示初始数据动画-第二部分
...
### [](#transition-timing-function-css-property)过渡计时功能 <abbr title="Cascading Style Sheets">CSS</abbr> 属性
...
## [](#exit-off-screen-animation)退出离屏动画
...
### [](#animation-direction-css-property)动画方向 <abbr title="Cascading Style Sheets">CSS</abbr> 属性
