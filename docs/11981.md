...
> 原文:[https://dev . to/spino 327/building-a-raspberry-pi-cluster-3o8i](https://dev.to/spino327/building-a-raspberry-pi-cluster-3o8i)
...
#### [](#21-network-configuration-using-a-router)2.1。网络配置(使用路由器)
...
##### [](#211-network-configuration-using-a-switch-and-head-node-with-nat)2.1.1 网络配置(使用带有 NAT 的交换机和头节点)
...
#### [](#22-setting-up-passwordless)2.2。设置无密码
...
#### [](#41-configuring-the-master-node)4.1。配置主节点
...
#### [](#42-configuring-the-network-with-flannel)4.2。用法兰绒配置网络
...
#### [](#43-configuring-the-worker-nodes)4.3。配置工作节点
...
#### [](#44-accessing-the-cluster)4.4。访问集群
