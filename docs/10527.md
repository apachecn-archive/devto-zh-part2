...
> 原文:[https://dev . to/bnevilleoneill/level-up-your-CSS-selector-skills-5ha 1](https://dev.to/bnevilleoneill/level-up-your-css-selector-skills-5ha1)
...
### [](#user-interface-selectors)用户界面选择器
