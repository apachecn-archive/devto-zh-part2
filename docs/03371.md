...
> 原文:[https://dev . to/vidyasagarmsc/build-a-container-image-inside-a-k8s-cluster-and-push-it-to-IBM-cloud-container-registry-448n](https://dev.to/vidyasagarmsc/build-a-container-image-inside-a-k8s-cluster-and-push-it-to-ibm-cloud-container-registry-448n)

### [](#build-a-container-image-inside-a-kubernetes-cluster-and-push-it-to-ibm-cloud-container-registry)在 Kubernetes 集群中构建一个容器映像，并将其推送到 IBM Cloud Container Registry
...
### [](#so-what-is-kaniko)那么，Kaniko 是什么？
...
### [](#what-is-a-build-template)什么是构建模板？
