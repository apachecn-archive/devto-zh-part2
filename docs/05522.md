...
> 原文:[https://dev . to/megamattmiller/the-git-aliases-that-get-me-to-Friday-1cmj](https://dev.to/megamattmiller/the-git-aliases-that-get-me-to-friday-1cmj)
...
## [](#fetchingsyncingmerging)抓取/同步/合并
