...
> 原文:[https://dev . to/jeremylikness/server less-application-architecture-patterns-and-implementation-4l5o](https://dev.to/jeremylikness/serverless-application-architecture-patterns-and-implementation-4l5o)

#### [](#an-overview-of-serverless-with-implementations-using-azure-functions-logic-apps-and-event-grid)使用 Azure 功能、逻辑应用和事件网格实现的无服务器概述。
