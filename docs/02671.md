...
> 原文:[https://dev . to/psy ked/eslint-visual-studio-code-editor-integration-for-the-win-jb8](https://dev.to/psyked/eslint-visual-studio-code-editor-integration-for-the-win-jb8)
...
### [](#configuring-visual-studio-code-with-eslint)用 ESLint 配置 Visual Studio 代码
...
#### [](#integrating-with-visual-studio-code)与 Visual Studio 代码集成
