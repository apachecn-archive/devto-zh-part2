...
> 原文:[https://dev . to/Sr _ Bala Ji/devo PS-tool-chain-setup-on-kubernetes-cluster-59cn](https://dev.to/sr_balaji/devops-tool-chain-setup-on-kubernetes-cluster-59cn)
...
### [](#kubernetes-cluster-environment)Kubernetes 集群环境
...
#### [](#storage-class-for-jenkins)詹金斯的存储类
...
#### [](#persistent-volume-for-jenkins)对詹金斯的持久卷
