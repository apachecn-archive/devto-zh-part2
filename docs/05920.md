...
> 原文:[https://dev . to/danieljsummers/a-tour-of-my prayer journal-authentic ation-343 e](https://dev.to/danieljsummers/a-tour-of-myprayerjournal-authentication-343e)
...
## [](#integrating-auth0-in-the-app)在 App 中集成 Auth0
...
## [](#using-jwts-in-the-app)在 App 中使用 jwt
...
## [](#maintaining-authentication)维护认证
...
## [](#using-jwts-in-the-api)在 API 中使用 jwt
