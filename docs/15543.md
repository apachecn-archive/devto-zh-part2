...
> 原文:[https://dev . to/resir 014/a-type-safe-approach-to-redux-stores-in-typescript-5ajm](https://dev.to/resir014/a-type-safe-approach-to-redux-stores-in-typescript--5ajm)

# [](#an-update-20180706)一次更新(2018-07-06)
...
### [](#use-a-dedicated-raw-store-endraw-directory)使用专用的`store/`目录
...
### [](#group-stores-by-context)按上下文对门店进行分组
...
### [](#combine-reducers-inside-raw-storeindexts-endraw-)结合减速器内部`store/index.ts`
...
### [](#separate-presentational-and-container-components)分离表示层和容器组件
...
### [](#declare-the-state-of-each-reducer)宣告各减速器的状态
...
### [](#declare-action-types-as-interfaces)将动作类型声明为接口
...
### [](#-raw-actioncreator-endraw-is-your-friend)`ActionCreator`是你的朋友
...
## [](#hooking-up-with-react)猎艳有什么反应

现在让我们看看这整个结构是如何反应的。

### [](#connecting-a-react-component-to-redux)将 React 组件连接到 Redux
