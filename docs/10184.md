...
## [](#legacy-es-c%C3%B3digo-sin-tests)遗留是未经测试的代码
...
## [](#%C2%A0refactor-como-reflejo-del-conocimiento-sobre-el-c%C3%B3digo)反应器作为代码知识的反映
...
## [](#refactors-aplicados)重构 aplicados
...
### [](#extraer-m%C3%A9todos)提取方法

#### [](#aislar-dependencias-ocultas)孤立隐藏的依存关系
...
#### [](#simplificar-operaciones-complejas-en-base-a-niveles-de-abstracci%C3%B3n)根据抽象水平简化复杂操作
...
#### [](#encapsular-operaciones-complejas-y-darles-significado)封装复杂操作并赋予其意义
...
## [](#m%C3%A1s-all%C3%A1-del-c%C3%B3digo-bien-escrito)超越了写得好的代码
