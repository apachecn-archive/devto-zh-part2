...
## [](#i-thought-these-were-for-web-development-practice-some-of-them-say-app-right-in-the-description)我以为这些是为了 web 开发实践。他们中的一些人在描述中说“应用程序”。

“应用程序”可以指 web 应用程序或移动应用程序。即使构建一个移动应用程序，你仍然可以使用与构建 web 应用程序相同的技术。看看[反应原生](https://facebook.github.io/react-native/)。

## [](#these-seem-hard-i-dont-think-i-know-enough-to-build-them)这些看起来很难。我不认为我有足够的知识去建造它们。
...
## [](#where-to-start-if-i-know)如果知道从哪里开始…
...
### [](#reactreact-native)React/React Native
