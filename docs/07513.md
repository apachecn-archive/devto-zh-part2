...
> 原文:[https://dev . to/klamping/how-to-test-the-log in-page-of-your-1 bpe](https://dev.to/klamping/how-to-test-that-login-page-of-yours-1bpe)
...
# [](#identifying-a-starting-point)确定一个起点
...
# [](#the-test-your-login-webdriverio-tutorial)《测试你的登录》WebdriverIO 教程

## [](#the-video-version)视频版
...
## [](#the-text-version)文字版

### [](#step-1-install-webdriverio)第一步:安装 WebdriverIO
...
### [](#running-webdriverio)运行 WebdriverIO
...
### [](#folder-amp-file-set-up)文件夹&文件设置
...
## [](#all-set-up-and-ready-to-dance)一切准备就绪，准备跳舞
...
### [](#going-to-the-login-page)进入登录页面
...
### [](#entering-valid-credentials)输入有效凭证
...
### [](#validating-were-logged-in)验证我们已登录
