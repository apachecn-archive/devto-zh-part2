...
## [](#code-step-by-step)逐步码...

### [](#1-add-raw-nsmotionusagedescription-endraw-to-your-raw-infoplist-endraw-)1。将`NSMotionUsageDescription`添加到您的`info.plist`中
...
### [](#3-create-a-method-for-tracking-activity-events)3。创建跟踪活动事件的方法
...
### [](#4-create-a-method-for-steps-counting-updates)4。创建步骤计数更新的方法
...
### [](#5-start-getting-updates)5。开始获取更新
