...
> 原文:[https://dev.to/neshaz/when-to-use-git-reset-git-revert-git-check out-18je](https://dev.to/neshaz/when-to-use-git-reset-git-revert--git-checkout-18je)
...
## [](#undoing-with-git-commands)用 Git 命令撤销
...
### [](#fix-the-previous-commit-message)修复之前的提交消息
