...
> 原文:[https://dev . to/tomoyukiaota/creating-a-alias-for-powershell-equivalent-of-RM-RF-in-bash-2g L3](https://dev.to/tomoyukiaota/creating-an-alias-for-powershell-equivalent-of-rm--rf-in-bash-2gl3)

###### [](#a-japanese-translation-is-available-here)(此处有日文翻译[。)](https://qiita.com/TomoyukiAota/items/f94c9b0dfdeeb8a092f7)
...
# [](#how-to-create-the-command)如何创建命令
