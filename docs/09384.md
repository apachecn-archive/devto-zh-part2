...
> 原文:[https://dev.to/sait/advanced-reactjs-22lo](https://dev.to/sait/advanced-reactjs--22lo)
...
## [](#accordion-component-code)手风琴组件代码
...
## [](#accordion-component-implementation)手风琴组件实现。
...
## [](#demo-url)[演示 url](https://saigowthamr.github.io/React-Accordion/)

## [](#code-repository)[代码库](https://github.com/saigowthamr/React-Accordion)