...
> 原文:[https://dev . to/BG Adrian/from-monolith-to-cloud-auto-increment-to-uuid-10ki](https://dev.to/bgadrian/from-monolith-to-cloud-auto-increment-to-uuid-10ki)
...
## [](#from-monolith-to-cloud-series-%F0%9F%8C%A9)从独石到云系列🌩
...
## [](#id-int-not-null-autoincrement)ID int NOT NULL 自动递增🔢
...
> # [](#uuid-can-be-used-in-relationship-databases-and-viceversa-auto-incrementing-in-nosql)UUID can be used in the [relational database](https://stackoverflow.com/questions/5230638/mysql-autoincrement-to-guid) , and vice versa, it will be automatically incremented in NoSql.
...
> # [](#i-will-recommend-using-uuids-for-any-new-apps-the-current-state-of-software-needs-demand-ixxxt-scaling-apps-multiple-type-of-clients-amp-platforms-offline-apps)I will recommend any new application that uses UUID, the current state of software requirements iXXXt (extended application, various types of client & platforms, offline applications …).

#### [](#before-you-go-i-recommend-reading-some-more)走之前，我推荐多读一些:
