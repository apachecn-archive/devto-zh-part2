...
有了一点 CSS，一点 JavaScript，最重要的是，一个在摄像机和麦克风后面的志愿者(就是你，试着对着屏幕说话或大喊)，这就是我想到的。

[https://codepen.io/philnash/embed/zmVLog?height=600&default-tab=result&embed-version=2](https://codepen.io/philnash/embed/zmVLog?height=600&default-tab=result&embed-version=2)