...
> 原文:[https://dev . to/kbk 0125/JavaScript-map-method-explained-by-going-on-a-hike-537 I](https://dev.to/kbk0125/javascript-map-method-explained-by-going-on-a-hike--537i)
...
### [](#the-basics-of-the-map-method)地图的基本知识()方法
...
### [](#example-2-using-an-array-full-of-objects)例 2:使用一个充满对象的数组
...
### [](#get-more-visualized-tutorials)获取更多可视化教程
