...
> 原文:[https://dev . to/take shape/how-to-build-a-design-portfolio-with take shape-4k7h](https://dev.to/takeshape/how-to-build-a-design-portfolio-with-takeshape-4k7h)

## [](#in-part-1-of-this-4-part-series-youll-learn-to-model-and-create-content-with-takeshape)在这个 4 部分系列的第 1 部分中，你将学习用[建模和创建内容](https://www.takeshape.io/)
...
### [](#sign-up-for-a-takeshape-account)注册一个 TakeShape 账号

如果你还没有一个 TakeShape 账户，从[注册](https://app.takeshape.io/signup)开始。如果您已经有了一个账户，[登录](https://app.takeshape.io/login)。

### [](#create-a-new-blank-takeshape-project)新建一个空白的 TakeShape 项目
...
### [](#add-the-first-project-to-your-portfolio)将第一个项目添加到您的作品集
...
### [](#create-a-client-taxonomy-content-type)创建客户端分类内容类型
...
### [](#relate-clients-to-projects)将客户与项目联系起来
...
### [](#surprise-you-also-built-a-graphql-api)惊喜吧，你还内置了 GraphQL API！
...
### [](#create-a-static-site)创建静态站点

现在，您已经为您的投资组合项目定制了 CMS，您可以轻松地更新您的项目和客户。在第 2 部分中，您将创建一个独特的静态网站来展示您的项目。

## [](#interested-in-creative-tools-to-build-custom-websites)对打造定制网站的创意工具感兴趣？
