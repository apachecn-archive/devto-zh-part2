...
> 原文:[https://dev . to/Ben/should-browsers-still-allow-users-disable-JavaScript-211d](https://dev.to/ben/should-browsers-still-allow-users-to-disable-javascript--211d)
