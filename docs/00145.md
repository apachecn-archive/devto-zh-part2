...
> 原文:[https://dev . to/pofigster/fassing-IOT-for-innovation-a-tutorial-n0l](https://dev.to/pofigster/faking-iot-for-innovation-a-tutorial-n0l)
...
## [](#step-1-get-started-with-aws-iot)步骤 1 -开始使用 AWS IoT
...
## [](#step-2-get-a-server-to-pretend-to-be-an-iot-device)第二步——让一台服务器伪装成物联网设备
...
## [](#step-3-collect-data-sent-via-iot)步骤 3 -收集通过物联网发送的数据
