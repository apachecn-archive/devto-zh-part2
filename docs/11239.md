...
> 原文:[https://dev.to/peterj/playing-with-the-fn-project-5e3f](https://dev.to/peterj/playing-with-the-fn-project-5e3f)
...
# [](#the-basics%E2%80%8A%E2%80%8Ainstall-and-run)基础知识—安装和运行
...
## [](#custom-api-endpoints)自定义 API 端点
...
# [](#example-call-counter-extension-using-call-listener)示例:使用呼叫监听器的呼叫计数器分机
