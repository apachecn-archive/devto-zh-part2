...
> 原文:[https://dev . to/graphic beacon/top-10-array-utility-methods-you-should-know-dart-version-3217](https://dev.to/graphicbeacon/top-10-array-utility-methods-you-should-know-dart-version--3217)
...
## [](#7-where-firstwhere-singlewhere)7。where()，firstWhere()，singleWhere()
...
## [](#what-to-check-out-next)接下来要检查什么
