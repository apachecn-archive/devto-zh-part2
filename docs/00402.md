...
## [](#3-springcontextindexer)3。spring 上下文索引器
...
## [](#6-tieredstopatlevel)6。TieredStopAtLevel
...
## [](#7-specify-springconfiglocation-explicitly)7。请显式指定 SpringConfigLocation
...
## [](#11-exclude-hibernatevalidator)11。排除 HibernateValidator
...
## [](#13-flux-with-thin-launcher)13。具有薄发射器的焊剂
...
## [](#14-thin-launcher-cds)14。瘦启动器+光盘
