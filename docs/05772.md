...
> 原文:[https://dev . to/krit ner/and-its-like-what-the-deal-with-build-servers-bn8](https://dev.to/kritner/and-its-like-whats-the-deal-with-build-servers-bn8)
...
*原载于 2015 年 1 月 21 日 kritner.blogspot.com*[](https://dev.to/kritner/and-its-like-whats-the-deal-with-build-servers-3kmd)**。**