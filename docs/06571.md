...
> 原文:[https://dev.to/bryce/progressive-images-in-react-iph](https://dev.to/bryce/progressive-images-in-react-iph)
...
# [](#render-static-component-on-server)渲染服务器❄️上的静态组件
...
# [](#hydrate-component-on-client)客户端上的水合物组分💧
...
# [](#swap-the-images-%F0%9F%8F%9E)交换图像🌃🤝🏞
