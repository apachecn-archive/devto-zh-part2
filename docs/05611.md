...
## [](#setup-and-maps-integration)设置和地图整合
...
## [](#initializing-maps-in-react-component)初始化 React 组件中的贴图
...
### [](#dynamically-retrieving-the-google-maps-library)动态检索谷歌地图库
...
### [](#getting-initial-state-of-markers)获取标记的初始状态
...
## [](#search-the-places-through-the-foursqaure)通过四方搜索地点
...
## [](#replacing-reactjs-with-preactjs)用 PreactJS 替换 ReactJS
