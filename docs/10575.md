...
> 原文:[https://dev.to/franken/how-to-install-prestashop-17-1gh5](https://dev.to/franken/how-to-install-prestashop-17-1gh5)
...
# [](#what-are-the-steps-to-prepare-for-installing-prestashop-17)安装 Prestashop 1.7 有哪些准备步骤
...
## [](#step-i-download-prestashop-amp-upload-to-server)第一步-下载预铺&上传到服务器
...
## [](#step-ii-create-a-database)第二步-创建数据库
...
## [](#step-iii-run-prestashop-17-installation-wizard)第三步-运行 Prestashop 1.7 安装向导
...
## [](#step-iv-delete-install-folder-amp-archive-file)第四步-删除安装文件夹&的归档文件
