...
## [](#%F0%9F%9B%A0-how-do-i-set-this-up)🛠我该如何设置这个？
...
### [](#base-unsecured-environment)🔓基础不安全环境
...
### [](#install-the-caddy-plugins)📸安装 Caddy 插件
...
### [](#set-up-the-google-oauth2-provider)🔑设置 Google OAuth2 提供程序
...
### [](#create-the-login-portal)🌐创建登录门户
...
### [](#secure-the-internal-service)🔐保护内部服务
...
#### [](#optional-session-persistance-across-caddy-restarts)可选的跨 Caddy 重启的⚡会话持久性
