...
> 原文:[https://dev . to/ruidfigueiredo/ORM-less-data-access-in-net-core-23ac](https://dev.to/ruidfigueiredo/orm-less-data-access-in-net-core-23ac)
...
## [](#crud-with-adonet-in-net-core)与 ADO.NET 混为一谈。网络核心
...
## [](#getting-metadata-from-the-database)从数据库中获取元数据
