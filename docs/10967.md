...
## [](#building-our-realtime-map-in-android-studio)在 Android Studio 中构建我们的实时地图
...
### [](#adding-app-dependencies)添加应用依赖关系
...
### [](#setting-up-google-maps-api-key)设置谷歌地图 API 键
...
### [](#configuring-our-map-and-getting-realtime-updates)配置地图并获得实时更新
