...
> 原文:[https://dev . to/emasuriano/how-to-create-a-Gatsby-starter-42m 8](https://dev.to/emasuriano/how-to-create-a-gatsby-starter-42m8)
...
### [](#1-make-it-attractive-to-developers)#1。让它对开发者有吸引力💅
...
### [](#2-do-not-hardcode-personal-information)#2。不要硬编码个人信息🤷‍♂️
...
我决定用一个 CMS 来存储我所有的数据，然后显示在启动器上，在这种情况下，我选择了[](https://www.contentful.com)*，我真的很满意😃。*
...
### [](#3-provide-a-quick-setup)#3。提供快速设置🚀
...
### [](#4-add-it-to-the-official-gatsby-starters-list)#4。把它加入盖茨比的官方首发名单📦
