...
> 原文:[https://dev.to/howtocodejs/javascript-what-areyou-58lh](https://dev.to/howtocodejs/javascript-what-areyou-58lh)
...
## [](#what-is-a-singlethreaded-language)什么是单线程语言？
...
## [](#what-is-nonblocking-asynchronicity-and-concurrency)什么是非阻塞、异步、并发？
