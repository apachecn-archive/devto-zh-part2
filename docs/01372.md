...
> 原文:[https://dev . to/quantum sheep/what-I-learned-on-3-weeks-57ok](https://dev.to/quantumsheep/what-i-learned-about-cryptography-in-3-weeks-57ok)
...
# [](#keys-passwords-in-cryptography)密码学中的密钥(密码)
