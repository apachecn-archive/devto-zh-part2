...
> 原文:[https://dev.to/franiglesias/builder-pattern-56ka](https://dev.to/franiglesias/builder-pattern-56ka)
...
## [](#el-caso-para-el-patr%C3%B3n-builder)对图案生成器的案例
...
## [](#construyendo-un-builder-para-nuestro-objeto)为我们的对象建造构造器
...
## [](#un-builder-paso-a-paso)循序渐进的构建器
...
## [](#un-builder-inteligente)联合国智能建筑公司
