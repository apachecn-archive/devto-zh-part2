...
> 原文:[https://dev.to/ntoooop/just-port-a-golang-game-to-android-3a9f](https://dev.to/ntoooop/just-port-a-golang-game-to-android--3a9f)
...
## [](#how-to-make-a-fullscreennotitlebar-screen)如何制作全屏/无标题栏屏幕？
...
## [](#where-to-store-my-game-data-)我的游戏数据存放在哪里？
...
## [](#how-to-get-the-system-language)如何获取系统语言？
...
## [](#how-to-exit-the-app-manually)如何手动退出 app？
...
## [](#preserve-eglcontext)保存 eglContext！！
...
## [](#how-to-set-targetsdkversion-)如何设置‘targetSdkVersion’？
