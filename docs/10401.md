...
> 原文:[https://dev . to/samer buna/yes-react-is-taking-over-front-end-development-the-question-is-why-4 mad](https://dev.to/samerbuna/yes-react-is-taking-over-front-end-development-the-question-is-why-4mad)
...
#### [](#1%E2%80%8A%E2%80%8Athe-use-of-reusable-composable-and-stateful-components)1 —使用可重用、可组合和有状态的组件
...
#### [](#2%E2%80%8A%E2%80%8Athe-nature-of-reactive-updates)2 —反应式更新的性质
...
#### [](#3%E2%80%8A%E2%80%8Athe-virtual-representation-of-views-in-memory)3 —视图在内存中的虚拟表示
...
#### [](#reacts-reconciliation-algorithm-example)React 的对账算法示例
