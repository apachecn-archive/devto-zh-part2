...
> 原文:[https://dev . to/take shape/how-to-build-a-jam stack-website-with-take shape-35l](https://dev.to/takeshape/how-to-build-a-jamstack-website-with-takeshape-35l)
...
#### [](#standalone-project-pages)独立项目页面
...
## [](#interested-in-jamstack-cms)对 JAMstack CMS 感兴趣？
