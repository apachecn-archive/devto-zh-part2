...
> 原文:[https://dev.to/meanin/deploy-a-complete-environment-a12](https://dev.to/meanin/deploy-a-complete-environment-a12)
...
### [](#1-create-a-storage-account)1。创建存储帐户
...
### [](#2-pass-connection-string-to-key-vault)2。将连接字符串传递给密钥库
...
### [](#4-application-deployment)4。应用程序部署
