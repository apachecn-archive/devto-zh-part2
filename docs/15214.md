...
> 原文:[https://dev . to/Nikola/how-to-create-an-Android-Cordova-plugin-for-showing-toast-popups-9fb](https://dev.to/nikola/how-to-create-an-android-cordova-plugin-for-showing-toast-popups--9fb)
...
## [](#wwwandroidtoastjs)www/AndroidToast.js
...
## [](#running-the-demo-locally)本地运行演示
