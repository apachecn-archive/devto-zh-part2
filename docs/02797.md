...
> 原文:[https://dev.to/alvarocavalcanti/readability-for-real 使用有意义的名称进行数据库查询-doc](https://dev.to/alvarocavalcanti/readability-for-real---using-meaningful-names-for-database-queries-doc)
...
# [](#its-dangerous-to-go-alone-take-this)一个人去很危险，带上这个
