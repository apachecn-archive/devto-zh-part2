...
## [](#ios-snapshot-testing)iOS 快照测试

### [](#viewbased-testing)基于视图测试

基于视图的测试意味着验证用户看到的正是我们(作为开发者)希望他们看到的。多亏了这种测试，我们可以保证在不同的状态或版本中，我们的视图能够如预期的那样显示。

### [](#snapshot-test-how-does-it-work)快照测试。它是如何工作的？
...
### [](#run-views-in-an-isolated-way)以隔离方式运行视图
...
## [](#if-you-found-this-article-about-ios-snapshot-testing-interesting-you-might-like)如果你觉得这篇关于 iOS 快照测试的文章很有趣，你可能会喜欢…
