...
> 原文:[https://dev . to/Collin Barrett/resharper-vs-coderush-a-quick-n-dirty-unfair-comparison-41k 2](https://dev.to/collinbarrett/resharper-vs-coderush-a-quick-n-dirty-unfair-comparison-41k2)
...
### [](#coderush-intellirush)CodeRush IntelliRush

似乎无关紧要，因为 Visual Studio 2017 包含了本质上相同的功能。

### [](#coderush-structural-highlighting)CodeRush 结构高亮

似乎无关紧要，因为 Visual Studio 2017 包含了本质上相同的功能。

### [](#keyboard-shortcuts-templates-code-expansion)键盘快捷键、模板、代码扩展

这两种产品在概念上非常相似，但实现方式不同。不过，我还没有升级到超级用户的快捷方式，因此没有进行超级彻底的比较。

### [](#code-cleanup-raw-resharper-endraw-)代码清理[ `ReSharper++` ]
...
### [](#coderush-toolbar-toggles-raw-coderush-endraw-)CodeRush 工具栏切换[ `CodeRush++` ]
...
### [](#core-business-alignment-raw-resharper-endraw-)核心业务对齐[ `ReSharper++` ]

JetBrains 在 IDE 工具领域有着良好的记录。他们的核心业务建立在流行的 ide 和 ide 插件组合之上。另一方面，DevExpress 以其 UI 控件而闻名。

### [](#pricing-amp-licensing-business)定价&许可(业务)
