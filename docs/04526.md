...
> 原文:[https://dev . to/bnevilleoneill/5-reasons-you-should-be-using-graphql-2d2i](https://dev.to/bnevilleoneill/5-reasons-you-shouldn-t-be-using-graphql-2d2i)
...
### [](#graphql-will-make-some-tasks-more-complex)GraphQL 会让一些任务变得更加复杂
...
### [](#you-wont-be-able-to-use-a-web-cache-with-graphql)您将无法通过 GraphQL 使用网络缓存
...
### [](#graphql-schemas-could-be-a-problem)GraphQL 模式可能有问题
