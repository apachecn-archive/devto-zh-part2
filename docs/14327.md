...
> 原文:[https://dev.to/neo/building-a-messenger-app-using-net-46n](https://dev.to/neo/building-a-messenger-app-using-net--46n)
...
# [](#setting-up-our-chat-project)设置我们的聊天项目
...
## [](#creating-our-chat-app)创建我们的聊天应用

### [](#defining-pages-and-routes)定义页面和路线
...
### [](#rendering-the-chat-page)渲染聊天页面
...
### [](#selecting-contacts-and-sending-messages)选择联系人并发送消息
...
### [](#adding-realtime-functionality)添加实时功能
