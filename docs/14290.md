...
> 原文:[https://dev.to/omerlh/dynamic-security-tests-made-easy-14ff](https://dev.to/omerlh/dynamic-security-tests-made-easy--14ff)
...
## [](#proxy-tweeks-api-smoke-tests)代理 Tweek 的 API 冒烟测试
...
## [](#filtering-results-with-glue)用胶水过滤结果
