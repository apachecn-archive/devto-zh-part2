...
> 原文：<https://dev.to/jaimelr/im-developing-software-and-i-dont-google-any-more-3ecb>

我敢打赌，当你在开发软件时，当你对一个库方法、命令行中的一条错误消息或 bug 有疑问时，有人会告诉你“谷歌一下”。我很确定你可能在点击了几次后找到了解决方案，而且这个解决方案肯定在 StackOverflow 上。这似乎是软件工程师的共同任务，甚至更多像我这样的学徒。

您发现自己花费了大量时间寻找获取所需数据所需的角度过滤器，更不用说使用 CSS 将 HTML 元素放在正确的位置，或者寻找曾经使用过但现在不再受 Node/Rails/React 应用程序支持的替代方法。

由于我刚刚开始开发软件，我确实花了相当多的时间来做这项工作，所以我需要一种方法来尽快找到正确的答案，以便能够改进我的开发工作流程，并且很长一段时间以来，我认为*谷歌搜索*我的问题实际上是最快的方法。
...
非常正确！但是由于 DuckDuckGo 不使用广告(包括你的个人信息)来筹集资金，我觉得作为用户，我们有责任传播这个消息，让其他人知道这个神奇的工具。
...
> 所以我读了所有这些帖子，只是为了节省我的点击和滚动？

是啊！你做到了。如果你只是看着它，它可能看起来很愚蠢，但是如果你想想你花费在等待整个 StackOverflow 页面加载和滚动到答案上的时间，这可能是 4-5 秒，这取决于你的互联网连接，然后你乘以你谷歌一些关于软件开发的问题的次数，那么它可能看起来没有那么糟糕。

此外，有时你需要了解更多关于 StackOverflow 的答案，所以你必须像在谷歌中一样点击链接进入问题，当你点击 DuckDuckGo 结果时，它会自动带你到接受的答案，而无需滚动。你还记得在这篇文章的开头，我告诉过你你的*...解决方案肯定在 StackOverflow"* 嗯，DuckDuckGo 会为您优先考虑 StackOverflow 解决方案。

就像我刚刚向你描述的这些特性一样，还有许多其他特性非常适合你的开发工作流程，但我很难解释所有这些特性...试试看！使用几次后，你可能会发现更多，记住，如果你单独看它们，它们可能看起来不够有效，但当你开始将它们放在一起时，它们开始成为改善你工作流程时间的重要选择，特别是当你像我一样做问题时。
