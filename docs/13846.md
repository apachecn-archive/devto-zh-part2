...
> 原文:[https://dev . to/isabolic 99/plsql-find-me-right-table-and-column-based-on-a-value-ocf](https://dev.to/isabolic99/plsql-find-me-right-table-and-column-based-on-a-value--ocf)
