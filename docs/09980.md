...
> 原文:[https://dev . to/education ecosystem/results-of-a-study-to-understand-JavaScript-bugs-and-how-to-avoid-them-2e 64](https://dev.to/educationecosystem/results-of-a-study-to-understand-javascript-bugs-and-how-to-avoid-them-2e64)
...
## [](#1-domrelated-errors)1。与 DOM 相关的错误
...
## [](#2-syntaxbased-errors)2。基于语法的错误
...
## [](#4-improper-usage-of-the-return-statement)4。return 语句的不正确用法
...
## [](#5-other-causes-of-javascript-bugs)5。JavaScript 错误的其他原因
