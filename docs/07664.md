...
> 原文:[https://dev . to/PUE mos/some-beginner-tips-for-concurrency-with-asyncait-and-promise all-1 PMI](https://dev.to/puemos/some-beginner-tips-for-concurrency-with-asyncawait-and-promiseall-1pmi)

#### [](#how-you-can-make-good-use-of-concurrency-to-reduce-execution-time)如何利用好并发来减少执行时间。
