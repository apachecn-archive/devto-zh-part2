...
> 原文:[https://dev . to/on myway 133/playground-driven-development-in-swift-3ga 9](https://dev.to/onmyway133/playground-driven-development-in-swift-3ga9)
...
## [](#the-need-to-quickly-tweak-ui)需要快速调整 UI
...
## [](#custom-framework-in-playground)自定义游乐场框架
...
## [](#creating-app-framework)创建 app 框架
...
### [](#step-1-adding-a-pod)第一步:添加 pod
...
### [](#step-2-using-the-pod-in-your-app-project)步骤 2:在应用程序项目中使用 pod
...
### [](#step-3-adding-a-cocoatouch-framework)第三步:添加 CocoaTouch 框架
...
### [](#step-4-adding-files-to-appframework)步骤 4:向 AppFramework 添加文件
...
### [](#step-6-adding-pod-to-appframework)第六步:向 AppFramework 添加 pod
...
### [](#step-7-adding-a-playground)第七步:添加游乐场
...
### [](#step-1-import-bridging-header)第一步:导入桥接表头
...
## [](#fonts-localised-strings-images-and-bundle)字体、本地化字符串、图像和捆绑
...
### [](#step-1-adding-resources-to-appframework-target)步骤 1:向 AppFramework 目标添加资源
...
### [](#step-2-specifying-bundle)第二步:指定捆绑包
...
## [](#device-size-and-trait-collection)设备尺寸和特性集合
