...
> 原文:[https://dev . to/jrop/what-I-learn-this-week-March-30-2018-1ck 3](https://dev.to/jrop/what-i-learned-this-week-march-30-2018-1ck3)

## [](#directed-graphs-connected-components)有向图:[连通分量](https://en.wikipedia.org/wiki/Connected_component_%28graph_theory%29)
...
## [](#relearn-dag-topological-sort)重新学习: [DAG:拓扑排序](https://en.wikipedia.org/wiki/Topological_sorting)
