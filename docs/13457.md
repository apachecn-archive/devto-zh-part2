...
> 原文:[https://dev.to/asaaki/progressive-web-app-nfi](https://dev.to/asaaki/progressive-web-app-nfi)
...
### [](#tools-for-minification-and-compression)用于缩小和压缩的工具
...
#### [](#stylesheets-css-and-javascript-js)样式表(CSS)和 JavaScript (JS)
...
### [](#next-level-progressive-web)下一级:渐进式网络
