...
> 原文:[https://dev . to/star _ _ hoshi/TDD-in-cloud-functions-for-fire base-use-rescue-fire-413d](https://dev.to/star__hoshi/tdd-in-cloud-functions-for-firebase-using-rescue-fire--413d)
...
## [](#2-prepare-google-cloud-account-credentials)2。准备 Google 云帐户凭据
...
## [](#3-install-testing-library)3。安装测试库
...
### [](#4-finally-create-functions)4。最后，创建函数
