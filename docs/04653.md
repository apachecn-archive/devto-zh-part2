...
> 原文:[https://dev . to/canderson 93/6-制作响应式网站的技巧-从头开始-4427](https://dev.to/canderson93/6-tips-for-making-a-responsive-website-from-scratch-4427)
...
## [](#have-designs-for-two-sizings)有两种尺寸的图案
...
## [](#make-use-of-responsive-units)利用反应灵敏的单位
...
## [](#dont-bake-your-breakpoints)不要烘焙你的断点...
...
## [](#actually-dont-write-them-at-all)...实际上，根本不要写它们
