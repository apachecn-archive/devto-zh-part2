...
> 原文:[https://dev . to/nioperas 06/let-make-mason ite-framework-and-laravel-mix-work-together-3 lbj](https://dev.to/nioperas06/lets-make-masonite-framework-and-laravel-mix-work-together--3lbj)
...
# [](#create-a-new-masonite-project)创建新的 Masonite 项目
...
# [](#install-and-setup-laravel-mix)安装并设置 Laravel Mix
