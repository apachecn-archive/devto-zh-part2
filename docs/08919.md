...
> 原文:[https://dev . to/oktadev/build-a-basic-crud-app-with-node-and-react-554 c](https://dev.to/oktadev/build-a-basic-crud-app-with-node-and-react-554c)
...
## [](#create-a-basic-homepage-in-react-with-material-ui)在 React with Material UI 中创建基本主页
...
## [](#add-authentication-to-your-node-react-app-with-okta)用 Okta 给你的 Node + React App 添加认证
...
## [](#add-a-node-rest-api-server)添加一个节点 REST API 服务器
...
## [](#add-the-posts-manager-page-to-your-node-react-app)将帖子管理器页面添加到您的 Node + React 应用程序中
...
### [](#create-a-post-editor-component)创建帖子编辑器组件
...
### [](#create-the-posts-manager-page-component)创建帖子管理器页面组件
...
### [](#add-the-route-and-navigation-links)添加路线和导航链接
...
## [](#test-your-react-node-crud-app)测试你的 React + Node CRUD App
...
## [](#learn-more-about-react-node-and-okta)了解 React、Node 和 Okta 的更多信息
