...
> 原文:[https://dev . to/Hugo _ _ df/using-es6-classes-for-sequelize-4-models-17ga](https://dev.to/hugo__df/using-es6-classes-for-sequelize-4-models-17ga)
...
# [](#initialise-the-model-with-typed-fields)用键入的字段初始化模型
...
# [](#associate-your-model-to-other-models)将您的模型关联到其他模型
...
# [](#setting-a-custom-table-name-for-your-model)为你的模型设置一个自定义表名
...
# [](#setting-a-custom-model-name-for-your-model-for-sequelize)为您的模型设置自定义模型名称(用于序列化)
...
# [](#initialise-all-your-models)初始化您的所有模型
