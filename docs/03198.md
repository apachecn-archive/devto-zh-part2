...
> 原文:[https://dev.to/essentialdeveloper/xctest-swift-setup teardown-vs-factory-methods-385](https://dev.to/essentialdeveloper/xctest--swift-setupteardown-vs-factory-methods-385)
...
## [](#when-we-use-xctestcase-setupteardown-in-swift)当我们在 Swift 中使用 XCTestCase 设置/拆卸时
