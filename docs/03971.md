...
## [](#the-generalenoughtoworkforallappslayout)通用的足以满足所有应用的布局:
...
### [](#-raw-srcreduxstore-endraw-)`src/redux-store`
...
### [](#-raw-srcuiroutesroutenamecomponents-endraw-)`src/ui/routes/{route-name}/-components`
