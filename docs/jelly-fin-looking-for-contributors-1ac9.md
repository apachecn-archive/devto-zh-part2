...
> 原文：<https://dev.to/sublimegeek/jelly-fin-looking-for-contributors-1ac9>

Jelly Fin 现在是开源的。感谢 [@ben](https://dev.to/ben) 的鼓励！您可以在这里找到它:
...
现在，只有我一个人，但是如果你愿意的话，我需要一些帮助。我以前从未真正做过一个严肃的开源项目，所以我不知道从哪里开始才能确保它成功。有什么建议吗？

如果你有兴趣加入，很好。我所能提供的最多只是一些接触一些很酷的东西，比如无服务器架构、多平台开发、干净的设计和很多观点。

我现在创建了一些问题来概述一些功能，但我可以在文档中使用一些帮助，在 AWS 上构建 API，然后将成为客户端的 beast。

如果你对这个有趣的项目感兴趣，请在下面发表评论！