...
### [](#what-can-be-done-to-decrease-image-size)怎样才能缩小图像尺寸？
...
### [](#what-is-the-cost-of-a-failure)一次失败的代价是什么？
...
### [](#optimization-distributions)优化分配
...
### [](#percentages-of-100-scores-for-lighthouse-audits)灯塔审计 100 分的百分比:
...
### [](#sites-with-multiple-optimizations)多次优化的站点
...
### [](#comparing-to-actual-load-times)对比实际加载时间
