...
> 原文:[https://dev . to/wia io/how-to-build-your-own-security-system-using-Android-things-3n0m](https://dev.to/wiaio/how-to-build-your-own-security-system-using-android-things-3n0m)
...
# [](#set-up-your-space-in-wia)在 Wia 中设置您的共享空间
...
#### [](#pir-sensor-sensitivity-measures)PIR 传感器灵敏度测量
