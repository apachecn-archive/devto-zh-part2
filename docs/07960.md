...
> 原文:[https://dev . to/blackode/2-biggest-exunit-improvements-in-elixir-17-22jo](https://dev.to/blackode/2-biggest-exunit-improvements-in-elixir-17-22jo)
...
## [](#1-arguments-in-the-failure-report)1。失败报告中的参数
...
### [](#quick-docs-about-the-code-in-basicmathex-file)关于 basic_math.ex 文件中代码的快速文档。
...
> # [](#before-using-test-the-code)Before use, test the code.
...
## [](#2-running-mix-test-with-a-failed-flag)2。运行带有失败标志的混合测试🚩
