...
> 原文:[https://dev . to/mokkapps/run-automated-electronic-app-tests-using-Travis-ci-10 B2](https://dev.to/mokkapps/run-automated-electron-app-tests-using-travis-ci-10b2)
...
## [](#integrate-travis-ci-in-your-project)在您的项目中集成 Travis CI
...
## [](#configure-travis-ci)配置 Travis CI
...
## [](#electron-builder-configurations)电子生成器配置
