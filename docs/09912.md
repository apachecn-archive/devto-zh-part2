...
> 原文:[https://dev.to/nitya/2-入门-4n2p](https://dev.to/nitya/2--getting-started-4n2p)
...
### [](#2a-get-flutter-sdk-set-up)2a。安装 Flutter SDK。
...
### [](#2b-verify-flutter-sdk-set-up)2b。验证颤振 SDK 设置。
...
### [](#2c-get-target-platform-support-set-up)2c。设置目标平台支持。
...
### [](#2e-your-first-test-app)2e。你的第一个测试应用
