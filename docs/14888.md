...
> 原文:[https://dev.to/danhomola/point-free-gotchas-in-javascript-3pfi](https://dev.to/danhomola/point-free-gotchas-in-javascript--3pfi)
...
## [](#what-is-pointfree-style)什么是无点风格
...
## [](#gotcha-1-function-taking-more-parameters-than-you-expected)问题 1:函数接受的参数比预期的多
...
## [](#gotcha-2-unexpected-raw-this-endraw-)抓住问题 2:意想不到的`this`
