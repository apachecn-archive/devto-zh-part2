...
> 原文:[https://dev . to/pongsatt/setup-dynamic-storage-class-provisioner-based-on-NFS-1d4i](https://dev.to/pongsatt/setup-dynamic-storage-class-provisioner-based-on-nfs-1d4i)
...
### [](#1-create-storage-class)1。创建存储类
...
### [](#2-create-service-account-and-permission)2。创建服务帐户和权限
...
### [](#3-deploy-provisioner-as-pod)3。将置备程序部署为 pod
...
### [](#4-test-our-storage-class)4。测试我们的存储类
