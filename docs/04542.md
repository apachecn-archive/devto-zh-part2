...
> 原文:[https://dev.to/ibalajisankar/depz-14g5](https://dev.to/ibalajisankar/depz-14g5)
...
## [](#what-is%C2%A0depz)什么是 Depz？

DepZ 是一个用于托管静态网站的开源平台。

## [](#why-i-built%C2%A0depz)我为什么要建 DepZ？
...
## [](#how-can-we-achieve-all%C2%A0this)如何才能实现这一切？
