...
### [](#my-accessibility-journey-what-ive-learned-so-far)[我的无障碍之旅:目前为止我学到了什么](https://alistapart.com/article/my-accessibility-journey-what-ive-learned-so-far)

请务必在文章末尾找到一些链接，这些链接指向 Manuel Matuzovi 在他的可访问性之旅中发现有用的大量资源、时事通讯和书籍。

### [](#inclusive-components)[包容成分](https://inclusive-components.design/)

> 一个试图成为模式库的博客。一点一点地设计包容性的网络界面。

我喜欢 Heydon Pickering 对构建可访问组件的深入探究。

### [](#what-kind-of-ethics-do-frontend-developers-need)[前端开发者需要什么样的操守？](https://hiddedevries.nl/en/blog/2018-07-05-what-kind-of-ethics-do-front-end-developers-need)
...
### [](#resilient-css-7part-series)[弹性 CSS: 7 集系列](https://www.youtube.com/playlist?list=PLbSquHt1VCf1kpv9WRGMCA9_Nn4vCLZ9Y)

Jen Simmons 在这个由 7 部分组成的 YouTube 系列中讲述了如何编写同时适用于所有浏览器的 CSS 新旧浏览器。

### [](#how-to-contribute-to-an-open-source-project-on-github)[如何为 GitHub 上的开源项目做贡献](https://egghead.io/courses/how-to-contribute-to-an-open-source-project-on-github)
...
### [](#advice-for-beginners-tech-skills-applying-for-jobs-focus-imposter-syndrome-more)[给初学者的建议——科技技能、求职、专注、冒名顶替综合症+更多](https://syntax.fm/show/058/advice-for-beginners-tech-skills-applying-for-jobs-focus-imposter-syndrome-more)
...
### [](#our-vs-code-workspaces)[我们的 VS 代码工作区](https://spec.fm/podcasts/toolsday/161302)
...
### [](#mybrowserfyi)[mybrowser.fyi](https://mybrowser.fyi/)
...
### [](#its-simple-until-you-make-it-complicated)“简单到你把它变复杂。”
