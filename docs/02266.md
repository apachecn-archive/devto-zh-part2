...
> 原文:[https://dev.to/uilicious/explain-distributed-storage 和它如何为 github-uilicious-cloud-etc-1 mni 而倒下](https://dev.to/uilicious/explain-distributed-storage---and-how-it-goes-down-for-github--uilicious--cloud--etc-1mni)
