...
> 原文:[https://dev . to/Hugo _ _ df/why-you-should-wrap-your-JavaScript-dependencies-48o 2](https://dev.to/hugo__df/why-you-should-wrap-your-javascript-dependencies-48o2)
...
## [](#example-using-sendgrid)使用 SendGrid 的例子
...
## [](#how-do-we-consume-this)我们如何消费这个？
...
## [](#switching-to-another-email-provider)切换到另一个电子邮件提供商
