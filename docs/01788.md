...
> 原文:[https://dev . to/API tron/generating-pdf-file-invoice-using-c-347 I](https://dev.to/apitron/generating-pdf-file-invoice-using-c-347i)
...
##### [](#private-void-generateinvoicestream-stream)私有 void GenerateInvoice(流流)
...
##### [](#private-grid-createproductsgrid)私有网格 CreateProductsGrid()
