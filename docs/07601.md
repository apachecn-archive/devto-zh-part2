...
> 原文:[https://dev.to/aggre/dev-代币换你的 OSS-可持续性-mb3](https://dev.to/aggre/dev---tokens-for-your-oss-sustainability-mb3)
...
### [](#evaluation-logic-for-dev)评估逻辑为“Dev”
...
#### [](#future-plans-to-distribute-to-contributors)未来计划分配给贡献者
...
### [](#how-to-connect-with-dev)如何连接“Dev”
...
#### [](#i-want-to-support-oss)我要支持 OSS
...
#### [](#there-is-an-oss-that-i-want-to-directly-support)有一个 OSS 我想直接支持
