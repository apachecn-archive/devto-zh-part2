...
## [](#primeiro-%C3%A9-importante-saber-o-que-%C3%A9-o-javascript-e-como-ele-atua)首先要知道 Javascript 是什么以及它的作用方式。
...
## [](#ok-mas-e-o-nodejs)Ok，mas e o Node.js？
...
#### [](#para-saber-mais-sobre-node)Para saber mais sobre Node:
