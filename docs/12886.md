...
> 原文:[https://dev . to/blade fidz/MongoDB-query-optimization-covered-query-34 D2](https://dev.to/bladefidz/mongodb-query-optimization-covered-query--34d2)
...
### [](#first-implementation-without-indexing)第一次实现:无索引
...
### [](#second-implementation-with-indexing-and-proper-covered-query)第二种实现:带有索引和适当的覆盖查询
