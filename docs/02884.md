...
> 原文:[https://dev . to/kayis/book-review-learn-cloud formation-with-tutorial-1k 96](https://dev.to/kayis/book-review-learn-cloudformation-with-tutorial-1k96)
...
## [](#what-i-liked-about-learn-cloudformation)我喜欢学习云形成
...
### [](#setting-up-the-aws-command-line-interface-cli)设置 AWS 命令行界面(CLI)
...
### [](#configuring-security-access-for-cloudformation)配置云形成的安全访问
...
### [](#building-and-deploying-cloudformation)构建和部署云编队
