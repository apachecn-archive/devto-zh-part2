...
## [](#how-i-got-started-with-static-site-generators)我如何开始使用静态站点生成器
...
### [](#dynamic-stuff-doesnt-work)动态的东西不起作用
...
## [](#the-rise-of-the-static-site-generators)静止站点发电机的兴起
...
### [](#posts-written-in-markdown)用 Markdown 写的帖子
...
### [](#pages-written-in-react)页写在 React 上
