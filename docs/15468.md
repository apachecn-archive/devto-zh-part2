...
> 原文:[https://dev . to/netlify/choosing-a-JavaScript-build-tool-to-config-or-not-config-2ia 8](https://dev.to/netlify/choosing-a-javascript-build-tool-to-config-or-not-config-2ia8)
...
## [](#what-are-we-comparing-again)我们又在比较什么？
