...
> 原文:[https://dev.to/shalvah/eliminating-hidden-dependencies-116 c](https://dev.to/shalvah/eliminating-hidden-dependencies--116c)
...
## [](#hidden-dependencies-in-the-wild)隐藏在野外的依赖

我将分享一些我在现实世界代码库中遇到的隐藏依赖的例子。

### [](#php-raw-include-endraw-files)PHP `include`文件
...
### [](#including-javascript-files-via-ltscriptgt-tags)通过<脚本>标签包含 JavaScript 文件
...
### [](#reading-from-the-environment)从环境中阅读
...
## [](#so-why-are-hidden-dependencies-dangerous)那么，为什么隐藏依赖是危险的呢？
...
## [](#getting-rid-of-hidden-dependencies)摆脱隐藏的依赖
...
## [](#sometimes-you-just-cant-help-it)有时候，你就是没办法
