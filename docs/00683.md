...
> 原文:[https://dev . to/bnevilleoneill/promise-chaining-is-dead-long-live-async-await-52aa](https://dev.to/bnevilleoneill/promise-chaining-is-dead-long-live-async-await-52aa)
...
### [](#easy-to-read-easy-to-maintain)易于阅读，易于维护
...
### [](#code-is-constantly-changing)代码是不断变化的
...
### [](#you-dont-need-promiseall-because-its-dead)你不需要 Promise.all()因为它死了
