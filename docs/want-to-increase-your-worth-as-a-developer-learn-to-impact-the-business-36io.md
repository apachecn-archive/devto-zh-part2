...
> “我们可以做到这一点，但每当我们接触这个页面时，开发和 QA 时间都会增加 10%。同样，如果我们再次这样做，开发时间会加倍。你觉得这样舒服吗？”
...
> 
> 我们不是问我们是否能花掉钱——我们是问我们是否能为 T2 省下钱。
> 
...
营销人员——像你的客户和内部利益相关者这样的人——习惯于为他们的公司解决问题。压力太大了。有人向他们扔技术并不会让他们感觉更自信；但是有一个解决问题的伙伴就可以了。确保他们知道你了解他们的问题，并正在努力解决这些问题，这是开发商可以使用的最有效的销售策略，客户和销售团队都会感谢你使用这种策略。
...
作为一名开发者，你想增加自己的价值吗？学会影响商业最早出现在[的博客](https://blog.logrocket.com)上。