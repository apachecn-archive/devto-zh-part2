...
> 原文：<https://dev.to/davidszabo97/open-checklist---react-preact-4ohl>

嗨伙计们，

这里很晚了，我也懒得在这里写什么了。

我刚刚把我的新开源项目发布到了网上，我刚刚完成了它在移动设备上的兼容性。它是用来在桌面上使用的，所以我没有想到手机。所以手机上的 UX 是垃圾。

您可以通过在任务名称的末尾键入“:”来创建新的部分。例如，“目标:”将创建一个新的部分，如下图所示。

我欢迎任何建议，欢迎在 Github 上发表问题。
