...
> 原文:[https://dev . to/Hugo _ _ df/es6-by-example-a-module CLI-to-wait-for-postgres-in-docker-compose-902](https://dev.to/hugo__df/es6-by-example-a-modulecli-to-wait-for-postgres-in-docker-compose-902)
...
# [](#writing-es-modules-without-a-build-step)编写 ES 模块，无需构建步骤🎨
...
# [](#sane-defaults-%F0%9F%97%83)郑山默认🗃
...
## [](#attempting-to-destructure-null-or-undefined)试图析构空的或未定义的 0️⃣
...
# [](#waiting-for-postgres-with-asyncawait-%F0%9F%9B%8E)用异步/等待🛎等待 Postgres
...
# [](#integrating-as-a-cli-with-raw-meow-endraw-)与`meow`集成为一个 CLI😼
...
## [](#publishing-to-npm-with-np)用 np 发布到 npm
...
## [](#pointing-to-the-esm-version-of-the-module)指向 ESM 版本的模块
...
## [](#a-promise-waitforpg-implementation)一个承诺等待 pg 实现
