...
> 原文:[https://dev . to/star BIST/using-alpha-beta-gamma-naming-conventi on-37oh](https://dev.to/starbist/using-alpha-beta-gamma-naming-convention-37oh)
