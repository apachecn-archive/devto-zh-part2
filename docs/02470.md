...
> 原文:[https://dev . to/akshaykumar 6/progressive-we B- apps-configure-status-bar-16fa](https://dev.to/akshaykumar6/progressive-web-apps-configure-status-bar-16fa)
