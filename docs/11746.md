...
> 原文:[https://dev . to/play tomic/how-we-build-our-stack with-docker-swarm-3m D5](https://dev.to/playtomic/how-we-built-our-stack-with-docker-swarm-3md5)
...
### [](#how-are-we-going-to-build-services)我们要如何构建服务？
...
### [](#how-can-we-be-sure-that-everything-is-working-properly)如何才能确定一切都正常工作？
