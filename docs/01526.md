...
> 原文:[https://dev.to/dan_abramov/making-sense-of-react-hooks-2eib](https://dev.to/dan_abramov/making-sense-of-react-hooks-2eib)
...
### [](#do-hooks-make-react-bloated)勾手会让 React 臃肿吗？
...
### [](#what-are-hooks-exactly)钩子到底是什么？
...
### [](#but-arent-hooks-magic)但是钩子不是魔法吗？
