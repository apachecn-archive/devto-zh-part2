...
> 原文:[https://dev.to/genta/what-the-generators-4fmn](https://dev.to/genta/what-the-generators-4fmn)

想了解一下*发电机*？

### [](#first-you-need-to-check-iterators)首先你需要检查[迭代器](https://dev.to/genta/what-the-iterators-1lhc)
...
## [](#generators-are-not-magic)发电机不是魔法！
