...
# [](#dont-forget-to-consider-different-screen-sizes)别忘了考虑不同的屏幕尺寸...
...
### [](#creating-layoutxml-files-for-different-screen-densities)为不同的屏幕密度创建 layout.xml 文件
...
# [](#naming-your-class-packages-and-layout-resources)命名你的类包和布局资源
