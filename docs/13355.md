...
## [](#break-up-the-big-method-into-small-methods)把大方法分解成小方法
...
## [](#separate-dependency-registration-into-modules)将依赖关系注册分离成模块
...
### [](#easier-more-complete-integration-tests)更简单、更完整的集成测试
...
## [](#injecting-dependencies-into-our-dependency-registration-classes)将依赖注入到我们的依赖注册类中
...
## [](#dont-call-constructors-unless-you-have-no-choice-and-you-always-have-a-choice)除非别无选择，否则不要调用构造函数，你总是有选择的
