...
## [](#introducing-the-raw-wrappable-endraw-module)介绍`Wrappable`模块
...
> ## [](#in-ruby-classes-are-just-objects)在 Ruby 中，类只是对象
> 
...
## [](#using-instance-variables-on-classes)在类上使用实例变量
