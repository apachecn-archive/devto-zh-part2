# 树木和二分搜索法树——BaseCS 视频系列

> 原文：<https://dev.to/vaidehijoshi/trees--binary-search-trees--basecs-video-series-5e38>

### “当你头脑中的数据结构灯泡熄灭时，你很难不从各个方向看到数据结构！”

这个视频描述了树木和二分搜索法树的意义和原因。我们分析了为什么这些概念如此吸引人，以及为什么理解它们对您的软件开发生涯如此重要。
...
#computerscience #datastructures #binarytrees](/vaidehijoshi/leaf-it-up-to-binary-trees)
