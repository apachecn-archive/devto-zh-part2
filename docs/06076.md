...
> 原文:[https://dev.to/jperasmus/useful-reduce-use-cases-929](https://dev.to/jperasmus/useful-reduce-use-cases-929)
...
### [](#array-to-object-conversion)数组到对象的转换
...
### [](#piping-or-composing-functions)配管或排版功能
