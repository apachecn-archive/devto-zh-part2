...
> 原文:[https://dev . to/mnivoliez/getting-started-with-rust-enum-on-steroids-8 B4](https://dev.to/mnivoliez/getting-started-with-rust-enum-on-steroids-8b4)
...
## [](#yeah-but-what-is-an-enum-anyway)“是啊，....但是什么是枚举呢？”
...
## [](#ok-i-have-use-other-language-before-this-is-just-a-switch-case-no)“好吧，我以前也用过其他语言，这只是一种切换情况，不是吗？”
...
## [](#what-the-f-freacking-duck)“搞什么鬼......脆皮鸭？”
...
## [](#wow-such-variant-but-are-we-oblidge-to-express-all-possible-case-into-the-match-statement)“哇，这样的变种...但是我们是否忽略了将所有可能的情况表达到匹配语句中？”
...
## [](#what-about-doing-the-same-thing-for-different-value)“做同样的事情换不同的价值怎么办？”
...
## [](#ok-are-they-other-things-we-have-to-know-about-enum-and-match-expression)“好的，关于 enum 和 match 表达式，还有其他我们需要知道的吗？”
