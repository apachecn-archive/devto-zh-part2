...
> 原文:[https://dev.to/flexdinesh/upgrade-to-webpack-4-5b C5](https://dev.to/flexdinesh/upgrade-to-webpack-4---5bc5)
...
### [](#1-pass-through-npm-script)1。通过 npm 脚本
...
### [](#2-pass-through-config-file)2。传递配置文件
