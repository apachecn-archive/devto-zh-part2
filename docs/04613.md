...
#### [](#originally-posted-at-carloscuestas-blog)*原载于 [carloscuesta 的博客](https://carloscuesta.me/blog/react-native-meets-codepush)*
...
#### [](#code-sign-setup)代码标志设置✍️

**签约**原生申请**吓人**😱，特别是当你来自 JavaScript 生态系统的时候。证书、预置描述文件、密钥...在开发团队中使用它们时，你必须非常有条理。

我们通过[](http://fastlane.tools)*采用了 [codesigning.guide 概念。基本上，这个想法是通过一个特定的 **git 库**到**存储**和**在整个开发团队中分发**证书来实现的。我们将 **iOS** 和 **Android** 代码签名文件存储在 GitHub 上的加密私有 git 存储库中。](https://codesigning.guide)*
...
#### [](#beta-testing-distribution)Beta 测试分布🐤
...
> #### [](#machines-should-work-people-should-think)**The machine** should **work** , and **people** should **think**
