...
> 原文:[https://dev . to/neo/build-a-live-comments-feed-with-go-and-vuejs-2i7n](https://dev.to/neo/build-a-live-comments-feed-with-go-and-vuejs-2i7n)
...
## [](#configuring-the-database-and-routes)配置数据库和路线
...
### [](#making-comments-display-in-realtime)实时显示评论
