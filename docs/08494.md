...
### [](#q3-explain-what-is-reactor-pattern-in-nodejs)Q3:解释 Node.js 中的反应器模式是什么？
...
### [](#q5-why-should-you-separate-express-app-and-server)Q5:为什么要把快递的‘app’和‘server’分开？
...
### [](#q7-rewrite-the-code-sample-without-trycatch-block)Q7:重写不带 try/catch 块的代码示例
