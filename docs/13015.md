...
### [](#how-is-this-like-cooking-exactly)这怎么像做饭，到底？
...
### [](#an-introduction-to-the-bind-method)绑定方法介绍
...
### [](#an-introduction-to-the-call-method)调用方法介绍
...
### [](#an-introduction-to-the-apply-method)应用方法介绍
