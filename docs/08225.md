...
> 原文:[https://dev.to/morinoko/the-basics-of-sinatra-洛杉矶-mvc -配置-路线-表格-417e](https://dev.to/morinoko/the-basics-of-sinatra--la-mvc--configuration--routes--forms-417e)
...
## [](#file-structure-and-initial-setupconfiguration)文件结构和初始设置/配置
...
## [](#configenvironmentrb)config/environment.rb
...
### [](#passing-data-to-view-templates-through-instance-variables)通过实例变量向视图模板传递数据
...
### [](#passing-data-with-forms-and-catching-it-with-post-routes)用表单传递数据，用‘post’路由捕捉数据
