...
#### [](#1-multiple-endpoints-multiple-round-trips)1。多个端点(多次往返)
...
#### [](#2-overfetchingunderfetching-data)2。过蚀刻/欠蚀刻数据
...
#### [](#1-nonexistent-caching)1。不存在的缓存
...
#### [](#2-monitoring-and-error-reporting)2。监控和错误报告
...
#### [](#3-exposed-schema-and-resource-attacks)3。暴露的模式和资源攻击
...
#### [](#4-security-authentication-and-authorization)4。安全性-身份验证和授权
...
#### [](#5-n-1-query-problem)5。N + 1 查询问题
