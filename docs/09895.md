...
# [](#creating-a-new-android-project)创建新的 Android 项目
...
## [](#adding-chucknorris-sources)添加 ChuckNorris 源
...
## [](#fun-with-jnidispatchso)与 jnidispatch.so 同乐
