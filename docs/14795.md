...
## [](#check-if-the-google-search-is-working)检查谷歌搜索是否正常
...
### [](#initialize-a-new-nodejs-project)初始化新的 NodeJS 项目
...
### [](#install-the-following-node-modules)安装以下节点模块
...
### [](#add-a-npm-script-for-running-the-test)添加运行测试的 npm 脚本
