...
> 原文:[https://dev . to/oktadev/get-started-with-reactive-programming-in-spring-1o6a](https://dev.to/oktadev/get-started-with-reactive-programming-in-spring-1o6a)
...
## [](#reactive-programming-or-io-io-its-off-to-work-we-go%E2%80%8B)无功编程，或者，I/O，I/O，该下班了我们走…
...
## [](#solve-for-the-missing-metaphor)比喻为失踪的人解决
...
## [](#reactive-programming-with-spring-webflux)用 Spring WebFlux 进行无功编程
...
## [](#learn-more-about-reactive-programming-and-spring)了解关于反应式编程和 Spring 的更多信息
