...
> 原文:[https://dev . to/scleriot/build-a-Firefox-extension-step-by-step-5d bl](https://dev.to/scleriot/build-a-firefox-extension-step-by-step-5dbl)
...
## [](#content-and-background-scripts)内容和后台脚本
