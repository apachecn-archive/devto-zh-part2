...
> 原文:[https://dev . to/auth 0/developing-real-time-apps-with-firebase-and-firestore-1kba](https://dev.to/auth0/developing-real-time-apps-with-firebase-and-firestore-1kba)
