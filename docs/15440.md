...
> 原文:[https://dev.to/elcotu/a-small-experiment-384 b](https://dev.to/elcotu/a-small-experiment--384b)
...
# [](#java-android-app)Java 安卓 App

这是我用我著名的方法编写的第一个应用程序的屏幕:

## [](#list-of-indicators)指标列表
...
## [](#add-new-value-to-an-indicator)给指标添加新值
...
## [](#values-of-an-indicator-and-includes-add)一个指标的值(并包括相加)
