...
> 原文:[https://dev . to/elaziziyoussouf/react-native-the-missing-piece-in-the-初学者指南-4174](https://dev.to/elaziziyoussouf/react-native-the-missing-piece-in-the-beginners-guides-4174)
...
### [](#react-native-difficulty-curve-is-react-native-difficult-)React Native 难度曲线(React Native 难吗？)
...
### [](#react-native-init-vs-expo)反应本机初始化 vs expo
...
### [](#ios-or-android-do-i-need-to-learn-javaswift-stuff)iOS 或 Android(我需要学习 java/swift 的东西吗)
...
### [](#state-management-and-api)状态管理和 API
