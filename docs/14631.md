...
> 原文:[https://dev . to/sema text/IOT-air-pollution-tracking-with-nodejs-elastic-stack-and-mqtt-3 LMI](https://dev.to/sematext/iot-air-pollution-tracking-with-nodejs-elastic-stack-and-mqtt-3lmi)
...
## [](#sniffing-fresh-air-and-collecting-data-from-pm-sensor)**吸入新鲜空气并从 PM 传感器收集数据**
...
## [](#getting-accurate-gps-position)**获取精确的 GPS 位置**
...
## [](#calculating-values-from-sensor-measurements)**计算传感器测量值**
...
## [](#shipping-and-consuming-sensor-data-with-mqtt)**用 MQTT 运送和消费传感器数据**
...
## [](#storing-data-in-elasticsearch-or-sematext-cloud)**在 Elasticsearch 或 Sematext Cloud 中存储数据**
...
## [](#the-complete-device-setup-for-bananapi)**香蕉-PI 的完整设备设置**
...
## [](#cpu-and-memory-footprint)**CPU 和内存占用**
...
## [](#visualizing-the-air-pollution)**可视化空气污染**
...
## [](#observation-of-particulate-matter-concentrations-in-various-scenarios)**各种场景下颗粒物浓度的观测**
