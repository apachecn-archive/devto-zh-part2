...
> 原文:[https://dev . to/graphic beacon/building-restful-we B- API-with-dart-aqueduct-and-postgresqlbonus-content-551g](https://dev.to/graphicbeacon/building-restful-web-apis-with-dart-aqueduct-and-postgresqlbonus-content-551g)
...
## [](#1-create-a-migration-file)1。创建迁移文件
...
## [](#2-create-an-author-model)2。创建作者模型
