...
> 原文:[https://dev . to/aurelkurtula/introduction-to-the-basics-of-nextjs-part-two-pad](https://dev.to/aurelkurtula/introduction-to-the-basics-of-nextjs---part-two-pad)
...
## [](#fetching-data-from-api)从 API 获取数据
...
## [](#functionality-to-like-a-photo)像照片一样的功能
...
## [](#getting-individual-photograph)拍摄个人照片
...
## [](#add-comments-to-the-image)给图像添加注释
