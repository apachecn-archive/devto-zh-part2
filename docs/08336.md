...
### [](#step-1-create-ebs-volume)步骤 1 -创建 EBS 卷
...
### [](#step-2-attach-ebs-volume-to-ec2)步骤 2 -将 EBS 卷连接到 EC2

选择我们刚刚为 swap 和您的 EC2 实例创建的 EBS 卷。

### [](#step-3-set-ebs-volume-as-swap-space)步骤 3 -将 EBS 卷设置为交换空间
...
### [](#step-4-check-swap-space)第 4 步-检查交换空间
