...
> 原文:[https://dev . to/nick Parsons/docker-commands-the-ultimate-cheat-sheet-33 N2](https://dev.to/nickparsons/docker-commands-the-ultimate-cheat-sheet-33n2)
...
### [](#docker-commands-and-best-practices)Docker 命令和最佳实践
...
#### [](#with-that-refresher-in-mind-here-are-some-quick-tips-for-building-applications-with-docker)**记住这一点，这里有一些用 Docker 构建应用程序的快速技巧:**
...
### 下面的 [](#below-youll-find-all-of-the-basic-docker-commands-that-you-need-to-start-working-with-containers) 中，您将找到开始使用容器所需的所有基本 Docker 命令:

#### [](#developing-with-docker-containers-)**用 Docker 容器开发**:
...
#### [](#running-docker-containers)**运行码头集装箱**
...
#### [](#using-docker-utilities)**使用 Docker 实用程序:**
...
#### [](#cleaning-up-your-docker-environment)**清理你的 Docker 环境:**
