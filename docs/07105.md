...
> 原文:[https://dev . to/lad vien/recording-brain-waves-IOs-SDK-setup-5332](https://dev.to/ladvien/recording-brain-waves-ios-sdk-setup-5332)

# [](#step-1-ios-app)第一步:iOS 应用

我假设你已经安装了 Xcode。

### [](#step-11-install-cocoapods)步骤 1.1:安装 CocoaPods
...
### [](#step-12-setup-xcode-project)步骤 1.2:设置 Xcode 项目
...
### [](#step-13-development-environment-setup)步骤 1.3:开发环境设置
...
### [](#step-14-install-neurosky-ios-sdk)步骤 1.4:安装 NeuroSky iOS SDK
...
### [](#step-15-workspace-setup)步骤 1.5:工作区设置
...
### [](#step-15-enable-secure-http-request)步骤 1.5:启用安全 HTTP 请求
...
### [](#step-15-setup-objectivec-bridge-header-for-mindwave-sdk)步骤 1.5:为 MindWave SDK 设置 Objective-C 桥接接头
