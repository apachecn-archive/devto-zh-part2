...
> 原文:[https://dev.to/neshaz/state-management-in-react-apps-第一部分-4707](https://dev.to/neshaz/state-management-in-react-apps---part-i-4707)
...
## [](#react-components-state)反应组件的状态
