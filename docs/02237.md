...
> 原文:[https://dev . to/paigen 11/streams-for-the-win-a-performance-comparison-of-nodejs-methods-for-reading-large-datasets-pt-2-4l4d](https://dev.to/paigen11/streams-for-the-win-a-performance-comparison-of-nodejs-methods-for-reading-large-datasets-pt-2-4l4d)
...
## [](#the-challenge-from-part-1)来自 part 1 的挑战
...
### [](#the-three-different-solutions-for-smaller-datasets)针对较小数据集的三种不同解决方案
...
## [](#comparing-solutions-to-find-the-optimal-one)比较方案，找出最优的一个
...
### [](#fsreadfile-code-implementation-sample)Fs.readFile()代码实现示例
...
### [](#fscreatereadstream-code-implementation-sample)Fs.createReadStream()代码实现示例
...
### [](#event-stream-code-implementation-sample)事件流代码实现示例
