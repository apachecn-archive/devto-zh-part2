...
> 原文:[https://dev.to/pemtajo/euler-fermat-and-primality-test-2dc8](https://dev.to/pemtajo/euler-fermat-and-primality-test-2dc8)
...
### [](#what-is-fermats-little-theorem)什么是**费马小定理**
...
### [](#the-proof-of-generalization)一般化的证明
