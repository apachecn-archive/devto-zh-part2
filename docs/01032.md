...
# [](#step-1-read-in-the-yaml-file-into-class-specifications)第一步:读入 YAML 文件，进入类规范
...
# [](#step-2-generate-java-source-files-from-the-class-specifications)第二步:从类规范生成 Java 源文件
