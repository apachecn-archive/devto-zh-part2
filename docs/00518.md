...
> 原文:[https://dev.to/sanity-io/say-hi 到新的令人愉快的健全工作室-7ec](https://dev.to/sanity-io/say-hi--to-the-new-delightful-sanity-studio-7ec)
...
## [](#onboarding-our-new-designer)新设计师入职
...
## [](#improved-user-experience)提升用户体验
...
## [](#a-cms-that-can-be-used-on-all-screen-sizes)可以在所有屏幕尺寸上使用的 CMS
...
## [](#global-navigation-that-scales)全球导航即比例尺
