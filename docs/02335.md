...
> 原文:[https://dev . to/on my way 133/react-native-bridging how-to-make-linear-gradient-view-5 f1](https://dev.to/onmyway133/react-native-bridginghow-to-make-linear-gradient-view-5f1)
...
## [](#native-ui-component-vs-native-module)原生 UI 组件 vs 原生模块
...
### [](#rngradientviewmanager)RNGradientViewManager
...
### [](#requirenativecomponent)需要 NativeComponent
...
### [](#rngradientmanager)RNGradientManager
...
### [](#gradientmanagerpackage)GradientManagerPackage
