...
> 原文:[https://dev.to/metcoder/big-o-notation-beginners-guide-1h38](https://dev.to/metcoder/big-o-notation-beginners-guide-1h38)
...
## [](#o1-constant-complexity)O(1):恒定复杂度
...
## [](#on-linear-complexity)O(n):线性复杂度
...
## [](#olog-n-logarithmic-complexity)O(log n):对数复杂度
...
## [](#o-n2-quadratic-complexity)O( n^2):二次复杂度
...
## [](#o-2n-exponential-complexity)O( 2^n):指数复杂度
