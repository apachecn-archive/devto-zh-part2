...
> 原文:[https://dev . to/themlsmith/debugging-JavaScript-with-source-maps-5 bie](https://dev.to/themlsmith/debugging-javascript-with-source-maps--5bie)
...
## [](#how-do-source-maps-work)源地图是如何工作的？
...
## [](#working-with-source-maps-in-production)在生产中使用源地图
...
### [](#tips-for-using-source-maps-in-production-and-debugging-with-rollbar)使用滚动条在生产和调试中使用源地图的提示
