...
> 原文:[https://dev . to/praxentsoftware/why-we-build-a-custom-react-boilerplate-hint-collaboration-speed-djn](https://dev.to/praxentsoftware/why-we-built-a-custom-react-boilerplate-hint-collaboration--speed-djn)
