...
> 原文：<https://dev.to/mokkapps/my-new-kickass-portfolio-website-2ife>
...
#portfolio #webdev #career #beginners](/aspittel/building-a-kickass-portfolio-28ph)I decided to make a complete rewrite and redesign of [my portfolio website](https://www.mokkapps.de).

这个链接的帖子包括了为什么一个网站开发者应该创建他自己独特的作品集网站的所有相关原因。鼓励我进行重构的一些主要原因是:
...
#hugo #netlify #website](/mokkapps/how-i-built-my-website-with-hugo-and-netlify-3n49)
