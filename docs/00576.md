...
> 原文:[https://dev . to/murder lon/crowdsourcing-the-evolution-of-text-parsing-with-unified-5ao 1](https://dev.to/murderlon/crowdsourcing-the-evolution-of-text-parsing-with-unified-5ao1)
...
## [](#first-whats%C2%A0unified)一、什么是统一？
...
## [](#how-its-used%C2%A0today)今天是怎么用的
...
## [](#announcing-the-unified-collective)宣布统一的集体
...
## [](#mdx-joins-forces-with%C2%A0unified)MDX 联手统一
...
## [](#be-part-of-the%C2%A0change)成为变化的一部分
...
## [](#being-an-open-collective)成为一个开放的集体
