...
> 原文:[https://dev . to/pranesh 229/how-to-improve-the-site-score-from-chrome-light house-3 FCA](https://dev.to/pranesh229/how-to-improve-the-site-score-from-chrome-lighthouse-3fca)

这份文件是关于我通过使用 Chrome Developer Tools 进行审核来为我的个人资料网站获得高分所遵循的一系列步骤。

### [](#how-to-audit-your-website-using-chrome-developer-tools)如何使用 Chrome 开发者工具审计你的网站
