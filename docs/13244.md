...
> 原文:[https://dev.to/ajiteshtiwari/go-functional-with-java-45ac](https://dev.to/ajiteshtiwari/go-functional-with-java-45ac)
...
## [](#family-of-functionalinterfaces)功能-接口系列

掌握所有的接口可能看起来很多。相反，如果我们只是了解他们的家庭，我们可以很容易地指向正确的界面。

有 4 类功能接口-

### [](#consumer-consume-and-discard)消费者——消费并丢弃
...
### [](#function-map-or-transform-or-compute)函数-映射或变换或计算
...
### [](#predicate-test-or-filter)谓词-测试或过滤
