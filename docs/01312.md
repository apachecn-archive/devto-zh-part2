...
> 原文:[https://dev . to/dbsheta/processing-streaming-Twitter-data-using-Kafka-and-spark the-plan-129 a](https://dev.to/dbsheta/processing-streaming-twitter-data-using-kafka-and-sparkthe-plan-129a)

## [](#what-is-apache-kafka)什么是阿帕奇卡夫卡？
