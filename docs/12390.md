...
> 原文:[https://dev . to/kena kamu/azure-vs-GCP-part-18-mobile-app-development-GCP-2j1h](https://dev.to/kenakamu/azure-vs-gcp-part-18-mobile-app-development-gcp-2j1h)
...
### [](#key-features-for-developer)开发者的关键特性
...
### [](#key-features-for-operation)主要功能为操作
...
### [](#create-firebase-project-and-install-sdk)创建 firebase 项目并安装 SDK
...
### [](#create-web-application-project)创建 web 应用项目
...
# [](#messagingpush-notification)消息/推送通知

接下来，添加推送通知。

### [](#background-worker)后台工作人员
...
### [](#register-device-to-notification)注册设备以通知
