...
> 原文:[https://dev . to/adnanrahic/a-crash-course-on-servers-with-AWS-image-resize-on-the-fly-with-lambda-and-S3-4 foo](https://dev.to/adnanrahic/a-crash-course-on-serverless-with-aws---image-resize-on-the-fly-with-lambda-and-s3-4foo)
...
## [](#create-the-project-structure)创建项目结构
...
## [](#create-a-secrets-file)创建一个机密文件
...
## [](#write-the-aws-lambda-function-configuration)编写 AWS Lambda 功能配置
...
## [](#write-aws-lambda-function-source-code)写 AWS Lambda 函数源代码
...
## [](#write-s3-bucket-configuration)写 S3 斗配置
...
## [](#deploy-with-docker)用 Docker 部署
...
## [](#test-with-dashbird)用 Dashbird 测试
