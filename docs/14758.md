...
> 原文:[https://dev . to/neo/monitoring-laravels-background-queues-in-real time-using-pusher-e75](https://dev.to/neo/monitoring-laravels-background-queues-in-realtime-using-pusher--e75)
...
## [](#building-the-backend-of-our-application)构建我们应用程序的后端
...
## [](#building-the-frontend-of-our-application)构建我们应用程序的前端
...
## [](#testing-our-application)测试我们的应用程序
