...
> 原文:[https://dev . to/Khaled _ gar baya/developer-friendly-API-using-es6-proxy-272d](https://dev.to/khaled_garbaya/developer-friendly-apis-using-es6-proxies-272d)
...
## [](#lets-build-our-one-thousand-and-one-nights-app)让我们构建我们的《一千零一夜》应用程序
