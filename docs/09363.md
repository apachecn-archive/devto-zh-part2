...
> 原文:[https://dev . to/fros nerd/event-handling-in-AWS-using-SNS-SQS-and-lambda-2 ng](https://dev.to/frosnerd/event-handling-in-aws-using-sns-sqs-and-lambda-2ng)
