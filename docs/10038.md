...
> 原文:[https://dev.to/devamaz/using-fetch-api-to-get-and-post-1g7d](https://dev.to/devamaz/using-fetch-api-to-get-and-post--1g7d)
...
### [](#how-to-use-fetch-api-to-get-data-from-an-api)如何使用 fetch API 从 API 中获取数据
...
### [](#how-to-use-fetch-api-to-post-data-to-an-api)如何使用 fetch API 向 API 发布数据
