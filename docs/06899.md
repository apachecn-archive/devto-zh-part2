...
> 原文:[https://dev . to/wia io/how-to-connect-a-SIG fox-sensit-to-wia-338 b](https://dev.to/wiaio/how-to-connect-a-sigfox-sensit-to-wia-338b)
...
# [](#connect-the-sensit-to-the-sigfox-app)将 Sens'It 连接到 Sigfox 应用程序
...
### [](#add-api-keys-to-wia)向 Wia 添加 API 键
...
### [](#setup-your-sigfox-callback)设置您的 Sigfox 回调
