...
> 原文:[https://dev.to/lefebvre/useful-raspberry-pi-tips-4i5j](https://dev.to/lefebvre/useful-raspberry-pi-tips-4i5j)

这里有一些小技巧可以帮助你充分利用你的树莓派。

# [](#updating-raspbian-os)更新 Raspbian 操作系统
...
# [](#transferring-files-to-raspberry-pi)将文件传输到树莓派
...
# [](#connecting-to-raspberry-pi-via-shell)通过 Shell 连接到树莓 Pi
...
# [](#connecting-to-raspberry-pi-via-vnc)通过 VNC 连接到树莓派
...
# [](#make-your-own-programs)制作自己的程序
