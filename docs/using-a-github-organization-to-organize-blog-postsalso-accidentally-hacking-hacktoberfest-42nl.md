# 使用 GitHub 组织来组织博客文章——还意外地黑了 Hacktoberfest！

> 原文：<https://dev.to/kritner/using-a-github-organization-to-organize-blog-postsalso-accidentally-hacking-hacktoberfest-42nl>
...
我发现我的 GitHub 库列表变得难以管理，也许这只是因为我分叉所有的东西而不是开始，尽管有时我也这样做。

我想尝试做一些事情来帮助组织我的存储库——创建一个 GitHub 组织来存放我在博客文章中使用的代码。

这个组织非常简单，希望我这样做不会违反任何规则。现在，我所有博客文章的代码(不多)都组织在一个地方！
...
这些和 Hacktoberfest 有什么关系？什么是*** Hacktoberfest？你可以在这里阅读全部内容[。但是 tldr 其中之一是:](https://hacktoberfest.digitalocean.com/)

> 在 10 月期间编写代码并提交 PRs，并获得免费的东西！

无意的(但欢迎！)创建 GitHub 组织的结果是，我提交到我的组织/博客帖子存储库的提交(PRs)计入了我 10 月份的 5 个 PRs。诚然，当我发现这一点时，我已经有了 5 个 PRs，但这仍然是一个很好的惊喜。
...
在他们停止发放免费的 Hacktoberfest 衬衫之前，仍然有将近 25k 挑战完成！黑我的人！