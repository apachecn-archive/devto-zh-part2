...
> 原文:[https://dev . to/hml on/what-to-do-when-you-need-a-web-app-quickly-jcj](https://dev.to/hmlon/what-to-do-when-you-need-a-web-app-quickly-jcj)
...
## [](#is-this-a-system-of-linear-equations)这是线性方程组吗？
...
## [](#making-a-form-with-a-twodimensional-array-input)用二维数组输入制作表格
...
## [](#finally-solving-the-system)最终求解系统
...
## [](#areas-of-improvement-homework)需要改进的地方(作业？)
