...
> 原文:[https://dev . to/djug/POC-partial-random-passwords-or-how-to-protect-users-passwords-from-key loggers-with-partial-random-passwords-4c PE](https://dev.to/djug/poc-partially-random-passwords-or-how-to-protect-users-passwords-from-keyloggers-with-partially-random-passwords-4cpe)
...
## [](#partiallyrandom-passwords)部分随机密码
...
## [](#what-if-the-hacker-knows-exactly-which-part-of-the-password-is-random)如果黑客确切知道密码的哪一部分是随机的怎么办？
