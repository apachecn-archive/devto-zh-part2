...
> 原文:[https://dev . to/nieds/getting-started-building-component-libraries-with-angular-CLI-4 ncj](https://dev.to/nieds/getting-started-building-component-libraries-with-angular-cli-4ncj)
...
### [](#generating-a-library-project-with-the-angular-cli)用 Angular CLI 生成一个库项目
