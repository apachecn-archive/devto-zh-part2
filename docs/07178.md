...
> 原文:[https://dev . to/itachiuchiha/dockerizing-an-adonisjs-app-27bd](https://dev.to/itachiuchiha/dockerizing-an-adonisjs-app-27bd)
...
# [](#dockerizing-an-adonisjs-app)将一个 AdonisJs 应用程序归档

在开始之前，我应该说，这个帖子不会给出任何关于 adonisjs 的深入信息。比如它的控制器系统我就不教了。如果你没问题的话，我们开始吧。

# [](#installing-docker-to-ubuntu)安装 Docker 到 Ubuntu

Docker 要求 64 位 Ubuntu 系统。所以如果你打算安装你的服务器或者你的个人电脑，你需要确定你有 64 位的 Ubuntu 系统。

### [](#1-add-gpg-key-to-system-for-official-docker-repository)1-)将 GPG 密钥添加到官方 Docker 存储库系统中
...
### [](#2-add-docker-repositories-to-apt-resources)2-)将 Docker 储存库添加到 APT 资源
...
### [](#4-to-make-sure-that-the-docker-repo-is-received-we-will-use-aptcache)4-)为了确保收到 docker repo，我们将使用 apt-cache。
...
### [](#5-docker-installation)5-)码头工人安装
...
### [](#6-checking-the-docker-running-status)6-)检查对接机运行状态
...
# [](#installation-of-docker-compose)安装 Docker 作曲
...
# [](#creating-new-adonis-project)创建新的 Adonis 项目
