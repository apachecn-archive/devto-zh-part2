...
> 原文:[https://dev.to/risdenk/apache-ambari-定制-预警-调度-脚本-43no](https://dev.to/risdenk/apache-ambari---custom-alert-dispatch-script-43no)
...
### [](#integrating-ambari-alerts-with-external-tools)集成 Ambari 警报和外部工具
...
### [](#creating-a-custom-ambari-alert-dispatcher)创建自定义的 Ambari 预警调度程序
...
#### [](#create-the-ambari-custom-alert-dispatcher-script)创建 Ambari 自定义警报调度程序脚本
...
#### [](#delete-ambari-alert-target)删除安巴里预警目标
