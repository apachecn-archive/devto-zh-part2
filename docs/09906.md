...
## [](#developing-the-http-api)开发 HTTP API
...
## [](#creating-the-elastic-beanstalk-application)创建弹性豆茎应用程序
...
## [](#setting-up-the-elastic-beanstalk-environment)设置弹性豆茎环境
...
## [](#managing-application-versions)管理应用版本
...
## [](#deploying-the-http-api)部署 HTTP API
