...
> 原文:[https://dev . to/nothing/design-systems-maintaining-design-with-pattern-libraries-1e 70](https://dev.to/nothing/design-systems-maintaining-design-with-pattern-libraries-1e70)
...
## [](#four-reasons-to-use-pattern-libraries)**使用模式库的四个理由**
...
## [](#looking-at-a-concrete-example)**看一个具体的例子**
...
## [](#the-tools-zeplin-pattern-lab)**工具:Zeplin +模式实验室**
...
## [](#build-the-pattern-library-from-the-smallest-to-the-biggest-piece)**建立图案库:从最小块到最大块**
...
## [](#delivering-the-pattern-library-to-partners-and-customers)**向合作伙伴和客户交付模式库**
...
## [](#maintenance-pattern-library-first)**维护:花样库第一**
