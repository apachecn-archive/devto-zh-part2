...
> 原文:[https://dev . to/Hugo _ _ df/testing-an-express-app-with-supertest-moxios-and-jest-4f 44](https://dev.to/hugo__df/testing-an-express-app-with-supertest-moxios-and-jest-4f44)
...
# [](#a-simple-express-app)一个简单的快递 app🎁
...
## [](#testing-strategy-%E2%80%8D)试探策略🕵️‍
...
# [](#testing-a-less-simple-express-app)测试一个不太简单的快递 app📚
...
## [](#testing-strategy-%F0%9F%9B%A0)试探策略🛠
...
## [](#where-redis-gets-mocked)雷迪斯被嘲笑的地方🤡
