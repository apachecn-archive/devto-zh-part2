...
> 原文:[https://dev . to/bnevilleoneill/JavaScript-design-patterns-1k fn](https://dev.to/bnevilleoneill/javascript-design-patterns-1kfn)
...
#### [](#why-consider-using-a-design-pattern-in-javascript)为什么要考虑在 Javascript 中使用设计模式？
...
#### [](#how-can-you-recognize-a-good-design-pattern)如何才能识别出好的设计模式？
...
#### [](#design-pattern-categories)设计模式类别
