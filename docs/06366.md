...
## [](#why-might-you-want-to-switch)你为什么会想转行？
...
## [](#what-would-be-involved-in-switching)切换会涉及到什么？
...
#### [](#aws-lambda-docs)AWS Lambda ( [docs](https://docs.aws.amazon.com/lambda/latest/dg/nodejs-prog-model-handler.html)
...
#### [](#azure-functions-docs)Azure 函数([文档](https://docs.microsoft.com/en-us/azure/azure-functions/functions-reference-node)
...
#### [](#google-cloud-functions-docs)谷歌云功能([文档](https://cloud.google.com/functions/docs/quickstart)
...
### [](#changes-to-deployment-trigger-and-execution-configuration)部署、触发和执行配置的变更
...
## [](#how-can-you-mitigate-the-risks-of-needing-to-switch-in-the-future)您如何降低未来需要切换的风险？
