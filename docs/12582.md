...
> 原文:[https://dev . to/hasurahq/architecture-of-a-high-performance-graphql-to-SQL-engine-nof](https://dev.to/hasurahq/architecture-of-a-high-performance-graphql-to-sql-engine-nof)
...
## [](#processing-the-graphql-request)处理 GraphQL 请求

以下是获取 GraphQL 查询所需数据的各种方法:

### [](#naive-resolvers)天真的解析者
