...
> 原文:[https://dev.to/geraldcroes/kubernetes-特拉菲克-101-当简单-重要-6k6](https://dev.to/geraldcroes/kubernetes--traefik-101-when-simplicity-matters-6k6)
...
### [](#what-you-need-to-know-about-kubernetes)你需要了解的 Kubernetes

#### [](#kubernetes-as-in-cluster)Kubernetes，如在集群中
...
### [](#what-you-need-to-know-about-traefik)关于 Traefik 你需要知道的事情
...
### [](#lets-start-putting-everything-together)让我们开始把所有东西放在一起吧！

*这是我们实际开始将服务部署到 Kube 集群并将 Traefik 配置为入口控制器的部分。*

#### [](#prerequisite)先决条件

您可以访问一个 Kubernetes 集群，并且您有指向该集群的[](https://kubernetes.io/docs/reference/kubectl/overview/)*。*
...
#### [](#setting-up-traefik-using-helm)使用舵设置 Traefik
...
#### [](#lets-deploy-some-pods)让我们部署一些豆荚吧！
