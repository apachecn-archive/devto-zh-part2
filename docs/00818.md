...
> 原文:[https://dev.to/plutov/docker-and-go-modules-3kkn](https://dev.to/plutov/docker-and-go-modules-3kkn)
...
## [](#package-with-docker)用 Docker 打包
