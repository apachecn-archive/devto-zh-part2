...
> 原文:[https://dev . to/artis 3n/encrypting-files-in-a-post-PGP-age-59bf](https://dev.to/artis3n/encrypting-files-in-a-post-pgp-age-59bf)
...
## [](#what-are-my-alternatives)我有哪些替代品？
...
#### [](#use-the-keybase-client)使用 Keybase 客户端
