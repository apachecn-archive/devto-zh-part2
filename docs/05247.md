...
> 原文:[https://dev . to/rajmondburgaj/how-to-setup-methods-which-return-a-build-int-type-and-implement-ienumerable-interface-in-MOQ-20 of](https://dev.to/rajmondburgaj/how-to-setup-methods-which-return-a-built-int-type-and-implement-ienumerable-interface-in-moq--20of)
