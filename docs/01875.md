...
> 原文:[https://dev . to/qlik branch/getting-started-with-qlik-core-2781](https://dev.to/qlikbranch/getting-started-with-qlik-core-2781)
...
### [](#first-of-all-why-qlik-core)首先，为什么要 Qlik Core？
...
### [](#qlik-core-to-the-rescue%E2%80%8A%E2%80%8Abut-what-is-qlik-core)Qlik Core 前来救援——但是什么是*Qlik Core 呢？*
