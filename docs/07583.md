...
### [](#xmlhttprequest-object)XMLHttpRequest 对象
...
### [](#xhr-xmlhttprequest-object-states)xhr [XMLHttpRequest]对象状态
...
### [](#xmlhttprequest-20-event-handlers)XMLHttpRequest 2.0 事件处理程序
...
### [](#sending-a-request-to-a-server)向服务器发送请求
