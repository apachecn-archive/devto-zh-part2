...
### [](#logic-extracted-from-raw-try-endraw-blocks)逻辑从`try`块中提取
...
### [](#await-with-raw-catch-endraw-)与`.catch()`恭候
...
## [](#other-problems-with-promises)承诺的其他问题
