...
> 原文:[https://dev . to/GM lion/lambda-calculus-and-currying-in-JavaScript-476](https://dev.to/gmlion/lambda-calculus-and-currying-in-javascript-476)
...
### [](#one-argument-to-rule-them-all)一个论点统治所有人
...
### [](#the-conservative-approach)采用“保守”的方法
...
### [](#the-lambda-semantic-approach)采用“λ语义”的方法
