...
> 原文:[https://dev . to/codevbus/deploy-AWS-lambda-functions-with-AWS-Sam-CLI-and-Travis-ci-3m9m](https://dev.to/codevbus/deploy-aws-lambda-functions-with-aws-sam-cli-and-travis-ci-3m9m)
...
### [](#what-are-we-doing-why)我们在做什么？为什么？
...
### [](#create-a-github-repository)创建 GitHub 资源库
...
### [](#create-the-lambda-function)创建λ函数
...
### [](#create-the-sam-template)创建 SAM 模板
...
### [](#generate-a-sample-payload)生成样本有效载荷
...
### [](#test-the-lambda-function)测试 Lambda 函数
