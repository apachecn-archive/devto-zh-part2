...
> 原文:[https://dev . to/shal vah/how-to-build-a-real time-spreadsheets-application-with-pusher-channels-part-1-users-and-spreadsheets-34ej](https://dev.to/shalvah/how-to-build-a-realtime-spreadsheets-application-with-pusher-channels---part-1-users-and-spreadsheets-34ej)
...
## [](#building-the-user-dashboard)构建用户仪表盘
