...
> 原文:[https://dev . to/Hector 6872/面向对象编程和希腊神话-6jg](https://dev.to/hector6872/object-oriented-programming-and-greek-mythology-6jg)

## [](#principles-and-laws)原理和规律
...
### [](#what-is-tell-dont-ask-tda-principle-about)什么是告诉，不问(TDA)原则？
...
### [](#principles-are-not-laws)原则不是法律
...
*   我们可能会违反其他原则，例如 [SRP](https://en.wikipedia.org/wiki/Single_responsibility_principle)
    ...
    > # [](#tell-dont-ask-principle-cannot-be-treated-like-the-rule-of-thumb-like-many-other-principles-because-we-often-have-to-ask-questions)Tell everyone that the principle of don't ask can't be treated like the rule of thumb (like many other principles) because we often have to ask questions.
...
> # [](#true-friendship-isnt-about-being-inseparable-but-about-being-separated-and-knowing-nothing-will-changes-ted)"True friendship is not inseparable, but not knowing what will change even if we are separated"- [TED](https://en.wikipedia.org/wiki/Ted_(film))
