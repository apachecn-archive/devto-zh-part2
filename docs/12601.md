...
> 原文:[https://dev . to/codesmith _ staff/explain-JavaScript s-prototype-chain-like-im-five-51p](https://dev.to/codesmith_staff/explain-javascripts-prototype-chain-like-im-five-51p)
...
## [](#how-do-we-initialize-our%C2%A0chain)我们如何初始化我们的链？
...
## [](#putting-it-all%C2%A0together)把所有的东西放在一起
