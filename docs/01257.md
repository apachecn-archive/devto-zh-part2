...
> 原文:[https://dev . to/progress telerik/5-things-I-not-know-about-create-react-app-49nj](https://dev.to/progresstelerik/5-things-i-didnt-know-about-create-react-app-49nj)
...
## [](#1-displaying-lint-errors-in-the-editor)1。在编辑器中显示 Lint 错误
...
## [](#2-formatting-code-automatically-using-prettier)2。使用更漂亮的自动格式化代码
...
## [](#3-developing-components-in-isolation)3。孤立地开发组件
...
## [](#4-making-a-progressive-web-app)4。制作渐进式 Web 应用程序
