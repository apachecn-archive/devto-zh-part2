...
> 原文:[https://dev . to/jalend port/你的 shell-path-570p 到底是什么](https://dev.to/jalendport/what-exactly-is-your-shell-path-570p)
...
#### [](#a-brief-introduction-to-the-file-system)文件系统简介
