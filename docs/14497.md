...
> 原文:[https://dev . to/marluanespiritusanto/why-important-to-learn-vanilla-JavaScript-first-before-opting-for-a-framework-or-library-5 ffg](https://dev.to/marluanespiritusanto/why-is-important-to-learn-vanilla-javascript-first-before-opting-for-a-framework-or-library--5ffg)
...
## [](#the-solution-here-is-clear-and-precise-vanilla-javascript)这里的解决方案清晰而精确:**香草 JavaScript**
