...
> 原文:[https://dev.to/mohitkalra/the-y-why 因维姆里奇- 31k4](https://dev.to/mohitkalra/the-y-why--in-vimrc--31k4)
...
## [](#managing-the-vimrc-file)管理 vimrc 文件。

在第一部分中，我讨论了 vimrc 文件本身和一些管理它的技巧。

### [](#make-vimrc-always-available)使 vimrc 始终可用:
...
### [](#source-vimrc-as-soon-as-you-write-it)一写就源 vimrc
