...
> 原文:[https://dev . to/bnevilleoneill/the-easy-way-to-keep-your-web-apps-accessible-1nc 2](https://dev.to/bnevilleoneill/the-easiest-way-to-keep-your-web-apps-accessible-1nc2)
...
### [](#styling-accessible-text)样式辅助文本
...
### [](#accessibility-and-frameworks)可达性和框架
...
### [](#keep-your-apps-accessible)保持您的应用程序可访问
