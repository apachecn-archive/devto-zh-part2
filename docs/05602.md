...
> 原文:[https://dev.to/mornir/flexbox-space-evenly-value-58gf](https://dev.to/mornir/flexbox-space-evenly-value-58gf)

### [](#using-the-raw-spaceevenly-endraw-value-with-flexbox)使用 Flexbox 的`space-evenly`值
