...
> 原文:[https://dev . to/dbsheta/processing-streaming-Twitter-data-using-Kafka-and-spark-part-2-creating-Kafka-Twitter-stream producer-12k o](https://dev.to/dbsheta/processing-streaming-twitter-data-using-kafka-and-spark-part-2-creating-kafka-twitter-streamproducer-12ko)
...
## [](#generating-twitter-api-keys)生成 Twitter API 密钥
...
## [](#streaming-tweets-to-kafka-cluster)向 Kafka 集群发送流推文
