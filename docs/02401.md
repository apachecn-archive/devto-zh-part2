...
> 原文:[https://dev . to/brandonskeritt/what ' s a decision tree-in-machine-learning-5bcb](https://dev.to/brandonskerritt/what-is-a-decision-tree-in-machine-learning-5bcb)
...
### [](#making-decision-trees-using-a-formal-language)使用形式化语言制作决策树
...
### [](#splitting-candidates-in-the-tree)拆分树中的候选项
...
### [](#finding-the-best-splits)寻找最佳劈叉
...
#### [](#information-gain-example)信息增益示例
...
### [](#overfitting-with-noisy-data)过度拟合有噪声的数据
...
### [](#overfitting-with-noisefree-data)无噪声数据过拟合
