...
> 原文:[https://dev . to/chiangs/how-im-starting-my-own-angular-component-library-part-1-generic-button-3f3m](https://dev.to/chiangs/how-im-starting-my-own-angular-component-library-part-1---generic-button-3f3m)
...
### [](#what-i-want-this-button-to-be-capable-of-handling)我希望这个按钮能够处理什么
...
#### [](#create-the-component-via-angular-cli)通过 Angular CLI 创建组件
...
#### [](#decide-on-the-inputs-and-outputs)决定输入和输出
