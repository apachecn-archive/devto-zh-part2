...
# [](#setting-up-a-react-native-environment)设置 react 原生环境

## [](#steps)步骤

### [](#software-installs-and-file-setup)软件安装和文件设置
...
### [](#android-sdk-and-avd-install)Android SDK 和 AVD 安装
...
### [](#installing-testing-tools)安装测试工具
