...
### [](#install-and-host-locally)本地安装和托管
...
### [](#install-and-host-using-docker)使用 Docker 安装和托管
...
#### [](#run-mongodb)运行 MongoDB

##### [](#run-mongodb-using-named-volume)使用命名卷运行 MongoDB
...
##### [](#run-mongodb-using-bind-mount)使用绑定挂载运行 MongoDB
...
#### [](#access-mongodb)访问蒙古数据库

##### [](#access-mongodb-from-local-machine)从本地机器访问 MongoDB
...
##### [](#access-mongodb-via-docker-interactive-tty)通过 Docker 互动 TTY 访问 MongoDB
...
### [](#host-with-mongodb-atlas)主机用 MongoDB 图册
...
#### [](#install-azure-cosmosdb-extension)安装 Azure CosmosDB 扩展
...
#### [](#configure-user-settings)配置用户设置
...
#### [](#connect-to-mongo-on-localhost)连接本地主机上的 Mongo
...
#### [](#run-commands-using-mongo-scrapbooks)使用 Mongo 剪贴簿运行命令
...
## [](#basic-mongodb-commands)基本的 MongoDB 命令
