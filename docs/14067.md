...
> 原文:[https://dev.to/risdenk/apache-solr-JDBC-简介-两周年-21ga](https://dev.to/risdenk/apache-solr---jdbc-introduction---two-year-anniversary-21ga)
...
### [](#sql-clients-and-database-visualization-tools)SQL 客户端和数据库可视化工具
