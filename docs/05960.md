...
> 原文:[https://dev . to/Gary _ wood fine/simple-factory-pattern-in-c-and-net-core-3263](https://dev.to/gary_woodfine/simple-factory-pattern-in-c-and-net-core-3263)
...
## [](#simple-factory-pattern-implementation)简单工厂模式实现
...
### [](#build-a-simple-factory-pattern)构建简单的工厂模式
...
### [](#unit-test-simple-factory-pattern)单元测试简单工厂模式
