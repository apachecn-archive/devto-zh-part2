...
> 原文:[https://dev.to/anoff/gitlab-cicd-for-githubhow-and-why-4bik](https://dev.to/anoff/gitlab-cicd-for-githubhow-and-why-4bik)
...
### [](#how-to-enable-a-gitlab-cicd-pipeline-for-a-github-project)如何为 GitHub 项目启用 GitLab CI/CD 管道
...
### [](#how-to-configure-a-ci-pipeline)如何配置配置项管道
