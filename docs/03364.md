...
> 原文:[https://dev . to/mean in/create-azure-storage-account-on-release-pipeline-4kn 4](https://dev.to/meanin/create-azure-storage-account-on-release-pipeline-4kn4)
