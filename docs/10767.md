...
> 原文:[https://dev . to/sadok/flyimg-dockerized-PHP 7-application-runs-as-a-microservice-to-resize-and-crop-images-on-the-fly-h3b](https://dev.to/sadok/flyimg-dockerized-php7-application-runs-as-a-microservice-to-resize-and-crop-images-on-the-fly-h3b)
...
### [](#face-detection-cropping)人脸检测裁剪:
...
### [](#face-detection-blurring-resize)人脸检测模糊+调整大小:
