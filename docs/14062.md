...
> 原文:[https://dev . to/philnash/CSS-select-first-of-class-with-successful-sibling-combinator-13li](https://dev.to/philnash/css-select-first-of-class-with-the-subsequent-sibling-combinator-13li)
...
## [](#the-subsequent-sibling-combinator)后续的兄弟组合子
...
## [](#the-subsequent-sibling-combinator-and-firstofclass)后继兄弟组合子和:一流
...
## [](#css-selectors-level-4)CSS 选择器第 4 级
...
## [](#css-hacking-is-still-fun)CSS 黑客依然好玩
