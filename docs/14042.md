...
> 原文:[https://dev.to/dmerejkowsky/lets-build-chuck-norris-第三部分-包装-51ap](https://dev.to/dmerejkowsky/lets-build-chuck-norris---part-3-a-c-wrapper-51ap)
...
# [](#introduction-when-languages-talk-together)简介:当语言在一起交谈
...
# [](#calling-c-code-from-c)从 C 中调用 C++代码
...
## [](#implementing-the-c-api)实现 C API
