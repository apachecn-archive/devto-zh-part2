...
### [](#1-limit-your-web-root-to-an-indexphp-and-asset-files)1。将您的 Web 根目录限制为 index.php 和资产文件
...
### [](#2-turn-off-display-errors)2。关闭显示错误
...
### [](#3-use-passwordhash-to-store-your-passwords)3。使用 password_hash 存储您的密码
...
### [](#4-encrypt-all-communication)4。加密所有通信
...
### [](#5-use-a-template-framework)5。使用模板框架
