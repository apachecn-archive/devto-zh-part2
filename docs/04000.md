...
# [](#a-class-describes-an-object)一个类描述一个对象

## [](#-but-isnt-the-object-itself)...但不是物体本身。

当你在 OOP 中编写我们称之为`class`的东西时，它基本上是一个构建*对象*的指导手册。让我们考虑一把椅子:椅子本身就是对象——有时人们说它是类的一个*实例*——而帮助你构建椅子的手册就是类。

## [](#a-class-also-describes-the-behaviour-of-an-object)一个类也描述一个对象的行为
...
# [](#some-technical-vocabulary)一些技术词汇
...
# [](#extending-our-classes)扩展我们的类

## [](#the-concept-of-inheritance)继承的概念
