...
> 原文:[https://dev . to/David gf/canary-deployments-in-server less-applications-2n3d](https://dev.to/davidgf/canary-deployments-in-serverless-applications-2n3d)
...
## [](#how-can-alias-traffic-shifting-help-us)别名流量转移如何帮助我们？
...
## [](#automating-the-deployment-process)自动化部署流程
...
## [](#rolling-back-to-the-previous-lambda-function-version)回滚到上一个 Lambda 函数版本
...
## [](#cloudformation-all-the-things)云形成万物
