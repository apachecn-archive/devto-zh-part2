...
> 原文:[https://dev . to/biros/-how-to-master-your-code-through-your-project-life cycle-22-2 pej](https://dev.to/biros/-how-to-master-your-code-through-your-project-lifecycle-22-2pej)
...
## [](#how-to-embed-code-analysis-tools-in-your-workflow)如何在你的 workflow❓中嵌入代码分析工具

使用 CLI 手动检查您的代码很酷(真的吗？🤔)，但不是很有成效。让我们把⚙自动化一点！

### [](#in-your-editor-or-ide)📝在你的编辑器或 IDE 中
...
### [](#%E2%9A%99-automatisation-through-composer)⚙通过作曲家
...
### [](#in-your-cicd-pipeline)🚉在您的 CI/CD 渠道中
