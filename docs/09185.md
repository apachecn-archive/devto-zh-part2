...
> 原文:[https://dev . to/yazanaabed/five-way-to-advanced-react-patterns-2 Bai](https://dev.to/yazanaabed/five-ways-to-advanced-react-patterns-2bai)
...
### [](#advanced-react-patterns)高级反应模式

软件模式让你有能力让你的代码更加可重用。

#### [](#compound-components)复合成分
