...
### [](#capital-string-and-boolean-lowercase-int)大写字符串和布尔，小写 int？
...
### [](#explicit-getters-and-setters)显式 Getters 和 Setters
