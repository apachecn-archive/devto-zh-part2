...
> 原文:[https://dev.to/progresstelerik/whats-new-in-angular-7-24b2](https://dev.to/progresstelerik/whats-new-in-angular-7-24b2)
...
## [](#you-too-can-be-on-version-7-today)今天你也可以上 7 版了
...
## [](#cli-prompt-of-awesomeness)牛逼的 CLI 提示
...
## [](#angular-material-gets-minor-updates)棱角分明的物质得到微小的更新
...
### [](#better-accessibility-for-selects)选择的可访问性更好
...
## [](#improving-application-performance)提升应用性能

### [](#setting-budgets-for-new-apps)为新应用设置预算
...
#### [](#checking-your-own-app-bundle-size)检查您自己的应用捆绑包大小
...
### [](#stripping-out-the-reflectmetadata-polyfill-in-production)剥离生产中的反射元数据聚合填充
...
## [](#will-this-affect-kendo-ui)这会影响剑道 UI 吗？
