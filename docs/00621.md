...
> 原文:[https://dev . to/k _ penguin _ sato/build-a-simple-API-using-ror 5-38ap](https://dev.to/k_penguin_sato/build-a-simple-api-using-ror5-38ap)
...
# [](#create-the-controller-and-model-for-post)为 Post 创建控制器和模型
...
# [](#set-up-routes-with-namespaces)用名称空间设置路线
...
# [](#set-up-the-post-controller)设置岗位控制器。
...
# [](#test-the-api-using-postman)使用[邮递员](https://www.getpostman.com/)测试 api
...
### [](#post-httplocalhost3000apiv1posts)帖子([http://localhost:3000/API/v1/posts](http://localhost:3000/api/v1/posts))
...
### [](#deletehttplocalhost3000apiv1postsid)删除([http://localhost:3000/API/v1/posts/:id](http://localhost:3000/api/v1/posts/:id)
