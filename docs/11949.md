...
> 原文:[https://dev.to/ladvien/setting-up-nginx-on-linode-c0l](https://dev.to/ladvien/setting-up-nginx-on-linode-c0l)
...
## [](#2-choose-a-server-provided)2。选择提供的服务器

以前租过服务器吗？我也没有。

这是我的建议表，里面装满了我的意见。

#### [](#a-dont-go-flashy)a .不要浮华
...
#### [](#beware-ye-stackscripts)**当心叶的死记硬背！**
...
没看到吗？你没把`<h1>`换成`<title>`吧？问我怎么知道的...
...
## [](#8-get-a-jekyll-starter)8。吃一份 Jekyll 开胃菜
...
## [](#9-build-the-jekyll-theme)9。构建 Jekyll 主题
