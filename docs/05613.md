...
> 原文:[https://dev . to/agathacco/how-to-create-pure-CSS-illustrations-and-animate-them-part-3-3e8a](https://dev.to/agathacco/how-to-create-pure-css-illustrations-and-animate-them---part-3-3e8a)
...
#### [](#using-loops-to-generate-and-randomize-content)使用循环来生成和随机化内容
...
#### [](#using-css-transforms)使用 CSS 变换
...
# [](#useful-tools-and-resources)有用的工具和资源
