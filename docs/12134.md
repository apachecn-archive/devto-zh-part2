...
> 原文:[https://dev.to/sait/what-is-hoisting-in-javascript-2jkm](https://dev.to/sait/what-is-hoisting-in-javascript-2jkm)
...
## [](#have-you-checked-hoisting-for-the-let-and-var-keywords)有没有检查过 let 和 var 关键字的提升？
...
# [](#check-out-my-book-on-javascript)查看[我的 JavaScript 书](https://dev.to/saigowthamr/learn-javascript-with-examples---book-35k7)