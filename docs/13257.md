...
> 原文:[https://dev . to/Alex MacArthur/preloading-JavaScript-assets-in-WordPress-1 led](https://dev.to/alexmacarthur/preloading-javascript-assets-in-wordpress-1led)
...
## [](#measure-your-performance-results)衡量你的表现结果！
...
## [](#this-should-be-safe-but-test-thoroughly)这个*应该*安全，但是要彻底测试
