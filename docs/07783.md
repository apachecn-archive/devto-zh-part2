...
> 原文:[https://dev . to/bnevilleoneill/JavaScript-es6-5-new-abstracts-to-improve-your-code-3j0b](https://dev.to/bnevilleoneill/javascript-es6-5-new-abstractions-to-improve-your-code-3j0b)
...
### [](#2-default-and-rest-parameters)2。默认和静止参数
...
#### [](#this-and-arrow-functions)本和箭头功能
