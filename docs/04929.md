...
## [](#the-solution-enter-windows-subsystem-for-linux-wsl)解决方案:进入 Windows 子系统 for Linux (WSL)
...
## [](#git-install-and-clone)Git 安装和克隆
...
## [](#adding-htmlproofer-from-windows)添加 html-proofer(从 Windows！)
...
## [](#setting-up-my-github-account-for-push-within-wsl)在 WSL 中设置我的 GitHub 推送账户
...
## [](#the-payoff-running-htmlproofer-without-issue)回报:运行 html-proofer 没有问题！
