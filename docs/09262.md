...
> 原文:[https://dev . to/adnanrahic/a-crash-course-on-server less-API-with-express-and-MongoDB-193k](https://dev.to/adnanrahic/a-crash-course-on-serverless-apis-with-express-and-mongodb-193k)
...
#### [](#2-create-an-iam-user-in-your-aws-console)2。在 AWS 控制台中创建 IAM 用户
...
#### [](#3-enter-iam-keys-in-the-serverless-configuration)3。在无服务器配置中输入 IAM 密钥
...
#### [](#5-explore-the-service-directory-with-a-code-editor)5。使用代码编辑器浏览服务目录
...
#### [](#1-creating-the-serverjs)1。创建 server.js
...
#### [](#3-creating-the-express-app)3。创建快速应用程序
...
#### [](#5-writing-the-crud-logic)5。编写 CRUD 逻辑
...
#### [](#2-create-a-new-aws-iam-role-for-dashbird)2。为 Dashbird 创建一个新的 **AWS IAM 角色**
...
#### [](#3-setup-dashbird-with-the-created-role)3。用创建的角色设置 Dashbird
