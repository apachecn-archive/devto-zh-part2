...
## [](#join-the-digital-economy-without-rewriting-code)加入数字经济无需重写代码
...
## [](#the-secret-of-how-mainframe-apps-participate-in-the-digital-economy-rest)大型机应用如何参与数字经济的秘密:休息
...
## [](#natural-handson-example)自然动手的例子
...
## [](#extract-the-server-interface)提取服务器界面
...
## [](#generate-the-rest-resource)生成剩余资源
...
## [](#provide-cobol-assets-as-rest-resources)提供 COBOL 资产作为剩余资源
