...
> 原文:[https://dev . to/lexswed/add-vue-to-your-acknowledged-stack-2g C4](https://dev.to/lexswed/add-vue-to-your-acknowledged-stack-2gc4)
...
###### [](#quicktip-vetur-is-a-vue-syntax-helper-for-vs-code)(快速提示: [Vetur](https://marketplace.visualstudio.com/items?itemName=octref.vetur) 是 VS 代码的 Vue 语法助手)

## [](#quick-intro-to-templates)模板快速介绍
...
## [](#lets-define-data-and-logic)我们来定义数据和逻辑
...
###### [](#some-vuespecific-methods-or-data-always-start-from-raw-endraw-sign)一些 vue 特有的方法或数据总是从`$`符号开始。
