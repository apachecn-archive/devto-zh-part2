...
> 原文:[https://dev . to/rafaacioly/working-with-queues-and-stacks-in-PHP-39ch](https://dev.to/rafaacioly/working-with-queues-and-stacks-in-php--39ch)
...
# [](#-raw-queue-endraw-and-raw-stack-endraw-helper-methods)`Queue`和`Stack`助手方法:
...
## [](#iterating-over-the-queue-and-stack)遍历队列和堆栈:
