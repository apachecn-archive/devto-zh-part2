...
> 原文:[https://dev . to/sublime geek/jelly-fin-got-a-minute-we-can-use-it-48ad](https://dev.to/sublimegeek/jelly-fin-got-a-minute-we-could-use-it-48ad)
...
### [](#we-need-a-docker-guru-person-shortterm)我们需要一个 Docker ~guru~ person【短期】

我想让它更容易投入，所以社区有了与 Docker 共享环境的想法。谁能帮助我们设置它，并写一些关于如何使用它的清晰的文档？

### [](#multiplatform-travis-builds-shortterm)多平台 Travis 构建【短期】

以前有没有人做过这样的工作，可以帮助我们把构建过程做得漂亮些？

* * *

# [](#long-term-needs)长期需求

最终会让我咬指甲的事情。

### [](#anyone-willing-to-be-a-project-manager-longterm)有人愿意当项目经理吗？[长期]

我们已经定义了一些 GitHub 问题，但是它们应该被分解并优先化为里程碑。如果有人能帮我让一切井然有序，我会很高兴。

### [](#user-experience-longterm)用户体验【长期】

随着我们开始获得牵引力并为应用程序奠定基础，我们最终将需要一些线框和设计来构建。我有一些基本的想法，但是以前做过这个的人可能有更好的想法；).

### [](#project-marketing-longterm)项目营销【长期】
