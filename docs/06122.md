...
> 原文:[https://dev . to/bnevilleoneill/full-guide-to-using-font-awesome-icons-in-vue-js-apps-ee3](https://dev.to/bnevilleoneill/full-guide-to-using-font-awesome-icons-in-vue-js-apps-ee3)
...
### [](#showing-the-javascript-or-vuejs-brand-icon)显示 JavaScript 或 Vue.js 品牌图标
...
### [](#getting-back-to-vuejs-and-font-awesome)回到 Vue.js 和字体牛逼
...
### [](#special-effects-in-font-awesome)字体特效牛逼
...
### [](#icon-buttons-and-conditional-rendering)图标按钮和条件渲染
