...
## [](#creating-a-separate-namespace)创建单独的名称空间
...
### [](#deploying-the-mysql-pod)部署 MySQL Pod
...
## [](#deploying-the-mysql-service)部署 MySQL 服务
...
### [](#deploying-the-prisma-pod)展开棱镜吊舱
...
### [](#deploying-the-prisma-service)部署 Prisma 服务
