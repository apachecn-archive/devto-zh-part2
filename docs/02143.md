...
> 原文:[https://dev.to/zellwk/creating-a-simple-form-with-css-grid-38dm](https://dev.to/zellwk/creating-a-simple-form-with-css-grid--38dm)
...
## [](#building-the-form-with-css-grid)用 CSS 网格构建表单
