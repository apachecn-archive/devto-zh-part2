...
> 原文:[https://dev.to/andrious/flutter-MVC-at-last-2jd 3](https://dev.to/andrious/flutter--mvc-at-last-2jd3)
...
### [](#some-github-examples-right-off-the-hop)一些 Github 的例子！
...
### [](#however-theres-no-model)但是，没有模型
...
### [](#so-how-do-you-use-it)**所以呢？你如何使用它？**
...
### [](#but-what-about-statefulwidget)但是 StatefulWidget 呢？
...
### [](#listen-therere-listeners)**听着！有听众！**
...
### [](#a-function-for-every-event)**每个事件的一个函数**
...
### [](#how-to-start-your-app)**如何启动你的 App**
...
### [](#theres-an-error-handler)有一个错误处理程序
...
### [](#theres-an-error-handler-everywhere)有一个错误处理程序。到处都是！
...
### [](#its-your-responsibility-handle-it)是你的责任。处理它！
...
### [](#the-other-stateview-class)其他 StateView 类
...
### [](#this-stateview-handles-errors)这个状态视图处理错误
