...
> 原文:[https://dev.to/turnersoftware/mongo-what-now-34lg](https://dev.to/turnersoftware/mongo-what-now-34lg)

你有没有让你的主要副业项目衍生出自己的副业项目？我不知道这种情况在其他人身上发生的频率有多高，但这似乎是我的项目中反复出现的主题。

在我解释这个 *side* side 项目是什么之前，让我稍微解释一下我是如何来到这里的。

# [](#the-original-side-project)原方项目
...
# [](#c-mongodb-mongodb-c-driver)C# + MongoDB = MongoDB C#驱动？
