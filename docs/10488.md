...
## [](#what-about-when-i-want-to-change-an-immutable-object)当我想改变一个不可变的对象时怎么办？
...
### [](#where-to-put-the-builder)把构建器放在哪里？
...
## [](#what-about-immutable-objects-with-bad-data)有坏数据的不可变对象怎么办？
