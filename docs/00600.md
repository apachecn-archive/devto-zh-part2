...
## [](#api-specification-vs-api-documentation)API 规范与 API 文档
...
### [](#generating-the-specification)生成规范
...
#### [](#setting-up-the-build-tools)设置构建工具
...
#### [](#creating-the-spec-object)创建规格对象
...
#### [](#extracting-reusable-components)提取可复用组件
...
## [](#documentation-with-redoc)带 ReDoc 的文档
