...
> 原文:[https://dev . to/pubs 12/automated-text-generator-using-Markov-chain-2ge 2](https://dev.to/pubs12/automated-text-generator-using-markov-chain-2ge2)

#### [](#see-this-step-by-step-guide-on-how-the-algorithm-works-with-reference-code-provided)参考提供的代码，查看该算法如何工作的分步指南。
...
#### [](#what-is-a-markov-chain-in-the-context-of-a-text-generation)什么是文本生成上下文中的马尔可夫链？
