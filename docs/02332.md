...
### [](#what-is-typewrapper)什么是 TypeWrapper？
...
### [](#but-image-does-not-conform-to-codable)但图像不符合编码
...
### [](#how-about-data-convertible)数据可转换怎么样？
...
### [](#how-about-data-producer)数据生产者怎么样？
