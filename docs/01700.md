...
> 原文:[https://dev.to/nabbisen/openbsd-vm-on-gcegcp-12-本地-部分-gp3](https://dev.to/nabbisen/openbsd-vm-on-gcegcp---12-local-part-gp3)
...
## [](#requirements-with-references)要求附参考文献
...
### [](#step-1-create-vdi-disk-where-openbsd-is-installed)第一步:创建安装了 OpenBSD 的 VDI 磁盘
...
#### [](#option-smt-multithreading)选项:SMT -多线程
...
#### [](#option-how-to-manage-the-guest-os-next-time)选项:下次如何管理来宾操作系统
