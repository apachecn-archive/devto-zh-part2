...
### [](#pageheight-and-pagewidth-properties)[页面高度](https://apireference.aspose.com/net/cad/aspose.cad.imageoptions/vectorrasterizationoptions/properties/pageheight)和[页面宽度](https://apireference.aspose.com/net/cad/aspose.cad.imageoptions/vectorrasterizationoptions/properties/pagewidth)属性:
...
### [](#pagesize)[页面大小](https://apireference.aspose.com/net/cad/aspose.cad.imageoptions/vectorrasterizationoptions/properties/pagesize):

本质上是一样的，只是接受了一次定义高度和宽度的 SizeF。

### [](#borderx-and-bordery)[边境](https://apireference.aspose.com/net/cad/aspose.cad.imageoptions/vectorrasterizationoptions/properties/borderx)和[边境](https://apireference.aspose.com/net/cad/aspose.cad.imageoptions/vectorrasterizationoptions/properties/bordery):

这些定义了实际图像区域周围的边距，即最终图像的尺寸为页面高度+边框*2，页面宽度+边框*2。

### [](#centerdrawing)[插画](https://apireference.aspose.com/net/cad/aspose.cad.imageoptions/vectorrasterizationoptions/properties/centerdrawing):

如果设置为 true，将确定显示对象的几何中心，并将其固定到图像的中心。导出 3D 实体时，它将自动被视为已启用。

### [](#backgroundcolor)[背景色](https://apireference.aspose.com/net/cad/aspose.cad.imageoptions/vectorrasterizationoptions/properties/backgroundcolor):

显然，设置背景颜色，因为 CAD 系统通常暗示没有背景，但你确实需要一个光栅图像。默认为白色。

### [](#drawcolor)[DrawColor](https://apireference.aspose.com/net/cad/aspose.cad.imageoptions/vectorrasterizationoptions/properties/drawcolor) :
...
### [](#drawtype)[DrawType](https://apireference.aspose.com/net/cad/aspose.cad.imageoptions/cadrasterizationoptions/properties/drawtype) :

指示是使用文档中指定的颜色还是使用 DrawColor 来呈现实体。默认值为 UseDrawColor。

### [](#unittype)[单位类型](https://apireference.aspose.com/net/cad/aspose.cad.imageoptions/vectorrasterizationoptions/properties/unittype):
...
### [](#contentasbitmap)[内容位图](https://apireference.aspose.com/net/cad/aspose.cad.imageoptions/vectorrasterizationoptions/properties/contentasbitmap):

仅在导出为 PDF 时适用，如果设置为 true，渲染图像将栅格化并作为光栅图像嵌入 PDF，而不是常规的矢量图像。默认值为 false。

### [](#graphicsoptions)[【显卡选项】](https://apireference.aspose.com/net/cad/aspose.cad.imageoptions/vectorrasterizationoptions/properties/graphicsoptions):

允许为光栅图像(包括嵌入在 PDF 中的图像)设置抗锯齿级别、插值质量和文本渲染模式

### [](#zoom)[变焦](https://apireference.aspose.com/net/cad/aspose.cad.imageoptions/cadrasterizationoptions/properties/zoom):

指定边距的另一种方法。值 1 对应于精确拟合，值 1 以下允许创建边距，值 1 以上允许按比例绘制。

### [](#penoptions)[PenOptions](https://apireference.aspose.com/net/cad/aspose.cad.imageoptions/cadrasterizationoptions/properties/penoptions) :

允许为没有定义笔选项的实体设置笔选项。目前只允许设置开始和结束线帽。

### [](#observerpoint)[观察点](https://apireference.aspose.com/net/cad/aspose.cad.imageoptions/cadrasterizationoptions/properties/observerpoint):
...
### [](#layers)[层层](https://apireference.aspose.com/net/cad/aspose.cad.imageoptions/cadrasterizationoptions/properties/layers):

获取或设置要为 AutoCAD 文档导出的图层。

### [](#layouts)[布局](https://apireference.aspose.com/net/cad/aspose.cad.imageoptions/cadrasterizationoptions/properties/layouts):
...
### [](#automaticlayoutscaling)[自动伸缩](https://apireference.aspose.com/net/cad/aspose.cad.imageoptions/cadrasterizationoptions/properties/automaticlayoutsscaling):

将 CAD 文档内容缩放至输出图像大小如果设置为 true，则默认值为 true。

### [](#noscaling)[无标度](https://apireference.aspose.com/net/cad/aspose.cad.imageoptions/cadrasterizationoptions/properties/noscaling):
