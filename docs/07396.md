...
> 原文:[https://dev . to/ozzyaaron/configuring-circle-ci-20-for-a-real-rails-application-2n 86](https://dev.to/ozzyaaron/configuring-circle-ci-20-for-a-real-rails-application-2n86)
...
## [](#concatenating-to-bashenv)串联到$BASH_ENV
...
## [](#caching-yarns-binary-folder)缓存纱线的二进制文件夹
...
## [](#why-do-we-need-to-wait-30-minutes-for-bundler)为什么我们需要等 30 分钟的 Bundler？！
