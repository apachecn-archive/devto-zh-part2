...
## [](#restricting-new-user-from-dashboard)从仪表板限制新用户
...
## [](#notifying-administrator-about-new-user)通知管理员有新用户
...
## [](#approving-new-user-by-administrator)管理员审批新用户
