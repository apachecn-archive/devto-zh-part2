...
> 原文：<https://dev.to/worldclassdev/ui-snippets-say-no-to-ugly-check-boxes--5881>

好吧！！！我不完全是前端专家，但当我访问某些网站，发现它们使用了设计糟糕的复选框时，我真的感觉不太好。相信我，当复选框仍然保持默认外观时，伤害会更大。

*免责声明*:请注意，这个项目只是展示我们如何改善复选框的美观。它并不声称遵守最佳实践和可访问性原则。只是一个 CSS 噱头！

所以我写了一点代码，开始反对丑陋的复选框。看看吧，在评论区告诉我你对它的看法。
