...
## [](#generating-random-numbers-with-kernelrand)用核#rand 生成随机数
...
## [](#generating-reproducible-sequences-with-kernelsrand)用核#srand 生成可再现序列
...
## [](#generating-random-numbers-with-random)用随机数生成随机数
...
## [](#generating-random-numbers-based-on-normal-distribution)基于正态分布生成随机数
