...
*   **函数/方法和变量的命名约定** — 。在创建您最终可能会使用的代码时，了解您的团队成员使用的是 camelCase 还是 snake_case 非常有用。如果你曾经使用过 PHP 4 或 PHP 5(是的，那是很久以前了)，你就会明白我的意思。语言本身对于本地函数的名字没有内在的一致性，所以你总是被迫回到文档中去理解它们是如何命名的。了解你的队友用什么语言命名实体也很有用，比如，他们用英语吗？西班牙语？克林贡语？它们都是有效的选择，只是要确保每个人都以同样的方式做。
...
*   一个开发环境，在这里你可以测试你的代码和团队其他成员的代码。如果您正在开发的系统足够复杂，这可能是您无法在个人工作站上完成的事情。
...
因此，如果您将这些核心分支与您的 CI 系统联系起来，那么无论何时在它们中执行合并，您都可以自动化部署(通过在分支/环境之间提升代码，您可以直接控制这些合并何时发生)。
