...
### [](#application-installation-amp-setup)应用安装&设置
...
### [](#flashmessage-component)FlashMessage 组件
...
#### [](#flashmessage-breakdown)FlashMessage 故障
...
### [](#app-component-container)App 组件(容器)
...
#### [](#app-container-breakdown)App(容器)细分
