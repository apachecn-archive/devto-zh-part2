...
## [](#create-the-vuex-store)创建 Vuex 商店
...
## [](#an-use-case-for-the-store)商店的一个用例
...
## [](#introducing-the-new-components-we-need)介绍我们需要的新组件
...
## [](#adding-those-components-to-the-app)将那些组件添加到应用程序中
...
## [](#add-the-state-to-the-store)给商店添加状态
...
## [](#add-a-getter-to-reference-a-state-property)添加一个 getter 来引用一个状态属性
...
## [](#adding-the-vuex-store-to-the-app)将 Vuex 商店添加到应用程序
...
## [](#update-the-state-on-a-user-action-using-commit)使用提交更新用户动作的状态
...
## [](#use-the-getter-to-print-the-state-value)使用 getter 打印状态值
