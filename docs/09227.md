...
> 原文:[https://dev . to/oktadev/deploy-your-secure-vuejs-app-to-AWS-5 G5](https://dev.to/oktadev/deploy-your-secure-vuejs-app-to-aws-5g5)
...
## [](#about-single-page-applications)关于单页应用
...
## [](#understand-hash-history)了解哈希历史
...
## [](#building-your-single-page-application)构建您的单页应用程序
...
## [](#host-your-app-on-amazon-s3)在亚马逊 S3 托管您的应用
...
#### [](#access-denied-and-s3-bucket-policies)拒绝访问和 S3 斗策略
...
## [](#deploy-to-aws-with-awscli)使用 aws-cli 部署到 AWS
...
## [](#distribute-your-app-with-amazon-cloudfront-cdn)使用亚马逊 CloudFront CDN 分发您的应用
...
## [](#add-secure-authentication-to-your-app)为您的应用添加安全认证
...
## [](#build-a-secure-express-rest-server)构建安全的 Express REST 服务器
...
### [](#call-the-secure-api-endpoint-from-your-vuejs-frontend)从 Vue.js 前端调用安全 API 端点
...
## [](#configure-serverless-and-deploy-the-express-api)配置无服务器，部署 Express API
...
### [](#change-frontend-vue-to-use-production-api)改变前端 Vue 使用生产 API
