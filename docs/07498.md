...
## [](#create-your-angular-6-app)打造你的 Angular 6 App
...
## [](#create-a-basic-homepage-with-material-ui)用素材 UI 创建基本主页
...
## [](#add-authentication-to-your-node-angular-app-with-okta)用 Okta 给你的 Node + Angular App 添加认证
...
## [](#add-the-posts-manager-page)添加帖子管理员页面
...
### [](#create-a-post-api-service)创建发布 API 服务
...
### [](#write-the-posts-manager-page)编写帖子管理器页面
...
## [](#test-your-angular-node-crud-app)测试你的 Angular + Node CRUD App
...
## [](#learn-more-about-angular-node-and-app-security)了解有关角度、节点和应用安全性的更多信息
