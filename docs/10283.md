...
> 原文:[https://dev . to/datawireio/using-API-gateways-to-facilitate-your-transition-from-monolith-to-micro-services-4n4g](https://dev.to/datawireio/using-api-gateways-to-facilitate-your-transition-from-monolith-to-microservices-4n4g)
