...
> 原文:[https://dev . to/kena kamu/develop-a-line-bot-in-c-for-beginner-part-2-adding-ai-to-your-bot-2b5d](https://dev.to/kenakamu/develop-a-line-bot-in-c-for-beginner-part-2--adding-ai-to-your-bot--2b5d)
...
## [](#publish-luis-and-get-access-key)发布 LUIS 并获取访问密钥
...
# [](#improve-the-conversation-flow)改善谈话流程
...
# [](#deploy-to-azure-and-final-test)部署到 Azure 并最终测试
