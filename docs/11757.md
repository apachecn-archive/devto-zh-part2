...
> 原文:[https://dev . to/kball/creating-multi-root-vuejs-components-23j 0](https://dev.to/kball/creating-multi-root-vuejs-components-23j0)
...
## [](#the-solution-functional-components)解决方案:功能组件
