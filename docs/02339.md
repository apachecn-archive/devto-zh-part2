...
# [](#2-build-and-package-a-simple-app-using-cabal)2。使用 cabal 构建和打包一个简单的应用程序

## [](#introducing-cabal)引入阴谋集团
...
## [](#create-a-cabal-app)创建一个 cabal app
...
## [](#running-your-cabal-app-cabal-run)运行你的 cabal 应用程序(cabal run)
...
## [](#other-useful-cabal-commands)其他有用的阴谋集团命令

### [](#-raw-cabal-clean-endraw-)`cabal clean`
...
### [](#-raw-cabal-install-endraw-)`cabal install`
...
### [](#-raw-cabal-repl-endraw-)`cabal repl`
