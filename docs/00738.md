...
> 原文:[https://dev.to/oktadev/create-and-verify-jwts-with-node-o8o](https://dev.to/oktadev/create-and-verify-jwts-with-node-o8o)
...
## [](#build-a-simple-node-app)搭建一个简单的节点 App
...
## [](#create-json-web-tokens-in-your-node-app)在您的节点应用程序中创建 JSON Web 令牌
...
## [](#verify-json-web-tokens-in-your-node-app)在您的节点应用程序中验证 JSON Web 令牌
...
### [](#why-auth-with-okta)为什么用 Okta Auth？
...
### [](#create-an-okta-server)创建一个 Okta 服务器
...
## [](#learn-more-about-node-jwts-and-secure-user-management)了解有关节点、jwt 和安全用户管理的更多信息
