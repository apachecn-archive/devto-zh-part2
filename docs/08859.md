...
> 原文:[https://dev . to/oktadev/build-a-health-tracking-app-with-react-graphql-and-user-authentic ation-90f](https://dev.to/oktadev/build-a-health-tracking-app-with-react-graphql-and-user-authentication-90f)
...
## [](#why-a-health-tracking-app)为什么要做健康追踪 App？
...
## [](#building-an-api-with-typeorm-graphql-and-vesper)用 TypeORM、GraphQL 和 Vesper 构建 API
...
### [](#install-vesper-to-integrate-typeorm-and-graphql)安装 Vesper 集成 TypeORM 和 GraphQL
...
## [](#get-started-with-react)开始使用 React
...
### [](#configure-apollo-client-for-your-api)为您的 API 配置 Apollo 客户端
...
## [](#add-authentication-for-react-with-openid-connect)添加与 OpenID 连接的 React 认证
...
### [](#get-user-information-from-jwts)从 jwt 获取用户信息
...
## [](#learn-more-about-react-node-and-user-authentication)了解关于 React、节点和用户认证的更多信息
