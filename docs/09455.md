...
> 原文:[https://dev . to/jakelumetta/buttercms-vs-WordPress-headless-CMS-vs-traditional-CMS-4 ODF](https://dev.to/jakelumetta/buttercms-vs-wordpress-headless-cms-vs-traditional-cms-4odf)
...
## [](#what-is-a-traditional-cms)什么是传统的 CMS？
...
### [](#side-note-whats-an-api)边注:什么是 API？

API 代表应用编程接口。这篇文章用简单的英语对 API 做了很好的解释(T2)。

## [](#what-is-buttercms)什么是 ButterCMS？
...
## [](#comparison-wordpress-vs-buttercms)对比:WordPress vs ButterCMS
...
## [](#choosing-between-traditional-and-headless-cms)在传统和无头 CMS 之间选择

### [](#when-a-traditional-cms-may-be-a-good-fit-for-your-team)传统 CMS 可能非常适合您的团队
...
### [](#when-a-headless-cms-may-be-a-good-fit-for-your-team)当一个无头 CMS 可能很适合你的团队
