...
> 原文:[https://dev.to/akanksha_9560/beginners-guide-to-sass-8lh](https://dev.to/akanksha_9560/beginners-guide-to-sass-8lh)

# [](#beginners-guide-to-sass)萨斯入门指南
...
### [](#problem-statement-1-write-css-for-parent1-and-parent1link1)**问题陈述 1** :为 ***parent1 ** *和** *parent1__link1* **写 CSS
...
### [](#problem-statement-2-write-hover-and-after-classes-for-element)**问题陈述 2** :在**元素
