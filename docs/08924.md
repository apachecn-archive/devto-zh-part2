...
> 原文:[https://dev . to/Vince campanele/using-recursion-to-loop-in-elm-19pf](https://dev.to/vincecampanale/using-recursion-to-loop-in-elm-19pf)
...
### [](#with-a-raw-for-endraw-loop)同`for`循环
...
### [](#in-order-to-understand-recursion)为了理解递归...
