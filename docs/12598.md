...
> 原文:[https://dev . to/acro 5 piano/when-developing-laravel-app-with-vim-you-can-still-jump-to-magic-methods-1in 3](https://dev.to/acro5piano/when-developing-laravel-app-with-vim-you-can-still-jump-to-magic-methods-1in3)
