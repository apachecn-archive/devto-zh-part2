...
> 原文:[https://dev . to/adnanrahic/how-to-deploy-a-nodejs-application-to-AWS-lambda-using-server less-2nc 7](https://dev.to/adnanrahic/how-to-deploy-a-nodejs-application-to-aws-lambda-using-serverless-2nc7)
...
### [](#1-install-and-configure-the-serverless-framework)1。安装和配置无服务器框架
...
### [](#2-create-the-boilerplate-code)2。创建样板代码
...
### [](#3-installing-dependencies)3。安装依赖项
...
### [](#1-add-a-secretsjson-file-to-keep-environment-variables)1。添加 secrets.json 文件来保存环境变量
...
### [](#2-add-a-reference-for-the-secretsjson-in-the-serverlessyml)2。在 serverless.yml 中添加对 secrets.json 的引用
