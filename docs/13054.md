...
> 原文:[https://dev . to/gaijinity/profiling-your-website-with-craft-CMS-3-s-debug-toolbar-5961](https://dev.to/gaijinity/profiling-your-website-with-craft-cms-3-s-debug-toolbar-5961)
...
## [](#enabling-the-debug-toolbar)启用调试工具栏
...
## [](#pro%C2%ADfil%C2%ADing-data%C2%ADbase-queries)专业数据库查询
...
## [](#sift%C2%ADing-through-logs)筛选日志
...
## [](#over%C2%ADall-per%C2%ADfor%C2%ADmance-profiling)超过所有人力分析
...
## [](#plu%C2%ADg%C2%ADin-developers)Plu g in 开发者
