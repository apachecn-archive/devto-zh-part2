...
> 原文:[https://dev . to/mahmoudelmahdi/set-up-react-tool chain-from-the-ground-up-3340](https://dev.to/mahmoudelmahdi/set-up-react-toolchain-from-the-ground-up-3340)
...
## [](#creating-a-project-directory)创建项目目录
...
## [](#type-checking-for-react-props)对反应道具进行类型检查
