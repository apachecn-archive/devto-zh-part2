...
> 原文:[https://dev . to/kball/understanding-the-spread-operator-in-JavaScript-48op](https://dev.to/kball/understanding-the-spread-operator-in-javascript-48op)
...
### [](#spread-operators-for-arrays)数组展开运算符
...
### [](#spread-operators-for-objects)为对象展开运算符
...
### [](#spread-syntax-enables-compact-and-expressive-code)Spread 语法支持紧凑且富有表现力的代码
