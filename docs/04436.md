...
> 原文:[https://dev . to/on myway 133/running-uitests-with-Facebook-log in-IOs-1mg 0](https://dev.to/onmyway133/running-uitests-with-facebook-login-in-ios-1mg0)
...
## [](#create-a-facebook-test-user)创建一个脸书测试用户
...
## [](#click-the-login-button-and-show-facebook-login)点击登录按钮，显示脸书登录
...
## [](#wait-for-element-to-appear)等待元素出现
...
## [](#the-password-text-field)密码文本字段
