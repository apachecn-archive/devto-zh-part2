...
[![Query box](../Images/0afa4501ff7de3bc485b00b71816dd51.png)T2】](https://res.cloudinary.com/practicaldev/image/fetch/s--0fNRDBV5--/c_limit%2Cf_auto%2Cfl_progressive%2Cq_66%2Cw_880/https://thepracticaldev.s3.amazonaws.com/i/1vt5c70re7njvfxkw7c9.gif)

## 编辑字段

为了编辑字段，我回到了生成表格的代码。现在，如果查询给出的数据应该是可编辑的，则添加一个事件侦听器，侦听焦点和模糊，当被触发时，一个函数会检查内容是否已更改，如果是，则向用户请求确认。

[![Editing fields](../Images/e4ee6ec7f01af964110765bd770d1d5b.png)T2】](https://res.cloudinary.com/practicaldev/image/fetch/s--ROZVLaKh--/c_limit%2Cf_auto%2Cfl_progressive%2Cq_66%2Cw_880/https://thepracticaldev.s3.amazonaws.com/i/jgip1rjrwlwydnwkkqq5.gif)
