...
> 原文:[https://dev.to/dmerejkowsky/lets-build-chuck-norris-part-2-SQLite-and-Conan-5acj](https://dev.to/dmerejkowsky/lets-build-chuck-norris---part-2-sqlite-and-conan-5acj)
...
# [](#adding-the-dependency-by-hand)手工添加依赖关系

先从“手动”做作品开始，再讲柯南是怎么做的。

## [](#building-sqlite3)建筑广场 3
...
## [](#finding-and-using-the-sqlite3-library)查找和使用 sqlite3 库
...
# [](#creating-a-conanfiletxt)创建一个 conanfile.txt
...
# [](#adapt-cmakeliststxt)改编 CMakeLists.txt
