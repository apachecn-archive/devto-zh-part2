...
> 原文:[https://dev . to/davidimoore/using-storybook-as-both-a-visual-library-and-test-code-3c B4](https://dev.to/davidimoore/using-storybook-as-both-a-visual-library-and-test-code-3cb4)
...
### [](#step-1-add-storybook)步骤 1–添加故事书
...
### [](#step-2-create-a-userlist-story)步骤 2–创建用户列表故事
...
### [](#step-3-create-storybook-generated-snapshots-with-storyshots)第 3 步–用故事镜头创建故事书生成的快照
