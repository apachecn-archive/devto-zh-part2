...
> 原文:[https://dev . to/samw software/creating-a-shopping-app-from scratch-part-2-12pn](https://dev.to/samwsoftware/creating-a-shopping-app-from-scratch-part-2-12pn)
...
#### [](#converting-filtering-into-queries)将过滤转换成查询
