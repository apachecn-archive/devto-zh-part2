...
> 原文:[https://dev . to/swyx/a-walk-of-the-react-suspension-demo-4j6a](https://dev.to/swyx/a-walkthrough-of-that-react-suspense-demo--4j6a)
...
# [](#diving-into-react-suspense)潜入 React 悬念
...
# [](#hey-you-open-the-demo-before-you-read-on)[嘿！你！在您继续阅读之前，请打开演示！](https://codesandbox.io/s/5zk7x551vk)

* * *

## [](#meet-raw-simplecacheprovidersimplecache-endraw-)遇见`simple-cache-provider.SimpleCache`
...
## [](#side-effects-in-render)渲染中的副作用
...
## [](#meet-reactdomunstabledeferredupdates)满足 react DOM . unstable _ deferredUpdates
...
## [](#skipping-masterdetail-header-and-search)跳过主细节、标题和搜索
...
## [](#digging-into-raw-simplecacheprovidercreateresource-endraw-)深挖`simple-cache-provider.createResource`
...
## [](#introducing-raw-reacttimeout-endraw-)介绍`React.Timeout`
...
## [](#async-image-loading-or-how-to-make-just-passing-a-string-not-boring)异步镜像加载，或者说，如何让仅仅传递一个字符串不无聊
