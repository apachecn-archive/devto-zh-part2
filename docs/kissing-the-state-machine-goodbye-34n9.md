...
> 原文：<https://dev.to/bertilmuth/kissing-the-state-machine-goodbye-34n9>

最近，我写了关于[简化基于事件的应用](https://dev.to/bertilmuth/simplifying-an-event-sourced-application-1klp)的文章。
...
我希望你喜欢我的文章。请在评论里说说你的看法。

我还想邀请您看看我在整篇文章中使用的库。在实践中尝试一下，让我知道结果。
