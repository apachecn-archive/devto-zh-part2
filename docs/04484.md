...
> 原文:[https://dev . to/alirezabashiri/疲倦的 JSON-schema-try-dry-validation-2eg 3](https://dev.to/alirezabashiri/tired-of-json-schema-try-dry-validation-2eg3)
...
### [](#creating-the-custom-matcher)创建自定义匹配器
...
### [](#defining-the-anonymous-user-schema)定义匿名用户模式
