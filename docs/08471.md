...
> 原文:[https://dev.to/clovis1122/dont-make-that-function-async-9m6](https://dev.to/clovis1122/dont-make-that-function-async-9m6)
...
### [](#what-happens-when-you-await-a-function)等待函数时会发生什么。
...
### [](#advices-for-making-a-function-async)异步创建函数的建议。
