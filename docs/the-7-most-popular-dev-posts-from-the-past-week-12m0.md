...
> 原文：<https://dev.to/devteam/the-7-most-popular-dev-posts-from-the-past-week-12m0>

# 1。【生活魔术】

Vue 不仅是 web 和移动应用程序的优秀框架，您还可以使用 Vue 构建桌面应用程序！Natalia 分享了一个完整的分步指南。
...
#git](/robertcoopercode/using-aliases-to-speed-up-your-git-workflow-2f5a)
...
#css #purecss #animation #illustration](/agathacco/how-to-create-pure-css-illustrations-and-animate-them---part-1-1j1k)
...
#programming #coding #computerscience #language](/mortoray/we-dont-need-a-ternary-operator-309n)
...
#es6 #javascript #beginners](/andersonjoseph/learn-es6-without-leave-devto-57o3)
