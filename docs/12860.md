...
> 原文:[https://dev . to/hasurahq/tutorial-full stack-react-native-with-graph QL-5f3o](https://dev.to/hasurahq/tutorial-fullstack-react-native-with-graphql-5f3o)

### [](#a-tutorial-to-build-a-react-native-todo-app-with-apollos-new-query-and-mutation-components)用 Apollo 新的查询和变异组件构建 React 原生待办应用的教程
...
## [](#part-1-deploying-a-graphql-backend)第 1 部分:部署 GraphQL 后端
...
### [](#part-2-setup-react-native-project)第 2 部分:设置 React 本地项目
