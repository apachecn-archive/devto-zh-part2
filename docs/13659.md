...
> 原文:[https://dev . to/mogery/tracking-errors-in-sentry-in-nodejs-4d1o](https://dev.to/mogery/tracking-errors-in-sentry-in-nodejs-4d1o)
...
# [](#setting-up-your-sentry-project)设置您的哨兵项目
...
## [](#method-1-wrapping-code-into-a-context)方法 1——将代码包装到上下文中
...
## [](#method-2-manually-capturing-errors)方法 2 -手动捕捉错误
...
# [](#breadcrumbs-breadcrumbs-everywhere)面包屑，面包屑遍地！
