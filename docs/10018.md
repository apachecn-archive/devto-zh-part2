...
> 原文:[https://dev . to/itachiuchiha/bulma-based-ui-components-for-vue js-41i 4](https://dev.to/itachiuchiha/bulma-based-ui-components-for-vuejs-41i4)
...
## [](#bulma-based-ui-components-for-vuejs)基于布尔玛的 UI 组件为 Vue.js
...
## [](#lets-create-login-modal)让我们创建登录模式
