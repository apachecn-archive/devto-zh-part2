...
> 原文:[https://dev . to/cindyachieng/pipenv-the-new-python-packaging-tool-179n](https://dev.to/cindyachieng/pipenv-the-new-python-packaging-tool-179n)
...
#### [](#understanding-pipfile-and-pipfilelock)了解 pipfile 和 pipfile.lock
