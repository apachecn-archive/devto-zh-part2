...
## [](#sobre-la-luhn-test-kata)Sobre la Luhn 测试形
...
## [](#empecemos-con-un-test)帝企鹅 con un 测试
...
### [](#escribir-tests-en-python)用 Python 编写测试
...
### [](#analizar-el-problema-y-escoger-el-primer-test)分析问题，选择第一次测试
...
## [](#empezando-con-el-c%C3%B3digo-de-producci%C3%B3n)从生产代码开始
...
### [](#c%C3%B3digo-m%C3%ADnimo-para-pasar-el-test)通过考试的最低码
...
## [](#buscando-un-nuevo-ejemplo)寻找新的例子
...
## [](#los-tests-deben-forzar-implementaciones)测试必须强制实施
...
## [](#buscando-un-algoritmo-m%C3%A1s-general)寻找更一般的算法
...
## [](#a%C3%B1adiendo-prestaciones)加入福利
