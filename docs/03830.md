...
> 原文:[https://dev . to/pics oung/prevent-duplicate-entries-on-your-forms-using-server less-1 CEA](https://dev.to/picsoung/prevent-duplicate-entries-on-your-forms-using-serverless--1cea)
...
### [](#general-principle-%F0%9F%97%BA)一般原理🗺
...
#### [](#get-tftoken-value)获取 TF_TOKEN 值🔑
...
#### [](#deploy-serverless-function)部署无服务器功能⏫
...
#### [](#add-webhook-to-our-form)给我们的表单添加 Webhook🔗
