...
> 原文:[https://dev . to/Jorge _ rockr/my-development-environment-setup-part-2-4c K9](https://dev.to/jorge_rockr/my-development-environment-setup-part-2-4ck9)
...
## [](#61-fix-0x7a69-color-error-on-vim-optional)6.1。修复 vim 上的 0x7A69 颜色错误(可选)
...
## [](#62-fix-weird-backspace-character-on-vim-optional)6.2。修复 vim 上奇怪的退格字符(可选)
...
## [](#7-install-vim-plugins)7。安装 vim 插件
...
## [](#8-mastering-vim-nerdtree-is-your-friend)8。掌握 vim: NerdTree 是你的朋友
...
## [](#9-mastering-vim-window-splitting)9。掌握 vim:窗口拆分
...
## [](#10-mastering-vim-delete-file-buffers)10。掌握 vim:删除文件缓冲区
