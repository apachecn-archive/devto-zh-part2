...
## [](#its-an-alternative-to-rest-so-what-why-should-i-use-graphql-instead)是休息的替代，那又怎样？为什么要用 GraphQL 代替？
...
### [](#queries-how-graphql-asks-for-data)查询:GraphQL 如何请求数据
...
### [](#mutations-how-graphql-manipulates-data)突变:GraphQL 如何操纵数据
...
### [](#resolvers-how-graphql-fetches-the-data-for-its-query-or-mutation-field)解析器:GraphQL 如何为其查询(或变异)字段获取数据
...
## [](#graphql-client-libraries)GraphQL 客户端库
...
## [](#more-about-graphql)关于 GraphQL 的更多信息

如果你愿意，你可以在这里停下来，更好地理解 GraphQL 是什么，但是如果你想知道更多关于 GraphQL 在客户端和服务器端的好处，请继续阅读。

### [](#graphql-and-the-client-side)GraphQL 和客户端
...
### [](#graphql-and-the-server-side)GraphQL 和服务器端
...
### [](#graphql-tooling-and-its-ecosystem)GraphQL 工具及其生态系统
