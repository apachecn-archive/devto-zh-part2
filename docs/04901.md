...
## [](#use-a-lot-of-small-named-functions)使用大量小型命名函数
...
## [](#dont-use-magic-numbers)不要使用神奇的数字
...
## [](#remember-its-all-subjective)记住这一切都是主观的
