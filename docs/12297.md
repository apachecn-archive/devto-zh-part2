...
## [](#what-are-some-approaches-we-can-take)我们可以采取哪些方法？

### [](#cssbased-clipping)基于 CSS 的裁剪
...
### [](#javascriptbased-clipping)基于 Javascript 的裁剪
...
### [](#javascript-truncation-on-arbitrary-items)任意项上的 Javascript 截断
