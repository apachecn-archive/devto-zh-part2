...
> 原文:[https://dev . to/rrampage/algorithms-generating-combinations-100 daysofcode-400a](https://dev.to/rrampage/algorithms-generating-combinations-100daysofcode-4o0a)
...
### [](#prelude-a-function-for-calculating-factorial-of-a-number)前奏:计算一个数的阶乘的函数
...
### [](#generating-the-combinations)生成组合
...
#### [](#generating-for-a-specific-value-of-raw-r-endraw-r-2)生成特定值的`r` (r = 2)
