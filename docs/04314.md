...
## [](#tutorial-adding-an-email-account-to-iphone-ipad)教程:向 iPhone / iPad 添加电子邮件帐户
...
#### [](#tips-what-should-you-set-to-each-field)温馨提示:应该给每个字段设置什么？
...
## [](#optional-tutorial-deleting-an-account)可选教程:删除账户
