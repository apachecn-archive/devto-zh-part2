...
> 原文:[https://dev . to/aurelkurtula/working-with-insta gram-API-and-passport js-in-a-node-application-5068](https://dev.to/aurelkurtula/working-with-instagram-api-and-passportjs-in-a-node-application--5068)
...
## [](#setting-up-the-application-with-express)使用 Express 设置应用程序
...
## [](#setting-up-instagram-strategy)设置 Instagram 策略
...
#### [](#creating-our-developer-application-raw-clientid-endraw-and-raw-clientsecret-endraw-)创建我们的开发者(应用)`clientID`和`clientSecret`
...
## [](#lets-make-the-raw-users-endraw-page-look-nice)让我们把`/users`页面做得好看些
...
## [](#creating-the-raw-user-endraw-page)创建`/user`页面
