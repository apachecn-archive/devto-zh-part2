...
> 原文:[https://dev . to/capermintech/building-a-hybrid-app-with-Android-studio-2491](https://dev.to/caperminttech/building-a-hybrid-app-with-android-studio--2491)
...
#### [](#step-3-add-a-platform-to-your-project)步骤 3:向您的项目添加平台
...
#### [](#step-4-testing-the-application)第四步:测试应用程序
...
#### [](#step-6-testing-the-application-on-a-device)步骤 6:在设备上测试应用程序
...
#### [](#step-7-distribute-it-to-the-app-store)第七步:分发到 App Store
...
#### [](#step-8-the-final-process)第八步:最终流程
