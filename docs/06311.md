...
> 原文:[https://dev.to/aralroca/first-steps-with-tensorflowjs-197p](https://dev.to/aralroca/first-steps-with-tensorflowjs-197p)
...
## [](#training-a-model-with-tensorflowjs)用 TensorFlow.js 训练模型
...
## [](#predicting-with-tensorflowjs)用 TensorFlow.js 预测
...
## [](#use-pretrained-models-with-tensorflowjs)使用 TensorFlow.js 的预训练模型
...
## [](#importing-models-from-keras)从 Keras 导入模型
