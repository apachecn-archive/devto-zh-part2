...
# [](#querydsl-is-awesome)Querydsl 牛逼
...
# [](#abstract-the-complex-away)把复杂的东西抽象掉
...
# [](#define-production-implementation)定义生产实现
...
# [](#using-inmemory-database-in-tests)在测试中使用内存数据库
...
# [](#notes-on-inmemory-implementation)关于内存实现的说明
