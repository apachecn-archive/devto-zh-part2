...
### [](#what-is-parceljs)什么是 Parcel.js？

根据 Parcel.js 网站，它是:

> ...一个 web 应用捆绑器，以其开发者体验而与众不同。它利用多核处理提供极快的性能，并且不需要任何配置。

#### [](#why-is-this-useful-to-us)为什么这个对我们有用？
...
### [](#setting-up-our-project-with-parceljs)使用 Parcel.js 设置我们的项目

#### [](#1-create-directory-and-enter)1。创建目录并输入
...
#### [](#2-initialize-npm-or-yarn)2。初始化 NPM 或纱线
...
#### [](#3-initialize-git-repo-and-add-gitignore)3。初始化 Git repo 并添加。gitignore
...
#### [](#4-create-an-indexhtml-file)4。创建一个 index.html 文件
...
#### [](#7-create-a-babelrc-file-to-tell-it-how-to-compile-the-javascript)7。创建一个. babelrc 文件，告诉它如何编译 JavaScript
...
#### [](#8-add-scripts-to-our-packagejson-file)8。向我们的 package.json 文件添加脚本
