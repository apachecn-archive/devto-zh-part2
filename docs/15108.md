...
> 原文:[https://dev . to/adjoa/building-a-command-line-interface-with-ruby-370k](https://dev.to/adjoa/building-a-command-line-interface-with-ruby--370k)

在这篇文章中，我将讲述我用 Ruby 构建命令行界面应用程序的经历；生成一个 gem 目录，用 Nokogiri 抓取数据，并组装用户界面。

## [](#draw-your-own-map)绘制自己的地图
...
## [](#a-view-of-the-destination)目的地的景色
...
## [](#keep-your-data-sources-close)关闭你的数据源
...
## [](#scraping-forward-with-nokogiri)用 Nokogiri 向前刮
...
## [](#homecoming-return-to-the-cli)同学会:返回 CLI
