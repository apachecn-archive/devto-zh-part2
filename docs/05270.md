...
> 原文:[https://dev . to/ankursheel/securing-git-commits-from-tricking-you-on-windows-39ig](https://dev.to/ankursheel/securing-git-commits-from-tricking-you-on-windows-39ig)
...
## [](#setup-kleopatra)Setup Kleopatra
...
## [](#configure-git-to-sign-commits)配置 Git 对提交进行签名
...
## [](#configure-kleopatra-to-cache-the-passphrase-for-a-longer-time)配置 Kleopatra 将密码缓存更长时间
...
## [](#configure-github-to-show-verified-commits)配置 Github 以显示已验证的提交
