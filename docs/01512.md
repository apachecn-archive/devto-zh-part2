...
> 原文:[https://dev . to/adityarohilla 94/a-brief-introduction-to-support-vector-machine-4ne 8](https://dev.to/adityarohilla94/a-brief-introduction-to-support-vector-machine-4ne8)
...
### [](#using-support-vector-machines)使用支持向量机
