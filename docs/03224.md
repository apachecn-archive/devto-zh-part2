...
> 原文:[https://dev . to/zellwk/how-I-remember-CSS-grid-properties-9 i5](https://dev.to/zellwk/how-i-remember-css-grid-properties-9i5)
...
### [](#positioning-items-in-your-grid)在网格中定位项目
...
### [](#positioning-items-in-named-areas)定位命名区域中的项目
...
### [](#how-to-remember-these-properties)如何记住这些属性
...
### [](#content-items-and-self)内容、项目和自我
...
### [](#how-to-remember-the-implicit-grid)如何记忆隐含网格
