...
> 原文:[https://dev . to/lcezermf/tips-to-improve-your-ruby-code-design-530j](https://dev.to/lcezermf/tips-to-improve-your-ruby-code-design-530j)
...
### [](#why-you-should-care-about-the-design-of-your-code)为什么你应该关心你的代码的设计？
...
### [](#avoid-hidden-structures)避开隐藏的结构
...
#### [](#how-to-avoid-hidden-structures)如何避开隐藏结构？
...
### [](#avoid-comparison-with-regular-expressions)避免与正则表达式进行比较
...
### [](#avoid-directly-dependencies)避免直接依赖
...
### [](#follow-the-demeters-law)遵循得墨忒耳定律
