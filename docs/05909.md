...
# [](#spread-operator-to-create-an-array-using-an-array-literal)Spread 运算符使用数组文字创建一个数组
...
# [](#objects-are-associative-arrays-aka-maps)对象是关联数组(又名地图)
