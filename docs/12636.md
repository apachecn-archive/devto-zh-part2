...
> 原文:[https://dev . to/goozen burger/exporting-scripts-from-SQL-server-for-use-with-dbup-1j 3](https://dev.to/goozenburger/exporting-scripts-from-sql-server-for-use-with-dbup-1j3)
