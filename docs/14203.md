...
> 原文:[https://dev . to/ryantownsend/shift-commerces-journey-解构-单片-应用-服务- 4c2d](https://dev.to/ryantownsend/shift-commerces-journey-deconstructing-monolithic-applications-into-services--4c2d)
...
# [](#are-monoliths-such-a-bad-thing)独石是这么坏的东西吗？
...
## [](#3-language-or-infrastructure-limitations)3。语言或基础设施限制
...
# [](#what-are-our-steps-to-migrating-to-kafkadriven-services)我们迁移到 Kafka 驱动的服务的步骤是什么？
...
## [](#step-1-add-producer-logic-to-the-monolith)步骤 1:向 Monolith 添加生产者逻辑
...
## [](#step-2-consume-the-stream-into-the-database)第二步:将流消费到数据库中
...
## [](#step-3-test-the-consumer)第三步:测试消费者
...
## [](#step-4-replicate-your-logic)第四步:复制你的逻辑
...
## [](#step-5-add-test-and-consume-event-triggers)第五步:添加、测试和消费事件触发器
...
## [](#step-6-push-events-back)第六步:推回事件
...
## [](#step-7-test-action-events)第七步:测试动作事件

激活测试帐户的功能切换，并测试应用程序是否继续正常运行。

## [](#step-8-remove-deprecated-logic-from-monolith)步骤 8:从 Monolith 中删除不赞成使用的逻辑
...
# [](#where-are-shift-today)今天换班去哪里了？
