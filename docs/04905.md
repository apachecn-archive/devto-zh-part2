...
> 原文:[https://dev.to/swyx/networking-essentials-routing-5gb7](https://dev.to/swyx/networking-essentials-routing-5gb7)
...
## [](#interdomain-routing-business-models)域间路由商业模式
