...
> 原文:[https://dev . to/oktadev/build-a-one-time-password-token-for-MFA-with-okta-1i4d](https://dev.to/oktadev/build-a-one-time-password-token-for-mfa-with-okta-1i4d)
...
## [](#get-up-and-running-with-an-okta-verify-token)使用 Okta 验证令牌启动并运行
...
## [](#working-with-source-code-and-dependencies)处理源代码和依赖项
...
## [](#navigating-around-the-oktaardutoken-interface)在 OktaArduToken 界面导航
...
## [](#configure-okta-for-multifactor-authentication)为多因素认证配置 Okta
...
### [](#configure-an-mfa-enrollment-policy)配置 MFA 注册策略
...
### [](#configure-an-mfa-enforcement-policy)配置 MFA 实施策略
...
## [](#authenticate-with-okta-and-the-oktaardutoken)向 Okta 和 OktaArduToken 认证
...
这是 OktaArduToken 与 Okta Verify 移动应用程序并排显示:
 ...
 <video src="https://developer.okta.com/assets/blog/ardu-token-mfa/oktaardusidebyside-cf0d8571e5c5fef9f84a0d64d6242466e4f1d8301aef24009f89da0ec40aadcf.mp4" controls="">## [](#a-look-at-the-totp-arduino-code)一看 TOTP 的 Arduino 代码
...
## [](#learn-more-about-okta-verify-and-multifactor-authentication)了解有关 Okta 验证和多因素认证的更多信息
