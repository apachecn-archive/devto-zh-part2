...
> 原文:[https://dev . to/circle ci/dockerizing-Java-apps-with-circle ci-and-jib-2f8](https://dev.to/circleci/dockerizing-java-apps-with-circleci-and-jib-2af8)
...
## [](#our-sample-application)我们的示例应用程序
...
## [](#pushing-jib-images-to-a-registry)将 Jib 图像推送到注册表中
...
## [](#encrypting-maven-credentials)加密 Maven 凭证
