...
> 原文:[https://dev . to/y shogo 87/how-to-create-material-animation-for-listview-in-Android-pk7](https://dev.to/yshogo87/how-to-create-material-animation-for-listview-in-android-pk7)
...
## [](#setting-transition-name)设置过渡名称
...
## [](#%E3%80%80screen-transitions-implementation-in-android-applications-with-kotlin)用 Kotlin 实现 Android 应用中的屏幕过渡
