...
> 原文:[https://dev.to/pa1nd/from-java-to-react-native-23b8](https://dev.to/pa1nd/from-java-to-react-native-23b8)
...
## [](#questions-around-react-native-rn)问题围绕 React Native (RN)？
...
## [](#who-uses-react-native)谁使用 React Native
...
## [](#so-what-is-react-native)那么什么是 React Native 呢？
...
## [](#what-could-go-against-it)有什么可能违背它？
