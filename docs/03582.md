...
> 原文:[https://dev . to/atability/how-we-measure-simplicity-to-assure-users-can-do-more-with-less-c1n](https://dev.to/tability/how-we-measure-simplicity-to-make-sure-users-can-do-more-with-less-c1n)
...
### [](#wait-whats-squadlytics)等等，什么是 Squadlytics？
...
## [](#how-we-treat-simplicity-as-a-feature)我们如何把简单当作一种特性

### [](#defining-a-framework-to-measure-simplicity)定义衡量简单性的框架
...
### [](#establishing-the-baseline)建立基线
...
## [](#things-we-did-to-improve-the-user-experience)我们为改善用户体验所做的事情

### [](#reduce-contextswitching)减少上下文切换
...
## [](#data-doesnt-tell-all-the-story)数据不能说明一切
...
## [](#enabling-users-to-do-more-with-less-effort)让用户事半功倍
