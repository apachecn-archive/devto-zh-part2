...
> 原文:[https://dev . to/flipped coding/you-can-get-a-new-job-30-faster-2bg 2](https://dev.to/flippedcoding/you-can-get-a-new-job-30-faster-2bg2)
...
# [](#tell-people-you-are-looking-for-a-job)告诉别人你在找工作。
...
# [](#start-going-to-industry-specific-events)开始走向行业特定事件。
...
# [](#shotgun-applications-and-then-reach-out-to-the-person-that-posted-them-if-possible)鸟枪式应用，如果可能的话，联系发布它们的人。
...
# [](#grow-and-nurture-your-network)发展和培养你的人际网络。
...
# [](#be-open-to-different-roles)对不同的角色持开放态度。
