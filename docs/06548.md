...
> 原文:[https://dev . to/oktadev/build-a-simple-rest-API-with-node-and-oauth-20-1m4p](https://dev.to/oktadev/build-a-simple-rest-api-with-node-and-oauth-20-1m4p)
...
## [](#build-your-node-server)构建您的节点服务器
...
## [](#secure-your-node-express-rest-api-with-oauth-20)使用 OAuth 2.0 保护您的 Node + Express REST API
...
### [](#create-an-authorization-server)创建授权服务器
...
### [](#create-middleware-to-verify-tokens-in-express)创建中间件来验证 Express 中的令牌
...
### [](#create-a-test-client-in-node)在节点中创建一个测试客户端
...
## [](#learn-more-about-node-and-oauth-20-client-credentials-with-okta)通过 Okta 了解有关节点和 OAuth 2.0 客户端凭证的更多信息
