...
> 原文:[https://dev . to/nabbi sen/virtualbox-how-to-activate-guest-additions-1 ojg](https://dev.to/nabbisen/virtualbox-how-to-activate-guest-additions-1ojg)
...
### [](#step-1-getting-the-installer)第一步:获取安装程序
...
### [](#shared-clipboards-better-video-support-and-so-on)共享剪贴板/更好的视频支持/等等
