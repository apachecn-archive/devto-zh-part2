...
> 原文:[https://dev . to/progress telerik/let-build-a-sales-dashboard-with-react-41hn](https://dev.to/progresstelerik/lets-build-a-sales-dashboard-with-react-41hn)
...
## [](#building-the-sales-dashboard-in-kendoreact)在 KendoReact 中构建销售仪表板
...
### [](#ensure-yarn-is-installed)确保纱线安装完毕:
...
## [](#raising-the-bar-chart-component)提升条形图组件
...
## [](#adding-the-grid-component)添加网格组件
...
### [](#embed-sparkline-as-content-for-a-grid-column)嵌入迷你图作为网格列的内容
...
## [](#adding-panelbar-navigation)添加 PanelBar 导航
...
### [](#try-out-kendoreact)试用 KendoReact
