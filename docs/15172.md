...
> 原文:[https://dev . to/yos/stateless-authentic ation-with-JSON-we b-tokens-km3](https://dev.to/yos/stateless-authentication-with-json-web-tokens--km3)
...
## [](#a-minimum-viable-authentication-service)最低可行的认证服务
...
## [](#benefits-of-using-jwts-for-authentication)使用 jwt 进行认证的好处
...
## [](#updated-authentication-flow)更新认证流程
...
## [](#a-minimum-viable-authentication-middleware)一个最小可行的认证中间件
