...
> 原文:[https://dev . to/jaybeekeeper/byte-size-changing-habits-with-the-command-line-3lil](https://dev.to/jaybeekeeper/byte-size-changing-habits-with-the-command-line-3lil)
...
###### [](#i-dont-have-to-do-this-anymore)我再也不用这样了
