...
> 原文:[https://dev . to/kball/Friday-frontend-community-evolution-edition-2lam](https://dev.to/kball/friday-frontend-community-evolution-edition-2lam)
...
##### [](#creating-horizontal-scrolling-containers-the-right-way-css-grid)[以正确的方式创建水平滚动容器【CSS 网格】](https://medium.com/@dannievinther/creating-horizontal-scrolling-containers-the-right-way-css-grid-c256f64fc585)
...
##### [](#grid-vs-flexbox-which-should-you-choose)[Grid Vs Flexbox:你该选哪个？](https://www.webdesignerdepot.com/2018/09/grid-vs-flexbox-which-should-you-choose/)
...
##### [](#its-2018-you-shouldnt-be-writing-vanilla-css)[现在是 2018 年:你不应该写香草 CSS](https://dev.to/bnevilleoneill/its-2018-you-shouldnt-be-writing-vanilla-css-50ff-temp-slug-8409804)

我原以为这是在吹捧 CSS 框架，但实际上这是对 CSS 预处理程序的概述(一路 SCSS！)、后处理器(postCSS 功能惊人的强大)以及 CSS-in-JS 选项。看看这个。

##### [](#getting-to-know-a-legacy-codebase)[了解遗产代码库](https://csswizardry.com/2018/07/getting-to-know-a-legacy-codebase/)
...
##### [](#javascript-arrow-functions-how-why-when-and-when-not-to-use-them)[JavaScript Arrow 函数:如何、为什么、何时(以及何时不)使用它们](https://dev.to/kball/javascript-arrow-functions-how-why-when-and-when-not-to-use-them-253e)
...
##### [](#javascript-essentials-types-amp-data-structures)[JavaScript 要点:类型&数据结构](https://codeburst.io/javascript-essentials-types-data-structures-3ac039f9877b)
...
##### [](#writing-multiple-vue-components-in-a-single-file)[在单个文件中写入多个 Vue 组件](https://dev.to/hugo__df/writing-multiple-vue-components-in-a-single-file-hgj)
...
##### [](#nodejs-foundation-and-js-foundation-announce-intent-to-create-joint-organization)[Node.js 基金会和 js 基金会宣布有意创建联合组织](https://www.linuxfoundation.org/news/2018/10/node-js-foundation-and-js-foundation-announce-intent-to-create-joint-organization-to-support-the-broad-node-js-and-javascript-communities/)
...
##### [](#best-html-css-javascript-practice-chrome-extension)[最佳 HTML、CSS、Javascript 练习:Chrome 扩展](https://medium.com/@thejungwon/best-html-css-javascript-practice-chrome-extension-ae4e5e7839e)

创建 Chrome 扩展的步骤的一个很好的演示。目标是相对的新手——刚刚完成 Codecademy 的人——但是对任何从未做过扩展并且想做的人都有用。

##### [](#the-most-important-skill-nobody-taught-you)[没人教你的最重要的技能](https://medium.com/personal-growth/the-most-important-skill-nobody-taught-you-9b162377ab77)
...
##### [](#do-you-really-know-cors)[你真的了解 CORS 吗？](http://performantcode.com/web/do-you-really-know-cors)
