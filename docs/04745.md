...
> 原文:[https://dev . to/johnbwoodruf/component-libraries-with-stencil js-your-first-component-3b7p](https://dev.to/johnbwoodruff/component-libraries-with-stenciljs---your-first-component-3b7p)
