...
> 原文:[https://dev . to/amejiarosario/tree-data-structures-explained-with-JavaScript-1d7d](https://dev.to/amejiarosario/tree-data-structures-explained-with-javascript-1d7d)
...
### [](#implementing-a-simple-tree-data-structure)实现简单的树形数据结构
...
### [](#full-complete-and-perfect-binary-trees)完全、完整、完美的二叉树
...
## [](#binary-search-tree-bst)二叉查找树(英国夏令时)
...
## [](#balanced-vs-nonbalanced-trees)平衡与非平衡树
