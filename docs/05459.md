...
> 原文:[https://dev . to/missismada/deliver-critical-transactional-push-notifications-with-pusher-beams-2079](https://dev.to/missismada/deliver-critical-transactional-push-notifications-with-pusher-beams-2079)
...
# [](#gain-visibility-once-notifications-are-sent)发送通知后获得可见性
...
# [](#stop-wasting-time-with-gateway-scaffolding)停止浪费时间用网关脚手架
