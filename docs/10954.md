...
> 原文:[https://dev . to/pure suze/unit-testing-browser-extensions-39 a5](https://dev.to/pureooze/unit-testing-browser-extensions-39a5)
...
### [](#the-testing%C2%A0approach)测试方法
...
### [](#testing-with-webextension-apis)用 WebExtension APIs 进行测试
