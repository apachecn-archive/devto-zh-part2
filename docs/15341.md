...
> 原文:[https://dev . to/shrayasr/generate-a-quick-AWS-dashboard-using-linq pad-1 a5](https://dev.to/shrayasr/generate-a-quick-aws-dashboard-using-linqpad--1a5)
...
### [](#creating-users-and-policies-on-iam)在 IAM 上创建用户和策略
...
## [](#linqpads-raw-dump-endraw-function)LINQPad 的`Dump`功能
...
## [](#lprun-for-command-line-scripting-purposes)lprun 用于命令行脚本目的
