...
> 原文:[https://dev . to/mazentouati/snacks console-intuitive-browser-based-SQL-console-2 BCI](https://dev.to/mazentouati/snacksconsole-intuitive-browser-based-sql-console-2bci)
...
#### [](#extended-command-support)扩展命令支持
...
#### [](#enhance-the-manipulation-of-the-fetched-data)增强对提取数据的操作
