...
> 原文:[https://dev . to/on myway 133/learn-IOs-best-practices-by-building-a-simple-recipes-app-1j 69](https://dev.to/onmyway133/learn-ios-best-practices-by-building-a-simple-recipes-app-1j69)
...
### [](#xcode-and-swift-version)Xcode 和 Swift 版本
...
### [](#minimum-ios-version-to-support)支持最低 iOS 版本
...
### [](#organising-the-xcode-project)组织 Xcode 项目
...
## [](#recipes-app-structure)菜谱 app 结构
...
### [](#marking-sections-of-code)标注代码段
...
### [](#linting-code-with-swiftlint)林挺用 SwiftLint 编码
...
### [](#better-navigation-with-flowcontroller)使用流量控制器进行更好的导航
...
### [](#massive-view-controller)海量视图控制器
...
### [](#how-to-test-networking-code)如何测试联网代码
...
### [](#implementing-cache-for-offline-support)实现离线支持缓存
...
### [](#making-image-loading-more-convenient-for-uiimageview)使 UIImageView 的图像加载更加方便
...
### [](#handling-responsibilities-with-a-child-view-controller)用子视图控制器处理职责
...
### [](#composition-and-dependency-injection)组成和依赖注入
...
### [](#app-transport-security)App 运输安全
...
### [](#a-custom-scrollable-view)自定义可滚动视图
...
### [](#understanding-presentation-context)理解演示上下文
...
### [](#debouncing-search-actions)去抖搜索动作
...
### [](#testing-debouncing-with-inverted-expectation)用反向期望测试去抖
...
### [](#testing-user-interface-with-uitests)用 UITests 测试用户界面
...
### [](#measuring-performances-and-issues)衡量绩效和问题
...
### [](#prototyping-with-playground)原型与游乐场
