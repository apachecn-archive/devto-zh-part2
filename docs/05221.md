...
### [](#creating-an-executable-file)创建可执行文件
...
#### [](#referencing-or-substituting-a-variable)*引用*或替代变量:
...
### [](#passing-variables-to-our-script-from-terminal)从终端向我们的脚本传递变量
...
## [](#the-more-advanced-stuff)越高级的东西
...
### [](#parsing-arguments-raw-while-endraw-and-raw-case-endraw-statements)解析自变量(`while`和`case`语句)
