...
## [](#you-may-change-external-state-by-accident-when-you-reassign-values)重新赋值时，可能会意外改变外部状态
...
## [](#you-create-complex-code-when-you-reassign-values)重新赋值时会创建复杂的代码
...
### [](#working-with-many-branches)与多个分支合作
