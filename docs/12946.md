...
> 原文:[https://dev . to/jurriaanpro/spiele rei-with-bit bucket-pipelines-and-kubernetes-16 D1](https://dev.to/jurriaanpro/spielerei-with-bitbucket-pipelines-and-kubernetes-16d1)
...
# [](#step-1-create-remote-repository)步骤 1:创建远程存储库
...
# [](#step-2-create-react-app)第二步:创建 React app
...
# [](#step-3-push-to-remote)第三步:推送至远程
...
# [](#step-3-build-react-app)第三步:构建 React app
...
# [](#step-4-build-docker-container)第四步:构建 Docker 容器
...
# [](#step-6-continuous-deployment)第六步:持续部署

## [](#step-6a-create-kubernetes-cluster)步骤 6a:创建 Kubernetes 集群

创建一个 Kubernetes 集群，并配置您的终端，使其能够使用`kubectl`与之通信。

## [](#step-6b-create-initial-deployment)步骤 6b:创建初始部署
...
## [](#step-6c-setup-kubernetes-authentication-and-authorization)步骤 6c:设置 Kubernetes 认证和授权
...
### [](#step-6c1-authentication)步骤 6c1:认证
...
### [](#step-6c2-authorization)步骤 6c2:授权
...
## [](#step-6d-configure-bitbucket-pipeline)步骤 6d:配置 Bitbucket 流水线
