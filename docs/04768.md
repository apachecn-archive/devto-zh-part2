...
> 原文:[https://dev.to/aalises/preact-打字稿-包裹-还原-归零-重建-量化-前端-关注性能和极简主义-1lnp](https://dev.to/aalises/preact--typescript--parcel--redux-zero-rebuilding-the-qmenta-front-end-focusing-on-performance-and-minimalism-1lnp)
...
### [](#but-why-preact-typescript)但是……为什么 Preact + Typescript？🤔
...
##### [](#-asynchronous-method-interceptors)-异步方法拦截器
...
##### [](#-connecting-with-and-managing-api-calls)-连接和管理 API 调用
...
### [](#state-management-and-routing)状态管理和路由🚀
...
### [](#unit-and-e2e-acceptance-testing-with-jest-puppeteer)用 Jest +木偶师进行单元和 e2e 验收测试
