...
> 原文:[https://dev.to/biros/how-i-backupsync-my-dotfiles-apps-o0b](https://dev.to/biros/how-i-backupsync-my-dotfiles--apps-o0b)

我关心的是自动备份我的配置文件(又名点文件)并生成所有已安装应用的快照，无论是通过我的发行版的包管理器还是通过第三方包管理器，如`npm`或`pip`。这是能够在新安装的电脑上自动同步我的应用程序的第一步(还有待完成)。

## [](#backuping-dotfiles)备份点文件
...
## [](#generate-a-snapshot-of-your-apps)生成应用程序的快照
