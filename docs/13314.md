...
> 原文:[https://dev . to/twilio/better-passwords-in-ruby-applications-with-the-pwned-passwords-API-4o9f](https://dev.to/twilio/better-passwords-in-ruby-applications-with-the-pwned-passwords-api-4o9f)
...
## [](#pwned-passwords-and-rails)Pwned 密码和 Rails
...
## [](#pwned-passwords-and-devise)Pwned 密码和设计
...
## [](#safer-users-with-safer-passwords)更安全的用户，更安全的密码
