...
> 原文:[https://dev . to/oktadev/add-authentic ation-to-your-PHP-app-in-5-minutes-5e 04](https://dev.to/oktadev/add-authentication-to-your-php-app-in-5-minutes-5e04)
...
## [](#set-up-the-sample-php-app)设置示例 PHP 应用程序
...
## [](#create-an-oauth-application-in-okta)在 Okta 中创建 OAuth 应用程序
...
## [](#handle-the-oauth-redirect)处理 OAuth 重定向
