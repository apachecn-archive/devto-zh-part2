...
> 原文:[https://dev . to/lad vien/installing-arch-Linux-on-raspberry-pi-with-immediate-wifi-access-3d0i](https://dev.to/ladvien/installing-arch-linux-on-raspberry-pi-with-immediate-wifi-access-3d0i)
...
### [](#1-create-an-sd-card-by-following-the-arch-linux-instructions)1。按照 Arch Linux 说明创建 SD 卡
...
### [](#2-create-script-to-enable-wifi-on-boot)2。创建脚本以在启动时启用 WiFi
