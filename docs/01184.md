...
> 原文:[https://dev . to/mjyc/programming-a-social-robot-using-cycle js-23jl](https://dev.to/mjyc/programming-a-social-robot-using-cyclejs-23jl)
...
## [](#what-is-a-social-robot)什么是社交机器人？
...
## [](#why-cyclejs-for-social-robots)为什么社交机器人要用 Cycle.js？
...
## [](#implementing-travel-personality-test)实施“旅行个性测试”
...
#### [](#taking-a-closer-look-at-raw-runrobotprogram-endraw-)仔细查看`runRobotProgram`
