...
> 原文:[https://dev . to/惠晶/creating-a-custom-sublime-text-colour-scheme-7ha](https://dev.to/huijing/creating-a-custom-sublime-text-colour-scheme-7ha)
...
## [](#ui-theme-versus-colour-scheme)用户界面主题与配色方案
...
## [](#step-1-creating-the-raw-tmtheme-endraw-file)第一步:创建`.tmTheme`文件
...
## [](#step-2-install-your-custom-theme)第二步:安装你的自定义主题
...
## [](#step-3-share-with-friends)第三步:与朋友分享
