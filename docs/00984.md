...
#### [](#applying-rpa-should-not-be-an-unattended-shortterm-painkiller-therapy-but-embedded-in-a-proper-strategy-to-modernize-your-it-landscape)应用 RPA 不应是一种无人值守的短期止痛疗法，而是嵌入到一种适当的战略中，以实现 IT 环境的现代化。
...
### [](#challenges-when-applying-rpa)应用 RPA 时的挑战
...
### [](#the-danger-of-abusing-painkillers-like-rpa)滥用止痛药(如 RPA)的危害
...
#### [](#rpa-can-lead-to-a-downward-spiral-in-maintenance-costs)**RPA 会导致维护成本呈螺旋式下降**
...
#### [](#you-can-only-attract-it-talent-if-you-have-a-strong-technical-vision)**只有拥有强大的技术眼光，才能吸引 IT 人才**
...
#### [](#but-i-cannot-influence-our-strategy-what-to-do)**但我无法影响我们的战略，该如何是好？**
...
### [](#apply-rpa-properly-and-think-about-separation-of-concerns)正确应用 RPA，考虑关注点分离
...
### [](#combining-rpa-and-workflow-automation)结合 RPA 和工作流自动化
