 ...
 *### [](#what-about-mocking-i-hear-you-need-that-for-di-and-also-its-evil)嘲讽呢？我听说你需要它作为 DI，而且它是邪恶的

嘲讽后面会详细介绍(而且不是恶)。您使用嘲讽来用一个您可以在测试中控制和检查的虚构版本替换您注入的真实内容。但是在我们的例子中，标准库已经为我们准备好了一些东西。

### [](#the-go-standard-library-is-really-good-take-time-to-study-it)围棋标准库确实不错，抓紧时间研究一下吧
