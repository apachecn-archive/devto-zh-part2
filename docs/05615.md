...
> 原文:[https://dev . to/agathacco/how-to-create-pure-CSS-illustrations-and-animate-them-part-1-1j1k](https://dev.to/agathacco/how-to-create-pure-css-illustrations-and-animate-them---part-1-1j1k)

我一直对设计、插图和调色板很感兴趣，但在过去几年里，我一直专注于成为一名更好的前端开发人员，几乎没有时间练习我的创作技能。当我第一次接触 CSS 图像时，我迫不及待地想尝试一下。最后，我可以玩形状和颜色，并在编码时探索和发展我的创造力！

#### [](#but-first-what-is-a-pure-css-image)但是首先，什么是纯 CSS 图像？
...
#### [](#html-templating-language)HTML 模板语言
