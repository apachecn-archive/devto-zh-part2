# 开始连载 Elixir 入门( Elixir 入门也签)

> 原文：<https://dev.to/gumi/elixerelixir-10g2>
...
Elixir 在[Erlang](http://www.erlang.org/) (艾伦)的虚拟机上运行。 Erlang 是一种产生于 20 世纪 80 年代，用于开发电话 APP 应用程序的语言。 因此容易形成分散 APP，对故障具有耐受性([容错](https://ja.wikipedia.org/wiki/%E3%83%95%E3%82%A9%E3%83%BC%E3%83%AB%E3%83%88%E3%83%88%E3%83%AC%E3%83%A9%E3%83%B3%E3%83%88%E8%A8%AD%E8%A8%88))。 非常适合运用可靠、可扩展的互联网 APP 应用。

Elixir 是由[Plataformatec 公司](http://plataformatec.com.br/)的共同创始人[José Valim](https://twitter.com/josevalim) 开发的。 Plataformatec 公司的[Elixir 网站](https://elixir-lang.org/)中，面向入门者有“[GETTING STARTED](https://elixir-lang.org/getting-started/introduction.html) ”的指南，共进行了 23 章的基本解说。

《Elixir 入门》是得到 Plataformatec 公司的许可，用日语解说全部 23 章的连载。 但是，不是翻译，而是整理内容，补充说明和代码，为了更容易理解而进行了修改。 希望这个连载能对日本的 Elixir 用户有帮助。 第 23 章的日语标题如下。 每次公开的报道都会添加链接。
