...
> 原文:[https://dev . to/brob/use-CSS-grid-to-mix-and-match-design-patterns-j02](https://dev.to/brob/use-css-grid-to-mix-and-match-design-patterns-j02)
...
## [](#crafting-our-initial-grid)精心制作我们的初始网格
...
## [](#converting-the-image-to-a-background)将图像转换成背景
...
## [](#add-the-overlay-with-mixblendmodes)添加混合混合模式叠加
...
## [](#add-a-breakpoint-for-tablets-and-large-phones)为平板和大手机添加断点
...
## [](#now-for-the-fun-desktop-reconfiguration)现在为了娱乐:桌面重新配置
...
## [](#alternate-image-and-text-location-on-promos)宣传片上的备选图片和文字位置
...
### [](#free-ebook-common-css-grid-patterns)免费电子书-常用 CSS 网格模式
