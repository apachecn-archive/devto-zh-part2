...
> 原文:[https://dev . to/MongoDB/modern-distributed-application-deployment-with-kubernetes-and-MongoDB-atlas-159j](https://dev.to/mongodb/modern-distributed-application-deployment-with-kubernetes-and-mongodb-atlas-159j)
...
#### [](#why-atlas-with-kubernetes)为什么 Atlas 用 Kubernetes？
...
#### [](#selecting-your-gcp-region-for-atlas)为地图集选择您的 GCP 地区
...
#### [](#create-cluster-and-add-a-user)创建集群并添加用户
...
#### [](#docker-and-google-kubernetes-engine)Docker 和 Google Kubernetes 引擎
...
#### [](#build-your-cluster-with-google-kubernetes-engine)使用 Google Kubernetes 引擎构建您的集群
