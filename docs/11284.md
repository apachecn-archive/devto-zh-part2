...
> 原文:[https://dev . to/fabrik 42/signing-react-native-Android-apks-on-Microsoft-app-center-33 F6](https://dev.to/fabrik42/signing-react-native-android-apks-on-microsoft-app-center-33f6)
