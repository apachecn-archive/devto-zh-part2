...
> 原文:[https://dev . to/acho _ Arnold/PHP-test-coverage-with-Travis-ci-and-code-climate-using-clover-eih](https://dev.to/acho_arnold/php-test-coverage-with-travis-ci-and-code-climate-using-clover-eih)
...
#### [](#1-get-your-code-climate-test-reporter-id)1。获取您的代码气候测试记者 ID
...
#### [](#2-configure-your-travisyml-file)2。配置您的. travis.yml 文件
...
#### [](#3-configure-phpunitxml)3。配置 phpunit.xml
