...
> 原文:[https://dev . to/edoverflow/an-analysis-of-logic-flaws-in-web-of-trust-services-3bhj](https://dev.to/edoverflow/an-analysis-of-logic-flaws-in-web-of-trust-services--3bhj)
...
# [](#attack-vector-one-distribution-of-content-on-timelines)攻击载体一——时间线上的内容分布
...
# [](#attack-vector-two-namespace-attacks)攻击载体二——命名空间攻击
...
# [](#attack-vector-three-redirects)攻击向量三—重定向
