# 用 Pusher 开发一个实时的协作编辑器

> 原文：<https://dev.to/auth0/developing-a-real-time-collaborative-editor-with-pusher-51of>

在本文中，您将了解如何构建一个实时、协作的笔记编辑器应用程序，使多个用户能够同时处理同一个文档。要创建这个应用程序，您将使用 Node.js、Express、Pusher 和 Auth0 等工具。
