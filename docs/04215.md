...
> 原文:[https://dev . to/gate 3/how-to-setup-couch db-on-azure-a-step-by-step-guide-4o3p](https://dev.to/gate3/how-to-setup-couchdb-on-azure-a-step-by-step-guide-4o3p)
...
## [](#enter-pouchdb-and-couchdb)输入 [PouchDb](https://pouchdb.com) 和 [CouchDb](http://couchdb.apache.org/)
...
### [](#step-1-go-to-the-marketplace)第一步(去市场)
...
### [](#step-2-search-for-couchdb)第二步(搜索 Couchdb)
...
### [](#step-3-configure-your-vm-instance)步骤 3(配置您的虚拟机实例)
...
## [](#setting-up-couchdb)设置 Couchdb

Bitnami 在这里提供了一个官方的文档。仅供参考。

### [](#obtain-server-credentials-for-those-that-signed-up-using-password)获取服务器凭证(针对使用密码注册的用户)

#### [](#method-1-boot-diagnostics-method)方法 1:开机诊断法
...
#### [](#method-1-ssh-tunelling)方法 1(SSH tunneling)
...
#### [](#method-2-public-access)方法二(公共访问)
