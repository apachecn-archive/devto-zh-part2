...
> 原文:[https://dev . to/oktadev/flask-tutorial-simple-user-registration-and-log in-23kk](https://dev.to/oktadev/flask-tutorial-simple-user-registration-and-login-23kk)
...
## [](#initialize-authentication-for-your-flask-app-with-okta)用 Okta 初始化你的 Flask App 的认证
...
## [](#create-an-index-and-dashboard-view-in-flask)在 Flask 中创建索引和仪表板视图
...
## [](#add-user-registration-and-login-to-your-flask-app)添加用户注册并登录到您的 Flask 应用程序
...
### [](#step-3-inject-the-user-into-each-request)第三步:将用户注入到每个请求中
...
### [](#step-4-enable-user-registration-login-and-logout)第四步:启用用户注册、登录和注销
