...
## [](#step-1-install-groovy-on-os-x)第一步:在 OS X 上安装 Groovy
...
## [](#step-2-set-groovyhome-environment-variable)第二步:设置 Groovy_home 环境变量
...
## [](#step-4-start-using-groovy-to-automate-tasks-in-jira-or-confluence)第四步:在吉拉或 Confluence 中开始使用 Groovy 自动化任务
