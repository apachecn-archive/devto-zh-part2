...
> 原文:[https://dev . to/neo/create-a-two-player-game-with-python-vue-4c3j](https://dev.to/neo/create-a-two-player-game-with-python-and-vue-4c3j)
...
## [](#setting-up-the-app-environment)设置 app 环境
