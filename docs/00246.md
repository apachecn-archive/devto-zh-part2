...
> 原文:[https://dev . to/progress/give-your-apps-some-style-with-the-native script-theme-builder-1n 01](https://dev.to/progress/give-your-apps-some-style-with-the-nativescript-theme-builder-1n01)
...
## [](#using-the-nativescript-theme-builder)使用 NativeScript 主题生成器

要利用由 NativeScript 主题生成器创建的主题，您需要遵循几个简单的步骤:

### [](#1-use-the-nativescript-core-theme)1)使用 NativeScript 核心主题
...
### [](#2-create-a-style-using-the-nativescript-theme-builder)2)使用 NativeScript 主题生成器创建一个样式
