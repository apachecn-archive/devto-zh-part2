...
> 原文:[https://dev . to/binygal/continuously-running-flow type-checks-with-jest-runner-af9](https://dev.to/binygal/continuously-running-flowtype-checks-with-jest-runner-af9)
...
#### [](#what-is-jest-runner)什么是 Jest runner？
