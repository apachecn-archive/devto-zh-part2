...
> 原文:[https://dev . to/booyaa/we B- app-development-core-skill-hedgehog-part-two-3p1i](https://dev.to/booyaa/web-app-development-core-skill-hedgehog---part-two-3p1i)
...
### [](#useful-react-knowledge)有用的反应知识
...
### [](#situations-in-which-using-react-would-be-a-benefit)使用 React 会有好处的情况
...
### [](#what-a-react-component-is)什么是 React 组件
...
### [](#what-are-props-within-a-component)什么是组件内的道具
...
### [](#what-is-state-within-a-component)什么是组件内的状态
...
### [](#what-propschildren-refers-to)指什么道具
...
### [](#one-approach-to-styling-react-components)一种设计 react 组件样式的方法
...
### [](#an-approach-to-managing-application-state)一种管理应用程序状态的方法
