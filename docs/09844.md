...
### [](#signalling-vs-actual-use)信令 Vs 实际使用
...
### [](#using-npm-downloads-as-a-proxy-for-use)使用 NPM 下载作为代理使用
...
### [](#the-data-react-is-still-dominating)数据:React 依然独霸
...
### [](#adding-angular-to-the-mix)添加棱角
...
### [](#angular-npm-downloads)棱角分明的 NPM 下载
...
### [](#in-conclusion-react-still-dominates-vue-growing-fastest)总之:React 仍占主导地位，Vue 增长最快
