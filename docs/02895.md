...
> 原文:[https://dev.to/joelnet/lets-make-a-devto-cli-together-4eh1](https://dev.to/joelnet/lets-make-a-devto-cli-together-4eh1)
...
# [](#create-srcapimjs)创建 src/api.mjs
...
# [](#javascript-interop)JavaScript 互操作
...
# [](#so-you-decided-to-skip-to-the-end)所以你决定跳到最后？
...
# [](#warnings-about-the-cli)关于 CLI 的警告
