...
> 原文:[https://dev . to/kev Cui/3-mitmproy-tips-you-may-not-know-about-5d BG](https://dev.to/kevcui/3-mitmproxy-tips-you-might-not-know-about-5dbg)
...
### [](#tips-1-custom-configuration-and-key-binding)技巧 1:自定义配置和按键绑定
...
### [](#tips-2-knowing-client-connection-status-when-a-filter-is-applied)提示 2:应用过滤器时了解客户端连接状态
...
### [](#tips-3-using-mitmproxy-as-a-mock-server)技巧 3:使用 mitmproxy 作为模拟服务器
