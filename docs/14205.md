...
## [](#i-make-an-agent-and-an-intent-in-dialogflow)一、在 Dialogflow 中做代理和意向
...
## [](#ii-make-an-custom-app-in-slack-and-connect-it-to-dialogflow)二世。在 Slack 中制作一个自定义应用程序，并将其连接到 Dialogflow
...
## [](#iii-add-some-schemas-for-intents-and-fullfillments-in%C2%A0sanity)三世。在理智中为意图和实现添加一些模式
