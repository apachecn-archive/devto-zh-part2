...
> 原文:[https://dev . to/intrincate cloud/web driver io-tips-using-browser debug-to-help-debug-your-tests-1mdb](https://dev.to/intricatecloud/webdriverio-tips-using-browserdebug-to-help-debug-your-tests-1mdb)
...
### [](#losing-context-in-the-repl)在 REPL 失去语境
