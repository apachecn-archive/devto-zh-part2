...
> 原文:[https://dev . to/adammckenna/fast-as-a-veyron-achieving-100100-on-Google-page speed-insights-and-beyond-5a da](https://dev.to/adammckenna/fast-as-a-veyron-achieving-100100-on-google-pagespeed-insights-and-beyond-5ada)
...
## [](#concepts-and-design)概念和设计

### [](#simple-ui-design)简单的 UI 设计
...
### [](#the-application-shell-model)应用外壳模型
...
## [](#the-pagespeed-insight-metrics)页面速度洞察指标

### [](#avoid-landing-page-redirects)避免登陆页面重定向
...
### [](#eliminate-renderblocking-javascript-and-css-in-abovethefold-content)消除叠加内容中阻碍渲染的 JavaScript 和 CSS
...
### [](#prioritise-visible-content-via-the-application-shell-model-architecture)区分可视内容的优先级(通过应用外壳模型架构)
...
### [](#leverage-browser-caching)利用浏览器缓存
...
### [](#reduce-server-response-time)减少服务器响应时间
...
### [](#minify-html-css-and-javascript)缩小 HTML、CSS 和 JavaScript
