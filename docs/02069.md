...
> 原文:[https://dev . to/bpohoriletz/en-domain-driven-rails-architecture-2pla](https://dev.to/bpohoriletz/en-domain-driven-rails-architecture-2pla)
...
# [](#separation-of-representation-and-domain)**表象与领域的分离**
...
# [](#separation-of-environments-and-building-independent-test-suites)**分离环境并构建独立的测试套件**
...
#### [](#domain-test-suite-configuration)域测试套件配置
...
#### [](#representations-test-suite-configuration)表示测试套件配置
