...
> 原文:[https://dev . to/qlik branch/system-integration-with-qliks-APIs why-and-how-58g 8](https://dev.to/qlikbranch/system-integration-with-qliks-apiswhy-and-how-58g8)
...
### [](#so-lets-dive-in-with-apis-you-can-do-amazing-things-but-wait-what-is-an-api)所以让我们一头扎进去。有了 API，你可以做令人惊奇的事情。但是等等，什么是 API？
...
### [](#now-that-you-know-what-an-api-iswhat-can-you-build-with-qlik-sense-apis)现在你知道什么是 API 了…你能用 Qlik Sense APIs 构建什么？
...
#### [](#mashup-lv1%E2%80%8A%E2%80%8Abuild-a-webpage-of-iframes)Mashup Lv.1 —构建 iframes 的网页
...
#### [](#mashup-lv2%E2%80%8A%E2%80%8Amashup-with-apis-and-libraries)Mashup Lv.2 —带有 API 和库的 Mashup
...
#### [](#mashup-lv3%E2%80%8A%E2%80%8Abuilding-a-qlik-dashboard-which-looks-completely-nonrelated-to-qlik)Mashup Lv.3 —构建一个看起来与 Qlik 完全无关的 Qlik 仪表盘
...
#### [](#mashup-lv4%E2%80%8A%E2%80%8Ausing-enigmajs-and-engine-api)Mashup Lv.4 —使用 enigma.js 和引擎 API
...
#### [](#mashup-lvmax%E2%80%8A%E2%80%8Aleveraging-on-the-engine-itself)混搭(？)吕。MAX —利用引擎本身
...
### [](#so-how-should-you-get-started)那么，应该如何入门呢？
