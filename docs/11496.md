...
### [](#getting-an-ascii-codec-cant-decode-error)得到“ascii 编解码器无法解码”错误？
...
## [](#2-generating-an-app-key)2。生成应用密钥
...
## [](#4-i-did-everything-right-but-im-getting-a-502)4。我什么都做对了，但是我得了 502 分！
...
## [](#bonus-overcoming-tls-issues)奖励:克服 TLS 问题
