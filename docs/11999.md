...
> 原文:[https://dev . to/claire codes/why-it-the-important-to-give your-html-button-a-type-58k 9](https://dev.to/clairecodes/why-its-important-to-give-your-html-button-a-type-58k9)

## [](#spoiler)剧透

一个没有类型属性的按钮充当`type="submit"`，当被点击时将尝试提交表单数据。明确你的意图，并善待未来使用你的代码的开发人员:提供一个类型。通过指定`button`、`submit`或`reset`，代码的目的很清楚，也更容易维护

## [](#button-basics)按钮基础知识
...
## [](#button-types-in-action)按钮类型在动作
...
## [](#why-should-you-always-declare-a-type-attribute)为什么要一直声明类型属性？

### [](#1-clear-definition-of-what-the-button-does)1)明确定义按钮的作用
