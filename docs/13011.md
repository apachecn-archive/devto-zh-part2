...
> 原文:[https://dev . to/Brandon 927/setup-sonarr-and-radarr-to-notify-via-SMS-with-twilio-runtime-la8](https://dev.to/brandonb927/setup-sonarr-and-radarr-to-notify-via-sms-with-twilio-runtime-la8)
...
### [](#twilio-runtime-functions)Twilio 运行时功能
...
#### [](#create-a-new-runtime-function)创建新的运行时函数
...
#### [](#configuration-and-handler-setup)配置和处理器设置
...
#### [](#testing-the-function-endpoint)测试函数端点
