...
> 原文:[https://dev.to/asaaki/from-cobaltrs-to-gutenberg-2kdm](https://dev.to/asaaki/from-cobaltrs-to-gutenberg-2kdm)
...
### [](#not-all-perfect-but-were-getting-there)不尽完美，但我们正在努力
...
#### [](#-raw-tidyhtml5-endraw-getting-rid-of-awkward-whitespaces-and-indentation)`tidy-html5` -摆脱尴尬的空白和缩进
...
### [](#more-about-raw-gutenberg-endraw-)更多关于`gutenberg`
...
### [](#migrate-all-the-things)迁移所有的东西
...
### [](#functions-lambdas-and-serverless)功能，lambdas 和“无服务器”
