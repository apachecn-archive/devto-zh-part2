...
> 原文:[https://dev . to/iam cherta/generate-authorized-short-living-URLs-in-rails-1c do](https://dev.to/iamcherta/generate-authorized-short-living-urls-in-rails--1cdo)
...
## [](#start-digging-stop-digging)开始挖掘，停止挖掘
