...
> 原文:[https://dev . to/kjunichi/how-to-build-plv 8-230-for-raspberry-pi3-2n 09](https://dev.to/kjunichi/how-to-build-plv8-230-for-raspberry-pi3-2n09)
...
## [](#installing-depottools)安装软件仓库 _ 工具
...
## [](#cross-compileing-for-raspberry-pi)交叉编译为树莓 Pi
...
# [](#copying-files-to-raspberry-pi)将文件复制到树莓派
...
# [](#building-plv8-itself-on-raspberry-pi)在 Raspberry Pi 上构建 plv8 本身
...
## [](#copy-v8-headers-and-libraries-to-plv8s-source-tree)将 v8 头文件和库复制到 plv8 的源树
...
## [](#installing-postgres-extension)安装 postgres 扩展
