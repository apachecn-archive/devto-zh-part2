...
> 原文:[https://dev . to/wired ferret/using-air table-to-manage-conference-submissions-4pd](https://dev.to/wiredferret/using-airtable-to-manage-conference-submissions-4pd)
