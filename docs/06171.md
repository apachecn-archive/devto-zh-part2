...
> 原文:[https://dev . to/will velida/installing-configuring-and-use-the-azure-data bricks-CLI-4nb 1](https://dev.to/willvelida/installing-configuring-and-using-the-azure-databricks-cli-4nb1)
