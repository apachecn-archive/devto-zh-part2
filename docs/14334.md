...
> 原文:[https://dev.to/atsushieno/fluidsynth-for-android-269 I](https://dev.to/atsushieno/fluidsynth-for-android--269i)
...
## [](#androidopensles-implementation)Android/OpenSLES 实现
...
## [](#nfluidsynth-and-fluidsynthmidiservice)NFluidsynth 和 FluidsynthMidiService
...
## [](#cmake-switches-and-androidfluidsynth-port)CMake 交换机和 android-fluidsynth 端口
...
## [](#whats-different-from-users-point-of-view)从用户的角度看有什么不同
