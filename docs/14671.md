...
> 原文:[https://dev . to/neo/how-to-build-a-online-real time-counter-using-net-and-pusher-14dh](https://dev.to/neo/how-to-build-an-online-realtime-counter-using-net-and-pusher-14dh)
...
## [](#building-the-frontend-for-our-realtime-counter-in-net)为我们的实时计数器构建前端。网
...
## [](#adding-realtime-updates-to-our-views-counter-with-pusher)**用推送器给我们的视图计数器添加实时更新**
