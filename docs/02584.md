...
> 原文:[https://dev . to/saltyshiomix/release-nextron-v3-electron-with-nextjs-apps-generator-2 HGF](https://dev.to/saltyshiomix/release-nextron-v3-electron-with-nextjs-apps-generator-2hgf)
...
## [](#dive-into-nextron)潜入 Nextron

### [](#development-mode-raw-node-buildnextronjs-dev-endraw-)发展模式(`node build/nextron.js dev`)
...
### [](#production-build-raw-node-buildnextronjs-build-endraw-)生产打造(`node build/nextron.js build`)
...
### [](#examplescustombuildoptions)[示例/定制-构建-选项](https://github.com/saltyshiomix/nextron/tree/master/examples/custom-build-options)
...
### [](#exampleswithjavascriptantdesign)[例子/用-javascript-ant-design](https://github.com/saltyshiomix/nextron/tree/master/examples/with-javascript-ant-design)
...
### [](#exampleswithtypescriptless)[例子/with-typescript-less](https://github.com/saltyshiomix/nextron/tree/master/examples/with-typescript-less)
...
### [](#exampleswithtypescriptmaterialui)[例子/with-typescript-material-ui](https://github.com/saltyshiomix/nextron/tree/master/examples/with-typescript-material-ui)
