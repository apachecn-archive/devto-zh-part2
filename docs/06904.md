...
> 原文:[https://dev.to/wonism/create-your-own-blog-with-gatsby-45hh](https://dev.to/wonism/create-your-own-blog-with-gatsby-45hh)
...
## [](#install-gatsby-cli-and-gatsby-starter)安装盖茨比 CLI 和盖茨比启动器
...
## [](#basic-structure-of-project)项目的基本结构
...
### [](#the-basic-components-of-a-markdown-file)降价文件的基本组成部分
...
### [](#add-react-application-into-post)将 react 应用添加到帖子中
