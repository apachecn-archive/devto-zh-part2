...
> 原文:[https://dev . to/solace devs/comparisng-machine-learning-through-BBC-news-analysis-38fa](https://dev.to/solacedevs/comparing-machine-learning-through-bbc-news-analysis-38fa)
...
#### [](#what-is-image-analysis)什么是图像分析？
...
#### [](#what-is-sentiment-analysis)什么是情感分析？
...
### [](#observations-so-far)目前为止的观察结果…

#### [](#not-all-machines-are-created-equal)并非所有的机器都生而平等
...
### [](#a-picture-paints-how-many-words-well-ill-tell-you)一幅画描绘了多少个字？好吧，我告诉你…
