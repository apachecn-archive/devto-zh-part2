...
> 原文:[https://dev.to/melezhik/sparrow-简单部署红宝石脚本-5c6g](https://dev.to/melezhik/sparrow---simple-deploy-of-ruby-scripts-5c6g)
...
## [](#create-sparrowhub-account)创建 SparrowHub 账户

前往[https://sparrowhub.org/sign_up](https://sparrowhub.org/sign_up)

## [](#generate-sparrowhub-token)生成 Sparrowhub 令牌:
...
## [](#convert-your-script-into-sparrow-plugin)“转换”你的脚本到麻雀插件:

### [](#name-your-script-storyrb)给你的剧本命名 story.rb
...
## [](#handle-input-parameters)处理输入参数
...
## [](#create-distribution-file)创建分发文件
...
# [](#distributing-private-scripts)分发私有脚本
...
# [](#comments-questions-ideas)评论、问题、想法
