...
> 原文：<https://dev.to/guifroes/3-books-that-will-take-you-to-the-next-level-4b56>

你可以编写代码，让计算机做你想做的事情——没问题。你甚至可以用不止一种语言来做这件事，而且你可以流利地使用许多框架。你知道你所有的数据结构和算法，可以毫不费力地使用数据库和外部 API。你已经做了好几年了。

然而，即使拥有所有这些知识和技能，并且总能完成工作，有时你也不确定自己是否做对了。

也许你的代码开始时很好，一切就绪，运行良好，但是过了一段时间，当添加新的功能时，它开始变得混乱不堪。或者错误开始出现，在不破坏其他东西的情况下修复东西变得越来越困难。

你花了很多时间追逐和杀死 bug，编码，这些曾经很有趣的事情，**变得令人沮丧**。

> 你觉得做事一定有更好的方法。而且有！

你需要的是一套新技能。你需要提升自己。

有很多方法可以做到这一点，但在这里我将推荐 3 本书，它们将改变你思考和编写代码的方式。当然，还有很多值得你花费时间和金钱的东西，但我认为这三个涵盖了很多内容，会让你物有所值。
...
顺便说一下，桑迪很棒，你应该读她所有的书，看她所有的演讲。说真的。
...
正如我所说的，我可以为那些希望获得更高级的编程技能的人推荐更多优秀的书籍，但是这个简短的列表应该足以向您介绍一个新的世界，并带给您编程的乐趣。

你还在等什么？

带你更上一层楼的 3 本书首先出现在[的 Gui Froes](https://guifroes.com/?utm_source=dev.to&utm_medium=post_footer) 上。