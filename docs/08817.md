...
#### [](#so-what-do-i-mean-by-command-delegation)那么我说的指挥授权是什么意思呢？
...
#### [](#so-how-do-i-install-it)那么我该怎么安装呢？
...
##### [](#publishing-raw-doing-endraw-a-command)发布(`Doing`)一个命令
