...
### [](#props-amp-state-immutability)道具&状态(im)易变性
...
### [](#-raw-setstate-endraw-correctness)`setState`正确性
...
### [](#ugly-case-of-generic-raw-setstate-endraw-)丑案的仿制`setState`
