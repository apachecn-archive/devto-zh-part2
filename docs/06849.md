...
> 原文:[https://dev . to/gaetanm/getting-back-to-an-old-postgressql-specific-version-3o 01](https://dev.to/gaetanm/getting-back-to-an-old-postgressql-specific-version-3o01)

# TL；速度三角形定位法(dead reckoning)

## [](#exemple-about-getting-back-to-966-from-967)从 9.6.7 回到 9.6.6 的例子
...
## [](#1-remove-all-postgresql-version-installed)1。删除安装的所有 PostgreSQL 版本
...
## [](#2-install-postgresapp)2。安装 Postgres.app
...
## [](#3-make-postgresql-related-tools-usable-with-the-terminal)3。使 PostgreSQL 相关工具可用于终端
