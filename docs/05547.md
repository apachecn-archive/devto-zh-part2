...
> 原文:[https://dev . to/neo/build-a-cryptocurrency-alert-app-using-kot Lin-and-go-part-1 the-frontend-2h9d](https://dev.to/neo/build-a-cryptocurrency-alert-app-using-kotlin-and-go-part-1the-frontend-2h9d)
...
### [](#building-our-android-application)构建我们的 Android 应用
...
#### [](#creating-a-pusher-beams-application)创建一个推梁应用程序
...
#### [](#adding-functionalities-to-our-application)为我们的应用添加功能
