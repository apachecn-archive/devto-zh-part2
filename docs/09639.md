...
## [](#why-would-you-test-your-database-with-citrus)为什么要用 Citrus 测试你的数据库？
...
## [](#citrusjdbc-features)柑橘-JDBC 特色
...
### [](#simulating-database-failures)模拟数据库故障
...
### [](#preparedcallable-statements)准备好/可调用的报表
