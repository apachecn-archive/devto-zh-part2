...
> 原文:[https://dev . to/kbk 0125/Amazon-we b-services-AWS-explained-by-operating-abrewery-2j 0](https://dev.to/kbk0125/amazon-web-services-aws-explained-by-operating-abrewery-2j0)
...
#### [](#the-context-of-amazon-web%C2%A0services)亚马逊网络服务的背景
...
### [](#aws-storage%C2%A0tools)AWS 存储工具
...
### [](#aws-database%C2%A0services)AWS 数据库服务
...
### [](#aws-data-warehouse-tools)AWS 数据仓库工具
...
### [](#get-the-latest-visual-tutorials)获取最新的可视化教程
