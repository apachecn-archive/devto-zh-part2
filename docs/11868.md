...
> 原文:[https://dev . to/Dustin software/net-core-in-docker-on-a-raspberry-pi-4ha 6](https://dev.to/dustinsoftware/net-core-in-docker-on-a-raspberry-pi-4ha6)
...
### [](#out-of-date-information-below)过期信息如下图:

默认情况下，会给你一个在 x86/x64 架构上运行良好的项目。然而，RPI 运行在 arm32v7 上。我们需要做一些小的改动来支持 Docker 中的这个架构。

### [](#arm-is-supported-by-aspnet-core-so-why-doesnt-it-just-work-in-docker)ARM 有 ASP.NET 内核支持，那为什么不直接在 Docker 中工作呢？
...
### [](#using-a-different-base-image)使用不同的基础图像
