...
> 原文:[https://dev . to/digital ocean/how-to-configure-nginx-as-a-web-server-and-reverse-proxy-for-Apache-on-one-Ubuntu-1804-server-2eib](https://dev.to/digitalocean/how-to-configure-nginx-as-a-web-server-and-reverse-proxy-for-apache-on-one-ubuntu-1804-server-2eib)
...
## [](#step-1-installing-apache-and-phpfpm)步骤 1 —安装 Apache 和 PHP-FPM
...
## [](#step-2-configuring-apache-and-phpfpm)步骤 2 —配置 Apache 和 PHP-FPM
...
## [](#step-3-configuring-apache-to-use-modfastcgi)步骤 3 —配置 Apache 使用 mod_fastcgi
...
## [](#step-4-verifying-php-functionality)步骤 4 —验证 PHP 功能
...
## [](#step-5-creating-virtual-hosts-for-apache)步骤 5 —为 Apache 创建虚拟主机
...
## [](#step-6-installing-and-configuring-nginx)步骤 6 —安装和配置 Nginx
...
## [](#step-7-configuring-nginx-for-apaches-virtual-hosts)步骤 7 —为 Apache 的虚拟主机配置 Nginx
...
## [](#step-8-installing-and-configuring-modrpaf)步骤 8 —安装和配置 mod_rpaf
...
## [](#step-9-setting-up-https-websites-with-lets-encrypt-optional)步骤 9 —使用“让我们加密”设置 HTTPS 网站(可选)
...
## [](#step-10-blocking-direct-access-to-apache-optional)步骤 10 —阻止对 Apache 的直接访问(可选)
...
## [](#step-11-serving-static-files-using-nginx-optional)步骤 11 —使用 Nginx 提供静态文件(可选)
